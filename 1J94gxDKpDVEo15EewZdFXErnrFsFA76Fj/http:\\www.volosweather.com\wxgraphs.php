http://www.volosweather.com/wxgraphs.php
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 17:39:39 GMT
Server: Apache
Expires: Thu, 19 Nov 1981 08:52:00 GMT
Cache-Control: no-store, no-cache, must-revalidate, post-check=0, pre-check=0
Pragma: no-cache
Set-Cookie: PHPSESSID=r5hpv43pj148vigak0ct9tfo33; path=/
...
<meta name="document-distribution" content="Global"/>
    ...
    <title>Volos Weather, Greece - Trend Graphs</title>
	 ...
	 Volos Weather, Greece</a>
	  ...
	  <div class="headerTemp">
	    <span class="doNotPrint">
 		  <span class="ajax" id="ajaxbigtemp">29&deg;C		  </span>
		</span>
 	  </div>
...
<div class="ajaxgizmo">
   <div class="doNotPrint">
	  <!-- ##### start of AJAX gizmo ##### -->
		...
		<span class="ajax" id="gizmodate">22/07/2014 20:35</span>&nbsp; 
	  ...
	  <br/>&nbsp;<img src="./ajax-images/spacer.gif" height="14" width="1" alt=" " />
		...
		<span class="ajaxcontent1" style="display: none">�����������: 
			<span class="ajax" id="gizmotemp">29.3&deg;C</span>
            
	        <span class="ajax" id="gizmotemparrow"><img src="./ajax-images/falling.gif" alt="��������� 1.3&deg;C ��� ��������� ���." title="��������� 1.3&deg;C ��� ��������� ���." width="7" height="8" style="border: 0; margin: 1px 3px;" />			</span>&nbsp;
			<span class="ajax" id="gizmotemprate">-1.3</span> 
			/hr		</span>
		...
		<span class="ajaxcontent3" style="display: none">������ ������: 
		  <span class="ajax" id="gizmodew">20.7&deg;C</span>		</span>
		...
		<span class="ajaxcontent6" style="display: none">���������: 
    		<span class="ajax" id="gizmobaro">1002.92  hPa</span><img src="./ajax-images/rising.gif" alt="��������� 0.2  hPa/hr" title="��������� 0.2  hPa/hr" width="7" height="8" style="border: 0; margin: 1px 3px;" />&nbsp;
...
<div id="main-copy">
    ...
    <p>Graphs generated by Cumulus 	 (1.9.0-b958)</p>
        


   <h2>����������� / �������</h2>
  <img src="./images/temp.png" alt="Temperature" width="620" height="248" />
  <br />
  <img src="./images/hum.png" alt="Humidity" width="620" height="248" />
  <br />
  <img src="./images/intemp.png" alt="Rain Rate" width="620" height="248" />
  <br />
  <h2>������ / ���������</h2>
  <img src="./images/wind.png" alt="Wind Speed" width="620" height="248" />
  <br />
  <img src="./images/windd.png" alt="Wind Direction" width="620" height="248" />
  <br />
  <img src="./images/press.png" alt="Barometer" width="620" height="248" />
  <br />
  <h2>�����</h2>
  <img src="./images/raint.png" alt="Rain" width="620" height="248" />
  <br />
  <img src="./images/rain.png" alt="Rain Rate" width="620" height="248" />
  <br />
