http://boards.420chan.org/1701/7.php
HTTP/1.0 200 OK
...
Connection: close
Date: Wed, 23 Jul 2014 04:15:13 GMT
Server: lighttpd/1.4.31

  <!DOCTYPE HTML> <html> <head> <title> STAR TREK FUCK YEAH - 420chan </title> <meta http-equiv="Content-Type" content="text/html;charset=utf-8" /> <link rel="shortcut icon" type="image/png" href="/static/images/board_icons/1701_icon_64.png" /> <link rel="apple-touch-icon-precomposed" href="/static/images/board_icons/1701_icon_128.png" /> <script type="text/javascript">var style_cookie="";</script> <link rel="stylesheet" type="text/css" href="/static/css/brandbar.css" /> <!-- Core JS Libraries --> <script type="text/javascript" src="http://cdn.420chan.org/j/jquery.min.js"></script> <!-- 420chan JS Libraries --> <script type="text/javascript" src="/static/min/?g=js&amp;v=10"></script> <script type="text/javascript" src="http://static.wowhead.com/widgets/power.js"></script> 	<link rel="stylesheet" type="text/css" href="/static/css/menus.css" />	
	...
	<link rel="stylesheet" type="text/css" href="/static/css/layout.css" />	
			...
			if ( Get_Cookie( 'test' ) )
			{
				cookie_set = true;
				Delete_Cookie('test', '/', '');
				// window.location = 'http://cdn.420chan.org/u/splash/?t=http://boards.420chan.org/1701/7.php';
			}
			else
			cookie_set = false;
			</script>
...
<li><a class='boardlink' title='Hentai' href='/h'><div class='icons' id='icon_h'></div>Hentai</a></li>
	...
	<div id="xmers"></div>
	 <div id="header"> <div id="board_logo"> <a href="/1701/" style="text-decoration:none; color:inherit;"> <img class="board_icon" src="/static/images/board_icons/1701_icon_64.png" alt="/1701/ Icon" /> <p class="board_title_block"> <span class="board_name">/1701/</span> <span class="board_title">STAR TREK FUCK YEAH</span> </p> </a> </div>	 <div id="derps" style="width:468px; height:60px; float: right; display: block;"> </div> </div><div id="content"> 	<div style="width: 100%; text-align: center; font-size: 18px; font-weight: bold; line-height: 22px; margin: 5px auto">
	...
	<!-- <div class="rss">
	 ...
	 <!--  --> <!-- <div class="rss"> <a href="http://420chan.org/donate/" style="font-size: 1.4em; font-weight: bold; margin: 2px 0;">420chan "Donate-or-Die" Donation FAQ</a> </div> -->   <div class="postarea"> <form id="postform" action="/1701/taimaba.pl" method="post" enctype="multipart/form-data"> <input type="hidden" name="board" value="1701" /> <input type="hidden" name="task" value="post" /> <input title="Password" type="hidden" name="password" size="8" />     <div class="trap"> Leave these fields empty (spam trap): <input type="text" name="name" size="28" autocomplete="off" /> <input type="text" name="link" size="28" autocomplete="off" /> </div>  <table> <tbody>  <tr> <td class="postblock">Name</td> <td> <input title="Name" type="text" name="field1" style="width:224px;" /> <div class="tooltip">  You can leave this blank to post anonymously, or you can create a Tripcode by using the float <b>Name#Password</b> </div>					 </td> </tr>    <tr style="font-weight: bold;"><td style="text-align: center;">A subject is required when posting a new thread</td></tr>   <tr> <td class="postblock">Subject</td> <td> <input title="Subject" type="text" name="field3" style="width:354px;" /> <div style="display:none;"></div> <input type="submit" value="Submit Post" class="postsubmit" style="width:96px;" /> <div style="display:none;"></div> </td> </tr>   <tr> <td class="postblock">Comment</td> <td> <textarea title="Comment" name="field4" rows="4" style="width:456px;" cols="50"></textarea> <div class="tooltip"> [*]<i>Italic Text</i>[/*] <br /> [**]<b>Bold Text</b>[/**] <br />									 [~]Taimapedia Article[/~] <br /> [%]Spoiler Text[/%] <br /> <span class="unkfunc">&gt;Highlight/Quote Text</span> <br /> [pre]Preformatted &amp; Monospace text[/pre] <br /> 1. Numbered lists become ordered lists <br /> * Bulleted lists become unordered lists <br /> </div> </td> </tr> <!-- <tr> <td> <input type="button" name="b" value="Bold" onclick="this.form.field4.value=this.form.field4.value.concat('[b][/b]');" /> <input type="button" name="i" value="Italic" onclick="this.form.field4.value=this.form.field4.value.concat('[i][/i]');" /> <input type="button" name="taimapedia" value="Taimapedia" onclick="this.form.field4.value=this.form.field4.value.concat('[taimapedia][/taimapedia]');" /> <input type="button" name="spoiler" value="Spoiler" onclick="this.form.field4.value=this.form.field4.value.concat('[spoiler][/spoiler]');"> </td> </tr> -->  <tr> <td class="postblock">File</td> <td> <input type="file" name="file" /> <div style="display:none;"></div>  <label> <input type="checkbox" name="sage" value="on" /> No Bump </label> <p style="display:none;"></p> <a href="/static/sandwich.php" class="popup"> <span class="sandwich"></span>Sandwich </a> </td> </tr>  <!-- <tr> <td class="postblock">Password</td> <td> <input title="Password" type="hidden" name="password" size="8" /> <div style="display:none;"></div> (Password for post and file deletion) </td>				 </tr> --> </tbody> </table> </form> </div>  <script type="text/javascript">set_inputs("postform")</script> <div id="rules"> <ul> <li>Supported file types are: GIF, JPG, PNG</li> <li>Maximum file size allowed is 3000KB.</li> <li>Images greater than 200x200 pixels will be thumbnailed.</li> <li>No personal contact info is to be posted under any circumstances.</li> <li>This is a work-safe board. Posting adult images is forbidden.</li>			  </ul> </div> <hr style="margin-bottom:2px;" /> 		<div style="margin: 5px auto 1px; width: 728px;">
			<a target="_blank" href="http://420chan.org/advertise"><img src="http://cdn.420chan.org/sp/YOUR-AD-HERE.gif"></a>
		</div>
		 <hr style="margin-top:2px;" />   <form id="delform" action="/1701/taimaba.pl" method="post" style="margin-top: none;"> <input type="hidden" name="board" value="1701" />    <div id="1701thread43415"> <div class="thread_header"> <a id="43415"></a> <span class="filetitle">Worst Star Trek Support Character</span>  <span class="inbetween"> by </span> <span class="postername">Admiral Adama</span>  <span class="inbetween"> - <span class="idhighlight">Thu, 13 Mar 2014 01:39:08 EST ID:xKtlUxom</span></span>  <span class="reflink"> <a href="/1701/res/43415.php#i43415">No.43415</a> </span>    			 <!--  - Awesome Thread? <a href="/1701/taimaba.pl?board=1701&amp;task=vote&amp;thread=43415&amp;vote=0">No!</a> | <a href="/1701/taimaba.pl?board=1701&amp;task=vote&amp;thread=43415&amp;vote=1">Yes!</a>  -->   <a class="ignorebtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="toggleIgnored('170131323035303334393234')" title="Ignore User"> <span class="ui-icon ui-icon-cancel"></span>Ignore </a>  <a class="rptbtn fg-button ui-state-default fg-button-icon-left ui-corner-all" onclick="openReport('43415')" title="Report Thread 43415"> <span class="ui-icon ui-icon-alert"></span>Report </a>  <a class="fg-button ui-state-default fg-button-icon-left ui-corner-all" href="/1701/res/43415.php"> <span class="ui-icon ui-icon-comment"></span>Reply </a>  <a class="opqrbtn fg-button ui-state-default fg-button-icon-left ui-corner-all" data-num="43415" data-thread="43415"> <span class="ui-icon ui-icon-comment"></span>Quick Reply </a>  <!--<i style="color: #148BB7; font-size:16px; margin-left: 5px;"class="glyphicon glyphicon-birthday_cake"></i>--> <div class="hidethread" style="float: right; font-size: 10px; margin-right: 4px;"><a class="hidelink" href="javascript:toggleHidden('1701thread43415');">Hide Thread</a></div> </div>  <span class="filesize"> <a target="_blank" href="/1701/src/1394689148532.jpg"> 1394689148532.jpg </a> -(<em>180265 B, 694x530</em>) <span class="thumbnailmsg"> Thumbnail displayed, click image for full size. </span> </span>  <a onclick="return imageExpansion(this)" class="img170131323035303334393234" target="_blank" href="/1701/src/1394689148532.jpg"> <img src="/1701/thumb/1394689148532s.jpg" alt="180265" class="thumb" /> </a>   			 <blockquote class="opcomment 170131323035303334393234">  Worst Star Trek character?<br><blockquote class = "unkfunc">&gt;pic related</blockquote>   </blockquote>   				 				  <span class="omittedposts">  76 posts and 21 images omitted. Click Reply to view.   </span>       <table><tbody><tr><td class="doubledash"><a href="/1701/res/43415.php#43933" onclick="highlight(43933);">&gt;&gt;</a></td> <td class="reply" id="reply43933"> <a id="43933"></a> <div class="replyheader"> 									 <span class="commentpostername">Ranjen Solbor</span>  - <span class="idhighlight">Thu, 10 Apr 2014 05:30:49 EST ID:05BCh7yT</span> <span class="reflink">  <a href="/1701/res/43415.php#i43933">No.43933</a>   </span>  <a class="ignorebtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="toggleIgnored('170132373139303635333236')" title="Ignore User"> <span class="ui-icon ui-icon-cancel"></span>Ignore </a>  <a class="rptbtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="openReport('43933', '43415')" title="Report Post 43933"> <span class="ui-icon ui-icon-alert"></span>Report </a> <a class="qrbtn fg-button ui-state-default fg-button-icon-left ui-corner-all" data-num="43933" data-thread="43415"> <span class="ui-icon ui-icon-comment"></span>Quick Reply </a>  <!--<i style="color: #934A9A; font-size:16px; margin-left: 5px;"class="glyphicon  glyphicon-birthday_cake"></i>--> </div>  <blockquote  class="170132373139303635333236">  <a href = "/1701/res/43415.php#43932" onclick = "highlight(43932)">&gt;&gt;43932</a><br><br>patack!   </blockquote>    				 </td> </tr> </tbody> </table>     <table><tbody><tr><td class="doubledash"><a href="/1701/res/43415.php#43936" onclick="highlight(43936);">&gt;&gt;</a></td> <td class="reply" id="reply43936"> <a id="43936"></a> <div class="replyheader"> 									 <span class="commentpostername">Lt. Joseph Carey</span>  - <span class="idhighlight">Thu, 10 Apr 2014 08:28:31 EST ID:FP2EfQGj</span> <span class="reflink">  <a href="/1701/res/43415.php#i43936">No.43936</a>   </span>  <a class="ignorebtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="toggleIgnored('170131323831393132303330')" title="Ignore User"> <span class="ui-icon ui-icon-cancel"></span>Ignore </a>  <a class="rptbtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="openReport('43936', '43415')" title="Report Post 43936"> <span class="ui-icon ui-icon-alert"></span>Report </a> <a class="qrbtn fg-button ui-state-default fg-button-icon-left ui-corner-all" data-num="43936" data-thread="43415"> <span class="ui-icon ui-icon-comment"></span>Quick Reply </a>  <!--<i style="color: #CB89B5; font-size:16px; margin-left: 5px;"class="glyphicon  glyphicon-birthday_cake"></i>--> </div>  <blockquote  class="170131323831393132303330">  <a href = "/1701/res/43415.php#43932" onclick = "highlight(43932)">&gt;&gt;43932</a><br>I think his biggest victory in TNG was the duel with Durras.<br><span class="spoiler" onmouseover=""><span>Although he seemed to have a harder time dealing with that guy&#39;s sisters.</span></span>   </blockquote>    				 </td> </tr> </tbody> </table>     <table><tbody><tr><td class="doubledash"><a href="/1701/res/43415.php#43940" onclick="highlight(43940);">&gt;&gt;</a></td> <td class="reply" id="reply43940"> <a id="43940"></a> <div class="replyheader"> 									 <span class="commentpostername">M'ret</span>  - <span class="idhighlight">Thu, 10 Apr 2014 15:01:09 EST ID:x+l3P6VT</span> <span class="reflink">  <a href="/1701/res/43415.php#i43940">No.43940</a>   </span>  <a class="ignorebtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="toggleIgnored('1701343037353039363832')" title="Ignore User"> <span class="ui-icon ui-icon-cancel"></span>Ignore </a>  <a class="rptbtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="openReport('43940', '43415')" title="Report Post 43940"> <span class="ui-icon ui-icon-alert"></span>Report </a> <a class="qrbtn fg-button ui-state-default fg-button-icon-left ui-corner-all" data-num="43940" data-thread="43415"> <span class="ui-icon ui-icon-comment"></span>Quick Reply </a>  <!--<i style="color: #053DF3; font-size:16px; margin-left: 5px;"class="glyphicon  glyphicon-birthday_cake"></i>--> </div>  <blockquote  class="1701343037353039363832">  <a href = "/1701/res/43415.php#43930" onclick = "highlight(43930)">&gt;&gt;43930</a><br>Youth fades sure, but holy fuck, this is like a star imploding or something, if it were a bomb it&#39;d be like the Czar Bomba fj fklaw jlaw j   </blockquote>    				 </td> </tr> </tbody> </table>     <table><tbody><tr><td class="doubledash"><a href="/1701/res/43415.php#43955" onclick="highlight(43955);">&gt;&gt;</a></td> <td class="reply" id="reply43955"> <a id="43955"></a> <div class="replyheader"> 									 <span class="commentpostername">KC Hunter</span>  - <span class="idhighlight">Fri, 11 Apr 2014 04:48:04 EST ID:qG5gyf0E</span> <span class="reflink">  <a href="/1701/res/43415.php#i43955">No.43955</a>   </span>  <a class="ignorebtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="toggleIgnored('1701383530303439323637')" title="Ignore User"> <span class="ui-icon ui-icon-cancel"></span>Ignore </a>  <a class="rptbtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="openReport('43955', '43415')" title="Report Post 43955"> <span class="ui-icon ui-icon-alert"></span>Report </a> <a class="qrbtn fg-button ui-state-default fg-button-icon-left ui-corner-all" data-num="43955" data-thread="43415"> <span class="ui-icon ui-icon-comment"></span>Quick Reply </a>  <!--<i style="color: #31E23A; font-size:16px; margin-left: 5px;"class="glyphicon  glyphicon-birthday_cake"></i>--> </div>  <blockquote  class="1701383530303439323637">  <blockquote class = "unkfunc">&gt;hating on worf</blockquote>   </blockquote>    				 </td> </tr> </tbody> </table>     <table><tbody><tr><td class="doubledash"><a href="/1701/res/43415.php#43962" onclick="highlight(43962);">&gt;&gt;</a></td> <td class="reply" id="reply43962"> <a id="43962"></a> <div class="replyheader"> 									 <span class="commentpostername">Greskrendtregk</span>  - <span class="idhighlight">Fri, 11 Apr 2014 17:34:27 EST ID:9Rx7E1s7</span> <span class="reflink">  <a href="/1701/res/43415.php#i43962">No.43962</a>   </span>  <a class="ignorebtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="toggleIgnored('170131383134353331363237')" title="Ignore User"> <span class="ui-icon ui-icon-cancel"></span>Ignore </a>  <a class="rptbtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="openReport('43962', '43415')" title="Report Post 43962"> <span class="ui-icon ui-icon-alert"></span>Report </a> <a class="qrbtn fg-button ui-state-default fg-button-icon-left ui-corner-all" data-num="43962" data-thread="43415"> <span class="ui-icon ui-icon-comment"></span>Quick Reply </a>  <!--<i style="color: #8FB853; font-size:16px; margin-left: 5px;"class="glyphicon  glyphicon-birthday_cake"></i>--> </div>  <blockquote  class="170131383134353331363237">  The most heroic thing Worf did was tag in for General Martok when they were in that Dominion prison.   </blockquote>    				 </td> </tr> </tbody> </table>   <br style="clear: left;" /> </div> <hr class="threadend" />    <div id="1701thread43876"> <div class="thread_header"> <a id="43876"></a> <span class="filetitle">So, lets take a look at what Janeway has been up to!</span>  <span class="inbetween"> by </span> <span class="postername">Icheb</span>  <span class="inbetween"> - <span class="idhighlight">Mon, 07 Apr 2014 21:34:20 EST ID:a0rHx5Jw</span></span>  <span class="reflink"> <a href="/1701/res/43876.php#i43876">No.43876</a> </span>    			 <!--  -->   <a class="ignorebtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="toggleIgnored('170131323638343331343939')" title="Ignore User"> <span class="ui-icon ui-icon-cancel"></span>Ignore </a>  <a class="rptbtn fg-button ui-state-default fg-button-icon-left ui-corner-all" onclick="openReport('43876')" title="Report Thread 43876"> <span class="ui-icon ui-icon-alert"></span>Report </a>  <a class="fg-button ui-state-default fg-button-icon-left ui-corner-all" href="/1701/res/43876.php"> <span class="ui-icon ui-icon-comment"></span>Reply </a>  <a class="opqrbtn fg-button ui-state-default fg-button-icon-left ui-corner-all" data-num="43876" data-thread="43876"> <span class="ui-icon ui-icon-comment"></span>Quick Reply </a>  <!--<i style="color: #A4D860; font-size:16px; margin-left: 5px;"class="glyphicon glyphicon-birthday_cake"></i>--> <div class="hidethread" style="float: right; font-size: 10px; margin-right: 4px;"><a class="hidelink" href="javascript:toggleHidden('1701thread43876');">Hide Thread</a></div> </div>  <span class="filesize"> <a target="_blank" href="/1701/src/1396920860004.jpg"> 1396920860004.jpg </a> -(<em>54803 B, 634x530</em>) <span class="thumbnailmsg"> Thumbnail displayed, click image for full size. </span> </span>  <a onclick="return imageExpansion(this)" class="img170131323638343331343939" target="_blank" href="/1701/src/1396920860004.jpg"> <img src="/1701/thumb/1396920860004s.jpg" alt="54803" class="thumb" /> </a>   			 <blockquote class="opcomment 170131323638343331343939">  Oh no!<br><br><a href="http://t.co/vp4X6kwtuF" rel="nofollow" target="_blank">http://t.co/vp4X6kwtuF</a>   </blockquote>   				 				  <span class="omittedposts">  8 posts and 3 images omitted. Click Reply to view.   </span>       <table><tbody><tr><td class="doubledash"><a href="/1701/res/43876.php#43909" onclick="highlight(43909);">&gt;&gt;</a></td> <td class="reply" id="reply43909"> <a id="43909"></a> <div class="replyheader"> 									 <span class="commentpostername">Senator Pardek</span>  - <span class="idhighlight">Wed, 09 Apr 2014 11:46:22 EST ID:KGQuWJQR</span> <span class="reflink">  <a href="/1701/res/43876.php#i43909">No.43909</a>   </span>  <a class="ignorebtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="toggleIgnored('170131323633383230393538')" title="Ignore User"> <span class="ui-icon ui-icon-cancel"></span>Ignore </a>  <a class="rptbtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="openReport('43909', '43876')" title="Report Post 43909"> <span class="ui-icon ui-icon-alert"></span>Report </a> <a class="qrbtn fg-button ui-state-default fg-button-icon-left ui-corner-all" data-num="43909" data-thread="43876"> <span class="ui-icon ui-icon-comment"></span>Quick Reply </a>  <!--<i style="color: #B6C21E; font-size:16px; margin-left: 5px;"class="glyphicon  glyphicon-birthday_cake"></i>--> </div>  <span class="filesize"> <a target="_blank" href="/1701/src/1397058382059.jpg"> 1397058382059.jpg </a> -(<em>11008 B, 394x319</em>) <span class="thumbnailmsg">Thumbnail displayed, click image for full size.</span> </span>  <a onclick="return imageExpansion(this)" target="_blank" href="/1701/src/1397058382059.jpg"> <img src="/1701/thumb/1397058382059s.jpg" alt="11008" class="thumb" /> </a>    <blockquote  class="170131323633383230393538">  <blockquote class = "unkfunc">&gt;About one in four Americans surveyed in a recent poll were unaware the Earth orbited the sun.</blockquote>   </blockquote>    				 </td> </tr> </tbody> </table>     <table><tbody><tr><td class="doubledash"><a href="/1701/res/43876.php#43915" onclick="highlight(43915);">&gt;&gt;</a></td> <td class="reply" id="reply43915"> <a id="43915"></a> <div class="replyheader"> 									 <span class="commentpostername">Nevala</span>  - <span class="idhighlight">Wed, 09 Apr 2014 19:03:26 EST ID:FP2EfQGj</span> <span class="reflink">  <a href="/1701/res/43876.php#i43915">No.43915</a>   </span>  <a class="ignorebtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="toggleIgnored('170131323831393132303330')" title="Ignore User"> <span class="ui-icon ui-icon-cancel"></span>Ignore </a>  <a class="rptbtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="openReport('43915', '43876')" title="Report Post 43915"> <span class="ui-icon ui-icon-alert"></span>Report </a> <a class="qrbtn fg-button ui-state-default fg-button-icon-left ui-corner-all" data-num="43915" data-thread="43876"> <span class="ui-icon ui-icon-comment"></span>Quick Reply </a>  <!--<i style="color: #A53037; font-size:16px; margin-left: 5px;"class="glyphicon  glyphicon-birthday_cake"></i>--> </div>  <blockquote  class="170131323831393132303330">  <a href = "/1701/res/43876.php#43909" onclick = "highlight(43909)">&gt;&gt;43909</a><br>Yeah, sorry. I don&#39;t buy that. I have known a lot of people, some I would describe as low-grade morons. I have never met anyone, from any generation, who was that stupid. I have known a lot of people who would answer that way on surveys just for shits and giggles tho.   </blockquote>    				 </td> </tr> </tbody> </table>     <table><tbody><tr><td class="doubledash"><a href="/1701/res/43876.php#43921" onclick="highlight(43921);">&gt;&gt;</a></td> <td class="reply" id="reply43921"> <a id="43921"></a> <div class="replyheader"> 									 <span class="commentpostername">Prophet</span>  - <span class="idhighlight">Wed, 09 Apr 2014 21:01:23 EST ID:4KuGUsyR</span> <span class="reflink">  <a href="/1701/res/43876.php#i43921">No.43921</a>   </span>  <a class="ignorebtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="toggleIgnored('170131363631343433323730')" title="Ignore User"> <span class="ui-icon ui-icon-cancel"></span>Ignore </a>  <a class="rptbtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="openReport('43921', '43876')" title="Report Post 43921"> <span class="ui-icon ui-icon-alert"></span>Report </a> <a class="qrbtn fg-button ui-state-default fg-button-icon-left ui-corner-all" data-num="43921" data-thread="43876"> <span class="ui-icon ui-icon-comment"></span>Quick Reply </a>  <!--<i style="color: #5AC86C; font-size:16px; margin-left: 5px;"class="glyphicon  glyphicon-birthday_cake"></i>--> </div>  <blockquote  class="170131363631343433323730">  I&#39;m so fucking disappointed. <br><br>I&#39;m gonna watch the Cosmos and cry.   </blockquote>    				 </td> </tr> </tbody> </table>     <table><tbody><tr><td class="doubledash"><a href="/1701/res/43876.php#43986" onclick="highlight(43986);">&gt;&gt;</a></td> <td class="reply" id="reply43986"> <a id="43986"></a> <div class="replyheader"> 									 <span class="commentpostername">Subcommander Velal</span>  - <span class="idhighlight">Sat, 12 Apr 2014 07:53:58 EST ID:yoT3Xk9o</span> <span class="reflink">  <a href="/1701/res/43876.php#i43986">No.43986</a>   </span>  <a class="ignorebtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="toggleIgnored('1701333934323137393432')" title="Ignore User"> <span class="ui-icon ui-icon-cancel"></span>Ignore </a>  <a class="rptbtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="openReport('43986', '43876')" title="Report Post 43986"> <span class="ui-icon ui-icon-alert"></span>Report </a> <a class="qrbtn fg-button ui-state-default fg-button-icon-left ui-corner-all" data-num="43986" data-thread="43876"> <span class="ui-icon ui-icon-comment"></span>Quick Reply </a>  <!--<i style="color: #7DED0F; font-size:16px; margin-left: 5px;"class="glyphicon  glyphicon-birthday_cake"></i>--> </div>  <span class="filesize"> <a target="_blank" href="/1701/src/1397303638655.gif"> 1397303638655.gif </a> -(<em>53227 B, 640x199</em>) <span class="thumbnailmsg">Thumbnail displayed, click image for full size.</span> </span>  <a onclick="return imageExpansion(this)" target="_blank" href="/1701/src/1397303638655.gif"> <img src="/1701/thumb/1397303638655s.jpg" alt="53227" class="thumb" /> </a>    <blockquote  class="1701333934323137393432">  <a href = "/1701/res/43876.php#43909" onclick = "highlight(43909)">&gt;&gt;43909</a>   </blockquote>    				 </td> </tr> </tbody> </table>     <table><tbody><tr><td class="doubledash"><a href="/1701/res/43876.php#43993" onclick="highlight(43993);">&gt;&gt;</a></td> <td class="reply" id="reply43993"> <a id="43993"></a> <div class="replyheader"> 									 <span class="commentpostername">Subcommander Velal</span>  - <span class="idhighlight">Sat, 12 Apr 2014 17:03:23 EST ID:yoT3Xk9o</span> <span class="reflink">  <a href="/1701/res/43876.php#i43993">No.43993</a>   </span>  <a class="ignorebtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="toggleIgnored('1701333934323137393432')" title="Ignore User"> <span class="ui-icon ui-icon-cancel"></span>Ignore </a>  <a class="rptbtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="openReport('43993', '43876')" title="Report Post 43993"> <span class="ui-icon ui-icon-alert"></span>Report </a> <a class="qrbtn fg-button ui-state-default fg-button-icon-left ui-corner-all" data-num="43993" data-thread="43876"> <span class="ui-icon ui-icon-comment"></span>Quick Reply </a>  <!--<i style="color: #27C2EC; font-size:16px; margin-left: 5px;"class="glyphicon  glyphicon-birthday_cake"></i>--> </div>  <blockquote  class="1701333934323137393432">  <a href = "/1701/res/43876.php#43915" onclick = "highlight(43915)">&gt;&gt;43915</a><br><br>It&#39;s mostly bullshit. The data comes from the Nation Science Foundation&#39;s &quot;Science &amp; Education Indicators&quot; meta study. The question in this case came from another study done by survey and it reads like this:<br><br><blockquote class = "unkfunc">&gt;Does the Earth go around the Sun, or does the Sun go around the Earth? <br></blockquote><br>It seems straight forward, except the survey had about a thousand questions. It&#39;s easy to see how someone quickly working through a lengthy questionnaire could confuse two similarly worded statements.<br><br>The SEI compares data from different countries. According to it, only two-thirds of people in the EU know the earth revolves around the sun and only 1/3 of Japanese people know electrons are smaller than atoms.<br><br>Surveys man, surveys.   </blockquote>    				 </td> </tr> </tbody> </table>   <br style="clear: left;" /> </div> <hr class="threadend" />    <div id="1701thread43801"> <div class="thread_header"> <a id="43801"></a> <span class="filetitle">Star Trek Into Blackout</span>  <span class="inbetween"> by </span> <span class="postername">John Cusack</span>  <span class="inbetween"> - <span class="idhighlight">Sun, 06 Apr 2014 01:38:20 EST ID:a1dhqo0x</span></span>  <span class="reflink"> <a href="/1701/res/43801.php#i43801">No.43801</a> </span>    			 <!--  - Awesome Thread? <a href="/1701/taimaba.pl?board=1701&amp;task=vote&amp;thread=43801&amp;vote=0">No!</a> | <a href="/1701/taimaba.pl?board=1701&amp;task=vote&amp;thread=43801&amp;vote=1">Yes!</a>  -->   <a class="ignorebtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="toggleIgnored('170131303232343338323831')" title="Ignore User"> <span class="ui-icon ui-icon-cancel"></span>Ignore </a>  <a class="rptbtn fg-button ui-state-default fg-button-icon-left ui-corner-all" onclick="openReport('43801')" title="Report Thread 43801"> <span class="ui-icon ui-icon-alert"></span>Report </a>  <a class="fg-button ui-state-default fg-button-icon-left ui-corner-all" href="/1701/res/43801.php"> <span class="ui-icon ui-icon-comment"></span>Reply </a>  <a class="opqrbtn fg-button ui-state-default fg-button-icon-left ui-corner-all" data-num="43801" data-thread="43801"> <span class="ui-icon ui-icon-comment"></span>Quick Reply </a>  <!--<i style="color: #09FF56; font-size:16px; margin-left: 5px;"class="glyphicon glyphicon-birthday_cake"></i>--> <div class="hidethread" style="float: right; font-size: 10px; margin-right: 4px;"><a class="hidelink" href="javascript:toggleHidden('1701thread43801');">Hide Thread</a></div> </div>  <span class="filesize"> <a target="_blank" href="/1701/src/1396762700472.png"> 1396762700472.png </a> -(<em>533228 B, 542x700</em>) <span class="thumbnailmsg"> Thumbnail displayed, click image for full size. </span> </span>  <a onclick="return imageExpansion(this)" class="img170131303232343338323831" target="_blank" href="/1701/src/1396762700472.png"> <img src="/1701/thumb/1396762700472s.jpg" alt="533228" class="thumb" /> </a>   			 <blockquote class="opcomment 170131303232343338323831">  Hey all - my name&#39;s John Cusack and for the next hour and a half or so I will be liveposting all my reactions to the 2013 smash hit Star Trek Into Darkness.<br><br>I&#39;ve never seen it before and have avoided most spoilers <span class="spoiler" onmouseover=""><span>except Khan, which was pretty fucking obvious from the second it was announced.</span></span><br><br>I&#39;ll also be taking a shot of whiskey every time I see a lens flare - so expect everything to get more and more incoherent as time wears on.<br><br>Feel free to jump in with any contribution whenever you feel.<br><br>OKAY, GO:   </blockquote>   				 				  <span class="omittedposts">   21 posts omitted. Click Reply to view.  </span>       <table><tbody><tr><td class="doubledash"><a href="/1701/res/43801.php#43852" onclick="highlight(43852);">&gt;&gt;</a></td> <td class="reply" id="reply43852"> <a id="43852"></a> <div class="replyheader"> 									 <span class="commentpostername">John Cusack</span>  - <span class="idhighlight">Mon, 07 Apr 2014 03:00:02 EST ID:a1dhqo0x</span> <span class="reflink">  <a href="/1701/res/43801.php#i43852">No.43852</a>   </span>  <a class="ignorebtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="toggleIgnored('170131303232343338323831')" title="Ignore User"> <span class="ui-icon ui-icon-cancel"></span>Ignore </a>  <a class="rptbtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="openReport('43852', '43801')" title="Report Post 43852"> <span class="ui-icon ui-icon-alert"></span>Report </a> <a class="qrbtn fg-button ui-state-default fg-button-icon-left ui-corner-all" data-num="43852" data-thread="43801"> <span class="ui-icon ui-icon-comment"></span>Quick Reply </a>  <!--<i style="color: #842819; font-size:16px; margin-left: 5px;"class="glyphicon  glyphicon-birthday_cake"></i>--> </div>  <blockquote  class="170131303232343338323831">  All in all - what a stupid film that didn&#39;t make any fucking sense at all, wherein the conflict exclusively served the momentum of the story. Such a retarded piece of motherfucking shit...<br><br>Although I will say that the action set-pieces worked well as action set-pieces...<br><br>Now, if you&#39;ll excuse me, I&#39;m off to buy a bunch of fucking drugs...   </blockquote>    				 </td> </tr> </tbody> </table>     <table><tbody><tr><td class="doubledash"><a href="/1701/res/43801.php#43861" onclick="highlight(43861);">&gt;&gt;</a></td> <td class="reply" id="reply43861"> <a id="43861"></a> <div class="replyheader"> 									 <span class="commentpostername">Tekeny Ghemor</span>  - <span class="idhighlight">Mon, 07 Apr 2014 19:03:19 EST ID:K+N+SgTM</span> <span class="reflink">  <a href="/1701/res/43801.php#i43861">No.43861</a>   </span>  <a class="ignorebtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="toggleIgnored('1701343034393034323031')" title="Ignore User"> <span class="ui-icon ui-icon-cancel"></span>Ignore </a>  <a class="rptbtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="openReport('43861', '43801')" title="Report Post 43861"> <span class="ui-icon ui-icon-alert"></span>Report </a> <a class="qrbtn fg-button ui-state-default fg-button-icon-left ui-corner-all" data-num="43861" data-thread="43801"> <span class="ui-icon ui-icon-comment"></span>Quick Reply </a>  <!--<i style="color: #62FF8D; font-size:16px; margin-left: 5px;"class="glyphicon  glyphicon-birthday_cake"></i>--> </div>  <blockquote  class="1701343034393034323031">  <a href = "/1701/res/43801.php#43833" onclick = "highlight(43833)">&gt;&gt;43833</a><br><br><blockquote class = "unkfunc">&gt;58:00 The LensTrek Enterprise&#39;s machinery looks like a place you&#39;d brew beer. Warp drives in TNG looked much cooler...<br></blockquote>SO MUCH THIS. Engineering looks like some sort of shitty factory.   </blockquote>    				 </td> </tr> </tbody> </table>     <table><tbody><tr><td class="doubledash"><a href="/1701/res/43801.php#43874" onclick="highlight(43874);">&gt;&gt;</a></td> <td class="reply" id="reply43874"> <a id="43874"></a> <div class="replyheader"> 									 <span class="commentpostername">Icheb</span>  - <span class="idhighlight">Mon, 07 Apr 2014 21:14:51 EST ID:a0rHx5Jw</span> <span class="reflink">  <a href="/1701/res/43801.php#i43874">No.43874</a>   </span>  <a class="ignorebtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="toggleIgnored('170131323638343331343939')" title="Ignore User"> <span class="ui-icon ui-icon-cancel"></span>Ignore </a>  <a class="rptbtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="openReport('43874', '43801')" title="Report Post 43874"> <span class="ui-icon ui-icon-alert"></span>Report </a> <a class="qrbtn fg-button ui-state-default fg-button-icon-left ui-corner-all" data-num="43874" data-thread="43801"> <span class="ui-icon ui-icon-comment"></span>Quick Reply </a>  <!--<i style="color: #EF6BF2; font-size:16px; margin-left: 5px;"class="glyphicon  glyphicon-birthday_cake"></i>--> </div>  <blockquote  class="170131323638343331343939">  &gt;&gt;43873<br>It looks like the set from Space Mutiny.   </blockquote>    				 </td> </tr> </tbody> </table>     <table><tbody><tr><td class="doubledash"><a href="/1701/res/43801.php#43877" onclick="highlight(43877);">&gt;&gt;</a></td> <td class="reply" id="reply43877"> <a id="43877"></a> <div class="replyheader"> 									 <span class="commentpostername">Commander Tebok</span>  - <span class="idhighlight">Mon, 07 Apr 2014 21:45:12 EST ID:FP2EfQGj</span> <span class="reflink">  <a href="/1701/res/43801.php#i43877">No.43877</a>   </span>  <a class="ignorebtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="toggleIgnored('170131323831393132303330')" title="Ignore User"> <span class="ui-icon ui-icon-cancel"></span>Ignore </a>  <a class="rptbtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="openReport('43877', '43801')" title="Report Post 43877"> <span class="ui-icon ui-icon-alert"></span>Report </a> <a class="qrbtn fg-button ui-state-default fg-button-icon-left ui-corner-all" data-num="43877" data-thread="43801"> <span class="ui-icon ui-icon-comment"></span>Quick Reply </a>  <!--<i style="color: #9577C3; font-size:16px; margin-left: 5px;"class="glyphicon  glyphicon-birthday_cake"></i>--> </div>  <span class="filesize"> <a target="_blank" href="/1701/src/1396921512381.gif"> 1396921512381.gif </a> -(<em>1377450 B, 320x240</em>) <span class="thumbnailmsg">Thumbnail displayed, click image for full size.</span> </span>  <a onclick="return imageExpansion(this)" target="_blank" href="/1701/src/1396921512381.gif"> <img src="/1701/thumb/1396921512381s.jpg" alt="1377450" class="thumb" /> </a>    <blockquote  class="170131323831393132303330">  <a href = "/1701/res/43801.php#43874" onclick = "highlight(43874)">&gt;&gt;43874</a><br>;)   </blockquote>    				 </td> </tr> </tbody> </table>     <table><tbody><tr><td class="doubledash"><a href="/1701/res/43801.php#43880" onclick="highlight(43880);">&gt;&gt;</a></td> <td class="reply" id="reply43880"> <a id="43880"></a> <div class="replyheader"> 									 <span class="commentpostername">Icheb</span>  - <span class="idhighlight">Mon, 07 Apr 2014 22:08:10 EST ID:a0rHx5Jw</span> <span class="reflink">  <a href="/1701/res/43801.php#i43880">No.43880</a>   </span>  <a class="ignorebtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="toggleIgnored('170131323638343331343939')" title="Ignore User"> <span class="ui-icon ui-icon-cancel"></span>Ignore </a>  <a class="rptbtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="openReport('43880', '43801')" title="Report Post 43880"> <span class="ui-icon ui-icon-alert"></span>Report </a> <a class="qrbtn fg-button ui-state-default fg-button-icon-left ui-corner-all" data-num="43880" data-thread="43801"> <span class="ui-icon ui-icon-comment"></span>Quick Reply </a>  <!--<i style="color: #65FDF7; font-size:16px; margin-left: 5px;"class="glyphicon  glyphicon-birthday_cake"></i>--> </div>  <blockquote  class="170131323638343331343939">  <a href = "/1701/res/43801.php#43877" onclick = "highlight(43877)">&gt;&gt;43877</a><br>I swear, if space mutiny had the same HD shit at JJ does, it&#39;d look exactly the same.   </blockquote>    				 </td> </tr> </tbody> </table>   <br style="clear: left;" /> </div> <hr class="threadend" />  <div class="harbl" style="width: 728px !important; margin: 0 auto;"> <div class="blarbl" style="font-size:10px;margin-bottom:2px;margin-top:2px;text-align:center;"> <a href="http://www.420chan.org/advertise">Advertise With Us</a> 		
...
<div id="foot">
	<div class="full_width">
		...
		<span class='byline'>Professional Wrestling Discussion - <a href='/wooo/res/3853728.php' class='boardlink'>Thread 3853728</a></span>
		<p>>>3854162
>Ascension ditch the supernatural gimmick
>Go all FUCK YOU-y

Yessss... <a href='/wooo/res/3853728.php' class='boardlink'>&#8629;</a></p></li>
<li><img width='32' height='32' class='boardicon' alt='wooo' src='/static/images/board_icons/wooo_icon_32.png' />
		<span class='byline'>Professional Wrestling Discussion - <a href='/wooo/res/3852635.php' class='boardlink'>Thread 3852635</a></span>
		<p>>>3854140
He's Canadian... <a href='/wooo/res/3852635.php' class='boardlink'>&#8629;</a></p></li>
						</ul>
					</div>
				</li>
				<div class="icon"></div>
