http://boards.420chan.org/mma/res/53244.php
HTTP/1.0 200 OK
...
Connection: close
Date: Thu, 24 Jul 2014 11:27:24 GMT
Server: lighttpd/1.4.31

  <!DOCTYPE HTML> <html> <head> <title> support joe torrez - Mixed Martial Arts Discussion - 420chan </title> <meta http-equiv="Content-Type" content="text/html;charset=utf-8" /> <link rel="shortcut icon" type="image/png" href="/static/images/board_icons/mma_icon_64.png" /> <link rel="apple-touch-icon-precomposed" href="/static/images/board_icons/mma_icon_128.png" /> <script type="text/javascript">var style_cookie="";</script> <link rel="stylesheet" type="text/css" href="/static/css/brandbar.css" /> <!-- Core JS Libraries --> <script type="text/javascript" src="http://cdn.420chan.org/j/jquery.min.js"></script> <!-- 420chan JS Libraries --> <script type="text/javascript" src="/static/min/?g=js&amp;v=10"></script> <script type="text/javascript" src="http://static.wowhead.com/widgets/power.js"></script> 	<link rel="stylesheet" type="text/css" href="/static/css/menus.css" />	
	...
	<link rel="stylesheet" type="text/css" href="/static/css/layout.css" />	
			...
			if ( Get_Cookie( 'test' ) )
			{
				cookie_set = true;
				Delete_Cookie('test', '/', '');
				// window.location = 'http://cdn.420chan.org/u/splash/?t=http://boards.420chan.org/mma/res/53244.php';
			}
			else
			cookie_set = false;
			</script>
...
<li><a class='boardlink' title='Hentai' href='/h'><div class='icons' id='icon_h'></div>Hentai</a></li>
	...
	<div id="xmers"></div>
	 <div id="header"> <div id="board_logo"> <a href="/mma/" style="text-decoration:none; color:inherit;"> <img class="board_icon" src="/static/images/board_icons/mma_icon_64.png" alt="/mma/ Icon" /> <p class="board_title_block"> <span class="board_name">/mma/</span> <span class="board_title">Mixed Martial Arts Discussion</span> </p> </a> </div>	 <div id="derps" style="width:468px; height:60px; float: right; display: block;"> </div> </div><div id="content"> 	<div style="width: 100%; text-align: center; font-size: 18px; font-weight: bold; line-height: 22px; margin: 5px auto">
	...
	<!-- <div class="rss">
	 ...
	 <!--  <div style="position: absolute; right: 2.5%;"> <ul style="text-align: right; float: right; list-style: none; margin: 5px; font-size: 11px;"> <li style="margin-bottom: 2px;">Board IRC: <a href="irc://irc.420chan.org/mma">#mma @ irc.420chan.org</a></li> <li>New to IRC? <a href="http://420chan.org/#irc">Start Here</a></li> </ul> </div>  --> <!-- <div class="rss"> <a href="http://420chan.org/donate/" style="font-size: 1.4em; font-weight: bold; margin: 2px 0;">420chan "Donate-or-Die" Donation FAQ</a> </div> -->   <div class="logo" style="font-size:16px; text-align: center; font-weight: bold;"> <a href="/mma/index.php">Replying to Thread #53244 (Return to Board)</a> </div>  <div class="postarea"> <form id="postform" action="/mma/taimaba.pl" method="post" enctype="multipart/form-data"> <input type="hidden" name="board" value="mma" /> <input type="hidden" name="task" value="post" /> <input title="Password" type="hidden" name="password" size="8" />  <input type="hidden" name="parent" value="53244" />     <div class="trap"> Leave these fields empty (spam trap): <input type="text" name="name" size="28" autocomplete="off" /> <input type="text" name="link" size="28" autocomplete="off" /> </div>  <table> <tbody>  <tr> <td class="postblock">Name</td> <td> <input title="Name" type="text" name="field1" style="width:224px;" /> <div class="tooltip">  You can leave this blank to post anonymously, or you can create a Tripcode by using the float <b>Name#Password</b> </div>					 </td> </tr>      <tr> <td> <input type="submit" value="Submit Post" class="postsubmit" style="width:96px;" /> <div style="display:none;"></div> </td> </tr>  <tr> <td class="postblock">Comment</td> <td> <textarea title="Comment" name="field4" rows="4" style="width:456px;" cols="50"></textarea> <div class="tooltip"> [*]<i>Italic Text</i>[/*] <br /> [**]<b>Bold Text</b>[/**] <br />									 [~]Taimapedia Article[/~] <br /> [%]Spoiler Text[/%] <br /> <span class="unkfunc">&gt;Highlight/Quote Text</span> <br /> [pre]Preformatted &amp; Monospace text[/pre] <br /> 1. Numbered lists become ordered lists <br /> * Bulleted lists become unordered lists <br /> </div> </td> </tr> <!-- <tr> <td> <input type="button" name="b" value="Bold" onclick="this.form.field4.value=this.form.field4.value.concat('[b][/b]');" /> <input type="button" name="i" value="Italic" onclick="this.form.field4.value=this.form.field4.value.concat('[i][/i]');" /> <input type="button" name="taimapedia" value="Taimapedia" onclick="this.form.field4.value=this.form.field4.value.concat('[taimapedia][/taimapedia]');" /> <input type="button" name="spoiler" value="Spoiler" onclick="this.form.field4.value=this.form.field4.value.concat('[spoiler][/spoiler]');"> </td> </tr> -->  <tr> <td class="postblock">File</td> <td> <input type="file" name="file" /> <div style="display:none;"></div>  <label> <input type="checkbox" name="sage" value="on" /> No Bump </label> <p style="display:none;"></p> <a href="/static/sandwich.php" class="popup"> <span class="sandwich"></span>Sandwich </a> </td> </tr>  <!-- <tr> <td class="postblock">Password</td> <td> <input title="Password" type="hidden" name="password" size="8" /> <div style="display:none;"></div> (Password for post and file deletion) </td>				 </tr> --> </tbody> </table> </form> </div>  <script type="text/javascript">set_inputs("postform")</script> <div id="rules"> <ul> <li>Supported file types are: GIF, JPG, PNG</li> <li>Maximum file size allowed is 3000KB.</li> <li>Images greater than 200x200 pixels will be thumbnailed.</li> <li>No personal contact info is to be posted under any circumstances.</li> <li>This is a work-safe board. Posting adult images is forbidden.</li>			  </ul> </div> <hr style="margin-bottom:2px;" /> 		<div style="margin: 5px auto 1px; width: 728px;">
			<a target="_blank" href="http://smash-wrestling.com"><img src="http://cdn.420chan.org/sp/smash.gif"></a>
		</div>
	 <hr style="margin-top:2px;" />  <div id="nowplaying"><p>Now Playing on /mma/tube - <a id="nptitle" href="http://taima.tv/r/mma"></a></p></div> <script type="text/javascript" charset="utf-8"> $(function(){ function update() { $.ajax({ dataType : 'json', type: "GET", url: "http://io.taima.tv/api/channels/mma", success: function(server_response){ $( '#nptitle' ).text( server_response.mediatitle ); }                                       });                        return false     }; setInterval(update, 30000); update(); });  </script>  <form id="delform" action="/mma/taimaba.pl" method="post" style="margin-top: none;"> <input type="hidden" name="board" value="mma" />    <div id="mmathread53244"> <div class="thread_header"> <a id="53244"></a> <span class="filetitle">support joe torrez</span>  <span class="inbetween"> by </span> <span class="postername">Harold Howard</span>  <span class="inbetween"> - <span class="idhighlight">Fri, 10 Jan 2014 08:41:59 EST ID:9UQUQctu</span></span>    			 <!--  -->  <span class="reflink"> <a href="javascript:insert('&gt;&gt;53244')">No.53244</a> </span>   <a class="ignorebtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="toggleIgnored('mma32383839333538303634')" title="Ignore User"> <span class="ui-icon ui-icon-cancel"></span>Ignore </a>  <a class="rptbtn fg-button ui-state-default fg-button-icon-left ui-corner-all" onclick="openReport('53244')" title="Report Thread 53244"> <span class="ui-icon ui-icon-alert"></span>Report </a>  <a class="opqrbtn fg-button ui-state-default fg-button-icon-left ui-corner-all" data-num="53244" data-thread="53244"> <span class="ui-icon ui-icon-comment"></span>Quick Reply </a>  <!--<i style="color: #F9AE7D; font-size:16px; margin-left: 5px;"class="glyphicon glyphicon-birthday_cake"></i>--> <div class="hidethread" style="float: right; font-size: 10px; margin-right: 4px;"><a class="hidelink" href="javascript:toggleHidden('mmathread53244');">Hide Thread</a></div> </div>  <span class="filesize"> <a target="_blank" href="/mma/src/1389361319969.jpg"> 1389361319969.jpg </a> -(<em>89621 B, 539x960</em>) <span class="thumbnailmsg"> Thumbnail displayed, click image for full size. </span> </span>  <a onclick="return imageExpansion(this)" class="imgmma32383839333538303634" target="_blank" href="/mma/src/1389361319969.jpg"> <img src="/mma/thumb/1389361319969s.jpg" alt="89621" class="thumb" /> </a>   			 <blockquote class="opcomment mma32383839333538303634">  Support joe torrez   </blockquote>   				 				       <table><tbody><tr><td class="doubledash"><a href="/mma/res/53244.php#53245" onclick="highlight(53245);">&gt;&gt;</a></td> <td class="reply" id="reply53245"> <a id="53245"></a> <div class="replyheader"> 									 <span class="commentpostername">Kazushi Sakuraba</span>  - <span class="idhighlight">Fri, 10 Jan 2014 15:10:47 EST ID:i+DFKD0Y</span> <span class="reflink">   <a href="javascript:insert('&gt;&gt;53245')">No.53245</a>  </span>  <a class="ignorebtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="toggleIgnored('mma31363132393039353932')" title="Ignore User"> <span class="ui-icon ui-icon-cancel"></span>Ignore </a>  <a class="rptbtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="openReport('53245', '53244')" title="Report Post 53245"> <span class="ui-icon ui-icon-alert"></span>Report </a> <a class="qrbtn fg-button ui-state-default fg-button-icon-left ui-corner-all" data-num="53245" data-thread="53244"> <span class="ui-icon ui-icon-comment"></span>Quick Reply </a>  <!--<i style="color: #31DEA0; font-size:16px; margin-left: 5px;"class="glyphicon  glyphicon-birthday_cake"></i>--> </div>  <blockquote  class="mma31363132393039353932">  Joe Torrents? What exactly does Joe Torrent?   </blockquote>    				 </td> </tr> </tbody> </table>     <table><tbody><tr><td class="doubledash"><a href="/mma/res/53244.php#53246" onclick="highlight(53246);">&gt;&gt;</a></td> <td class="reply" id="reply53246"> <a id="53246"></a> <div class="replyheader"> 									 <span class="commentpostername">Sean Sherk</span>  - <span class="idhighlight">Fri, 10 Jan 2014 18:26:05 EST ID:LKJU7NvF</span> <span class="reflink">   <a href="javascript:insert('&gt;&gt;53246')">No.53246</a>  </span>  <a class="ignorebtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="toggleIgnored('mma31383537303031323436')" title="Ignore User"> <span class="ui-icon ui-icon-cancel"></span>Ignore </a>  <a class="rptbtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="openReport('53246', '53244')" title="Report Post 53246"> <span class="ui-icon ui-icon-alert"></span>Report </a> <a class="qrbtn fg-button ui-state-default fg-button-icon-left ui-corner-all" data-num="53246" data-thread="53244"> <span class="ui-icon ui-icon-comment"></span>Quick Reply </a>  <!--<i style="color: #862A51; font-size:16px; margin-left: 5px;"class="glyphicon  glyphicon-birthday_cake"></i>--> </div>  <blockquote  class="mma31383537303031323436">  <a href = "/mma/res/53244.php#53245" onclick = "highlight(53245)">&gt;&gt;53245</a><br><br>That was bad brah   </blockquote>    				 </td> </tr> </tbody> </table>     <table><tbody><tr><td class="doubledash"><a href="/mma/res/53244.php#53322" onclick="highlight(53322);">&gt;&gt;</a></td> <td class="reply" id="reply53322"> <a id="53322"></a> <div class="replyheader"> 									 <span class="commentpostername">Joseph Benavidez</span>  - <span class="idhighlight">Fri, 31 Jan 2014 15:00:09 EST ID:tFw5M4fO</span> <span class="reflink">   <a href="javascript:insert('&gt;&gt;53322')">No.53322</a>  </span>  <a class="ignorebtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="toggleIgnored('mma393733353631313939')" title="Ignore User"> <span class="ui-icon ui-icon-cancel"></span>Ignore </a>  <a class="rptbtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="openReport('53322', '53244')" title="Report Post 53322"> <span class="ui-icon ui-icon-alert"></span>Report </a> <a class="qrbtn fg-button ui-state-default fg-button-icon-left ui-corner-all" data-num="53322" data-thread="53244"> <span class="ui-icon ui-icon-comment"></span>Quick Reply </a>  <!--<i style="color: #D78B13; font-size:16px; margin-left: 5px;"class="glyphicon  glyphicon-birthday_cake"></i>--> </div>  <blockquote  class="mma393733353631313939">  <a href = "/mma/res/53244.php#53245" onclick = "highlight(53245)">&gt;&gt;53245</a><br>0/10<br>Link for proof OP??   </blockquote>    				 </td> </tr> </tbody> </table>     <table><tbody><tr><td class="doubledash"><a href="/mma/res/53244.php#53323" onclick="highlight(53323);">&gt;&gt;</a></td> <td class="reply" id="reply53323"> <a id="53323"></a> <div class="replyheader"> 									 <span class="commentpostername">C-Higgy </span> <span class="postertrip">!lfsExjBfzE</span> - <span class="idhighlight">Fri, 31 Jan 2014 17:02:51 EST ID:EQmjp2me</span> <span class="reflink">   <a href="javascript:insert('&gt;&gt;53323')">No.53323</a>  </span>  <a class="rptbtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="openReport('53323', '53244')" title="Report Post 53323"> <span class="ui-icon ui-icon-alert"></span>Report </a> <a class="qrbtn fg-button ui-state-default fg-button-icon-left ui-corner-all" data-num="53323" data-thread="53244"> <span class="ui-icon ui-icon-comment"></span>Quick Reply </a>  <!--<i style="color: #738F9C; font-size:16px; margin-left: 5px;"class="glyphicon  glyphicon-birthday_cake"></i>--> </div>  <span class="filesize"> <a target="_blank" href="/mma/src/1391205771168.jpg"> 1391205771168.jpg </a> -(<em>22364 B, 298x381</em>) <span class="thumbnailmsg">Thumbnail displayed, click image for full size.</span> </span>  <a onclick="return imageExpansion(this)" target="_blank" href="/mma/src/1391205771168.jpg"> <img src="/mma/thumb/1391205771168s.jpg" alt="22364" class="thumb" /> </a>    <blockquote >  eh Joe Torre is pretty cool   </blockquote>    				 </td> </tr> </tbody> </table>     <table><tbody><tr><td class="doubledash"><a href="/mma/res/53244.php#53394" onclick="highlight(53394);">&gt;&gt;</a></td> <td class="reply" id="reply53394"> <a id="53394"></a> <div class="replyheader"> 									 <span class="commentpostername">Paulo Thiago</span>  - <span class="idhighlight">Tue, 18 Feb 2014 20:32:38 EST ID:jFjPUYhX</span> <span class="reflink">   <a href="javascript:insert('&gt;&gt;53394')">No.53394</a>  </span>  <a class="ignorebtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="toggleIgnored('mma31323434303739343633')" title="Ignore User"> <span class="ui-icon ui-icon-cancel"></span>Ignore </a>  <a class="rptbtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="openReport('53394', '53244')" title="Report Post 53394"> <span class="ui-icon ui-icon-alert"></span>Report </a> <a class="qrbtn fg-button ui-state-default fg-button-icon-left ui-corner-all" data-num="53394" data-thread="53244"> <span class="ui-icon ui-icon-comment"></span>Quick Reply </a>  <!--<i style="color: #1015C8; font-size:16px; margin-left: 5px;"class="glyphicon  glyphicon-birthday_cake"></i>--> </div>  <blockquote  class="mma31323434303739343633">  <a href="http://www.lcsun-news.com/las_cruces-news/ci_24855106/las-cruces-fighter-joe-torrez-preparing-legal-defense" rel="nofollow" target="_blank">http://www.lcsun-news.com/las_cruces-news/ci_24855106/las-cruces-fighter-joe-torrez-preparing-legal-defense</a><br><br>Crazy shit! It&#39;s a good thing he was there with his wife and kid being there and in danger.   </blockquote>    				 </td> </tr> </tbody> </table>     <table><tbody><tr><td class="doubledash"><a href="/mma/res/53244.php#53399" onclick="highlight(53399);">&gt;&gt;</a></td> <td class="reply" id="reply53399"> <a id="53399"></a> <div class="replyheader"> 									 <span class="commentpostername">Pat Healy</span>  - <span class="idhighlight">Thu, 20 Feb 2014 20:25:24 EST ID:tHHWq99W</span> <span class="reflink">   <a href="javascript:insert('&gt;&gt;53399')">No.53399</a>  </span>  <a class="ignorebtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="toggleIgnored('mma33363336323537323836')" title="Ignore User"> <span class="ui-icon ui-icon-cancel"></span>Ignore </a>  <a class="rptbtn fg-button ui-state-default fg-button-icon-solo ui-corner-all" onclick="openReport('53399', '53244')" title="Report Post 53399"> <span class="ui-icon ui-icon-alert"></span>Report </a> <a class="qrbtn fg-button ui-state-default fg-button-icon-left ui-corner-all" data-num="53399" data-thread="53244"> <span class="ui-icon ui-icon-comment"></span>Quick Reply </a>  <!--<i style="color: #6597D7; font-size:16px; margin-left: 5px;"class="glyphicon  glyphicon-birthday_cake"></i>--> </div>  <blockquote  class="mma33363336323537323836">  I guess he can up his record to 2-5   </blockquote>    				 </td> </tr> </tbody> </table>   <br style="clear: left;" /> </div> <hr class="threadend" />  <div class="harbl" style="width: 728px !important; margin: 0 auto;"> <div class="blarbl" style="font-size:10px;margin-bottom:2px;margin-top:2px;text-align:center;"> <a href="http://www.420chan.org/advertise">Advertise With Us</a> 		
...
<div id="foot">
	<div class="full_width">
		...
		<span class='byline'>Professional Wrestling Discussion - <a href='/wooo/res/3856802.php' class='boardlink'>Thread 3856802</a></span>
		<p>I agree with a lot of his ratings. I'd he's underrated AJ vs. Paige (Half a star, really?), Rusev vs... <a href='/wooo/res/3856802.php' class='boardlink'>&#8629;</a></p></li>
<li><img width='32' height='32' class='boardicon' alt='h' src='/static/images/board_icons/h_icon_32.png' />
		<span class='byline'>Hentai - <a href='/h/res/215501.php' class='boardlink'>Thread 215501</a></span>
		<p>Page 7... <a href='/h/res/215501.php' class='boardlink'>&#8629;</a></p></li>
						</ul>
					</div>
				</li>
				<div class="icon"></div>
