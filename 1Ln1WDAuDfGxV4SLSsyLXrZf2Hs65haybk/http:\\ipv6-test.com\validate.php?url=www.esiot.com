http://ipv6-test.com/validate.php?url=www.esiot.com
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 09:51:12 GMT
Server: Apache/2.4.9 (Debian)
X-Powered-By: PHP/5.6.0RC1
Set-Cookie: PHPSESSID=ri670votstaqc8t2rkfotnrgq4; expires=Wed, 23-Jul-2014 10:06:12 GMT; Max-Age=900; path=/; domain=.ipv6-test.com
	...
	<div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
		<form id="url_form">
			<div class="input-group input-group-lg">
				...
				<input type="text" id="url_input" value='www.esiot.com' class="form-control" />
...
<!--
	...
	<input type='text' id='url_input' value='www.esiot.com' />
