http://thepiratebay.se/about.php
HTTP/1.1 200 OK
Server: nginx/1.6.0
Date: Thu, 24 Jul 2014 10:43:15 GMT
Content-Type: text/html; charset=UTF-8
Connection: close
X-Powered-By: PHP/5.4.30
Set-Cookie: PHPSESSID=263313c6fe1ad5c130e353f59fc33286; path=/; domain=.thepiratebay.se
Set-Cookie: tpb_showArtist=deleted; expires=Thu, 01-Jan-1970 00:00:01 GMT
Expires: Mon, 26 Jul 1997 05:00:00 GMT
Last-Modified: Thu, 24 Jul 2014 10:43:15 GMT
Cache-Control: no-store, no-cache, must-revalidate
Cache-Control: post-check=0, pre-check=0
Pragma: no-cache
Set-Cookie: language=en_EN; expires=Fri, 24-Jul-2015 10:43:15 GMT; path=/; domain=.thepiratebay.se
...
<head>
	...
	<link rel="canonical" href="http://thepiratebay.se/about.php" />
	<style type="text/css">
		.searchBox{
			margin: 6px;
			width: 300px;
...
<div id="about">
<p>The Pirate Bay is the worlds largest bittorrent tracker. Bittorrent is
a filesharing protocol that in a reliable way enables big and fast
file transfers.</p>
<p>This is an open tracker, where anyone can download torrent files.
To be able to upload torrent files, write comments and personal messages
one must register at the site. This is of course free.</p>
<p>The members at The Pirate Bay represents a broad spectrum of file sharers.
Therefore material that seem offensive might be available. Do not contact
us if there is anything you find offensive, instead focus on the material
that you find positive. The Pirate Bay only removes torrents if the name
isn't in accordance with the content. One must know what is being
downloaded.</p>
<p>(accordance with the content also means any torrents which description is made to match a certain search phrase that is not relevant will also be deleted)</p><p>Only torrent files are saved at the server. That means no copyrighted
...
is being spread using the tracker. Any complaints from copyright and/or
lobby organizations will be ridiculed and published at the site.</p>
<p>The Pirate Bay was started by the swedish anti copyright organization <a href="http://piratbyran.org">Piratbyrån</a> in the late 2003, but in October 2004 it separated became run by dedicated individuals. In 2006 the site changed it's ownership yet again. Today the site is run by an organisation rather than individuals, though as a non-profit. The organisation is registered in the Seychelles and can be contacted using the contact form.</p><p>Using the site is free of charge for individuals however there are some restrictions. Please see the <a href="/policy">policy page</a></p>
<p>To contact The Pirate Bay click  <a href="/contact">here</a>.</p>
<p>To report child abuse or other similar unlawful activities please do so to your local authority. In Sweden you can contact <a href="mailto:childabuse@rkp.police.se">childabuse@rkp.police.se</a> to report child abuse matters. Please do so.</p><p>Tracker software: <a href="http://erdgeist.org/arts/software/opentracker/" target="_new">OpenTracker</a></p></div></div><!-- //div:content -->
	...
	<div id="foot" style="text-align:center;margin-top:1em;">
			...
			<a href="http://tvbay.net" title="Proxy" target="_blank">Proxy</a> |
...
<p id="footer" style="color:#666; font-size:0.9em; ">
        6.662.679 registered users. Last updated 12:40:06.<br />
        46.712.409 peers (34.517.248 seeders + 12.195.161 leechers) in 5.829.717 torrents.<br />
</p>
