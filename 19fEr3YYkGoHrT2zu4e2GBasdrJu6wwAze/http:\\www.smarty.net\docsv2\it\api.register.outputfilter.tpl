http://www.smarty.net/docsv2/it/api.register.outputfilter.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 15:20:59 GMT
...
<h2>Name</h2>
<p>register_outputfilter</p>
</div>
<div class="refsect1">
<a name="id3145411"></a><h2></h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">register_outputfilter</span>(<span class="methodparam"><span class="type">mixed </span><span class="parameter">function</span></span>);</code><p>
   ...
   visualizzato. Consultate i <a class="link" href="advanced.features.outputfilters.tpl" title="Filtri di output">filtri
   di output sui template</a> per maggiori informazioni su come
...
<td width="40%" align="right" valign="top"> register_postfilter</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 5 plus 20? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/api.register.outputfilter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02493 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
