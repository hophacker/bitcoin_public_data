http://www.smarty.net/docsv2/es/language.modifier.replace.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 13:23:19 GMT
...
<td>Esta es la cadena a ser substituida.</td>
</tr>
<tr>
...
<td align="center">Si</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Esta es la cadena que ira a substituir.</td>
</tr>
</tbody>
</table></div>
<p>
   Una simple busqueda y substituir en la variable. Esta es equivalente a la
   función <a class="ulink" href="http://php.net/str_replace" target="_top">str_replace()</a> de PHP.
  </p>
<div class="example">
<a name="id3074206"></a><p class="title"><b>Example 5.15. replace</b></p>
...
<br class="example-break"><p>
   ver también <a class="link" href="language.modifier.regex.replace.tpl" title="regex_replace">regex_replace</a>
...
<td width="40%" align="right" valign="top"> spacify</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.modifier.replace.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02402 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
