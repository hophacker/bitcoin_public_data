http://www.smarty.net/docsv2/es/template.resources.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 02:10:14 GMT
...
<p>
  ...
  <a class="link" href="api.display.tpl" title="display()">display()</a> o 
  <a class="link" href="api.fetch.tpl" title="fetch()">fetch()</a>, o incluye un template 
  ...
  <a class="link" href="variable.default.resource.type.tpl" title="$default_resource_type">$default_resource_type</a>
  es asumido.
   </p>
...
<p>
     ...
     <a class="link" href="api.variables.tpl#variable.template.dir" title="$template_dir">$template_dir</a> no requieren 
     ...
     directorio root <a class="link" href="api.variables.tpl#variable.template.dir" title="$template_dir">$template_dir</a>.
    </p>
<div class="example">
<a name="id3148654"></a><p class="title"><b>Example 15.6. Usando templates desde $template_dir</b></p>
...
<p>
     ...
     <a class="link" href="api.variables.tpl#variable.template.dir" title="$template_dir">$template_dir</a> requieren 
     el file: tipo de recurso del template, seguido por la ruta absoluta 
     y el nombre del template.
    </p>
<div class="example">
<a name="id3148702"></a><p class="title"><b>Example 15.7. usando templates desde cualquier directorio</b></p>
...
<div class="example">
<a name="id3148752"></a><p class="title"><b>Example 15.8. usando templates con rutas de archivos de windows</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<p>
     Vea la sección <a class="link" href="plugins.resources.tpl" title="Fuentes">resource plugins</a>
...
<div class="example">
<a name="id3148835"></a><p class="title"><b>Example 15.9. Usando recursos habituales</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<div class="example">
<a name="id3148938"></a><p class="title"><b>Example 15.10.  usando la función manipuladora de template por default</b></p>
<div class="example-contents"><pre class="programlisting">
...
<td width="40%" align="right" valign="top"> Chapter 16. Extendiendo Smarty con plugins</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 7 plus 6? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/template.resources.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02185 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
