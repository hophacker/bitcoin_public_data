http://www.smarty.net/docsv2/es/language.function.html.checkboxes.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 21:18:42 GMT
...
<td>Nombre de la lista checkbox</td>
</tr>
<tr>
<td align="center">values</td>
<td align="center">array</td>
<td align="center">Si, a menos que se este utilizando el atributo options</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Una matriz de valores para los botones checkbox</td>
</tr>
<tr>
<td align="center">output</td>
<td align="center">array</td>
<td align="center">Si, a menos que estuviera usando el atributo options</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>una matriz de salida para los botones checkbox</td>
</tr>
<tr>
...
<td>El(s) elemento(s) checkbox marcado(s)</td>
</tr>
<tr>
<td align="center">options</td>
<td align="center">arreglo asociativo</td>
<td align="center">Si, a menos que este usando values y output</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>empty</em></span></td>
<td>Cadena de texto para separar cada checkbox</td>
</tr>
<tr>
...
<td>Adicionar la etiqueta &lt;label&gt; para la salida</td>
</tr>
</tbody>
</table></div>
<p>
  {html_checkboxes} es una 
  <a class="link" href="language.custom.functions.tpl" title="Chapter 8. Custom Functions">función personalizada</a> 
...
<div class="example">
<a name="id3097173"></a><p class="title"><b>Example 8.7. {html_checkboxes}</b></p>
...
<a name="id3097259"></a><p class="title"><b>Example 8.8. 
...
<br class="example-break"><p>
  Vea también
  <a class="link" href="language.function.html.radios.tpl" title="{html_radios}">{html_radios}</a>
...
<td width="40%" align="right" valign="top"> {html_image}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.function.html.checkboxes.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02383 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
