...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 13:45:10 GMT
...
<p>
   ...
   <a class="ulink" href="http://php.net/strtoupper" target="_top">
   <code class="varname">strtoupper()</code></a> function.
  </p>
<div class="example">
<a name="idp7046624"></a><p class="title"><b>Example 5.23. upper</b></p>
...
<td width="40%" align="right" valign="top"> wordwrap</td>
          ...
          <div class="commentInfo">
              ...
              <div class="commentAuthor">by <b>Alex Moleiro</b> on Apr  5, 2013 at  6:25</div>
              <div class="commentBody">I you are noticing problems when uppercasing word with Spanish o Latin accents as Ã©Ã‰Ãˆ or similar, you can workaround the situation applying this command:
{$your_variable|@strtoupper}
This will solve the annoying problem of the just |upper command that doesn't work properly. Hope it'll be useful!</div>
            </div>
                              </div>
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/language.modifier.upper.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02831 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
