http://www.smarty.net/docsv2/fr/variable.plugins.dir.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 07:21:10 GMT
...
<p>
  ...
  <code class="filename">plugins/</code> sous
  le répertoire <a class="link" href="smarty.constants.tpl#constant.smarty.dir" title="SMARTY_DIR"><code class="constant">SMARTY_DIR</code></a>.
  Si vous donnez un chemin relatif, Smarty
  regardera d'abord relativement au
  <a class="link" href="smarty.constants.tpl#constant.smarty.dir" title="SMARTY_DIR"><code class="constant">SMARTY_DIR</code></a>, puis relativement
  au répertoire de travail courant, puis relativement à chaque entrée de votre répertoire
  d'inclusion PHP. Si <em class="parameter"><code>$plugins_dir</code></em> est un tableau de répertoires, Smarty
  cherchera les plugins dans chaque répertoire de plugins,
  <span class="bold"><strong>dans l'ordre donné</strong></span>.
 </p>
<div class="note" title="Note technique" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Note technique</h3>
<p>
   Pour des raisons de performances, ne réglez pas votre <em class="parameter"><code>$plugins_dir</code></em>
   pour qu'il utilise votre include_path PHP. Utilisez un
   chemin absolu ou un chemin relatif a <code class="constant">SMARTY_DIR</code> ou
   au répertoire de travail courant.
  </p>
</div>
<div class="example">
<a name="id2995839"></a><p class="title"><b>Example 12.1. Ajout d'un dossier local de plugins</b></p>
...
<a name="id2995856"></a><p class="title"><b>Example 12.2. Plusieurs $plugins_dir</b></p>
<div class="example-contents"><pre class="programlisting">
...
<td width="40%" align="right" valign="top"> $debugging</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/variable.plugins.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02016 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
