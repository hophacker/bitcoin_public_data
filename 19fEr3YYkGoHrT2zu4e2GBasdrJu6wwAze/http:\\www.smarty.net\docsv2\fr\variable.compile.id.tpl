http://www.smarty.net/docsv2/fr/variable.compile.id.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 02:19:21 GMT
...
<p>
  ...
  <em class="parameter"><code>$compile_id</code></em> a chaque appel de fonction mais une
  alternative consiste à régler ce
  <em class="parameter"><code>$compile_id</code></em>, qui sera utilisé implicitement.
 </p>
<p>
  Avec un <em class="parameter"><code>$compile_id</code></em>, vous pouvez contourner la limitation qui fait
  que vous ne pouvez pas utiliser le même
  <a class="link" href="variable.compile.dir.tpl" title="$compile_dir"><em class="parameter"><code>$compile_dir</code></em></a> pour
  différents <a class="link" href="api.variables.tpl#variable.template.dir" title="$template_dir"><em class="parameter"><code>$template_dirs</code></em></a>.
  Si vous définissez un <em class="parameter"><code>$compile_id</code></em> distinct pour
  chaque <a class="link" href="api.variables.tpl#variable.template.dir" title="$template_dir"><em class="parameter"><code>$template_dir</code></em></a>,
  alors Smarty indique aux templates compilés à part par leur
  <em class="parameter"><code>$compile_id</code></em>.
 </p>
<p>
  Si vous avez par exemple un <a class="link" href="plugins.prefilters.postfilters.tpl" title="filtres de pré-compilation/filtres de post-compilation">pré-filtre</a>
  qui traduit vos templates au moment de la compilation, alors, vous devriez utiliser le langage
  courant comme <em class="parameter"><code>$compile_id</code></em> et vous devriez obtenir un jeu
...
<div class="example">
<a name="id3001495"></a><p class="title"><b>Example 12.6. $compile_id dans un environement d'hôte virtuel</b></p>
...
<td width="40%" align="right" valign="top"> $use_sub_dirs</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 3 plus 4? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/variable.compile.id.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02539 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
