http://www.smarty.net/docsv2/es/language.modifier.count.sentences.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 23:36:36 GMT
...
<div class="example">
<a name="id3069940"></a><p class="title"><b>Example 5.6. count_sentences</b></p>
...
<td width="40%" align="right" valign="top"> count_words</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.modifier.count.sentences.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01748 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
