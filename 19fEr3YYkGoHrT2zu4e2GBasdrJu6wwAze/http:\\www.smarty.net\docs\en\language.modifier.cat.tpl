...
<div class="example">
<a name="idp6132704"></a><p class="title"><b>Example 5.3. cat</b></p>
...
<tr>
<td width="40%" align="left" valign="top">Chapter 5. Variable Modifiers </td>
...
<td width="40%" align="right" valign="top"> count_characters</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/language.modifier.cat.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02778 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
