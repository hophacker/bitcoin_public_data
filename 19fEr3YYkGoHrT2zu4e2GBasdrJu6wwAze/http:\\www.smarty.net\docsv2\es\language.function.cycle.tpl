http://www.smarty.net/docsv2/es/language.function.cycle.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 11:41:13 GMT
...
<td>Los valores del ciclo, o una lista delimitada por 
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>true</em></span></td>
<td>Cuando avanzar o no hacia el siguiente valor</td>
</tr>
<tr>
...
<td>El delimitador para usar el valor del atributo.</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>La variable del template que recibirá la salida</td>
</tr>
<tr>
...
<td>Este coloca al ciclo en el primer valor y no le permite avanzar</td>
</tr>
</tbody>
</table></div>
<p>
...
<div class="example">
<a name="id3095265"></a><p class="title"><b>Example 8.4. cycle</b></p>
...
<td width="40%" align="right" valign="top"> {debug}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.function.cycle.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02920 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
