http://www.smarty.net/docsv2/es/language.function.html.radios.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 03:32:18 GMT
...
<td>Nombre de la lista del radio</td>
</tr>
<tr>
<td align="center">values</td>
<td align="center">array</td>
<td align="center">Si, a menos que utilice el atributo options</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>una matriz de valores para radio buttons</td>
</tr>
<tr>
...
<td align="center">Si, a menos que utilice el atributo options</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>una matriz de salida para radio buttons</td>
</tr>
<tr>
...
<td>El elemento del radio selccionado</td>
</tr>
<tr>
<td align="center">options</td>
<td align="center">arreglo asociativo</td>
<td align="center">Si, a menos qie utilice valores y salida</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>empty</em></span></td>
<td>cadena de texto para separar cada objeto de radio</td>
</tr>
</tbody>
</table></div>
<p>
...
<div class="example">
<a name="id3099554"></a><p class="title"><b>Example 8.12. {html_radios} : Ejemplo 1</b></p>
...
<a name="id3099590"></a><p class="title"><b>Example 8.13. {html_radios} : Ejemplo 2</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<br class="example-break"><div class="example">
<a name="id3099640"></a><p class="title"><b>Example 8.14. {html_radios}- Ejemplo con base de Datos (eg PEAR o ADODB):</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<br class="example-break"><p>
   ver también
   <a class="link" href="language.function.html.checkboxes.tpl" title="{html_checkboxes}">{html_checkboxes}</a>
   y <a class="link" href="language.function.html.options.tpl" title="{html_options}">{html_options}</a>
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> {html_select_date}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 16 plus 10? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.function.html.radios.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01790 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
