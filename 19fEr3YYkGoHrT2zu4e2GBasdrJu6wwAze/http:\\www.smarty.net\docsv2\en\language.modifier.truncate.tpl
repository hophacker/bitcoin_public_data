...
<div class="example">
<a name="id2794369"></a><p class="title"><b>Example 5.21. truncate</b></p>
...
<td width="40%" align="right" valign="top"> upper</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/language.modifier.truncate.tpl">
            </form>
            </div>
          </div>
