http://www.smarty.net/docsv2/fr/language.function.html.select.date.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 00:04:02 GMT
...
<p>
  <code class="varname">{html_select_date}</code> est une
  <a class="link" href="language.custom.functions.tpl" title="Chapter 8. Fonctions utilisateur">fonction personnalisée</a>
  ...
  <code class="literal">&lt;select&gt;</code> des jours, mois et années.
 </p>
...
<td>Avec quoi préfixer le nom de variable</td>
</tr>
<tr>
<td align="center">time</td>
<td align="center">timestamp/YYYY-MM-DD</td>
<td align="center">Non</td>
<td align="center">la date courante au format unix YYYY-MM-DD
     format</td>
<td>La date / heure à utiliser</td>
</tr>
<tr>
...
<td>La première année dans la liste déroulante, soit
...
<td align="center">chaîne de caractères</td>
<td align="center">Non</td>
<td align="center">même chose que start_year</td>
<td>La dernière année dans la liste déroulante, soit
      le numéro de l'année, soit un nombre relatif à l'année
     courante (+/- N).</td>
</tr>
<tr>
...
<td>Si l'on souhaite afficher les jours ou pas.</td>
</tr>
<tr>
...
<td align="center">Non</td>
<td align="center">true</td>
<td>Si l'on souhaite afficher les mois ou pas.</td>
</tr>
<tr>
...
<td align="center">Non</td>
<td align="center">true</td>
<td>Si l'on souhaite afficher les années ou pas.</td>
</tr>
<tr>
...
<td>le format du mois (strftime)</td>
</tr>
<tr>
...
<td>Le format du jour (sprintf)</td>
</tr>
<tr>
...
<td>Le format de la valeur du jour (sprintf)</td>
</tr>
<tr>
...
<td>S'il faut afficher l'année au format texte</td>
</tr>
<tr>
...
<td align="center">Non</td>
<td align="center">false</td>
<td>Affiche les années dans l'ordre inverse</td>
</tr>
<tr>
...
<td align="center">Non</td>
<td align="center">null</td>
<td>Ajoute un attribut size à la liste
     déroulante des jours.</td>
</tr>
<tr>
...
<td align="center">Non</td>
<td align="center">null</td>
<td>Ajoute des attributs supplémentaires à
     toutes les balises select/input.</td>
</tr>
<tr>
...
<td align="center">Non</td>
<td align="center">null</td>
<td>Ajoute des attributs supplémentaires aux balises
     select/input du jour.</td>
</tr>
<tr>
...
<td>L'ordre dans lequel afficher les
     listes déroulantes.</td>
</tr>
<tr>
...
<td align="center">Non</td>
<td align="center">\n</td>
<td>la chaîne de caractères affichée entre les
     différents champs.</td>
</tr>
<tr>
...
<td>Le format strftime de la valeur des mois, par défaut %m
     pour les numéros.</td>
</tr>
<tr>
...
<td align="center">Non</td>
<td align="center">null</td>
<td>S'il est renseigné, alors le premier élément de la boite de sélection
    affiche le texte donné en tant que libellé et dispose de la valeur <span class="quote">“<span class="quote"></span>”</span>.
    Utile par exemple lorsque vous souhaitez que la boite de sélection affiche
    <span class="quote">“<span class="quote">Sélectionnez une année</span>”</span>.
    A savoir que vous pouvez spécifier des valeurs de la forme <span class="quote">“<span class="quote">-MM-DD</span>”</span> pour
    l'attribut time afin d'indiquer une année non sélectionnée.</td>
</tr>
<tr>
...
<td align="center">Non</td>
<td align="center">null</td>
<td>S'il est renseigné, le premier élément de la boite de sélection
     affiche le texte donné en tant que libellé et dispose de la valeur <span class="quote">“<span class="quote"></span>”</span>.
     A savoir que vous pouvez spécifier des valeurs de la forme <span class="quote">“<span class="quote">YYYY--DD</span>”</span> pour
     l'attribut time afin d'indiquer qu'il manque le moi.</td>
</tr>
<tr>
...
<td>S'il est renseigné, le premier élément de la boite de sélection
     affiche le texte donné en tant que libellé et dispose de la valeur <span class="quote">“<span class="quote"></span>”</span>.
     A savoir que vous pouvez spécifier des valeurs de la forme <span class="quote">“<span class="quote">YYYY-MM-</span>”</span> pour
...
<p>
   ...
   <a class="link" href="tips.dates.tpl" title="Dates">page des astuces sur les dates</a> pour convertir
   les valeurs <code class="varname">{html_select_date}</code> en un timestamp.
  </p>
</div>
<div class="example">
<a name="id2975947"></a><p class="title"><b>Example 8.19. {html_select_date} : Premier exemple</b></p>
<div class="example-contents">
<p>Code du template</p>
...
<a name="id2975973"></a><p class="title"><b>Example 8.20. {html_select_date} : Deuxième exemple</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<br class="example-break"><p>
  ...
  <a class="link" href="language.variables.smarty.tpl#language.variables.smarty.now" title="{$smarty.now}"><em class="parameter"><code>$smarty.now</code></em></a> et
  les <a class="link" href="tips.dates.tpl" title="Dates">astuces sur les dates</a>.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> {html_select_time}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/language.function.html.select.date.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03132 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
