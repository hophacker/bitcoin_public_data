http://www.smarty.net/docsv2/es/language.modifier.default.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 00:16:44 GMT
...
<thead><tr>
<th align="center">Pocisión del Parametro</th>
...
<td>Este es el valor por defecto para mostrar una variable 
       que estuviera vacia.</td>
</tr></tbody>
</table></div>
<p>
...
<div class="example">
<a name="id3072173"></a><p class="title"><b>Example 5.9. default</b></p>
...
<br class="example-break"><p>
   Ver también <a class="link" href="tips.default.var.handling.tpl" title="Manipulación del valor default de una variable">Default Variable Handling</a>
   y <a class="link" href="tips.tpl#tips.blank.var.handling" title="Manipulación de Variables Vacias">Blank Variable Handling</a>.
  </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> escape</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.modifier.default.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02850 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
