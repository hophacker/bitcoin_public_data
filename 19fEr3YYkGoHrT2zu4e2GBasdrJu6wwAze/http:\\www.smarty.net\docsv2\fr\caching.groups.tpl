http://www.smarty.net/docsv2/fr/caching.groups.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 11:41:22 GMT
...
<html lang="en">
  <head>
    ...
    <title>Groupes de fichiers de cache | Smarty</title>
...
<tr><th colspan="3" align="center">Groupes de fichiers de cache</th></tr>
<tr>
...
<div class="sect1" title="Groupes de fichiers de cache">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="caching.groups"></a>Groupes de fichiers de cache</h2></div></div></div>
<p>
  Vous pouvez faire des groupements plus élaborés en paramétrant les
  groupes de <em class="parameter"><code>$cache_id</code></em>. Il suffit de séparer chaque sous-groupe
  avec une barre verticale <code class="literal">|</code> dans la valeur de <em class="parameter"><code>$cache_id</code></em>.
...
<li class="listitem"><p>
    ...
    Par exemple, un groupe de cache <code class="literal">'a|b|c'</code> peut être considéré comme
    la hiérarchie de dossiers <code class="literal">'/a/b/c/'</code>.
   </p></li>
<li class="listitem"><p>
    ...
    supprimera les fichiers <code class="literal">'/a/b/*'</code>.
   </p></li>
<li class="listitem"><p>
    ...
    de cette façon <code class="literal">clear_cache(null,'a|b','foo')</code> il sera traité comme un groupe de
    cache apposé <code class="literal">'/a/b/c/foo/'</code>.
   </p></li>
<li class="listitem"><p>
    Si vous spécifiez un nom de template de cette façon
    <code class="literal">clear_cache('foo.tpl','a|b|c')</code> alors Smarty tentera d'effacer
    <code class="literal">'/a/b/c/foo.tpl'</code>.
   </p></li>
<li class="listitem"><p>
    Vous ne POUVEZ PAS effacer un nom de template spécifié sous un groupe de
    cache multiple comme <code class="literal">'/a/b/*/foo.tpl'</code>, le groupement de cache fonctionne
...
<p>
  ...
  vous avez une structure de template comme <code class="filename">themes/blue/index.tpl</code> et
  que vous voulez être capable d'effacer tous les fichiers de cache pour le thème <span class="quote">“<span class="quote">blue</span>”</span>,
  vous devriez créer une structure de groupe de cache qui reflète la structure
  de fichiers de vos templates, comme <code class="literal">display('themes/blue/index.tpl','themes|blue')</code>,
  et les effacer avec <code class="literal">clear_cache(null,'themes|blue')</code>.
 </p>
<div class="example">
<a name="id3027329"></a><p class="title"><b>Example 14.9. Groupes d'identifiants de cache</b></p>
...
<tr>
<td width="40%" align="left" valign="top">Caches multiples pour une seule page </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Contrôler la mise en cache des sorties des Plugins</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/caching.groups.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02904 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
