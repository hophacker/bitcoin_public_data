http://www.smarty.net/docsv2/it/variable.cache.lifetime.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 13:59:15 GMT
...
<p>
     E' la durata in secondi della validità di un file di cache. Una volta che
     questo tempo è scaduto, la cache verrà rigenerata. $caching deve essere
     impostato a "true" perché $cache_lifetime abbia significato. Il valore
     -1 forza la cache a non scadere mai. Il valore 0 farà sì che la cache
     venga sempre rigenerata (è utile solo in fase di test, per disabilitare
     il caching un metodo più efficiente è impostare <a class="link" href="variable.caching.tpl" title="$caching">$caching</a> a false.)
    </p>
<p>
     Se <a class="link" href="variable.force.compile.tpl" title="$force_compile">$force_compile</a> è
     ...
     con la funzione <a class="link" href="api.clear.all.cache.tpl" title="clear_all_cache">clear_all_cache()</a>, oppure singoli
     file (o gruppi di file) con la funzione <a class="link" href="api.clear.cache.tpl" title="clear_cache">clear_cache()</a>.
    </p>
...
<p>
      ...
      potete farlo impostando <a class="link" href="variable.caching.tpl" title="$caching">$caching</a> = 2,
...
<td width="40%" align="right" valign="top"> $cache_handler_func</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 4 plus 8? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/variable.cache.lifetime.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02565 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
