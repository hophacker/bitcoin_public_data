http://www.smarty.net/docsv2/it/api.fetch.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 19:58:03 GMT
...
<code class="methodsynopsis"><span class="type">string </span><span class="methodname">fetch</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">template</span></span>,<br>             <span class="methodparam"><span class="type">string </span><span class="parameter">cache_id</span></span>,<br>             <span class="methodparam"><span class="type">string </span><span class="parameter">compile_id</span></span>);</code><p>
   ...
   la <a class="link" href="template.resources.tpl" title="Risorse">risorsa del template</a>.
   Come secondo parametro opzionale potete passare una cache id.
   Consultate la <a class="link" href="caching.tpl" title="Chapter 14. Caching">sezione sul caching</a> per
   maggiori informazioni.
  </p>
<p>
 Come terzo parametro opzionale, potete passare un <em class="parameter"><code>compile_id</code></em>.
 ...
 è quando usate più di una $template_dir ma soltanto una $compile_dir. 
 Impostate un <em class="parameter"><code>compile_id</code></em> diverso per ogni $template_dir,
 altrimenti i template con lo stesso nome si sovrascriveranno a vicenda.
 Potete anche impostare la variabile <a class="link" href="variable.compile.id.tpl" title="$compile_id">$compile_id</a>
 una volta sola invece di passarla ogni volta che chiamate questa funzione.
</p>
<p>
   </p>
<div class="example">
<a name="id3142901"></a><p class="title"><b>Example 13.14. fetch</b></p>
...
<td width="40%" align="right" valign="top"> get_config_vars</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 3 plus 5? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/api.fetch.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02013 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
