http://www.smarty.net/docsv2/fr/variable.trusted.dir.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 12:25:20 GMT
...
<a accesskey="p" href="variable.security.settings.tpl">Prev</a> </td>
...
<p>
  <em class="parameter"><code>$trusted_dir</code></em> n'est utilisée lorsque
  <a class="link" href="variable.security.tpl" title="$security"><em class="parameter"><code>$security</code></em></a> est activée.
  C'est un tableau de tous les répertoires qui peuvent être considérés comme svrs.
...
<tr>
<td width="40%" align="left" valign="top">$security_settings </td>
...
<td width="40%" align="right" valign="top"> $left_delimiter</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 17 plus 5? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="64f227c3929e68598de9a479714fd397">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/variable.trusted.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01691 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
