...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 19:58:22 GMT
...
<li class="listitem"><p>
 One way is to <a class="link" href="api.register.object.tpl" title="registerObject()">register objects</a> to
...
<li class="listitem"><p>
   The other way is to <a class="link" href="api.assign.tpl" title="assign()"><code class="varname">assign()</code></a> 
...
<div class="example">
<a name="idp19349728"></a><p class="title"><b>Example 17.9. Using a registered or assigned object</b></p>
...
<br class="example-break"><p>
  See also <a class="link" href="api.register.object.tpl" title="registerObject()"><code class="varname">registerObject()</code></a>
  and
...
<td width="40%" align="right" valign="top"> Static Classes</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/advanced.features.objects.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02658 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
