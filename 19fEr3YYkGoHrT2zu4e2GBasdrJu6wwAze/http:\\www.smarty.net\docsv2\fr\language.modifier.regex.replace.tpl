http://www.smarty.net/docsv2/fr/language.modifier.regex.replace.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 19:58:33 GMT
...
<p>
  ...
  <a class="ulink" href="http://php.net/preg_replace" target="_top"><code class="varname">preg_replace()</code></a>.
 </p>
...
<td>Expression régulière à remplacer.</td>
</tr>
<tr>
...
<td align="center">Oui</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>La chaîne de remplacement.</td>
</tr>
</tbody>
</table></div>
<div class="example">
<a name="id2940997"></a><p class="title"><b>Example 5.15. regex_replace</b></p>
...
<br class="example-break"><p>
 Voir aussi
 <a class="link" href="language.modifier.replace.tpl" title="replace"><code class="varname">replace</code></a> et
...
<td width="40%" align="right" valign="top"> replace</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/language.modifier.regex.replace.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02139 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
