...
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 12:22:52 GMT
...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Chapter 3. Basic Syntax">
    <meta name="keywords" content="chapter, 3, basic, syntax">
...
<p>
  ...
  <code class="literal">}</code>, but they can be <a class="link" href="variable.left.delimiter.tpl" title="$left_delimiter">changed</a>.
 </p>
<p>
...
<p>
  ...
  by the
  <a class="link" href="variable.left.delimiter.tpl" title="$left_delimiter">delimiter</a>
  tags like so:
  </p>
...
<div class="example">
<a name="idp5376608"></a><p class="title"><b>Example 3.1. Comments within a template</b></p>
...
<td width="40%" align="right" valign="top"> Variables</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/language.basic.syntax.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01609 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
