http://www.smarty.net/docsv2/en/language.function.eval.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 16:02:37 GMT
...
<li class="listitem"><p>
   ...
   <a class="link" href="caching.tpl" title="Chapter 14. Caching">caching</a>   enabled, the
...
<div class="example">
<a name="id2820393"></a><p class="title"><b>Example 8.6. {eval}</b></p>
...
<a name="id2820446"></a><p class="title"><b>Example 8.7. Another {eval} example</b></p>
<div class="example-contents">
...
<td width="40%" align="right" valign="top"> {fetch}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 10 plus 14? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/language.function.eval.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02400 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
