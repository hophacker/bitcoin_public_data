http://www.smarty.net/docsv2/en/language.modifier.default.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 04:12:11 GMT
...
<div class="example">
<a name="id2790010"></a><p class="title"><b>Example 5.9. default</b></p>
...
<br class="example-break"><p>
   ...
   and the
   <a class="link" href="tips.tpl#tips.blank.var.handling" title="Blank Variable Handling">blank variable handling</a> pages.
  </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> escape</td>
          ...
          <div class="commentInfo">
              ...
              <div class="commentAuthor">by <b>Steve</b> on Mar  9, 2012 at  8:41</div>
              <div class="commentBody">Worth noting: It seems if the value===&quot;false&quot; the default modifier does not work.  It works on NULL and empty string only. 
</div>
            </div>
                              </div>
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/language.modifier.default.tpl">
            </form>
            </div>
          </div>
