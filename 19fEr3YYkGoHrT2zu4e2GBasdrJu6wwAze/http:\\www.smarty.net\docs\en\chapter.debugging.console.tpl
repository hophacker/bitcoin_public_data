...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 09:35:33 GMT
...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Chapter 10. Debugging Console">
    <meta name="keywords" content="chapter, 10, debugging, console">
...
<p>
  ...
  to <code class="constant">TRUE</code> in Smarty, and if needed set <a class="link" href="variable.debug_template.tpl" title="$debug_tpl">
...
<p>
    See also
    <a class="link" href="troubleshooting.tpl" title="Chapter 20. Troubleshooting">troubleshooting</a>.
   </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> Part III. Smarty For Programmers</td>
          ...
          <div class="commentInfo">
              ...
              <div class="commentAuthor">by <b>Andrew</b> on Feb 28, 2012 at  2:37</div>
              <div class="commentBody">The following is not true:
&quot;The debugging console does not work when you use the fetch() API, only when using display().&quot;

It works just fine if you use fetch() too.</div>
            </div>
                      <div class="commentWrapperEven">
              <div class="commentAuthor">by <b>Redn0x</b> on Oct 26, 2011 at  4:25</div>
              <div class="commentBody">If you need to use the fetch method for your template but still want to use the debugging console you can do this:
<pre class="code">
$smarty = new smarty();
...
$smarty-&gt;fetch('template.tpl');
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 4 plus 6? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/chapter.debugging.console.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02822 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
