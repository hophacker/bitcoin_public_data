http://www.smarty.net/docsv2/en/advanced.features.prefilters.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 07:47:23 GMT
...
<p>
  Prefilters can be either <a class="link" href="api.register.prefilter.tpl" title="register_prefilter()">registered</a> or loaded from
  the <a class="link" href="variable.plugins.dir.tpl" title="$plugins_dir">plugins directory</a>
  by using <a class="link" href="api.load.filter.tpl" title="load_filter()"><code class="varname">load_filter()</code></a> function or
  by setting the <a class="link" href="variable.autoload.filters.tpl" title="$autoload_filters">
...
<div class="example">
<a name="id2874772"></a><p class="title"><b>Example 15.2. Using a template prefilter</b></p>
...
<br class="example-break"><p>See also
 ...
 <a class="link" href="advanced.features.postfilters.tpl" title="Postfilters">postfilters</a>
 and
...
<td width="40%" align="right" valign="top"> Postfilters</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 2 plus 15? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/advanced.features.prefilters.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02952 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
