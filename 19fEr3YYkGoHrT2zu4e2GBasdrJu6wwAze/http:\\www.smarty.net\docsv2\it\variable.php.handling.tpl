http://www.smarty.net/docsv2/it/variable.php.handling.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 21:18:15 GMT
...
<th width="60%" align="center">Chapter 12. Variabili</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.security.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
       Questa variabile dice a Smarty come gestire il codice PHP
       incorporato nei template. Ci sono quattro possibili impostazioni:
       il default è SMARTY_PHP_PASSTHRU. Notate che questa variabile
       NON ha effetto sul codice php che si trova fra i tag <a class="link" href="language.function.php.tpl" title="php">{php}{/php}</a>.
      </p>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>SMARTY_PHP_PASSTHRU - Smarty stampa il contenuto
         dei tag così com'è.</p></li>
<li class="listitem"><p>SMARTY_PHP_QUOTE - Smarty trasforma i tag in entità
         html.</p></li>
<li class="listitem"><p>SMARTY_PHP_REMOVE - Smarty rimuove i tag dal 
         template.</p></li>
<li class="listitem"><p>SMARTY_PHP_ALLOW - Smarty esegue il codice PHP.</p></li>
</ul></div>
<div class="note" title="Note" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Note</h3>
<p>
        Incorporare codice PHP nei template è altamente sconsigliato. Usate
        invece le <a class="link" href="language.custom.functions.tpl" title="Chapter 8. Custom Functions">funzioni utente</a>
        o i <a class="link" href="language.modifiers.tpl" title="Chapter 5. Modificatori delle variabili">modificatori</a>.
       </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right"> <a accesskey="n" href="variable.security.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> $security</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 13 plus 11? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/variable.php.handling.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01962 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
