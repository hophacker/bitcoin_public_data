http://www.smarty.net/docsv2/fr/language.modifier.string.format.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 16:54:12 GMT
...
<p>
  ...
  <a class="ulink" href="http://php.net/sprintf" target="_top"><code class="varname">sprintf()</code></a>
...
<td>Le format à utiliser (sprintf)</td>
</tr></tbody>
</table></div>
<div class="example">
<a name="id2942230"></a><p class="title"><b>Example 5.18. string_format</b></p>
...
<td width="40%" align="right" valign="top"> strip</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/language.modifier.string.format.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02142 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
