http://www.smarty.net/docsv2/fr/language.function.math.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 08:26:11 GMT
...
<td width="20%" align="right"> <a accesskey="n" href="language.function.popup.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
  <code class="varname">{math}</code> autorise les designers de templates à effectuer
...
<li class="listitem"><p>+, -, /, *, abs, ceil, cos,
    ...
    <a class="ulink" href="http://php.net/eval" target="_top">mathématiques</a>.
   </p></li>
<li class="listitem"><p>
    Si vous spécifiez l'attribut <em class="parameter"><code>assign</code></em>, la sortie
    de la fonction <code class="varname">{math}</code> sera assignée à la variable
...
<p>
   <code class="varname">{math}</code> est une fonction coûteuse en terme de
   ...
   <a class="link" href="api.assign.tpl" title="assign()">assignez</a> le résultat au template.
   Evitez coût que coût les appels répétitifs à la fonction <code class="varname">{math}</code>,
   comme on pourait le faire une
   une boucle <a class="link" href="language.function.section.tpl" title="{section},{sectionelse}"><code class="varname">{section}</code></a>.
  </p>
</div>
...
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Le format du résultat (sprintf)</td>
</tr>
<tr>
...
<td align="center">Oui</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Les variables de l'opération</td>
</tr>
<tr>
...
<td align="center">Non</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Variable de template dans laquelle la sortie
     sera assignée</td>
</tr>
<tr>
<td align="center">[var ...]</td>
...
<td align="center">Oui</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Valeurs des variables de l'opération</td>
</tr>
</tbody>
</table></div>
<div class="example">
<a name="id2980576"></a><p class="title"><b>Example 8.24. {math}</b></p>
<div class="example-contents">
<p>
   <span class="bold"><strong>Exemple a :</strong></span>
  </p>
...
<p>
   <span class="bold"><strong>Exemple b :</strong></span>
  </p>
<pre class="programlisting">
...
<p>
   <span class="bold"><strong>Exemple c :</strong></span>
  </p>
<pre class="programlisting">
...
<p>
   <span class="bold"><strong>Exemple d :</strong></span>
  </p>
<pre class="programlisting">
...
<td width="40%" align="right"> <a accesskey="n" href="language.function.popup.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> {popup}</td>
          ...
          <div class="commentInfo">
              ...
              <div class="commentAuthor">by <b>Julien BREUX</b> on Feb  5, 2012 at 11:27</div>
              <div class="commentBody">Pour utiliser une valeur alÃ©atoire (rand / random), vous pouvez faire comme ceci (exemple entre 1 et 10 compris) :
<pre class="code">{math equation='rand(1,10)'}</pre>
...
<pre class="code">{math equation='rand(1,10)' assing='myRandValue'}</pre></div>
            </div>
                              </div>
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/language.function.math.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02987 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
