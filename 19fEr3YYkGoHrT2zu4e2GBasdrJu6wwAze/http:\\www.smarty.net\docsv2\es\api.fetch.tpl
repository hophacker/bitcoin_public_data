http://www.smarty.net/docsv2/es/api.fetch.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 14:31:02 GMT
...
<a name="id3129444"></a><h2>Descripción</h2>
<code class="methodsynopsis"><span class="type">string </span><span class="methodname">fetch</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">template</span></span>,<br>             <span class="methodparam"><span class="type">string </span><span class="parameter">cache_id</span></span>,<br>             <span class="methodparam"><span class="type">string </span><span class="parameter">$compile_id</span></span>);</code><p>
   ...
   <a class="link" href="api.display.tpl" title="display()">desplegarla</a>.
    Proporcionando un tipo y path valido 
    <a class="link" href="template.resources.tpl" title="Recursos">template resource</a>.
    Como un segundo parámetro opcional, usted puede pasar el
    identificador de cache.
    vea el <a class="link" href="caching.tpl" title="Chapter 14. Cache">caching section</a> para 
    mayor información.
  </p>
<p>
 ...
 Uste puede poner también la variable <a class="link" href="variable.compile.id.tpl" title="$compile_id">$compile_id</a> 
 una vez en lugar de pasar esta por cada llamada a la función.
</p>
<p>
   </p>
<div class="example">
<a name="id3130475"></a><p class="title"><b>Example 13.14. fetch()</b></p>
...
<div class="example">
<a name="id3130492"></a><p class="title"><b>Example 13.15. Usando fetch() y enviando a un e-mail</b></p>
...
<p>
     ...
     <a class="link" href="language.function.textformat.tpl" title="{textformat}">{textformat}</a>.
    </p>
<pre class="programlisting">
...
<p>
   Ver también
   <a class="link" href="language.function.fetch.tpl" title="{fetch}">{fetch}</a>
   <a class="link" href="api.display.tpl" title="display()">display()</a>,
   <a class="link" href="language.function.eval.tpl" title="{eval}">{eval}</a>,
   y 
   <a class="link" href="api.template.exists.tpl" title="template_exists()">template_exists()</a>.
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> get_config_vars()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 20 plus 4? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="b6ec2cbd44a5e3d0e8d7a2032189d0eb">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/api.fetch.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01702 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
