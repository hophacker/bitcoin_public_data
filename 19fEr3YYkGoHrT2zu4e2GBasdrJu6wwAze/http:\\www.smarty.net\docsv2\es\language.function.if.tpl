...
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 13:00:45 GMT
...
<p>
    Los comandos <span class="emphasis"><em>{if}</em></span> del Smarty tiene mucho de la 
    flexibilidad del comando 
    <a class="ulink" href="http://php.net/if" target="_top"><span class="command"><strong>if</strong></span></a> de php, 
    con algunas adiciones para la herramienta de template.
			Todo <span class="emphasis"><em>{if}</em></span> debe tener su <span class="emphasis"><em>{/if}</em></span>. 
   <span class="emphasis"><em>{else}</em></span> y <span class="emphasis"><em>{elseif}</em></span> también son
   permitidos. 
   Toda las condicionales de PHP son reconcidas, tal como 
   <span class="emphasis"><em>||</em></span>, <span class="emphasis"><em>or</em></span>,
   <span class="emphasis"><em>&amp;&amp;</em></span>, <span class="emphasis"><em>and</em></span>, etc.
			</p>
<p>
...
<td>agrupar niveles pares [not]</td>
<td>($a / $b) % 2 == 0</td>
</tr>
<tr>
...
<td align="center"> </td>
<td>$a is not odd</td>
<td>[not] el numero es impar (unary)</td>
<td>$a % 2 != 0</td>
</tr>
<tr>
...
<td>[not] agrupa los niveles impares</td>
<td>($a / $b) % 2 != 0</td>
</tr>
</tbody>
</table></div>
<div class="example">
<a name="id3085570"></a><p class="title"><b>Example 7.13. sentencia if</b></p>
...
<td width="40%" align="right" valign="top"> {ldelim},{rdelim}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 4 plus 5? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.function.if.tpl">
            </form>
            </div>
          </div>
