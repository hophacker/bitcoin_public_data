http://www.smarty.net/docsv2/es/installing.smarty.extended.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 11:55:06 GMT
...
<html lang="en">
  <head>
    ...
    <title>Expandiendo la configuración | Smarty</title>
...
<tr><th colspan="3" align="center">Expandiendo la configuración</th></tr>
<tr>
...
<div class="sect1" title="Expandiendo la configuración">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="installing.smarty.extended"></a>Expandiendo la configuración</h2></div></div></div>
<p>
    Esta es una continuación de la <a class="link" href="installing.smarty.basic.tpl" title="Instalación Básica">
    instalación básica</a>, por favor lea esta primero!
   </p>
<p>
    ...
    "/php/includes/guestbook/" y llamemos al nuevo archivo <code class="filename">setup.php
    </code>. En nuestro ejemplo, "/php/includes" está en nuestro include_path.
    Verifique que usted también lo definio, o utilice rutas absolutas de 
    los archivos.
   </p>
<div class="example">
<a name="id3063050"></a><p class="title"><b>Example 2.10. Editando /php/includes/guestbook/setup.php</b></p>
...
<div class="example">
<a name="id3063069"></a><p class="title"><b>Example 2.11. Editando /web/www.example.com/docs/guestbook/index.php</b></p>
<div class="example-contents"><pre class="programlisting">
...
<tr>
<td width="40%" align="left" valign="top">Instalación Básica </td>
...
<td width="40%" align="right" valign="top"> Part II. Smarty For Template Designers</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/installing.smarty.extended.tpl">
            </form>
            </div>
          </div>
