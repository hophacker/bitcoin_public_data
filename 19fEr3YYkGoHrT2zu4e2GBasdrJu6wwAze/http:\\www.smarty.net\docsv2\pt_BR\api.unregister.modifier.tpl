http://www.smarty.net/docsv2/pt_BR/api.unregister.modifier.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 19:31:29 GMT
...
<div class="sect1" title="unregister_modifier">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="api.unregister.modifier"></a>unregister_modifier</h2></div></div></div>
<div class="funcsynopsis">
<table border="0" summary="Function synopsis" cellspacing="0" cellpadding="0" class="funcprototype-table"><tr>
<td><code class="funcdef">void <b class="fsfunc">unregister_modifier</b>(</code></td>
<td>
...
<div class="example">
<a name="id2761816"></a><p class="title"><b>Example 13.26. unregister_modifier</b></p>
<div class="example-contents"><pre class="programlisting">
// nós não queremos que designers de template usem strip tags para os elementos

$smarty-&gt;unregister_modifier("strip_tags");</pre></div>
</div>
...
<td width="40%" align="right" valign="top"> unregister_object</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/api.unregister.modifier.tpl">
            </form>
            </div>
          </div>
