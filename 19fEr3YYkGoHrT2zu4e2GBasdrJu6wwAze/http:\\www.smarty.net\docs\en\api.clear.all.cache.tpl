...
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 21:33:07 GMT
...
<h2>Name</h2>
<p>clearAllCache() — clears the entire template cache</p>
</div>
<div class="refsect1" title="Description">
<a name="idp15543920"></a><h2>Description</h2>
...
<p>
    Since Smarty version 3.1.14 it is possible to delete cache files by their individual expiration time at creation by passing constant SMARTY::CLEAR_EXPIRED as <em class="parameter"><code>expire_time</code></em> parameter.
   </p>
</div>
<div class="example">
<a name="idp15594272"></a><p class="title"><b>Example 14.9. clearAllCache</b></p>
...
<br class="example-break"><p>
  ...
  and the
  <a class="link" href="caching.tpl" title="Chapter 15. Caching">caching</a> page.
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> clearAssign()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/api.clear.all.cache.tpl">
            </form>
            </div>
          </div>
