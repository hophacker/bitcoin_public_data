http://www.smarty.net/docsv2/pt_BR/variable.plugins.dir.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 07:20:47 GMT
...
<td width="40%" align="right" valign="top"> $debugging</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/variable.plugins.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.21658 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
