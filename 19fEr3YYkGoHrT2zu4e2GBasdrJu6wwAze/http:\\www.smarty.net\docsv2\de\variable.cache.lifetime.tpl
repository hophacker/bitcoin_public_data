http://www.smarty.net/docsv2/de/variable.cache.lifetime.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 15:15:43 GMT
...
<p>
    ...
    effizientere Methode wäre <a class="link" href="variable.caching.tpl" title="$caching">$caching</a>
    auf 'false' zu setzen).
   </p>
<p>
    Wenn <a class="link" href="variable.force.compile.tpl" title="$force_compile">$force_compile</a>
    gesetzt ist, wird der Cache immer neu generiert (was einem Ausschalten
    von caching gleichkommt). Mit der <a class="link" href="api.clear.all.cache.tpl" title="clear_all_cache (Cache vollständig leeren)">clear_all_cache()</a>
    Funktion können Sie alle Cache-Dateien auf einmal entfernen. Mit der
    <a class="link" href="api.clear.cache.tpl" title="clear_cache (leere Cache)">clear_cache()</a> Funktion können Sie
...
<p>
     ...
     können Sie dies tun indem Sie <a class="link" href="variable.caching.tpl" title="$caching">$caching</a>
     auf 2 stellen und '$cache_lifetime' einen einmaligen Wert zuweisen, bevor Sie
      <a class="link" href="api.display.tpl" title="display (ausgeben)">display()</a>
      oder <a class="link" href="api.fetch.tpl" title="fetch">fetch()</a> aufrufen.
    </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> $cache_handler_func</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 9 plus 8? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/variable.cache.lifetime.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02250 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
