http://www.smarty.net/docsv2/de/variable.request.vars.order.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 17:51:34 GMT
...
<html lang="en">
  <head>
    ...
    <title>$request_vars_order | Smarty</title>
...
<tr><th colspan="3" align="center">$request_vars_order</th></tr>
<tr>
...
<td width="20%" align="right"> <a accesskey="n" href="variable.request.use.auto.globals.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="$request_vars_order">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="variable.request.vars.order"></a>$request_vars_order</h2></div></div></div>
<p>
      Die Reihenfolge in welcher die Request-Variblen zugewiesen werden.
      Verhält sich wie 'variables_order' in der php.ini.
    </p>
<p>
      Siehe auch <a class="link" href="language.variables.smarty.tpl" title="Die reservierte {$smarty} Variable">$smarty.request</a>
      und
      <a class="link" href="variable.request.use.auto.globals.tpl" title="$request_use_auto_globals">$request_use_auto_globals</a>.
    </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="variable.request.use.auto.globals.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$compiler_class </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> $request_use_auto_globals</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="d9e9ce1a9275981bb7a691e39f5f6a9d">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/variable.request.vars.order.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02384 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
