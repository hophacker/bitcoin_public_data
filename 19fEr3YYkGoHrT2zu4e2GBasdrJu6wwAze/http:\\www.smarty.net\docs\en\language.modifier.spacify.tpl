...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 13:45:21 GMT
...
<p>
     <code class="varname">spacify</code> is a way to insert a space between every
...
<td>This what gets inserted between each character of
       the variable.</td>
</tr></tbody>
</table></div>
<div class="example">
<a name="idp6772416"></a><p class="title"><b>Example 5.17. spacify</b></p>
...
<td width="40%" align="right" valign="top"> string_format</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 6 plus 13? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/language.modifier.spacify.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01808 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
