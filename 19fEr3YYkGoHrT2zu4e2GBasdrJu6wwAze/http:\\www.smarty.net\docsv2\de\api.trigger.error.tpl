http://www.smarty.net/docsv2/de/api.trigger.error.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 05:33:23 GMT
...
<html lang="en">
  <head>
    ...
    <title>trigger_error (Fehler auslösen) | Smarty</title>
...
<tr><th colspan="3" align="center">trigger_error (Fehler auslösen)</th></tr>
<tr>
...
<div class="refentry" title="trigger_error (Fehler auslösen)">
<a name="api.trigger.error"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>trigger_error (Fehler auslösen)</p>
</div>
<div class="refsect1">
<a name="id2923927"></a><h2></h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">trigger_error</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">error_msg</span></span>,<br>                   <span class="methodparam"><span class="type">int </span><span class="parameter">level</span></span>);</code><p>
    ...
    Der <em class="parameter"><code>level</code></em>-Parameter kann alle
...
<tr>
<td width="40%" align="left" valign="top">register_resource (Ressource registrieren) </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> template_exists (Template existiert)</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/api.trigger.error.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02199 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
