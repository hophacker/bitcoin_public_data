http://www.smarty.net/docsv2/es/api.config.load.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 01:29:36 GMT
...
<h2>Name</h2>
<p>config_load() — Carga el archivo de configuración y lo asigna al template</p>
</div>
<div class="refsect1" title="Descripción">
<a name="id3128836"></a><h2>Descripción</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">config_load</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">file</span></span>,<br>                 <span class="methodparam"><span class="type">string </span><span class="parameter">section</span></span>);</code><p>
   Esto carga el <a class="link" href="config.files.tpl" title="Chapter 9. Config Files">archivo de configuración</a> de 
...
<p>
    ...
    mantenidas a través de <a class="link" href="api.fetch.tpl" title="fetch()">fetch()</a> y 
    <a class="link" href="api.display.tpl" title="display()">display()</a>. Las variables de
    ...
    <a class="link" href="variable.force.compile.tpl" title="$force_compile">force_compile</a> y 
    <a class="link" href="variable.compile.check.tpl" title="$compile_check">compile_check</a> de 
    configuración.
   </p>
</div>
<div class="example">
<a name="id3128987"></a><p class="title"><b>Example 13.11. config_load()</b></p>
...
<td width="40%" align="right" valign="top"> display()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 12 plus 1? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/api.config.load.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02380 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
