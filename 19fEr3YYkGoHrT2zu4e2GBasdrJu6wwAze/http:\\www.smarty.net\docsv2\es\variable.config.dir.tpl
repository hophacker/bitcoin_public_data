http://www.smarty.net/docsv2/es/variable.config.dir.tpl
HTTP/1.1 200 OK
...
<p>
       Este es el directorio usado para almacenar 
       <a class="link" href="config.files.tpl" title="Chapter 9. Config Files">archivos de configuración</a> 
       usados en los templates. 
       El default es <code class="filename">"./configs"</code>, 
       esto significa que lo buscara en el directorio de templates en 
       el mismo directorio que esta ejecutando el script php.
      </p>
...
<td width="40%" align="right" valign="top"> $plugins_dir</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 12 plus 7? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/variable.config.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02260 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
