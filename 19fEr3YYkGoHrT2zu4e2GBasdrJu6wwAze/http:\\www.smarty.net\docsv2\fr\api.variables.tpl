http://www.smarty.net/docsv2/fr/api.variables.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 19:20:33 GMT
...
<html lang="en">
  <head>
    ...
    <title>Chapter 12. Variables | Smarty</title>
...
<tr><th colspan="3" align="center">Chapter 12. Variables</th></tr>
<tr>
...
<div class="chapter" title="Chapter 12. Variables">
<div class="titlepage"><div><div><h2 class="title">
<a name="api.variables"></a>Chapter 12. Variables</h2></div></div></div>
<div class="toc">
...
<p>
  ...
  <code class="filename">./templates</code>, ce qui signifie
  qu'il va chercher le répertoire <code class="filename">templates/</code>
...
<td width="40%" align="right" valign="top"> $compile_dir</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/api.variables.tpl">
            </form>
            </div>
          </div>
