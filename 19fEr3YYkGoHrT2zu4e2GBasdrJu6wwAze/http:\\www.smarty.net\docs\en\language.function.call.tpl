...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 03:42:35 GMT
...
<p>
  <code class="varname">{call}</code> is used to call a template function defined by the
...
<p>
   ...
   The <a class="link" href="language.function.call.tpl" title="{call}"><code class="varname">{call}</code></a>
...
<li class="listitem"><p>
  The <code class="varname">{call}</code> tag must have the  <em class="parameter"><code>name</code></em> attribute
...
<td>The name of the variable that the output of
        called template function will be assigned to</td>
</tr>
<tr>
...
<div class="example">
<a name="idp8239520"></a><p class="title"><b>Example 7.20. Calling a recursive menu example</b></p>
...
<td width="40%" align="right" valign="top"> {capture}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/language.function.call.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02312 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
