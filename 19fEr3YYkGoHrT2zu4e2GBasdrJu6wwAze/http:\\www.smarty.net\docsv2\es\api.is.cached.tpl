http://www.smarty.net/docsv2/es/api.is.cached.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 13:59:20 GMT
...
<h2>Name</h2>
<p>is_cached() — Retorna true si hay cache valido para ese template</p>
</div>
<div class="refsect1" title="Descripción">
<a name="id3131436"></a><h2>Descripción </h2>
<code class="methodsynopsis"><span class="type">bool </span><span class="methodname">is_cached</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">template</span></span>,<br>               <span class="methodparam"><span class="type">string </span><span class="parameter">cache_id</span></span>,<br>               <span class="methodparam"><span class="type">string </span><span class="parameter">compile_id</span></span>);</code><p>
   Esto solamente funciona si <a class="link" href="variable.caching.tpl" title="$caching">
   caching</a> está asignado a true.
  ver también <a class="link" href="caching.tpl" title="Chapter 14. Cache">caching section</a>.
  </p>
<div class="example">
<a name="id3130994"></a><p class="title"><b>Example 13.19. is_cached()</b></p>
...
<br class="example-break"><p>
   ...
   <a class="link" href="caching.multiple.caches.tpl" title="Multiples caches por pagina">multiples caches</a> 
...
<p>
   ...
   <a class="link" href="variable.compile.id.tpl" title="$compile_id">$compile_id</a> es usada.
  </p>
<p>
   Si usted no quiere pasar el  
   <a class="link" href="variable.compile.id.tpl" title="$compile_id">identificador de cache</a> 
   solamente quiere pasar el compile id debe pasar <code class="literal">null</code>
   como el identidficador de cache.
  </p>
<div class="example">
<a name="id3131895"></a><p class="title"><b>Example 13.20. is_cached() con templates con multiple-cache</b></p>
<div class="example-contents"><pre class="programlisting">
...
<p>
   Si <code class="literal">is_cached</code> retorna true el carga actualmente 
   la salida del cache y lo guarda internamente. cualquier subsecuente
   llama a <a class="link" href="api.display.tpl" title="display()">display()</a> o
   <a class="link" href="api.fetch.tpl" title="fetch()">fetch()</a> y retorna este internamente 
   ...
   <a class="link" href="api.clear.cache.tpl" title="clear_cache()">clear_cache()</a> y otros cambios
   en el cache-settings que no tiene efecto despues que 
   <code class="literal">is_cached</code> retorna true.
  </p>
</div>
<p>
    Ver también 
    ...
    y 
    <a class="link" href="caching.tpl" title="Chapter 14. Cache">caching section</a>.
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> load_filter()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 12 plus 11? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/api.is.cached.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02807 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
