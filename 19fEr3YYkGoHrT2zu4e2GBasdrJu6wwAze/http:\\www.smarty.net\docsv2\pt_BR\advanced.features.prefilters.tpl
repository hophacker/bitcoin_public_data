http://www.smarty.net/docsv2/pt_BR/advanced.features.prefilters.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 13:45:19 GMT
...
<p>
     ...
     comentários indesejados, mantendo o olho no que as pessoas estão colocando nos seus templates,
      etc.  Prefilters podem ser ou <a class="link" href="api.register.prefilter.tpl" title="register_prefilter">registrado</a>
...
<div class="example">
<a name="id2768974"></a><p class="title"><b>Example 15.2. Usando um prefilter de template</b></p>
...
&lt;!--# esta linha será removida pelo prefilter --&gt;</pre></div>
</div>
...
<td width="40%" align="right" valign="top"> Postfilters</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 3 plus 18? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/advanced.features.prefilters.tpl">
            </form>
            </div>
          </div>
