http://www.smarty.net/docsv2/es/language.function.html.options.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 17:51:03 GMT
...
<div class="example">
<a name="id3098715"></a><p class="title"><b>Example 8.10. {html_options}</b></p>
...
<a name="id3098813"></a><p class="title"><b>Example 8.11. {html_options} - Ejemplo con base de datos (eg PEAR o ADODB):</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<br class="example-break"><p>
    ...
    y <a class="link" href="language.function.html.radios.tpl" title="{html_radios}">{html_radios}</a>
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> {html_radios}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 14 plus 6? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.function.html.options.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02484 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
