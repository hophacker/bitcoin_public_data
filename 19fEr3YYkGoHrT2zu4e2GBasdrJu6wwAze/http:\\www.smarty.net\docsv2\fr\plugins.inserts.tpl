http://www.smarty.net/docsv2/fr/plugins.inserts.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 16:03:32 GMT
...
<tr><th colspan="3" align="center">Insertions</th></tr>
<tr>
...
<div class="sect1" title="Insertions">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="plugins.inserts"></a>Insertions</h2></div></div></div>
<p>
...
<p>
  ...
  substitué à la balise <code class="varname">{insert}</code> dans le template.
 </p>
<div class="example">
<a name="id3036762"></a><p class="title"><b>Example 16.11. Plugin d'insertion</b></p>
...
<td width="40%" align="right" valign="top"> Part IV. Appendices</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 16 plus 9? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/plugins.inserts.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02087 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
