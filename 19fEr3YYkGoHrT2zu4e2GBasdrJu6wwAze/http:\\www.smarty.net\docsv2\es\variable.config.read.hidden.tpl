http://www.smarty.net/docsv2/es/variable.config.read.hidden.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 07:49:03 GMT
...
<td width="20%" align="right"> <a accesskey="n" href="variable.config.fix.newlines.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
       Si es asignado true, esconde secciones (nombres de secciones comenzando con 
       un periodo) en el <a class="link" href="config.files.tpl" title="Chapter 9. Config Files">archivo de configuración</a> 
       pueden ser leidos del template. Tipicamente desearia esto como false, de esta 
       forma usted puede almacenar datos sensibles en el archivo de configuración 
       como un parámetro de base de datos y sin preocuparse que el template los carge. 
       false es el default.
	   </p>
</div>
<div class="navfooter">
...
<td width="40%" align="right"> <a accesskey="n" href="variable.config.fix.newlines.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$config_booleanize </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> $config_fix_newlines</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 5 plus 18? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/variable.config.read.hidden.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02265 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
