http://www.smarty.net/docsv2/fr/variable.cache.dir.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 04:12:28 GMT
...
<p>
  ...
  <code class="filename">./cache</code>, ce qui signifie
  que Smarty va chercher ce répertoire
  dans le même répertoire que le script PHP en cours d'exécution.
  <span class="bold"><strong>Ce dossier doit être accessible en écriture par
   le serveur web</strong></span>
  (<a class="link" href="installing.smarty.basic.tpl" title="Installation de base">Voir l'installation</a> pour plus d'informations).
  Vous pouvez aussi utiliser votre propre fonction de
  <a class="link" href="section.template.cache.handler.func.tpl" title="Fonction de gestion du cache">gestion de cache
  personnalisé</a> pour contrôler les fichiers de cache, qui ignorera
  cette configuration.
  Voir aussi <a class="link" href="variable.use.sub.dirs.tpl" title="$use_sub_dirs"><em class="parameter"><code>$use_sub_dirs</code></em></a>.
 </p>
...
<p>
  ...
  <a class="link" href="variable.cache.modified.check.tpl" title="$cache_modified_check"><em class="parameter"><code>$cache_modified_check</code></em></a> et
...
<td width="40%" align="right" valign="top"> $cache_lifetime</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 1 plus 8? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/variable.cache.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02179 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
