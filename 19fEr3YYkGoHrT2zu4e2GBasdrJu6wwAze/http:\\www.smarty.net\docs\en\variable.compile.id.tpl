...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 20:07:37 GMT
...
<p>
  ...
  for different <a class="link" href="variable.template.dir.tpl" title="$template_dir">
  <em class="parameter"><code>$template_dirs</code></em></a>.  If you set a distinct
  <em class="parameter"><code>$compile_id</code></em> for each
  <a class="link" href="variable.template.dir.tpl" title="$template_dir"><em class="parameter"><code>$template_dir</code></em>
...
<div class="example">
<a name="idp14263504"></a><p class="title"><b>Example 13.1. $compile_id in a virtual host environment</b></p>
...
<td width="40%" align="right" valign="top"> $compile_locking</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/variable.compile.id.tpl">
            </form>
            </div>
          </div>
