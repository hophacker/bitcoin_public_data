http://www.smarty.net/docsv2/es/api.unregister.resource.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 21:33:20 GMT
...
<h2>Name</h2>
<p>unregister_resource() — Des-registra dinamicamente un plugin de recurso</p>
</div>
<div class="refsect1" title="Descripción">
<a name="id3136903"></a><h2> Descripción</h2>
...
<div class="example">
<a name="id3136936"></a><p class="title"><b>Example 13.29. unregister_resource()</b></p>
...
<br class="example-break"><p>
 ...
 y
 <a class="link" href="template.resources.tpl" title="Recursos">template resources</a>
</p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> Chapter 14. Cache</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/api.unregister.resource.tpl">
            </form>
            </div>
          </div>
