http://www.smarty.net/docsv2/it/variable.compile.id.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 03:42:31 GMT
...
<p>
           Identificatore persistente di compilazione. In alternativa a passare
           lo stesso compile_id ad ogni chiamata di funzione, potete impostare
           questa variabile ed il suo valore verrà usato implicitamente da quel
           momento in poi.
      </p>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> $use_sub_dirs</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/variable.compile.id.tpl">
            </form>
            </div>
          </div>
