...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 13:57:46 GMT
...
<html lang="en">
  <head>
    ...
    <title>Chapter 18. Extending Smarty With Plugins | Smarty</title>
    <meta name="description" content="Chapter 18. Extending Smarty With Plugins">
    <meta name="keywords" content="chapter, 18, extending, smarty, with, plugins">
...
<tr><th colspan="3" align="center">Chapter 18. Extending Smarty With Plugins</th></tr>
<tr>
...
<div class="chapter" title="Chapter 18. Extending Smarty With Plugins">
<div class="titlepage"><div><div><h2 class="title">
<a name="plugins"></a>Chapter 18. Extending Smarty With Plugins</h2></div></div></div>
<div class="toc">
...
<td width="40%" align="right" valign="top"> Naming Conventions</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 13 plus 0? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/plugins.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01406 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
