http://www.smarty.net/docsv2/es/language.function.eval.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 22:00:50 GMT
...
<td>variable (o cadena) para evaluar</td>
</tr>
<tr>
...
<p>
   ...
   <a class="link" href="caching.tpl" title="Chapter 14. Cache">cache</a> junto con el resto del template.
			</p>
</div>
<div class="example">
<a name="id3096106"></a><p class="title"><b>Example 8.5. {eval}</b></p>
...
<td width="40%" align="right" valign="top"> {fetch}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.function.eval.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02140 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
