http://www.smarty.net/docsv2/en/api.register.outputfilter.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 03:42:10 GMT
...
<html lang="en">
  <head>
    ...
    <title>register_outputfilter() | Smarty</title>
...
<td width="20%" align="right"> <a accesskey="n" href="api.register.postfilter.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<a name="id2858802"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">register_outputfilter</span>(<span class="methodparam"><span class="type">mixed </span><span class="parameter">function</span></span>);</code><p>
   ...
   <a class="link" href="plugins.outputfilters.tpl" title="Output Filters">outputfilters</a> to operate on
   a template's output before it is
   <a class="link" href="api.display.tpl" title="display()">displayed</a>. See
   <a class="link" href="advanced.features.outputfilters.tpl" title="Output Filters">template output
   filters</a>
...
<p>
See also
<a class="link" href="api.unregister.outputfilter.tpl" title="unregister_outputfilter()"><code class="varname">unregister_outputfilter()</code></a>,
...
<td width="40%" align="right"> <a accesskey="n" href="api.register.postfilter.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> register_postfilter()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 5 plus 0? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="aa83fed7571d572a1970ddf38467d5f5">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/api.register.outputfilter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01999 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
