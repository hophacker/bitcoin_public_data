...
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 17:26:47 GMT
...
<p>
  The <code class="varname">{for}{forelse}</code> tag is used to create simple loops. The following different formarts are supported:
 </p>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>
    <code class="varname">{for $var=$start to $end}</code> simple loop with step size of 1.
   </p></li>
<li class="listitem"><p>
    <code class="varname">{for $var=$start to $end step $step}</code> loop with individual step size.
   </p></li>
</ul></div>
<p>
  <code class="varname">{forelse}</code> is executed when the loop is not iterated.
 </p>
...
<td>Disables caching of the <code class="varname">{for}</code> loop</td>
</tr></tbody>
</table></div>
<div class="example">
<a name="idp8575568"></a><p class="title"><b>Example 7.27. A simple <code class="varname">{for}</code> loop</b></p>
...
<a name="idp8579200"></a><p class="title"><b>Example 7.28. Using the <code class="varname">max</code> attribute</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<br class="example-break"><div class="example">
<a name="idp8583648"></a><p class="title"><b>Example 7.29. Excution of <code class="varname">{forelse}</code></b></p>
<div class="example-contents">
<pre class="programlisting">
...
<br class="example-break"><p>
   See also <a class="link" href="language.function.foreach.tpl" title="{foreach},{foreachelse}"><code class="varname">{foreach}</code></a>,
...
<td width="40%" align="right" valign="top"> {foreach},{foreachelse}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/language.function.for.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01712 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
