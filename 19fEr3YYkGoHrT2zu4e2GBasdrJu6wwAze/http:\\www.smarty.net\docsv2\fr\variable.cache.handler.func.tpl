HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 15:26:58 GMT
...
<p>
  ...
  <a class="link" href="section.template.cache.handler.func.tpl" title="Fonction de gestion du cache">fonction de gestion de cache
  personnalisée</a> pour plus de détails.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $cache_modified_check</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/variable.cache.handler.func.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.19703 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
