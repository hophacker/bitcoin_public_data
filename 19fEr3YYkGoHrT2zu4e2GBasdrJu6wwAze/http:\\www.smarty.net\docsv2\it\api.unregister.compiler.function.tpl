http://www.smarty.net/docsv2/it/api.unregister.compiler.function.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 13:59:06 GMT
...
<h2>Name</h2>
<p>unregister_compiler_function</p>
</div>
<div class="refsect1">
<a name="id3147009"></a><h2></h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">unregister_compiler_function</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">name</span></span>);</code><p>
   ...
   Passate in <em class="parameter"><code>name</code></em> il nome della funzione.
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> unregister_function</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 13 plus 10? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="83214f086b65307b7382be53ac1b395d">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/api.unregister.compiler.function.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02536 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
