http://www.smarty.net/docsv2/pt_BR/api.unregister.outputfilter.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 10:40:48 GMT
...
<div class="sect1" title="unregister_outputfilter">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="api.unregister.outputfilter"></a>unregister_outputfilter</h2></div></div></div>
<div class="funcsynopsis">
<table border="0" summary="Function synopsis" cellspacing="0" cellpadding="0" class="funcprototype-table"><tr>
<td><code class="funcdef">void <b class="fsfunc">unregister_outputfilter</b>(</code></td>
<td>
<var class="pdparam">function_name</var><code>)</code>;</td>
<td> </td>
</tr></table>
<div class="paramdef-list">
<code>string <var class="pdparam">function_name</var></code>;</div>
...
<td width="40%" align="right" valign="top"> unregister_postfilter</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/api.unregister.outputfilter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02691 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
