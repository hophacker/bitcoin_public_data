http://www.smarty.net/docsv2/fr/api.register.modifier.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 06:25:14 GMT
...
<div class="refentry" title="register_modifier()">
<a name="api.register.modifier"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>register_modifier() — Déclare dynamiquement un plugin de modificateur</p>
</div>
<div class="refsect1" title="Description">
<a name="id3013441"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">register_modifier</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">name</span></span>,<br>                       <span class="methodparam"><span class="type">mixed </span><span class="parameter">impl</span></span>);</code><p>
...
<div class="example">
<a name="id3014336"></a><p class="title"><b>Example 13.24. register_modifier()</b></p>
...
<br class="example-break"><p>
   ...
   les <a class="link" href="language.modifiers.tpl" title="Chapter 5. Modificateurs de variables">modifieurs</a>,
   l'<a class="link" href="plugins.tpl" title="Chapter 16. Etendre Smarty avec des plugins">extension de Smarty avec des plugins</a> et
   la <a class="link" href="plugins.modifiers.tpl" title="Modificateurs">création de plugins modifieurs</a>.
 </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> register_object()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/api.register.modifier.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02363 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
