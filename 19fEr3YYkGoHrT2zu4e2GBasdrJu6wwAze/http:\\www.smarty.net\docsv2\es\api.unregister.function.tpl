http://www.smarty.net/docsv2/es/api.unregister.function.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 20:07:54 GMT
...
<h2>Name</h2>
<p>unregister_function() — des-registrar dinámicamente una función de plugin del template</p>
</div>
<div class="refsect1" title="Descripción">
<a name="id3136649"></a><h2> Descripción</h2>
...
<div class="example">
<a name="id3136599"></a><p class="title"><b>Example 13.27. unregister_function()</b></p>
...
<br class="example-break"><p>
     Ver también <a class="link" href="api.register.function.tpl" title="register_function()">register_function() </a>.
    </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> unregister_modifier()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/api.unregister.function.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01311 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
