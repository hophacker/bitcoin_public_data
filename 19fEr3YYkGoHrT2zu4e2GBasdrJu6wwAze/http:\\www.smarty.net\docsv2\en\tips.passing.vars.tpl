http://www.smarty.net/docsv2/en/tips.passing.vars.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 00:16:55 GMT
...
<div class="example">
<a name="id2885093"></a><p class="title"><b>Example 18.3. Passing the title variable to the header template</b></p>
...
<td width="40%" align="right" valign="top"> Dates</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/tips.passing.vars.tpl">
            </form>
            </div>
          </div>
