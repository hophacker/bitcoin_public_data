http://www.smarty.net/docsv2/pt_BR/smarty.constants.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 22:11:02 GMT
...
<div class="example">
<a name="id2748494"></a><p class="title"><b>Example 11.1. SMARTY_DIR</b></p>
<div class="example-contents"><pre class="programlisting">
// set path to Smarty directory
define("SMARTY_DIR","/usr/local/lib/php/Smarty/");

require_once(SMARTY_DIR."Smarty.class.php");</pre></div>
</div>
...
<tr>
<td width="40%" align="left" valign="top">Part III. Smarty para Programadores </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Chapter 12. Variáveis</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/smarty.constants.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02906 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
