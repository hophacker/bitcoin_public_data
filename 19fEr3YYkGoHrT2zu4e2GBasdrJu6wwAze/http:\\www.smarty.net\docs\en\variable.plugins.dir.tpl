...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 05:33:28 GMT
...
<p>
        ...
        <a class="link" href="api.add.plugins.dir.tpl" title="addPluginsDir()"><code class="varname">addPluginsDir()</code></a> instead.
       </p>
</div>
<p>
       See also 
...
<td width="40%" align="right" valign="top"> $right_delimiter</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/variable.plugins.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02246 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
