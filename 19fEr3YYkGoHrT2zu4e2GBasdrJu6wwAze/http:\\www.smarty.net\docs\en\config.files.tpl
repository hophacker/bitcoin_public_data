...
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 13:24:49 GMT
...
<html lang="en">
  <head>
    ...
    <title>Chapter 9. Config Files | Smarty</title>
    <meta name="description" content="Chapter 9. Config Files">
    <meta name="keywords" content="chapter, 9, config, files">
...
<div class="example">
<a name="idp13746416"></a><p class="title"><b>Example 9.1. Example of config file syntax</b></p>
...
<br class="example-break"><p>
  Values of <a class="link" href="language.config.variables.tpl" title="Variables loaded from config files">config file
...
<p>
  ...
  one will be used unless <a class="link" href="variable.config.overwrite.tpl" title="$config_overwrite">
...
<p>
  ...
  {config_load}</code></a> or the API <a class="link" href="api.config.load.tpl" title="configLoad()"><code class="varname">configLoad()</code></a> function.
 </p>
<p>
...
<p>
  ...
  That means that a config file can also be loaded from a db <code class="literal">$smarty-&gt;configLoad("db:my.conf")</code>.
 </p>
<p>
  See also
...
<td width="40%" align="right" valign="top"> Chapter 10. Debugging Console</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/config.files.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01643 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
