http://www.smarty.net/docsv2/fr/language.function.popup.init.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 11:22:40 GMT
...
<p>
  ...
  est une intégration de <a class="ulink" href="http://www.bosrup.com/web/overlib/" target="_top">overLib</a>,
...
<li class="listitem"><p>
    <code class="varname">{popup_init}</code> doit être appelé une <span class="emphasis"><em>seule fois</em></span>,
    de préférence dans la balise <code class="literal">&lt;head&gt;</code>, dans toutes les pages si vous
    comptez utiliser la fonction <a class="link" href="language.function.popup.tpl" title="{popup}">
     <code class="varname">{popup}</code></a>.
   </p></li>
<li class="listitem"><p>
...
<li class="listitem"><p>
    ...
    <a class="ulink" href="http://www.bosrup.com/web/overlib/" target="_top">http://www.bosrup.com/web/overlib/</a>.
   </p></li>
</ul></div>
<div class="example">
<a name="id2983935"></a><p class="title"><b>Example 8.26. {popup_init}</b></p>
...
<br class="example-break"><div class="note" title="Validation XHTML" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Validation XHTML</h3>
<p><code class="literal">{popup_init}</code> ne valide pas en validation stricte et vous devriez
 obtenir l'erreur :
<code class="literal">document type does not allow element "div" here;</code>
(i.e. une balise <code class="literal">&lt;div&gt;</code> dans la balise <code class="literal">&lt;head&gt;</code>).

Ceci signifie que vous devez inclure les balises <code class="literal">&lt;script&gt;</code> et
<code class="literal">&lt;div&gt;</code> manuellement.
</p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> {textformat}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/language.function.popup.init.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03144 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
