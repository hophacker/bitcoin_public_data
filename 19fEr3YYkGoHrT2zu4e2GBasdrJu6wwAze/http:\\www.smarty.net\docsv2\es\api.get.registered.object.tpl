http://www.smarty.net/docsv2/es/api.get.registered.object.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 13:24:24 GMT
...
<h2>Name</h2>
<p>get_registered_object() — Este retorna una referencia para un objeto registrado.</p>
</div>
<div class="refsect1" title="Descripción">
<a name="id3130304"></a><h2>Descripción</h2>
<code class="methodsynopsis"><span class="type">array </span><span class="methodname">get_registered_object</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">object_name</span></span>);</code><p>
   ...
   <a class="link" href="api.register.object.tpl" title="register_object()">objeto registrado</a>.
   Ver <a class="link" href="advanced.features.tpl#advanced.features.objects" title="Objetos">objects</a> para mas
   información;
  </p>
<div class="example">
<a name="id3131253"></a><p class="title"><b>Example 13.17. get_registered_object()</b></p>
...
<br class="example-break"><p>
     Ver también 
     <a class="link" href="api.register.object.tpl" title="register_object()">register_object()</a>,
     <a class="link" href="api.unregister.object.tpl" title="unregister_object()">unregister_object()</a>
     y
     <a class="link" href="advanced.features.tpl#advanced.features.objects" title="Objetos">objects section</a>
     </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> get_template_vars()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 15 plus 15? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="2a955fc4ac4dfadc54ae9f64d495a837">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/api.get.registered.object.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.19530 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
