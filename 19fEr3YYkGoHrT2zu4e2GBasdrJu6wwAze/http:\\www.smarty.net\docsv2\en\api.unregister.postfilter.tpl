http://www.smarty.net/docsv2/en/api.unregister.postfilter.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 17:26:41 GMT
...
<h2>Name</h2>
<p>unregister_postfilter() — dynamically unregister a postfilter</p>
</div>
<div class="refsect1" title="Description">
<a name="id2863318"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">unregister_postfilter</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">function_name</span></span>);</code><p>
    ...
    <code class="varname">register_postfilter()</code></a>
    and
    <a class="link" href="plugins.prefilters.postfilters.tpl" title="Prefilters/Postfilters">template post filters</a>.
</p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> unregister_prefilter()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/api.unregister.postfilter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.19453 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
