http://www.smarty.net/docsv2/it/advanced.features.outputfilters.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 11:54:26 GMT
...
<html lang="en">
  <head>
    ...
    <title>Filtri di output | Smarty</title>
...
<tr><th colspan="3" align="center">Filtri di output</th></tr>
<tr>
...
<div class="sect1" title="Filtri di output">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="advanced.features.outputfilters"></a>Filtri di output</h2></div></div></div>
<p>
...
<p>
    ...
    <a class="link" href="api.register.outputfilter.tpl" title="register_outputfilter">registrati</a> o caricati
    dalla directory plugins con la funzione
    <a class="link" href="api.load.filter.tpl" title="load_filter">load_filter()</a> oppure impostando la
    variabile <a class="link" href="variable.autoload.filters.tpl" title="$autoload_filters">$autoload_filters</a>.
...
<div class="example">
<a name="id3155357"></a><p class="title"><b>Example 15.4. uso di un filtro di output</b></p>
...
<tr>
<td width="40%" align="left" valign="top">Postfiltri </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Funzione di gestione della Cache</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 19 plus 14? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="5b69e4544ebb4be1e06a879871b593b8">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/advanced.features.outputfilters.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02277 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
