http://www.smarty.net/docsv2/en/language.function.config.load.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 07:49:23 GMT
...
<p>
   ...
   <a class="link" href="language.config.variables.tpl" title="Variables loaded from config files"><em class="parameter"><code>#variables#</code></em></a>
   from a <a class="link" href="config.files.tpl" title="Chapter 9. Config Files">configuration file</a> into the template.
 </p>
...
<div class="example">
<a name="id2800949"></a><p class="title"><b>Example 7.3. {config_load}</b></p>
...
<br class="example-break"><p>
  <a class="link" href="config.files.tpl" title="Chapter 9. Config Files">Config Files</a>
...
<div class="example">
<a name="id2801040"></a><p class="title"><b>Example 7.4. function {config_load} with section</b></p>
...
<br class="example-break"><p>
See <a class="link" href="variable.config.overwrite.tpl" title="$config_overwrite"><em class="parameter"><code>$config_overwrite</code></em></a>
to create arrays of config file variables.
</p>
<p>
  See also the <a class="link" href="config.files.tpl" title="Chapter 9. Config Files">config files</a> page,
  <a class="link" href="language.config.variables.tpl" title="Variables loaded from config files">config variables</a> page,
...
<tr>
<td width="40%" align="left" valign="top">Chapter 7. Built-in Functions </td>
...
<td width="40%" align="right" valign="top"> {foreach},{foreachelse}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 10 plus 13? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/language.function.config.load.tpl">
            </form>
            </div>
          </div>
