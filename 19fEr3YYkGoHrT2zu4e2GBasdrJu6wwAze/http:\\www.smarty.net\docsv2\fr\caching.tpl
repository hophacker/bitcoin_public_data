http://www.smarty.net/docsv2/fr/caching.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 12:23:22 GMT
...
<html lang="en">
  <head>
    ...
    <title>Chapter 14. Cache | Smarty</title>
...
<th width="60%" align="center">Part III. Smarty pour les programmeurs</th>
...
<p>
  Le cache est utilisée pour accélérer l'appel de <a class="link" href="api.display.tpl" title="display()"><code class="varname">display()</code></a> ou de <a class="link" href="api.fetch.tpl" title="fetch()"><code class="varname">fetch()</code></a> en sauvegardant leur résultat
  ...
  le résultat de <a class="link" href="api.display.tpl" title="display()"><code class="varname">display()</code></a> ou de 
  <a class="link" href="api.fetch.tpl" title="fetch()"><code class="varname">fetch()</code></a>est dans le cache, un fichier de cache 
...
<div class="sect1" title="Paramétrer le cache">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="caching.setting.up"></a>Paramétrer le cache</h2></div></div></div>
<p>
  ...
  <code class="literal"> = 1 (ou 2)</code>.
 </p>
<div class="example">
<a name="id3025208"></a><p class="title"><b>Example 14.1. Activation du cache</b></p>
...
<br class="example-break"><p>
  Avec le cache activé, la fonction <code class="literal">display('index.tpl')</code> va afficher
  ...
  Au prochain appel de <code class="literal">display('index.tpl')</code>, le fichier de cache sera préféré
...
<p>
   ...
   Bien qu'ils aient une extension <code class="filename">.php</code>, ils ne sont pas vraiment
   directement exécutable. N'éditez surtout pas ces fichiers !
  </p>
</div>
<p>
  Tout fichier de cache a une durée de vie limitée déterminée par <a class="link" href="variable.cache.lifetime.tpl" title="$cache_lifetime"><em class="parameter"><code>$cache_lifetime</code></em></a>. La valeur par
  ...
  <a class="link" href="variable.caching.tpl" title="$caching"><em class="parameter"><code>$caching</code></em></a><code class="literal">=2</code>.
  Se reporter à la documentation de <a class="link" href="variable.cache.lifetime.tpl" title="$cache_lifetime"><em class="parameter"><code>$cache_lifetime</code></em></a> pour plus de
  détails.
 </p>
<div class="example">
<a name="id3025961"></a><p class="title"><b>Example 14.2. Réglage individuel de $cache_lifetime</b></p>
<div class="example-contents"><pre class="programlisting">
...
<br class="example-break"><p>
  Si
  <a class="link" href="variable.compile.check.tpl" title="$compile_check"><em class="parameter"><code>$compile_check</code></em></a>
  ...
  pour des raisons de performances, mettez ce paramètre à <code class="constant">FALSE</code> pour une application
  en production.
 </p>
<div class="example">
<a name="id3026032"></a><p class="title"><b>Example 14.3. Activation de $compile_check</b></p>
<div class="example-contents"><pre class="programlisting">
...
<br class="example-break"><p>
  Si <a class="link" href="variable.force.compile.tpl" title="$force_compile"><em class="parameter"><code>$force_compile</code></em></a> est actif,
  les fichiers de cache sont toujours regénérés. Ceci revient finalement à
  désactiver le cache. <a class="link" href="variable.force.compile.tpl" title="$force_compile"><em class="parameter"><code>$force_compile</code></em></a>
  est utilisé à des fins de <a class="link" href="chapter.debugging.console.tpl" title="Chapter 10. Console de débogage">débogage</a>,
  un moyen plus efficace de désactiver le cache est de régler
  <a class="link" href="variable.caching.tpl" title="$caching"><em class="parameter"><code>$caching</code></em></a><code class="literal"> = 0</code>.
 </p>
<p>
  La fonction <a class="link" href="api.is.cached.tpl" title="is_cached()"><code class="varname">is_cached()</code></a> permet
...
<div class="example">
<a name="id3026126"></a><p class="title"><b>Example 14.4. Exemple avec is_cached()</b></p>
<div class="example-contents"><pre class="programlisting">
...
<br class="example-break"><p>
  ...
  page avec la fonction de template <a class="link" href="language.function.insert.tpl" title="{insert}"><code class="varname">{insert}</code></a>.
  Imaginons que toute une page doit être mise en cache à part
  une bannière en bas à droite. En utilisant une fonction
  <a class="link" href="language.function.insert.tpl" title="{insert}"><code class="varname">{insert}</code></a> pour la
  bannière, vous pouvez garder cet élément dynamique dans le contenu qui
  est en cache. Reportez-vous à la documentation
  <a class="link" href="language.function.insert.tpl" title="{insert}"><code class="varname">{insert}</code></a> pour plus de détails
  ainsi que des exemples.
 </p>
<p>
  Vous pouvez effacer tous les fichiers du cache avec la fonction <a class="link" href="api.clear.all.cache.tpl" title="clear_all_cache()"><code class="varname">clear_all_cache()</code></a>, ou de façon
  individuelle <a class="link" href="caching.groups.tpl" title="Groupes de fichiers de cache">(ou par groupe)</a>
  avec la fonction <a class="link" href="api.clear.cache.tpl" title="clear_cache()"><code class="varname">clear_cache()</code></a>.
 </p>
<div class="example">
<a name="id3026220"></a><p class="title"><b>Example 14.5. Nettoyage du cache</b></p>
<div class="example-contents"><pre class="programlisting">
...
<td width="40%" align="right" valign="top"> Caches multiples pour une seule page</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="f6c0c74f125eba8cd5a49be3553203ed">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/caching.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01964 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
