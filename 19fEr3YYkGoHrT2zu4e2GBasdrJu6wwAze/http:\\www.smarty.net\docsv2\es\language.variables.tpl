http://www.smarty.net/docsv2/es/language.variables.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 09:17:22 GMT
...
<html lang="en">
  <head>
    ...
    <title>Chapter 4. Variables | Smarty</title>
...
<p>
  ...
  <a class="link" href="language.syntax.attributes.tpl" title="Atributos">atributos</a>,  
  <a class="link" href="language.syntax.functions.tpl" title="Funciones">funciones</a> y  
  <a class="link" href="language.modifiers.tpl" title="Chapter 5. Modificadores de variables">modificadores</a>, dentro 
...
<p>
     Las variables que son <a class="link" href="api.assign.tpl" title="assign()">asignadas</a> desde PHP 
     ...
     <a class="link" href="language.custom.functions.tpl#language.function.assign" title="{assign}">assign</a> también son 
     mostradas de esta manera.
    </p>
<div class="example">
<a name="id3066281"></a><p class="title"><b>Example 4.1. variables definidas</b></p>
...
<div class="example">
<a name="id3066953"></a><p class="title"><b>Example 4.2. Accesando variables de matriz asociativa</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<div class="example">
<a name="id3067021"></a><p class="title"><b>Example 4.3. Accesando matrices por sus índices</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<p>
     Las propiedades de los <a class="link" href="advanced.features.tpl#advanced.features.objects" title="Objetos">objetos</a> 
     definidos desde PHP pueden ser referenciados especificando el nombre de la propiedad 
     después del simbolo '-&gt;'.
    </p>
<div class="example">
<a name="id3067093"></a><p class="title"><b>Example 4.4. Accesando propiedades de los Objetos</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<td width="40%" align="right" valign="top"> Variables cargadas desde archivos de configuración</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 16 plus 5? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.variables.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02238 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
