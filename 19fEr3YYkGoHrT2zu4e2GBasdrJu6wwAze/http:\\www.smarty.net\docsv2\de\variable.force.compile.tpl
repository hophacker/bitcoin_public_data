http://www.smarty.net/docsv2/de/variable.force.compile.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 19:30:35 GMT
...
<p>
      ...
      und das <a class="link" href="chapter.debugging.console.tpl" title="Chapter 10. Debugging Konsole">Debugging</a>
      nützlich sein.
      In einer Produktivumgebung sollte auf die Verwendung verzichtet werden.
      Wenn <a class="link" href="variable.caching.tpl" title="$caching">$caching</a> eingeschaltet ist,
...
<td width="40%" align="right" valign="top"> $caching</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/variable.force.compile.tpl">
            </form>
            </div>
          </div>
