http://www.smarty.net/docsv2/fr/language.syntax.attributes.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 12:25:25 GMT
...
<tr><th colspan="3" align="center">Paramètres</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="language.syntax.functions.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 3. Bases syntaxiques</th>
...
<div class="sect1" title="Paramètres">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.syntax.attributes"></a>Paramètres</h2></div></div></div>
<p>
  La plupart des <a class="link" href="language.syntax.functions.tpl" title="Fonctions">fonctions</a>
...
<p>
  Certains paramètres requièrent des valeurs booléennes (<code class="constant">TRUE</code> ou <code class="constant">FALSE</code>).
  Elles peuvent être spécifiées par l'une des valeures suivantes, sans guillemet:
  <code class="literal">true</code>, <code class="literal">on</code>, et <code class="literal">yes</code>,
  ou <code class="literal">false</code>, <code class="literal">off</code>, et <code class="literal">no</code>.
 </p>
<div class="example">
<a name="id2929304"></a><p class="title"><b>Example 3.4. Paramètres de fonction, syntaxe</b></p>
...
<tr>
<td width="40%" align="left" valign="top">Fonctions </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Variables insérées dans des chaînes de caractères</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/language.syntax.attributes.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03205 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
