http://www.smarty.net/docsv2/es/caching.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 15:26:22 GMT
...
<p>
   ...
   <a class="link" href="api.fetch.tpl" title="fetch()">fetch()</a> salvando esto en un
   ...
   <a class="link" href="api.display.tpl" title="display()">display()</a> o
   <a class="link" href="api.fetch.tpl" title="fetch()">fetch()</a> está en
...
<p>
    ...
    <a class="link" href="variable.caching.tpl" title="$caching">$caching</a> = true (o 1.)
   </p>
<div class="example">
<a name="id3144101"></a><p class="title"><b>Example 14.1. Habilitando Cache</b></p>
...
<br class="example-break"><p>
    ...
    (una copia de cache) en el <a class="link" href="variable.cache.dir.tpl" title="$cache_dir">$cache_dir</a>.
...
<p>
     Los archivos en el <a class="link" href="variable.cache.dir.tpl" title="$cache_dir">$cache_dir</a> son 
...
<p>
    ...
    <a class="link" href="variable.caching.tpl" title="$caching">$caching</a> = 2. 
    Vea la documentación en 
    <a class="link" href="variable.cache.lifetime.tpl" title="$cache_lifetime">$cache_lifetime</a>
    para mas detalles.
   </p>
<div class="example">
<a name="id3144812"></a><p class="title"><b>Example 14.2. Configurando cache_lifetime por cache</b></p>
<div class="example-contents"><pre class="programlisting">
...
<br class="example-break"><p>
    ...
    cabeceras, dejar <a class="link" href="variable.compile.check.tpl" title="$compile_check">$compile_check</a> 
    determinado false.
   </p>
<div class="example">
<a name="id3144880"></a><p class="title"><b>Example 14.3. Habilitando $compile_check</b></p>
<div class="example-contents"><pre class="programlisting">
...
<br class="example-break"><p>
    ...
    el caching. 
    <a class="link" href="variable.force.compile.tpl" title="$force_compile">$force_compile</a> generalmente 
    es usado para propositos de debug solamente, una forma mas eficiente 
    de desactivar el caching es asignando
    <a class="link" href="variable.caching.tpl" title="$caching">$caching</a> = false (ó 0.)
   </p>
<p>
    La función <a class="link" href="api.is.cached.tpl" title="is_cached()">is_cached()</a> puede ser 
...
<div class="example">
<a name="id3144947"></a><p class="title"><b>Example 14.4. Usando is_cached()</b></p>
<div class="example-contents"><pre class="programlisting">
...
<br class="example-break"><p>
    ...
    de template <a class="link" href="language.function.insert.tpl" title="insert">{insert}</a>.
    ...
    <a class="link" href="language.function.insert.tpl" title="insert">{insert}</a> para detalles 
    y ejemplos.
   </p>
<p>
...
<div class="example">
<a name="id3145025"></a><p class="title"><b>Example 14.5. Limpiando el cache</b></p>
<div class="example-contents"><pre class="programlisting">
...
<td width="40%" align="right" valign="top"> Multiples caches por pagina</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/caching.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02117 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
