http://www.smarty.net/docsv2/it/variable.left.delimiter.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 15:26:18 GMT
...
<p>
       E' il delimitatore di sinistra usato dal linguaggio dei template.
       Per default è "{".			
      </p>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> $right_delimiter</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/variable.left.delimiter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.19421 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
