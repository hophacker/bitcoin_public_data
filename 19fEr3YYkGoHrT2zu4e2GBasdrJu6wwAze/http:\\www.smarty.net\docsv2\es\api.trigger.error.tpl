http://www.smarty.net/docsv2/es/api.trigger.error.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 11:41:48 GMT
...
<html lang="en">
  <head>
    ...
    <title>trigger_error | Smarty</title>
...
<h2>Name</h2>
<p>trigger_error — Despliega un mensaje de error</p>
</div>
<div class="refsect1" title="Descripción">
<a name="id3135613"></a><h2> Descripción </h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">trigger_error</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">error_msg</span></span>,<br>                   <span class="methodparam"><span class="type">int </span><span class="parameter">level</span></span>);</code><p>
   ...
   usando Smarty. El parámetro <em class="parameter"><code>level</code></em> es uno de
   los valores usados para la función de php 
   <a class="ulink" href="http://php.net/trigger_error" target="_top">trigger_error()</a>, 
   ex.: E_USER_NOTICE, E_USER_WARNING, etc. 
   Por default es E_USER_WARNING.
  </p>
<p>
    Ver también 
    <a class="link" href="variable.error.reporting.tpl" title="$error_reporting">$error_reporting</a>,
    <a class="link" href="chapter.debugging.console.tpl" title="Chapter 10. Debugging Console">debugging</a>
    y
    <a class="link" href="troubleshooting.tpl#smarty.php.errors" title="Errores Smarty/PHP">Troubleshooting</a>.
 </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> template_exists()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/api.trigger.error.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03749 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
