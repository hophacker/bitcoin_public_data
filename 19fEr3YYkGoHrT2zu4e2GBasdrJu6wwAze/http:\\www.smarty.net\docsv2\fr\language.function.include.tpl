http://www.smarty.net/docsv2/fr/language.function.include.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 09:35:46 GMT
...
<p>
  Les balises <code class="varname">{include}</code> sont utilisées pour inclure des templates à
...
<li class="listitem"><p>
    La balise <code class="varname">{include}</code> doit contenir l'attribut
    <em class="parameter"><code>file</code></em> qui contient le chemin vers la ressource de
    template.
   </p></li>
<li class="listitem"><p>
    La définition de l'attribut optionnel <em class="parameter"><code>assign</code></em>
    spécifie la variable de template assignée à la sortie de
    <code class="varname">{include}</code> au lieu d'être affichée. Similaire à
...
<li class="listitem"><p>
    ...
    <a class="link" href="language.syntax.attributes.tpl" title="Paramètres">attributs</a>.
...
<li class="listitem"><p>
    ...
    incluant, parès l'instruction <code class="varname">{include}</code> statement.
   </p></li>
<li class="listitem"><p>
    Utilisez la synthaxe pour les
    <a class="link" href="template.resources.tpl" title="Ressources">ressources de template</a> aux fichiers
    <code class="varname">{include}</code> en dehors du dossier
...
<td>Le nom du template à inclure</td>
</tr>
<tr>
...
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Le nom de la variable dans laquelle sera assignée
     la sortie de include</td>
</tr>
<tr>
<td align="center">[var ...]</td>
<td align="center">[type de variable]</td>
<td align="center">Non</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Variables à passer au template</td>
</tr>
</tbody>
</table></div>
<div class="example">
<a name="id2954253"></a><p class="title"><b>Example 7.17. Exemple avec {include}</b></p>
...
<a name="id2954265"></a><p class="title"><b>Example 7.18. Fonction {include}, passage de variables</b></p>
...
<p>Le template ci-dessus inclut l'exemple <code class="filename">links.tpl</code></p>
<pre class="programlisting">
...
<br class="example-break"><div class="example">
<a name="id2954307"></a><p class="title"><b>Example 7.19. {include} et assignement à une variable</b></p>
<div class="example-contents">
<p>Cet exemple assigne le contenu de <code class="filename">nav.tpl</code> à la variable
   <code class="varname">$navbar</code>, qui est alors affichée en haut et en bas de la page.
  </p>
<pre class="programlisting">
...
<br class="example-break"><div class="example">
<a name="id2954341"></a><p class="title"><b>Example 7.20. Divers {include}, exemple de ressource template</b></p>
<div class="example-contents"><pre class="programlisting">
...
<br class="example-break"><p>
  ...
  les <a class="link" href="template.resources.tpl" title="Ressources">ressources de template</a> et
  les <a class="link" href="tips.componentized.templates.tpl" title="Templates composants">templates composants</a>.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> {include_php}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 17 plus 4? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/language.function.include.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02770 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
