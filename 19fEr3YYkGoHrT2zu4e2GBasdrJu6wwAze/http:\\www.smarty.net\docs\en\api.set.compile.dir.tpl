...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 05:33:37 GMT
...
<h2>Name</h2>
<p>setCompileDir() — set the directory where compiled templates are stored</p>
</div>
<div class="refsect1" title="Description">
<a name="idp16900416"></a><h2>Description</h2>
...
<a name="idp16903712"></a><p class="title"><b>Example 14.44. setCompileDir()</b></p>
...
<br class="example-break"><p>
   See also
   <a class="link" href="api.get.compile.dir.tpl" title="getCompileDir()"><code class="varname">getCompileDir()</code></a> and
...
<td width="40%" align="right" valign="top"> setConfigDir()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/api.set.compile.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01788 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
