http://www.smarty.net/docsv2/it/api.unregister.outputfilter.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 19:31:49 GMT
...
<td width="40%" align="right" valign="top"> unregister_postfilter</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/api.unregister.outputfilter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02657 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
