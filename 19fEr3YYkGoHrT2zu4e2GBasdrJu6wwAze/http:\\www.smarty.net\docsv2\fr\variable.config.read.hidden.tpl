http://www.smarty.net/docsv2/fr/variable.config.read.hidden.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 08:25:29 GMT
...
<p>
  Si cette variable est à <code class="constant">TRUE</code>, les sections cachées (dont les noms
  commencent par un point) dans les <a class="link" href="config.files.tpl" title="Chapter 9. Fichiers de configuration">fichiers de configuration</a>
  peuvent être lues depuis les templates. On laisse habituellement celà à <code class="constant">FALSE</code>, de
  ...
  Mise à <code class="constant">FALSE</code> par défaut.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $config_fix_newlines</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/variable.config.read.hidden.tpl">
            </form>
            </div>
          </div>
