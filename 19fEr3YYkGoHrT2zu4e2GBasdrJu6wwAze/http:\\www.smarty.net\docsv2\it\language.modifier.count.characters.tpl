http://www.smarty.net/docsv2/it/language.modifier.count.characters.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 15:26:52 GMT
...
<td>Stabilisce se gli spazi devono essere inclusi nel conteggio.</td>
</tr></tbody>
</table></div>
<p>
...
<div class="example">
<a name="id3093659"></a><p class="title"><b>Example 5.3. count_characters</b></p>
...
<tr>
<td width="40%" align="left" valign="top">Chapter 5. Modificatori delle variabili </td>
...
<td width="40%" align="right" valign="top"> cat</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 2 plus 18? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/language.modifier.count.characters.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03013 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
