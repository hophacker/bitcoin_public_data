http://www.smarty.net/docsv2/it/api.assign.by.ref.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 11:22:38 GMT
...
<p>
    ...
    valore, il template vedrà il valore modificato. Per gli oggetti,
...
<div class="example">
<a name="id3140724"></a><p class="title"><b>Example 13.4. assign_by_ref</b></p>
...
<td width="40%" align="right" valign="top"> clear_all_assign</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 6 plus 1? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/api.assign.by.ref.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01915 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
