...
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 07:20:37 GMT
...
<html lang="en">
  <head>
    ...
    <title>String Template Resources | Smarty</title>
    <meta name="description" content="String Template Resources">
    <meta name="keywords" content="string, template, resources">
...
<div class="example">
<a name="idp18861344"></a><p class="title"><b>Example 16.5. Using templates from strings</b></p>
...
<br class="example-break"><p>
     ...
     <a class="link" href="resources.extends.tpl" title="Extends Template Resources"><code class="varname">Extends Template Resource</code></a>
 </p>
<div class="example">
<a name="idp18871216"></a><p class="title"><b>Example 16.6. Using templates from encoded strings</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<td width="40%" align="right" valign="top"> Stream Template Resources</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 19 plus 19? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="89ff03262a720a1b21a2d10d679beb7f">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/resources.string.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01176 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
