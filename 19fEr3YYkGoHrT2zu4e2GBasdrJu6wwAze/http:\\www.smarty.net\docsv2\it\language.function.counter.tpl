http://www.smarty.net/docsv2/it/language.function.counter.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 13:58:00 GMT
...
<td>Nome del contatore</td>
</tr>
<tr>
<td align="center">start</td>
<td align="center">numerico</td>
<td align="center">no</td>
<td align="center"><span class="emphasis"><em>1</em></span></td>
<td>Valore di partenza del contatore</td>
</tr>
<tr>
...
<td>Direzione del conteggio (up/down)</td>
</tr>
<tr>
...
<td>Se stampare il valore oppure no</td>
</tr>
<tr>
...
<td>la variabile del template a cui assegnare il valore</td>
</tr>
</tbody>
</table></div>
<p>
...
<div class="example">
<a name="id3114274"></a><p class="title"><b>Example 8.2. counter</b></p>
...
<td width="40%" align="right" valign="top"> cycle</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/language.function.counter.tpl">
            </form>
            </div>
          </div>
