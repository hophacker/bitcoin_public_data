HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 15:26:05 GMT
...
<h2>Name</h2>
<p>clear_all_assign() — clears the values of all assigned variables</p>
</div>
<div class="refsect1" title="Description">
<a name="id2851363"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">clear_all_assign</span>();</code><div class="example">
<a name="id2851380"></a><p class="title"><b>Example 13.5. clear_all_assign()</b></p>
...
<br class="example-break"><p>
  See also
  <a class="link" href="api.clear.assign.tpl" title="clear_assign()"><code class="varname">clear_assign()</code></a>,
  ...
  and <a class="link" href="api.append.tpl" title="append()"><code class="varname">append()</code></a>
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> clear_all_cache()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 15 plus 7? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/api.clear.all.assign.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.04144 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
