http://www.smarty.net/docsv2/en/api.append.by.ref.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 15:24:48 GMT
...
<a name="id2850156"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">append_by_ref</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">varname</span></span>,<br>                   <span class="methodparam"><span class="type">mixed </span><span class="parameter">var</span></span>,<br>                   <span class="methodparam"><span class="type">bool </span><span class="parameter">merge</span></span>);</code><p>
   This is used to
   <a class="link" href="api.append.tpl" title="append()"><code class="varname">append()</code></a> values
   ...
   <a class="link" href="advanced.features.tpl#advanced.features.objects" title="Objects">objects</a>,
...
<div class="example">
<a name="id2851132"></a><p class="title"><b>Example 13.2. append_by_ref</b></p>
...
<td width="40%" align="right" valign="top"> assign()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/api.append.by.ref.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02075 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
