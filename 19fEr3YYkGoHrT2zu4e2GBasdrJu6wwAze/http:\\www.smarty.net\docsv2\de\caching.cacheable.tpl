http://www.smarty.net/docsv2/de/caching.cacheable.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 03:32:24 GMT
...
<html lang="en">
  <head>
    ...
    <title>Die Ausgabe von cachebaren Plugins Kontrollieren | Smarty</title>
...
<tr><th colspan="3" align="center">Die Ausgabe von cachebaren Plugins Kontrollieren</th></tr>
<tr>
...
<div class="sect1" title="Die Ausgabe von cachebaren Plugins Kontrollieren">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="caching.cacheable"></a>Die Ausgabe von cachebaren Plugins Kontrollieren</h2></div></div></div>
<p>
  Seit Smarty-2.6.0 kann bei der Registrierung angegeben werden ob ein
  Plugin cached werden soll. Der dritte Parameter für <a class="link" href="api.register.block.tpl" title="register_block (Block-Funktion registrieren)">register_block</a>, <a class="link" href="api.register.compiler.function.tpl" title="register_compiler_function (Compiler-Funktion registrieren)">register_compiler_function</a>
  und <a class="link" href="api.register.function.tpl" title="register_function">register_function</a>
  heisst <em class="parameter"><code>$cacheable</code></em>, der Standardwert ist TRUE,
  was das Verhalten von Smarty vor Version 2.6.0 wiederspiegelt.
 </p>
<p>
  Wenn ein Plugin mit <em class="parameter"><code>$cacheable=false</code></em>
  ...
  verhält sich ein wenig wie <a class="link" href="plugins.inserts.tpl" title="Inserts">{insert}</a>.
 </p>
<p>
  Im Gegensatz zu <a class="link" href="plugins.inserts.tpl" title="Inserts">{insert}</a> werden die
  Attribute standartmässig nicht gecached. Sie können das
  caching jedoch mit dem vierten Parameter
  <em class="parameter"><code>$cache_attrs</code></em>
  kontrollieren. <em class="parameter"><code>$cache_attrs</code></em> ist ein Array
  aller Attributnamen die gecached werden sollen.
 </p>
<div class="example">
<a name="id2932568"></a><p class="title"><b>Example 14.10. Verhindern des Caching der Ausgabe eines Plugins</b></p>
...
<a name="id2932618"></a><p class="title"><b>Example 14.11. Verhindern dass Template Blöcke gecached werden</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<tr>
<td width="40%" align="left" valign="top">Cache-Gruppen </td>
...
<td width="40%" align="right" valign="top"> Chapter 15. Advanced Features</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 10 plus 16? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="3c50830100bbed2d6836a6c2297252b2">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/caching.cacheable.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01763 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
