http://www.smarty.net/docsv2/pt_BR/api.trigger.error.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 15:51:35 GMT
...
<div class="sect1" title="trigger_error">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="api.trigger.error"></a>trigger_error</h2></div></div></div>
<div class="funcsynopsis">
<table border="0" summary="Function synopsis" cellspacing="0" cellpadding="0" class="funcprototype-table">
<tr>
<td><code class="funcdef">void <b class="fsfunc">trigger_error</b>(</code></td>
<td>
<var class="pdparam">error_msg</var>, </td>
<td> </td>
</tr>
<tr>
<td> </td>
<td>
<var class="pdparam">level</var><code>)</code>;</td>
<td> </td>
</tr>
</table>
<div class="paramdef-list">
<code>string <var class="pdparam">error_msg</var></code>;<br><code>[int <var class="pdparam">level</var>]</code>;</div>
<div class="funcprototype-spacer"> </div>
</div>
<p>
	 Essa função pode ser usada para saída de uma mensagem de erro usando Smarty.
	 O parâmetro <em class="parameter"><code>level</code></em> pode ser um dos valores usados 
...
<td width="40%" align="right" valign="top"> template_exists</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/api.trigger.error.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02391 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
