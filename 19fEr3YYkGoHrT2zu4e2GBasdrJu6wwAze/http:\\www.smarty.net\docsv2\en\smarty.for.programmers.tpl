http://www.smarty.net/docsv2/en/smarty.for.programmers.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 18:04:06 GMT
...
<td width="40%" align="right" valign="top"> Chapter 11. Constants</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/smarty.for.programmers.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03618 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
