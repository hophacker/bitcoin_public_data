http://www.smarty.net/docsv2/en/caching.cacheable.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 17:51:11 GMT
...
<html lang="en">
  <head>
    ...
    <title>Controlling Cacheability of Plugins' Output | Smarty</title>
...
<p>
   ...
   <code class="varname">register_compiler_function()</code></a> and <a class="link" href="api.register.function.tpl" title="register_function()"><code class="varname">register_function()</code></a>
...
<div class="example">
<a name="id2872589"></a><p class="title"><b>Example 14.10. Preventing a plugin's output from being cached</b></p>
...
<a name="id2872651"></a><p class="title"><b>Example 14.11. Preventing a whole passage of a template from being cached</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<td width="40%" align="right" valign="top"> Chapter 15. Advanced Features</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/caching.cacheable.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02783 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
