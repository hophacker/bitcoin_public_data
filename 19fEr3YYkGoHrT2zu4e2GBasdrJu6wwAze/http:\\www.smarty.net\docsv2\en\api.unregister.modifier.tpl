http://www.smarty.net/docsv2/en/api.unregister.modifier.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 12:22:56 GMT
...
<h2>Name</h2>
<p>unregister_modifier() — dynamically unregister modifier plugin</p>
</div>
<div class="refsect1" title="Description">
<a name="id2862645"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">unregister_modifier</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">name</span></span>);</code><p>
   Pass in the template modifier <em class="parameter"><code>name</code></em>.
  </p>
<div class="example">
<a name="id2862683"></a><p class="title"><b>Example 13.28. unregister_modifier()</b></p>
...
<br class="example-break"><p>
  ...
  and
  <a class="link" href="plugins.modifiers.tpl" title="Modifiers">plugin modifiers</a>,
 </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> unregister_object()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 1 plus 0? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="358ecdf9bead93553b13bc0d93867eea">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/api.unregister.modifier.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01940 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
