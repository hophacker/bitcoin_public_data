http://www.smarty.net/docsv2/es/plugins.block.functions.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 18:04:30 GMT
...
<div class="example">
<a name="id3152058"></a><p class="title"><b>Example 16.5. Función de bloque</b></p>
...
<td width="40%" align="right" valign="top"> Funciones Compiladoras</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 0 plus 12? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/plugins.block.functions.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.04362 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
