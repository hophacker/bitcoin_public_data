http://www.smarty.net/docsv2/es/api.unregister.prefilter.tpl
HTTP/1.1 200 OK
...
<html lang="en">
  <head>
    ...
    <title>unregister_prefilter() | Smarty</title>
...
<tr><th colspan="3" align="center">unregister_prefilter()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.unregister.postfilter.tpl">Prev</a> </td>
...
<div class="refentry" title="unregister_prefilter()">
<a name="api.unregister.prefilter"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>unregister_prefilter() — Des-registra dinamicamente un prefiltro</p>
</div>
<div class="refsect1" title="Descripción">
<a name="id3138176"></a><h2>Descripción </h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">unregister_prefilter</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">function_name</span></span>);</code><p>
    Ver también 
    <a class="link" href="api.register.prefilter.tpl" title="register_prefilter()">register_prefilter()</a>
    y <a class="link" href="plugins.prefilters.postfilters.tpl" title="Prefiltros/Postfiltros">pre filters</a>.
  </p>
</div>
</div>
<div class="navfooter">
...
<tr>
<td width="40%" align="left" valign="top">unregister_postfilter() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> unregister_resource()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 15 plus 11? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/api.unregister.prefilter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01848 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
