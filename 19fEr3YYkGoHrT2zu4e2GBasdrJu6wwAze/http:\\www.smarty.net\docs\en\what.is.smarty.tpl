...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Chapter 1. What is Smarty?">
    <meta name="keywords" content="chapter, 1, what, is, smarty, ">
...
<li class="listitem"><p>
     Built-in <a class="link" href="caching.tpl" title="Chapter 15. Caching">caching</a> support
    </p></li>
<li class="listitem"><p>
     Arbitrary <a class="link" href="resources.tpl" title="Chapter 16. Resources">template</a> sources
    </p></li>
<li class="listitem"><p>
    <a class="link" href="advanced.features.template.inheritance.tpl" title="Template Inheritance">Template Inheritance</a>
     for easy management of template content.
    </p></li>
<li class="listitem"><p>
     <a class="link" href="plugins.tpl" title="Chapter 18. Extending Smarty With Plugins">Plugin</a> architecture
    </p></li>
</ul></div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> Chapter 2. Installation</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/what.is.smarty.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02060 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
