http://www.smarty.net/docsv2/it/api.unregister.modifier.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 04:12:47 GMT
...
<h2>Name</h2>
<p>unregister_modifier</p>
</div>
<div class="refsect1">
<a name="id3147726"></a><h2></h2>
...
<div class="example">
<a name="id3147758"></a><p class="title"><b>Example 13.26. unregister_modifier</b></p>
...
<td width="40%" align="right" valign="top"> unregister_object</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/api.unregister.modifier.tpl">
            </form>
            </div>
          </div>
