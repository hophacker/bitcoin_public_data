http://www.smarty.net/docsv2/fr/api.unregister.modifier.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 09:16:50 GMT
...
<html lang="en">
  <head>
    ...
    <title>unregister_modifier() | Smarty</title>
...
<tr><th colspan="3" align="center">unregister_modifier()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.unregister.function.tpl">Prev</a> </td>
...
<div class="refentry" title="unregister_modifier()">
<a name="api.unregister.modifier"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>unregister_modifier() — Désalloue dynamiquement un plugin modificateur de variable</p>
</div>
<div class="refsect1" title="Description">
<a name="id3017763"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">unregister_modifier</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">name</span></span>);</code><p>
   Passez en paramètre le nom du modificateur de templates.
  </p>
<div class="example">
<a name="id3017797"></a><p class="title"><b>Example 13.28. Exemple avec unregister_modifier()</b></p>
...
<br class="example-break"><p>
   Voir aussi
   <a class="link" href="api.register.modifier.tpl" title="register_modifier()"><code class="varname">register_modifier()</code></a> et
   les <a class="link" href="plugins.modifiers.tpl" title="Modificateurs">plugins modificateur</a>.
  </p>
</div>
</div>
<div class="navfooter">
...
<tr>
<td width="40%" align="left" valign="top">unregister_function() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> unregister_object()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/api.unregister.modifier.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02417 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
