http://www.smarty.net/docsv2/fr/language.function.html.options.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 00:17:04 GMT
...
<p>
  <code class="varname">{html_options}</code> est une
...
<td align="center">Oui, à moins que vous n'utilisiez
      l'attribut options</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Un tableau de valeurs pour les listes
      déroulantes</td>
</tr>
<tr>
...
<td align="center">Oui, à moins que vous n'utilisiez
      l'attribut options</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Un tableau de libellés pour la liste
      déroulante</td>
</tr>
<tr>
<td align="center">selected</td>
<td align="center">chaîne de caractères/tableau</td>
<td align="center">Non</td>
<td align="center"><span class="emphasis"><em>empty</em></span></td>
<td>Les éléments sélectionnés</td>
</tr>
<tr>
<td align="center">options</td>
<td align="center">Tableau associatif</td>
<td align="center">Oui, à moins que vous n'utilisiez option
      et values</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Un tableau associatif valeur / libellé</td>
</tr>
<tr>
...
<li class="listitem"><p>
    ...
    <em class="parameter"><code>values</code></em> et <em class="parameter"><code>output</code></em>,
    à moins que vous n'utilisiez <em class="parameter"><code>options</code></em> à la place.
   </p></li>
<li class="listitem"><p>
    Si l'attribut optionnel <em class="parameter"><code>name</code></em> est fourni, les balises
    <code class="literal">&lt;select&gt;&lt;/select&gt;</code> seront créées,
    sinon, UNIQUEMENT la liste <code class="literal">&lt;option&gt;</code> sera générée.
   </p></li>
<li class="listitem"><p>
    Si la valeur fournie est un tableau, il sera traité comme un
    <code class="literal">&lt;optgroup&gt;</code> HTML, et affichera les groupes.
    La récursivité est supportée avec <code class="literal">&lt;optgroup&gt;</code>.
   </p></li>
<li class="listitem"><p>
    ...
    <code class="literal">&lt;select&gt;</code>. Ils seront ignorés si le paramètre optionnel
    <em class="parameter"><code>name</code></em> n'est pas fourni.
   </p></li>
<li class="listitem"><p>
...
<div class="example">
<a name="id2973342"></a><p class="title"><b>Example 8.12. Un tableau associatif avec l'attribut <code class="varname">options</code></b></p>
...
<p>
   ...
   de l'attribut <em class="parameter"><code>name</code></em> qui crée les
   balises <code class="literal">&lt;select&gt;</code>.
  </p>
<pre class="programlisting">
...
<a name="id2973405"></a><p class="title"><b>Example 8.13. Tableaux séparés pour <code class="varname">values</code> et
   <code class="varname">ouptut</code></b></p>
<div class="example-contents">
<pre class="programlisting">
...
<p>
   ...
   (notez l'utilisation de la fonction PHP <a class="ulink" href="http://php.net/function.count" target="_top">
    <code class="varname">count()</code></a> en tant que modificateur pour
...
<br class="example-break"><div class="example">
<a name="id2973482"></a><p class="title"><b>Example 8.14. Exemple avec une base de données (e.g. ADODB ou PEAR)</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<br class="example-break"><div class="example">
<a name="id2973536"></a><p class="title"><b>Example 8.15. Exemple avec &lt;optgroup&gt; </b></p>
<div class="example-contents">
<pre class="programlisting">
...
<p>Le script ci-dessus et le template suivant
  </p>
<pre class="programlisting">
...
<td width="40%" align="right" valign="top"> {html_radios}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 12 plus 9? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="7e9930368331e3f2cf7a7d426064153d">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/language.function.html.options.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02696 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
