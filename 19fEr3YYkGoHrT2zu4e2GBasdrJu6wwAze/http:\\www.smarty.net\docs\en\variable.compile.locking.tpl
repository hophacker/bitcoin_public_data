http://www.smarty.net/docs/en/variable.compile.locking.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 02:19:15 GMT
...
<p>
        Compile locking is enabled by default. To disable it set <code class="varname">$compile_locking</code> to <code class="constant">FALSE</code>. 
       </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $compiler_class</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/variable.compile.locking.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01142 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
