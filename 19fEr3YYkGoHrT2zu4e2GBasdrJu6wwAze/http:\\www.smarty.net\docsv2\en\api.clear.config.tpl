http://www.smarty.net/docsv2/en/api.clear.config.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 04:22:39 GMT
...
<h2>Name</h2>
<p>clear_config() — clears assigned config variables</p>
</div>
<div class="refsect1" title="Description">
<a name="id2852902"></a><h2>Description</h2>
...
<div class="example">
<a name="id2852951"></a><p class="title"><b>Example 13.10. clear_config()</b></p>
...
<br class="example-break"><p>
  ...
  <a class="link" href="config.files.tpl" title="Chapter 9. Config Files"><code class="varname">config files</code></a>,
...
<td width="40%" align="right" valign="top"> config_load()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 18 plus 7? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/api.clear.config.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02061 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
