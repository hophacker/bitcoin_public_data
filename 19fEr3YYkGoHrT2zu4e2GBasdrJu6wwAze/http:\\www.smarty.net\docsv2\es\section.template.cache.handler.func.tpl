http://www.smarty.net/docsv2/es/section.template.cache.handler.func.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 11:41:17 GMT
...
<html lang="en">
  <head>
    ...
    <title>Función manipuladora de cache | Smarty</title>
...
<div class="example">
<a name="id3148078"></a><p class="title"><b>Example 15.5.  ejemplo usando MySQL como una fuente de cache</b></p>
...
<td width="40%" align="right" valign="top"> Recursos</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/section.template.cache.handler.func.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02002 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
