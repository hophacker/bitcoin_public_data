http://www.smarty.net/docsv2/es/tips.dates.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 10:40:42 GMT
...
<tr><th colspan="3" align="center">Fechas</th></tr>
<tr>
...
<div class="sect1" title="Fechas">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="tips.dates"></a>Fechas</h2></div></div></div>
<p>
...
<p>
     ...
     por <a class="ulink" href="http://php.net/strtotime" target="_top">strtotime()</a>.
    </p>
</div>
<div class="example">
<a name="id3156606"></a><p class="title"><b>Example 18.4. Usando date_format</b></p>
...
<br class="example-break"><p>
    Cuando usa <a class="link" href="language.function.html.select.date.tpl" title="{html_select_date}">{html_select_date}</a> 
...
<div class="example">
<a name="id3156673"></a><p class="title"><b>Example 18.5. Convirtiendo elementos en forma de fecha de vuelta a un timestamp</b></p>
...
<br class="example-break"><p>
   ...
   <a class="link" href="language.function.html.select.time.tpl" title="{html_select_time}">{html_select_time}</a>,
   <a class="link" href="language.modifier.date.format.tpl" title="date_format">date_format</a>
   y <a class="link" href="language.variables.smarty.tpl#language.variables.smarty.now" title="{$smarty.now}">$smarty.now</a>,
   </p>
</div>
<div class="navfooter">
<hr>
...
<tr>
<td width="40%" align="left" valign="top">Pasando la variable titulo a la cabecera del template </td>
...
<td width="40%" align="right" valign="top"> WAP/WML</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/tips.dates.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02278 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
