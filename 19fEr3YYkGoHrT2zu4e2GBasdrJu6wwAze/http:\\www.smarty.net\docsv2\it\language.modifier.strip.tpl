http://www.smarty.net/docsv2/it/language.modifier.strip.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 09:35:18 GMT
...
<p>
    ...
    la <a class="link" href="language.function.strip.tpl" title="strip">funzione strip</a>.
   </p>
</div>
<div class="example">
<a name="id3098131"></a><p class="title"><b>Example 5.18. strip</b></p>
...
<td width="40%" align="right" valign="top"> strip_tags</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/language.modifier.strip.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03071 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
