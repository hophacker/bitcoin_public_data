http://www.smarty.net/docsv2/de/api.unregister.postfilter.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 16:02:44 GMT
...
<html lang="en">
  <head>
    ...
    <title>unregister_postfilter ('post'-Filter deaktivieren) | Smarty</title>
...
<tr><th colspan="3" align="center">unregister_postfilter ('post'-Filter deaktivieren)</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.unregister.outputfilter.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Methoden der Klasse Smarty</th>
<td width="20%" align="right"> <a accesskey="n" href="api.unregister.prefilter.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="unregister_postfilter ('post'-Filter deaktivieren)">
<a name="api.unregister.postfilter"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>unregister_postfilter ('post'-Filter deaktivieren)</p>
</div>
<div class="refsect1">
<a name="id2925419"></a><h2></h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">unregister_postfilter</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">function_name</span></span>);</code><p>
...
<td width="40%" align="right"> <a accesskey="n" href="api.unregister.prefilter.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">unregister_outputfilter (Ausgabefilter deaktivieren) </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> unregister_prefilter ('pre'-Filter deaktiviern)</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 12 plus 2? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/api.unregister.postfilter.tpl">
            </form>
            </div>
          </div>
