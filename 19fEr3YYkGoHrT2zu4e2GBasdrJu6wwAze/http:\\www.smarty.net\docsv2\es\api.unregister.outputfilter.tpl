http://www.smarty.net/docsv2/es/api.unregister.outputfilter.tpl
HTTP/1.1 200 OK
...
<h2>Name</h2>
<p>unregister_outputfilter() — des-registra dinámicamente un filtro de salida</p>
</div>
<div class="refsect1" title="Descripción">
<a name="id3137825"></a><h2> Descripción</h2>
...
<p>
   Ver también <a class="link" href="api.register.outputfilter.tpl" title="register_outputfilter()">register_outputfilter()</a>
...
<td width="40%" align="right" valign="top"> unregister_postfilter()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/api.unregister.outputfilter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.18956 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
