http://www.smarty.net/docs/en/variable.debug_template.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 16:54:14 GMT
...
<p>
	   ...
	   default, it is named <code class="filename">debug.tpl</code> and is
	   located in the <a class="link" href="smarty.constants.tpl#constant.smarty.dir" title="SMARTY_DIR"><code class="constant">SMARTY_DIR</code></a>.
      </p>
<p>
      See also
      <a class="link" href="variable.debugging.tpl" title="$debugging"><em class="parameter"><code>$debugging</code></em></a>
      and the
      <a class="link" href="chapter.debugging.console.tpl" title="Chapter 10. Debugging Console">debugging console</a> section.
      </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $debugging</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/variable.debug_template.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01668 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
