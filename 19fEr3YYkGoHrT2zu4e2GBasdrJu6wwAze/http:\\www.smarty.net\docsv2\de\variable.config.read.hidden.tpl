http://www.smarty.net/docsv2/de/variable.config.read.hidden.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 07:21:07 GMT
...
<p>
	   ...
	   <a class="link" href="config.files.tpl" title="Chapter 9. Konfigurationsdateien">Konfigurationsdateien</a> lesen dürfen.
...
<td width="40%" align="right" valign="top"> $config_fix_newlines</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/variable.config.read.hidden.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02934 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
