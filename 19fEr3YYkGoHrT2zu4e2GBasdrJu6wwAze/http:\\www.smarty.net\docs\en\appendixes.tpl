http://www.smarty.net/docs/en/appendixes.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 17:51:00 GMT
...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Part IV. Appendixes">
    <meta name="keywords" content="part, iv, appendixes">
...
<tr>
<td width="40%" align="left" valign="top">Chapter 19. SmartyBC - Backwards Compatibility Wrapper </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Chapter 20. Troubleshooting</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/appendixes.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02444 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
