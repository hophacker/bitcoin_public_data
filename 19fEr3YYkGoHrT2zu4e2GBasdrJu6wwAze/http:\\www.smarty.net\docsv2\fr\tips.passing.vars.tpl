http://www.smarty.net/docsv2/fr/tips.passing.vars.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 04:22:04 GMT
...
<html lang="en">
  <head>
    ...
    <title>Passage du titre à un template d'en-tête | Smarty</title>
...
<tr><th colspan="3" align="center">Passage du titre à un template d'en-tête</th></tr>
<tr>
...
<div class="sect1" title="Passage du titre à un template d'en-tête">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="tips.passing.vars"></a>Passage du titre à un template d'en-tête</h2></div></div></div>
<p>
   ...
   <a class="link" href="language.syntax.attributes.tpl" title="Paramètres">attribut</a> quand il est inclus.
  </p>
<div class="example">
<a name="id3040459"></a><p class="title"><b>Example 18.3. Passer le titre au template d'en-tête</b></p>
<div class="example-contents">
<p>
    <code class="filename">mainpage.tpl</code> - Lorsque la page principal est construite,
    le titre <span class="quote">“<span class="quote">Man Page</span>”</span> est passé au <code class="filename">header.tpl</code> et sera utilisé
    en tant que titre.
   </p>
...
<p>
    <code class="filename">archives.tpl</code> - Lorsque la page principal est construite, le titre
    sera <span class="quote">“<span class="quote">Archives</span>”</span>. Notez que dans cet exemple, nous utilisons une variable du fichier
    <code class="filename">archives_page.conf</code> au lieu d'une variable classique.
   </p>
<pre class="programlisting">
...
<p>
    <code class="filename">header.tpl</code> - Notez que <span class="quote">“<span class="quote">Smarty News</span>”</span> est affiché
    si la variable <code class="literal">$title</code> n'est pas définie, en utilisant le modificateur de variable par
...
<tr>
<td width="40%" align="left" valign="top">Gestion des variables par défaut </td>
...
<td width="40%" align="right" valign="top"> Dates</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/tips.passing.vars.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02029 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
