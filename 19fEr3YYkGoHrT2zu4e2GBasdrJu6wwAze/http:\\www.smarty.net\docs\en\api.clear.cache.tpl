...
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 19:31:01 GMT
...
<h2>Name</h2>
<p>clearCache() — clears the cache for a specific template</p>
</div>
<div class="refsect1" title="Description">
<a name="idp15589136"></a><h2>Description</h2>
...
<li class="listitem"><p>
   ...
   <a class="link" href="caching.tpl" title="Chapter 15. Caching">caching section</a> for more
   information.
   </p></li>
<li class="listitem">
<p>
...
<div class="example">
<a name="idp15661824"></a><p class="title"><b>Example 14.11. clearCache()</b></p>
...
<br class="example-break"><p>
  ...
  and
  <a class="link" href="caching.tpl" title="Chapter 15. Caching"><code class="varname">caching</code></a> section.
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> clearCompiledTemplate()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/api.clear.cache.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02502 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
