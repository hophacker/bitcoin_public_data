http://www.smarty.net/docsv2/fr/variable.config.dir.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 07:37:32 GMT
...
<p>
  ...
  La valeur par défaut est <code class="filename">./configs</code>,
...
<td width="40%" align="right" valign="top"> $plugins_dir</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/variable.config.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02636 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
