http://www.smarty.net/docsv2/es/variable.default.modifiers.tpl
HTTP/1.1 200 OK
...
<p>
   ...
   "smarty" con un valor de parámetro "nodefaults" modificando esto, tal
...
<td width="40%" align="right" valign="top"> $default_resource_type</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/variable.default.modifiers.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.19948 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
