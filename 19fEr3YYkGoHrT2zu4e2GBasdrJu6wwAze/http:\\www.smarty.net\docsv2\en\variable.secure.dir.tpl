http://www.smarty.net/docsv2/en/variable.secure.dir.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 13:25:13 GMT
...
<p>
 ...
 and <a class="link" href="language.function.fetch.tpl" title="{fetch}"><code class="varname">{fetch}</code></a>
 use this when
 <a class="link" href="variable.security.tpl" title="$security"><em class="parameter"><code>$security</code></em></a> is enabled.
      </p>
<div class="example">
<a name="id2844064"></a><p class="title"><b>Example 12.5. $secure_dir example</b></p>
...
<br class="example-break"><p>
 ...
 and <a class="link" href="variable.trusted.dir.tpl" title="$trusted_dir"><em class="parameter"><code>$trusted_dir</code></em></a>.
</p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $security_settings</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/variable.secure.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02224 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
