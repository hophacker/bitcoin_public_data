http://www.smarty.net/docsv2/fr/preface.tpl
HTTP/1.1 200 OK
...
<tr><th colspan="3" align="center">Préface</th></tr>
<tr>
...
<a name="preface"></a>Préface</h2></div></div></div>
<p>
...
<p>
  ...
  et <span class="productname">SmartTemplate</span>™ a vu le jour (note : cette
...
<tr>
<td width="40%" align="left" valign="top">Smarty - le moteur et compilateur de template PHP </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Part I. Pour commencer</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 1 plus 19? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/preface.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03008 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
