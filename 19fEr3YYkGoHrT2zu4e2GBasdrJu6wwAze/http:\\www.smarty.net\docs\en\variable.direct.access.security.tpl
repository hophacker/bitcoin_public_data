http://www.smarty.net/docs/en/variable.direct.access.security.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 17:26:24 GMT
...
<p>
        Direct access security is enabled by default. To disable it set <code class="varname">$direct_access_security</code> to <code class="constant">FALSE</code>. 
       </p>
...
<td width="40%" align="right" valign="top"> $error_reporting</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/variable.direct.access.security.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02088 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
