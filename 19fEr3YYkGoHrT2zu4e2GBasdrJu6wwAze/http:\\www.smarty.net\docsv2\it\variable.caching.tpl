http://www.smarty.net/docsv2/it/variable.caching.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 02:10:16 GMT
...
<p>
           ...
           su quando quella particolare cache scadrà. Consultate anche <a class="link" href="api.is.cached.tpl" title="is_cached">is_cached</a>.
      </p>
<p>
...
<td width="40%" align="right" valign="top"> $cache_dir</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/variable.caching.tpl">
            </form>
            </div>
          </div>
