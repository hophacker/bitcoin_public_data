http://www.smarty.net/docsv2/fr/api.unregister.prefilter.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 19:20:27 GMT
...
<h2>Name</h2>
<p>unregister_prefilter() — Désalloue dynamiquement un filtre de pré-compilation</p>
</div>
<div class="refsect1" title="Description">
<a name="id3018626"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">unregister_prefilter</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">function_name</span></span>);</code><p>
   Voir aussi
   <a class="link" href="api.register.prefilter.tpl" title="register_prefilter()"><code class="varname">register_prefilter()</code></a> et
   les <a class="link" href="plugins.prefilters.postfilters.tpl" title="filtres de pré-compilation/filtres de post-compilation">pré-filtres</a>.
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> unregister_resource()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/api.unregister.prefilter.tpl">
            </form>
            </div>
          </div>
