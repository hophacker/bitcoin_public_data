http://www.smarty.net/docsv2/fr/api.unregister.outputfilter.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 12:25:02 GMT
...
<h2>Name</h2>
<p>unregister_outputfilter() — Désalloue dynamiquement un filtre de sortie</p>
</div>
<div class="refsect1" title="Description">
<a name="id3018252"></a><h2>Description</h2>
...
<p>
   Voir aussi
   <a class="link" href="api.register.outputfilter.tpl" title="register_outputfilter()"><code class="varname">register_outputfilter()</code></a> et
...
<td width="40%" align="right" valign="top"> unregister_postfilter()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/api.unregister.outputfilter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02112 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
