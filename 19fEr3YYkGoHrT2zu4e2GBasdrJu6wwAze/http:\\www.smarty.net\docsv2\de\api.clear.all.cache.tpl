http://www.smarty.net/docsv2/de/api.clear.all.cache.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 08:26:12 GMT
...
<html lang="en">
  <head>
    ...
    <title>clear_all_cache (Cache vollständig leeren) | Smarty</title>
...
<tr><th colspan="3" align="center">clear_all_cache (Cache vollständig leeren)</th></tr>
<tr>
...
<div class="refentry" title="clear_all_cache (Cache vollständig leeren)">
<a name="api.clear.all.cache"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>clear_all_cache (Cache vollständig leeren)</p>
</div>
<div class="refsect1">
<a name="id2918684"></a><h2></h2>
...
<div class="example">
<a name="id2918640"></a><p class="title"><b>Example 13.6. clear_all_cache (Cache vollständig leeren)</b></p>
...
<tr>
<td width="40%" align="left" valign="top">clear_all_assign (alle Zuweisungen löschen) </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> clear_assign (lösche Zuweisung)</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/api.clear.all.cache.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02508 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
