...
<td>Stabilisce se i tag saranno sostituiti con ' ' (true) o con '' (false)</td>
</tr></tbody>
</table></div>
<p>
   Questo elimina i tag di markup, cioè fondamentalmente qualsiasi cosa compresa
   fra &lt; and &gt;.
  </p>
<div class="example">
<a name="id3099110"></a><p class="title"><b>Example 5.19. strip_tags</b></p>
...
<td width="40%" align="right" valign="top"> truncate</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/language.modifier.strip.tags.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01888 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
