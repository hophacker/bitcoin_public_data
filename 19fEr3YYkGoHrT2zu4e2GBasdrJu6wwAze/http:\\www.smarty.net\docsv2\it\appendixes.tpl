http://www.smarty.net/docsv2/it/appendixes.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 13:45:49 GMT
...
<html lang="en">
  <head>
    ...
    <title>Part IV. Appendici | Smarty</title>
...
<tr><th colspan="3" align="center">Part IV. Appendici</th></tr>
<tr>
...
<div class="part" title="Part IV. Appendici">
<div class="titlepage"><div><div><h1 class="title">
<a name="appendixes"></a>Part IV. Appendici</h1></div></div></div>
<div class="toc">
...
<td width="40%" align="right" valign="top"> Chapter 17. Troubleshooting</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 17 plus 9? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/appendixes.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02064 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
