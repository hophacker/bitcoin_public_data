http://www.smarty.net/docsv2/fr/api.get.registered.object.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 06:25:10 GMT
...
<html lang="en">
  <head>
    ...
    <title>get_registered_object() | Smarty</title>
...
<tr><th colspan="3" align="center">get_registered_object()</th></tr>
<tr>
...
<div class="refentry" title="get_registered_object()">
<a name="api.get.registered.object"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>get_registered_object() — Retourne la référence d'un objet enregistré</p>
</div>
<div class="refsect1" title="Description">
<a name="id3010006"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">array </span><span class="methodname">get_registered_object</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">object_name</span></span>);</code><p>
   Utile quand vous voulez accéder directement à un
   <a class="link" href="api.register.object.tpl" title="register_object()">objet enregistré</a>
   avec une fonction utilisateur. Lisez la documentation sur les
   <a class="link" href="advanced.features.tpl#advanced.features.objects" title="Objets">objets</a> pour plus d'informations.
  </p>
<div class="example">
<a name="id3011089"></a><p class="title"><b>Example 13.17. Exemple avec get_registered_object()</b></p>
...
<br class="example-break"><p>
   Voir aussi
   <a class="link" href="api.register.object.tpl" title="register_object()"><code class="varname">register_object()</code></a>,
   <a class="link" href="api.unregister.object.tpl" title="unregister_object()"><code class="varname">unregister_object()</code></a> et
   la <a class="link" href="advanced.features.tpl#advanced.features.objects" title="Objets">section sur les objets</a>.
  </p>
</div>
</div>
<div class="navfooter">
...
<tr>
<td width="40%" align="left" valign="top">get_config_vars() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> get_template_vars()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 10 plus 18? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/api.get.registered.object.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02768 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
