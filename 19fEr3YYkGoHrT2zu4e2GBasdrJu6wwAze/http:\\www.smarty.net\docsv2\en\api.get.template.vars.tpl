...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 11:54:08 GMT
...
<h2>Name</h2>
<p>get_template_vars() — returns  assigned variable value(s)</p>
</div>
<div class="refsect1" title="Description">
<a name="id2855825"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">array </span><span class="methodname">get_template_vars</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">varname</span></span>);</code><p>
   If no parameter
   is given, an array of all <a class="link" href="api.assign.tpl" title="assign()">assigned</a>
   variables are returned.
  </p>
<div class="example">
<a name="id2856169"></a><p class="title"><b>Example 13.18. get_template_vars</b></p>
...
<td width="40%" align="right" valign="top"> is_cached()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/api.get.template.vars.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03792 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
