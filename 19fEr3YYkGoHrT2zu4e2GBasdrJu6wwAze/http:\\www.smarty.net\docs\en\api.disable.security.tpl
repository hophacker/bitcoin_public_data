...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 09:35:44 GMT
...
<h2>Name</h2>
<p>disableSecurity() — disables template security</p>
</div>
<div class="refsect1" title="Description">
<a name="idp15997136"></a><h2>Description</h2>
...
<td width="40%" align="right" valign="top"> display()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/api.disable.security.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01800 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
