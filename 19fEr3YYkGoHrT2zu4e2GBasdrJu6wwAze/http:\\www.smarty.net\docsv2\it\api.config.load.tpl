http://www.smarty.net/docsv2/it/api.config.load.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 11:54:30 GMT
...
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">config_load</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">file</span></span>,<br>                 <span class="methodparam"><span class="type">string </span><span class="parameter">section</span></span>);</code><p>
   Carica i dati del file di configurazione <em class="parameter"><code>file</code></em> e
   li assegna al template. Funziona esattamente come la funzione del
   template <a class="link" href="language.function.config.load.tpl" title="config_load">config_load</a>.
  </p>
...
<p>
    ...
    impostazioni di <a class="link" href="variable.force.compile.tpl" title="$force_compile">force_compile</a>
    e <a class="link" href="variable.compile.check.tpl" title="$compile_check">compile_check</a>.
   </p>
</div>
<div class="example">
<a name="id3142191"></a><p class="title"><b>Example 13.11. config_load</b></p>
...
<td width="40%" align="right" valign="top"> display</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/api.config.load.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03192 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
