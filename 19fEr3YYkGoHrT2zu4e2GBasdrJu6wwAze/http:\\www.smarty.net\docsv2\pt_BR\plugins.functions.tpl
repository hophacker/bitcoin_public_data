http://www.smarty.net/docsv2/pt_BR/plugins.functions.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 07:20:36 GMT
...
<html lang="en">
  <head>
    ...
    <title>Funções de Template | Smarty</title>
...
<tr><th colspan="3" align="center">Funções de Template</th></tr>
<tr>
...
<div class="sect1" title="Funções de Template">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="plugins.functions"></a>Funções de Template</h2></div></div></div>
...
<p>
     Todos os atributos passados para as funções de template a
      ...
      <em class="parameter"><code>$params</code></em> como um array associativo. Ou acessa esses valores
      diretamente i.e <code class="varname">$params['start']</code> ou usa
     <code class="varname">extract($params)</code> para 
...
<p>
     ...
     (a função <code class="function">fetch</code>, por exemplo). Alternativamente, a função pode simplesmente executar
     alguma outra tarefa sem ter alguma saída
     (a função <code class="function">assign</code>).
    </p>
<p>
     ...
     o objeto <em class="parameter"><code>$smarty</code></em> fornecido para fazer isso.
    </p>
<p>
     Veja também:
     <a class="link" href="api.register.function.tpl" title="register_function">register_function()</a>,
     <a class="link" href="api.unregister.function.tpl" title="unregister_function">unregister_function()</a>.
    </p>
<p>
     </p>
<div class="example">
<a name="id2772558"></a><p class="title"><b>Example 16.1. função de plugin com saída</b></p>
...
Resposta: {eightball}.</pre>
<p>
     </p>
<div class="example">
<a name="id2772598"></a><p class="title"><b>Example 16.2. função de plugin sem saída</b></p>
<div class="example-contents"><pre class="programlisting">
&lt;?php
/*
 * Smarty plugin
...
<tr>
<td width="40%" align="left" valign="top">Escrevendo Plugins </td>
...
<td width="40%" align="right" valign="top"> Modifiers</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 0 plus 1? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="e4e37000cf1b37860b5a3d87d58adaf9">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/plugins.functions.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.22639 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
