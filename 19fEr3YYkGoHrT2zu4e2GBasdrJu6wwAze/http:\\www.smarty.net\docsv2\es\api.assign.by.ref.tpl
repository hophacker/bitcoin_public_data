http://www.smarty.net/docsv2/es/api.assign.by.ref.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 22:01:30 GMT
...
<h2>Name</h2>
<p>assign_by_ref — pasando valores por referencia</p>
</div>
<div class="refsect1" title="Descripción">
<a name="id3126218"></a><h2>Descripción</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">assign_by_ref</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">varname</span></span>,<br>                   <span class="methodparam"><span class="type">mixed </span><span class="parameter">var</span></span>);</code><p>
   Este es usado para <a class="link" href="api.assign.tpl" title="assign()">asignar</a> valores por 
   referencia al template en vez de hacer una copia. Vea el manual de PHP en 
   la parte sobre referencia de variables para una explicación mas detallada.
  </p>
...
<p>
    ...
    este valor, el valor asignado exprimentara el cambio también.
    Para <a class="link" href="advanced.features.tpl#advanced.features.objects" title="Objetos">objetos</a>, 
    assign_by_ref() también exite una copia del objetos asignado en memoria. 
    Vea el manual de PHP en refereciando variables para una mejor explicación.
   </p>
</div>
<div class="example">
<a name="id3127641"></a><p class="title"><b>Example 13.4. assign_by_ref()</b></p>
...
<br class="example-break"><p>
       Ver también <a class="link" href="api.assign.tpl" title="assign()">assign()</a>,
       <a class="link" href="api.clear.all.assign.tpl" title="clear_all_assign()">clear_all_assign()</a>,
       <a class="link" href="api.append.tpl" title="append()">append()</a>
       y <a class="link" href="language.custom.functions.tpl#language.function.assign" title="{assign}">{assign}</a>
     </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> clear_all_assign()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/api.assign.by.ref.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02169 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
