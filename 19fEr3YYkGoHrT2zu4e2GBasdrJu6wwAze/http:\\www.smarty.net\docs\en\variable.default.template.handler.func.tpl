http://www.smarty.net/docs/en/variable.default.template.handler.func.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 17:51:15 GMT
...
<div class="example">
<a name="idp14480416"></a><p class="title"><b>Example 13.5. $default_template_handler_func</b></p>
...
<td width="40%" align="right" valign="top"> $direct_access_security</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 20 plus 9? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/variable.default.template.handler.func.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03244 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
