http://www.smarty.net/docsv2/en/variable.config.dir.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 04:12:17 GMT
...
<p>
       ...
       <code class="filename">./configs</code>, meaning that
       Smarty will look for the <code class="filename">configs/</code>
...
<td width="40%" align="right" valign="top"> $plugins_dir</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/variable.config.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01732 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
