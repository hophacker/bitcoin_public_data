http://www.smarty.net/docsv2/en/variable.default.resource.type.tpl
HTTP/1.1 200 OK
...
<p>
      ...
      meaning. See the <a class="link" href="template.resources.tpl" title="Resources">resource</a>
...
<td width="40%" align="right" valign="top"> Chapter 13. Smarty Class Methods()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 19 plus 6? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/variable.default.resource.type.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02403 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
