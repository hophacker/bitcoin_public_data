...
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 15:25:12 GMT
...
<p>Once an application is
	   ...
	   an involved template file or config file was updated. See <a class="link" href="variable.force.compile.tpl" title="$force_compile">
       <em class="parameter"><code>$force_compile</code></em></a> and <a class="link" href="api.clear.compiled.tpl.tpl" title="clear_compiled_tpl()"><code class="varname">clear_compiled_tpl()</code>
       </a>.
      </p>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> $force_compile</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/variable.compile.check.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02957 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
