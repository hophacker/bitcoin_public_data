http://www.smarty.net/docsv2/es/variable.request.vars.order.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 13:58:03 GMT
...
<p>
 Ver también <a class="link" href="language.variables.smarty.tpl" title="La variable reservada {$smarty}">$smarty.request</a>
 y <a class="link" href="variable.request.use.auto.globals.tpl" title="$request_use_auto_globals">$request_use_auto_globals</a>.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $request_use_auto_globals</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/variable.request.vars.order.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02452 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
