http://www.smarty.net/docsv2/pt_BR/api.clear.config.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 16:03:26 GMT
...
<div class="sect1" title="clear_config">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="api.clear.config"></a>clear_config</h2></div></div></div>
...
<div class="example">
<a name="id2757072"></a><p class="title"><b>Example 13.10. clear_config</b></p>
<div class="example-contents"><pre class="programlisting">
// clear all assigned config variables.
$smarty-&gt;clear_config();

// clear one variable
$smarty-&gt;clear_config('foobar');</pre></div>
</div>
...
<td width="40%" align="right" valign="top"> config_load</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="04aaf06135234fbff869c994434ae025">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/api.clear.config.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03824 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
