...
<div class="example">
<a name="idp6878448"></a><p class="title"><b>Example 5.20. strip_tags</b></p>
...
<td width="40%" align="right" valign="top"> to_charset</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/language.modifier.strip.tags.tpl">
            </form>
            </div>
          </div>
