http://www.smarty.net/docsv2/fr/language.function.mailto.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 12:25:30 GMT
...
<p>
  <code class="varname">{mailto}</code> crée un lien <code class="literal">mailto:</code>
...
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Le texte à afficher, par défaut l'adresse email</td>
</tr>
<tr>
...
<td>Comment encoder l'adresse email.
      <code class="literal">none</code>, <code class="literal">hex</code>, <code class="literal">javascript</code>
      et <code class="literal">javascript_charcode</code> sont des valeurs correctes.</td>
</tr>
<tr>
...
<td align="center">Non</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Les adresses email en copie (Cc).
     Séparez les entrées par une virgule.</td>
</tr>
<tr>
...
<td align="center">Non</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Les adresses email en copie cachées (Bcc).
     Séparez les entrées par une virgule.</td>
</tr>
<tr>
...
<td align="center">Non</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Newsgroup où poster le message.
     Séparez les entrées par une virgule.</td>
</tr>
<tr>
...
<td align="center">Non</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Adresses où transmettre le message.
...
<td align="center">Non</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Toute information que vous souhaitez passer au lien,
     par exemple une classe css.</td>
</tr>
</tbody>
</table></div>
<div class="example">
<a name="id2979733"></a><p class="title"><b>Example 8.23. Exemple avec {mailto}</b></p>
...
<br class="example-break"><p>
  ...
  et <a class="link" href="tips.obfuscating.email.tpl" title="Dissimuler les adresses email">le camouflage des adresses E-mail</a>.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> {math}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 19 plus 4? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/language.function.mailto.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02911 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
