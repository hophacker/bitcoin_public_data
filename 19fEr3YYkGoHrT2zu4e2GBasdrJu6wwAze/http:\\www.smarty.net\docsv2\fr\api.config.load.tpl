http://www.smarty.net/docsv2/fr/api.config.load.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 01:39:50 GMT
...
<div class="refentry" title="config_load()">
<a name="api.config.load"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>config_load() — Charge les données d'un fichier de configuration et les assigne au template</p>
</div>
<div class="refsect1" title="Description">
<a name="id3008337"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">config_load</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">file</span></span>,<br>                 <span class="methodparam"><span class="type">string </span><span class="parameter">section</span></span>);</code><p>
   Utilisée pour charger des données d'un <a class="link" href="config.files.tpl" title="Chapter 9. Fichiers de configuration">fichier
   de configuration</a> et les assigner a un template. Cette fonction fonctionne
   exactement comme la fonction de template <a class="link" href="language.function.config.load.tpl" title="{config_load}"><code class="varname">{config_load}</code></a>.
  </p>
...
<p>
    ...
    Les variables de configuration chargées avec <code class="varname">config_load()</code> sont
    globales. Les fichiers de configuration sont aussi compilés pour une
    exécution plus rapide et respecte les réglages de <a class="link" href="variable.force.compile.tpl" title="$force_compile"><em class="parameter"><code>$force_compile</code></em></a> et de <a class="link" href="variable.compile.check.tpl" title="$compile_check"><em class="parameter"><code>$compile_check</code></em></a>.
   </p>
</div>
<div class="example">
<a name="id3008474"></a><p class="title"><b>Example 13.11. Exemple avec config_load()</b></p>
...
<br class="example-break"><p>
   ...
   <a class="link" href="api.clear.config.tpl" title="clear_config()"><code class="varname">clear_config()</code></a> et les
   <a class="link" href="language.config.variables.tpl" title="Variables chargées depuis des fichiers de configuration">variables de configuration</a>.
  </p>
</div>
</div>
<div class="navfooter">
...
<tr>
<td width="40%" align="left" valign="top">clear_config() </td>
...
<td width="40%" align="right" valign="top"> display()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/api.config.load.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.04239 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
