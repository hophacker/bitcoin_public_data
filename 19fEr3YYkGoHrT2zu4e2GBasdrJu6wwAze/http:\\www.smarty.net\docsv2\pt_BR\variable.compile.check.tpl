http://www.smarty.net/docsv2/pt_BR/variable.compile.check.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 03:42:00 GMT
...
<p>
	   ...
	   um complexo arquivo de ou um arquivo de configuração foi atualizado. Veja <a class="link" href="variable.force.compile.tpl" title="$force_compile">$force_compile</a> ou <a class="link" href="api.clear.compiled.tpl.tpl" title="clear_compiled_tpl">clear_compiled_tpl</a>.
      </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $force_compile</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/variable.compile.check.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02338 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
