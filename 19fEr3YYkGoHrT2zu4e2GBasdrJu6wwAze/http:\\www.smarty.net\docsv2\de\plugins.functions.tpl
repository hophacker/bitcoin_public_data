http://www.smarty.net/docsv2/de/plugins.functions.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 19:20:37 GMT
...
<html lang="en">
  <head>
    ...
    <title>Template-Funktionen | Smarty</title>
...
<tr><th colspan="3" align="center">Template-Funktionen</th></tr>
<tr>
...
<div class="sect1" title="Template-Funktionen">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="plugins.functions"></a>Template-Funktionen</h2></div></div></div>
...
<p>
    ...
    <em class="parameter"><code>$params</code></em> als assoziatives Array abgelegt. Sie können
     auf diese Werte entweder direkt mit <code class="varname">$params['start']</code> zugreifen
     oder sie mit <code class="varname">extract($params)</code> in die Symbol-Tabelle importieren.
</p>
<p>
 Die Ausgabe der Funktion wird verwendet, um das Funktions-Tag im Template
 (<code class="function">fetch</code> Funktion, zum Beispiel) zu ersetzen.
 Alternativ kann sie auch etwas tun, ohne eine Ausgabe zurückzuliefern
 (<code class="function">assign</code> Funktion, zum Beispiel).
</p>
<p>
 ...
 übergebene <em class="parameter"><code>$smarty</code></em> Objekt verwendet werden.
</p>
<p>
 
 Sehen Sie dazu:
 <a class="link" href="api.register.function.tpl" title="register_function">register_function()</a>,
  <a class="link" href="api.unregister.function.tpl" title="unregister_function (Template-Funktion deaktivieren)">unregister_function()</a>.
</p>
<p>
 </p>
<div class="example">
<a name="id2937576"></a><p class="title"><b>Example 16.1. Funktionsplugin mit Ausgabe</b></p>
...
<div class="example">
<a name="id2937624"></a><p class="title"><b>Example 16.2. Funktionsplugin ohne Ausgabe</b></p>
<div class="example-contents"><pre class="programlisting">
...
<tr>
<td width="40%" align="left" valign="top">Plugins schreiben </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Variablen-Modifikatoren</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/plugins.functions.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02014 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
