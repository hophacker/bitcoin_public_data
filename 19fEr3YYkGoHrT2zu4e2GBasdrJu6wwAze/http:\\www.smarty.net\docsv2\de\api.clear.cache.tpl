http://www.smarty.net/docsv2/de/api.clear.cache.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 17:26:55 GMT
...
<html lang="en">
  <head>
    ...
    <title>clear_cache (leere Cache) | Smarty</title>
...
<tr><th colspan="3" align="center">clear_cache (leere Cache)</th></tr>
<tr>
...
<div class="refentry" title="clear_cache (leere Cache)">
<a name="api.clear.cache"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>clear_cache (leere Cache)</p>
</div>
<div class="refsect1">
<a name="id2919213"></a><h2></h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">clear_cache</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">template</span></span>,<br>                 <span class="methodparam"><span class="type">string </span><span class="parameter">cache_id</span></span>,<br>                 <span class="methodparam"><span class="type">string </span><span class="parameter">compile_id</span></span>,<br>                 <span class="methodparam"><span class="type">int </span><span class="parameter">expire_time</span></span>);</code><p>
    ...
    <a class="link" href="caching.tpl" title="Chapter 14. Caching">caching</a>. Als vierten Parameter können Sie
     ein Mindestalter in Sekunden angeben, das ein Cache aufweisen muss,
     bevor er gelöscht wird.
   </p>
<div class="example">
<a name="id2919504"></a><p class="title"><b>Example 13.8. clear_cache (Cache leeren)</b></p>
...
<tr>
<td width="40%" align="left" valign="top">clear_assign (lösche Zuweisung) </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> clear_compiled_tpl (kompiliertes Template löschen)</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/api.clear.cache.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02514 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
