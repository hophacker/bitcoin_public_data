http://www.smarty.net/docsv2/en/language.function.mailto.tpl
HTTP/1.1 200 OK
Date: Sat, 26 Jul 2014 13:10:14 GMT
...
<div class="example">
<a name="id2829717"></a><p class="title"><b>Example 8.23. {mailto} example lines followed by the result</b></p>
...
<br class="example-break"><p>
 ...
 and
 <a class="link" href="tips.obfuscating.email.tpl" title="Obfuscating E-mail Addresses">obfuscating email addresses</a>.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> {math}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/language.function.mailto.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03074 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
