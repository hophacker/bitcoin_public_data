...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 22:01:11 GMT
...
<h2>Name</h2>
<p>getTemplateDir() — return the directory where templates are stored</p>
</div>
<div class="refsect1" title="Description">
<a name="idp16316528"></a><h2>Description</h2>
...
<a name="idp16374704"></a><p class="title"><b>Example 14.30. getTemplateDir()</b></p>
...
<br class="example-break"><p>
   ...
   <a class="link" href="api.add.template.dir.tpl" title="addTemplateDir()"><code class="varname">addTemplateDir()</code></a> and
...
<td width="40%" align="right" valign="top"> getTemplateVars()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/api.get.template.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02048 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
