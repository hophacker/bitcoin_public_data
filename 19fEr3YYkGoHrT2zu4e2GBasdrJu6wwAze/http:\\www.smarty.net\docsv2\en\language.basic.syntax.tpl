...
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 07:21:03 GMT
...
<div class="example">
<a name="id2779919"></a><p class="title"><b>Example 3.1. Comments within a template</b></p>
...
<td width="40%" align="right" valign="top"> Variables</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/language.basic.syntax.tpl">
            </form>
            </div>
          </div>
