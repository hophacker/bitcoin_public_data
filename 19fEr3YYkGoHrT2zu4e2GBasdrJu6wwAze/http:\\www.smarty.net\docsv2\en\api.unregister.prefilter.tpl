http://www.smarty.net/docsv2/en/api.unregister.prefilter.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 14:40:21 GMT
...
<h2>Name</h2>
<p>unregister_prefilter() — dynamically unregister a prefilter</p>
</div>
<div class="refsect1" title="Description">
<a name="id2863484"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">unregister_prefilter</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">function_name</span></span>);</code><p>
      ...
      and
      <a class="link" href="plugins.prefilters.postfilters.tpl" title="Prefilters/Postfilters">pre filters</a>.
</p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> unregister_resource()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 18 plus 10? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/api.unregister.prefilter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02500 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
