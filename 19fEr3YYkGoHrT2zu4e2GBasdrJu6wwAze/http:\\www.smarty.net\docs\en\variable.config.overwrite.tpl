http://www.smarty.net/docs/en/variable.config.overwrite.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 02:19:35 GMT
...
<div class="example">
<a name="idp14301824"></a><p class="title"><b>Example 13.2. Array of config #variables#</b></p>
...
<td width="40%" align="right" valign="top"> $config_read_hidden</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 3 plus 14? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/variable.config.overwrite.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01792 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
