http://www.smarty.net/docsv2/de/variable.compile.id.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 18:04:27 GMT
...
<p>
  ...
  <a class="link" href="variable.compile.dir.tpl" title="$compile_dir">$compile_dir</a>
  für unterschiedliche
  <a class="link" href="api.variables.tpl#variable.template.dir" title="$template_dir">$template_dirs</a>
  verwenden können.
  Wenn Sie eine eindeutige $compile_id für jedes
  <a class="link" href="api.variables.tpl#variable.template.dir" title="$template_dir">$template_dir</a> setzen,
...
<p>
  ...
  durch einen <a class="link" href="plugins.prefilters.postfilters.tpl" title="'pre'/'post'-Filter">prefilter</a>
...
<div class="example">
<a name="id2914641"></a><p class="title"><b>Example 12.4. $compile_id in einer Virtual Host Umgebung</b></p>
...
<td width="40%" align="right" valign="top"> $use_sub_dirs</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 20 plus 14? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="15588fe30a6382ca86661399d094d752">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/variable.compile.id.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03826 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
