http://www.smarty.net/docsv2/es/variable.cache.handler.func.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 23:36:39 GMT
...
<p>
       Usted puede proporcionar una función por default para manipular
       ...
       Para mas detalles vea la sección
       <a class="link" href="section.template.cache.handler.func.tpl" title="Función manipuladora de cache">
       cache handler function section</a>.
      </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $cache_modified_check</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/variable.cache.handler.func.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02476 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
