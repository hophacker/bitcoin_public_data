http://www.smarty.net/docsv2/fr/api.load.filter.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 07:37:09 GMT
...
<h2>Name</h2>
<p>load_filter() — Charge un plugin de filtrage</p>
</div>
<div class="refsect1" title="Description">
<a name="id3011716"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">load_filter</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">type</span></span>,<br>                 <span class="methodparam"><span class="type">string </span><span class="parameter">name</span></span>);</code><p>
   ...
   et peut prendre l'une des valeurs suivantes : <code class="literal">pre</code>, <code class="literal">post</code> ou
   <code class="literal">output</code>. Le second argument spécifie le nom du plugin
   de filtrage.
  </p>
<div class="example">
<a name="id3011506"></a><p class="title"><b>Example 13.21. Chargement de plugins de filtrage</b></p>
...
<br class="example-break"><p>
  ...
  <a class="link" href="variable.autoload.filters.tpl" title="$autoload_filters"><em class="parameter"><code>$autoload_filters</code></em></a> et
   les <a class="link" href="advanced.features.tpl" title="Chapter 15. Fonctionnalités avancées">fonctionnalités avancées</a>.
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> register_block()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 6 plus 5? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/api.load.filter.tpl">
            </form>
            </div>
          </div>
