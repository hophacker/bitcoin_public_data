...
<html lang="en">
  <head>
    ...
    <title>is_cached (gecachte Version existiert) | Smarty</title>
...
<tr><th colspan="3" align="center">is_cached (gecachte Version existiert)</th></tr>
<tr>
...
<div class="refentry" title="is_cached (gecachte Version existiert)">
<a name="api.is.cached"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>is_cached (gecachte Version existiert)</p>
</div>
<div class="refsect1">
<a name="id2921485"></a><h2></h2>
<code class="methodsynopsis"><span class="type">bool </span><span class="methodname">is_cached</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">template</span></span>,<br>               <span class="methodparam"><span class="type">string </span><span class="parameter">cache_id</span></span>,<br>               <span class="methodparam"><span class="type">string </span><span class="parameter">compile_id</span></span>);</code><p>
    ...
    Dies funktioniert nur, wenn <a class="link" href="variable.caching.tpl" title="$caching">caching</a> eingeschaltet ist.
   </p>
<div class="example">
<a name="id2921688"></a><p class="title"><b>Example 13.18. is_cached</b></p>
...
<div class="example">
<a name="id2921711"></a><p class="title"><b>Example 13.19. 'is_cached' bei mehreren Template-Caches</b></p>
<div class="example-contents"><pre class="programlisting">
...
<br class="example-break"><div class="note" title="Technische Bemerkung" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Technische Bemerkung</h3>
<p>
   Wenn <code class="literal">is_cached</code> true zurück gibt, wird die Ausgabe geladen. Alle weiteren Aufrufe von <a class="link" href="api.display.tpl" title="display (ausgeben)">display()</a> oder <a class="link" href="api.fetch.tpl" title="fetch">fetch()</a> werden aus diesem Cache bedient. Dies verhindert eine Race Condition, die auftauchen könnte, wenn ein anderes Script das besagte Template aus dem Cache löscht. Das bedeutet natürlich auch, dass <a class="link" href="api.clear.cache.tpl" title="clear_cache (leere Cache)">clear_cache()</a> und andere Cache spezifische Einstellungen keine Auswirkungen haben, nachdem <code class="literal">is_cached</code> true zurückgegeben hat.
  </p>
</div>
</div>
</div>
...
<tr>
<td width="40%" align="left" valign="top">get_template_vars (Template-Variablen extrahieren) </td>
...
<td width="40%" align="right" valign="top"> load_filter</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/api.is.cached.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02146 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
