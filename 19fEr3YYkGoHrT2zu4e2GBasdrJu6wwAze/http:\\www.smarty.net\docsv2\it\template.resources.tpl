http://www.smarty.net/docsv2/it/template.resources.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 06:24:43 GMT
...
<tr><th colspan="3" align="center">Risorse</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="section.template.cache.handler.func.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 15. Funzioni avanzate</th>
...
<div class="sect1" title="Risorse">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="template.resources"></a>Risorse</h2></div></div></div>
<p>
        ...
        viene utilizzato il valore di  <a class="link" href="variable.default.resource.type.tpl" title="$default_resource_type">$default_resource_type</a>.
   </p>
<div class="sect2" title="Template della $template_dir">
<div class="titlepage"><div><div><h3 class="title">
<a name="templates.from.template.dir"></a>Template della $template_dir</h3></div></div></div>
<p>
...
<div class="example">
<a name="id3156479"></a><p class="title"><b>Example 15.6. uso dei template della $template_dir</b></p>
...
<div class="sect2" title="Template da qualsiasi directory">
<div class="titlepage"><div><div><h3 class="title">
<a name="templates.from.any.dir"></a>Template da qualsiasi directory</h3></div></div></div>
<p>
...
<div class="example">
<a name="id3156892"></a><p class="title"><b>Example 15.7. uso dei template da qualsiasi directory</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<br class="example-break"><div class="sect3" title="Percorsi su Windows">
<div class="titlepage"><div><div><h4 class="title">
<a name="templates.windows.filepath"></a>Percorsi su Windows</h4></div></div></div>
<p>
...
<div class="example">
<a name="id3156942"></a><p class="title"><b>Example 15.8. uso di template da percorsi di Windows</b></p>
...
<div class="sect2" title="Template da altre risorse">
<div class="titlepage"><div><div><h3 class="title">
<a name="templates.from.elsewhere"></a>Template da altre risorse</h3></div></div></div>
<p>
...
<p>
     Consultate la sezione <a class="link" href="plugins.resources.tpl" title="Risorse">plugin
     risorse</a> per maggiori informazioni sulle funzioni che
     dovrete creare.
    </p>
...
<p>
      ...
      <code class="literal">file</code>, ma potete fornire una risorsa che legge i
      template dal filesystem in maniera diversa registrandola con un altro
      nome di risorsa.
     </p>
</div>
<div class="example">
<a name="id3157017"></a><p class="title"><b>Example 15.9. uso di risorse personalizzate</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<div class="sect2" title="Funzione di gestione dei template di default">
<div class="titlepage"><div><div><h3 class="title">
<a name="default.template.handler.function"></a>Funzione di gestione dei template di default</h3></div></div></div>
<p>
...
<div class="example">
<a name="id3157118"></a><p class="title"><b>Example 15.10. uso della funzione di gestione dei template di default</b></p>
<div class="example-contents"><pre class="programlisting">
...
<tr>
<td width="40%" align="left" valign="top">Funzione di gestione della Cache </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Chapter 16. Estendere Smarty con i Plugin</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 11 plus 8? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="8aa546afe6f1df21b8461e13335badfb">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/template.resources.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02905 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
