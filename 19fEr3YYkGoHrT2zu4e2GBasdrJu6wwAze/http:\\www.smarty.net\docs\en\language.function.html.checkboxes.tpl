...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 20:08:02 GMT
...
<td>Add id-attributes to &lt;label&gt; and &lt;input&gt; to the output</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em><code class="constant">TRUE</code></em></span></td>
<td>Escape the output / content (values are always escaped)</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em><code class="constant">FALSE</code></em></span></td>
<td>Will make the "extra" attributes <span class="emphasis"><em>disabled</em></span> and <span class="emphasis"><em>readonly</em></span> only be set, if they were supplied with either boolean <span class="emphasis"><em><code class="constant">TRUE</code></em></span> or string <span class="emphasis"><em>"disabled"</em></span> and <span class="emphasis"><em>"readonly"</em></span> respectively</td>
</tr>
</tbody>
</table></div>
...
<div class="example">
<a name="idp11607776"></a><p class="title"><b>Example 8.6. {html_checkboxes}</b></p>
...
<a name="idp11616048"></a><p class="title"><b>Example 8.7. 
...
<td width="40%" align="right" valign="top"> {html_image}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/language.function.html.checkboxes.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02322 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
