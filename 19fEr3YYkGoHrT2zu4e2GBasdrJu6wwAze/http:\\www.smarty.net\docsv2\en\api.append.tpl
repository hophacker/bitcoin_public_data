http://www.smarty.net/docsv2/en/api.append.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 13:45:51 GMT
...
<h2>Name</h2>
<p>append() — append an element to an assigned array</p>
</div>
<div class="refsect1" title="Description">
<a name="id2850029"></a><h2>Description</h2>
...
If you append
   ...
   parameter of <code class="constant">TRUE</code>, the value will be merged with the current array
   instead of appended.
  </p>
...
<div class="example">
<a name="id2850694"></a><p class="title"><b>Example 13.1. append</b></p>
...
<br class="example-break"><p>See also
  <a class="link" href="api.append.by.ref.tpl" title="append_by_ref()"><code class="varname">append_by_ref()</code></a>,
...
<tr>
<td width="40%" align="left" valign="top">Chapter 13. Smarty Class Methods() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> append_by_ref()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/api.append.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02100 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
