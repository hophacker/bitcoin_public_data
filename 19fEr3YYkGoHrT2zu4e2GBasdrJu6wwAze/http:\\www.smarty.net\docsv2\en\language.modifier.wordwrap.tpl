http://www.smarty.net/docsv2/en/language.modifier.wordwrap.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 04:12:13 GMT
...
<div class="example">
<a name="id2795084"></a><p class="title"><b>Example 5.23. wordwrap</b></p>
...
<td width="40%" align="right" valign="top"> Chapter 6. Combining Modifiers</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/language.modifier.wordwrap.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02358 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
