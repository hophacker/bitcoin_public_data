http://www.smarty.net/docsv2/es/advanced.features.outputfilters.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 15:21:07 GMT
...
<html lang="en">
  <head>
    ...
    <title>Filtros de salida | Smarty</title>
...
<tr><th colspan="3" align="center">Filtros de salida</th></tr>
<tr>
...
<div class="sect1" title="Filtros de salida">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="advanced.features.outputfilters"></a>Filtros de salida</h2></div></div></div>
<p>
...
<p>
    ...
    <a class="link" href="api.register.outputfilter.tpl" title="register_outputfilter()">registrado</a> o
    cargados del directorio de plugins usando la función
    <a class="link" href="api.load.filter.tpl" title="load_filter()">load_filter()</a> o 
...
<div class="example">
<a name="id3147182"></a><p class="title"><b>Example 15.4. Usando un filtro de salida de template</b></p>
...
<td width="40%" align="right" valign="top"> Función manipuladora de cache</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="ee0499fd157289ff789d551248a78984">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/advanced.features.outputfilters.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02256 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
