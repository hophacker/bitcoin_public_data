http://www.smarty.net/docsv2/es/smarty.constants.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 17:26:21 GMT
...
<p>
     ...
     automáticamente. Si es definido, el path <span class="bold"><strong>
      debe finalizar con una diagonal</strong></span>.
    </p>
<div class="example">
<a name="id3116749"></a><p class="title"><b>Example 11.1. SMARTY_DIR</b></p>
...
<br class="example-break"><p>
  ...
  y
  <a class="link" href="variable.php.handling.tpl" title="$php_handling">$php_handling constants</a>
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> SMARTY_CORE_DIR</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/smarty.constants.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02212 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
