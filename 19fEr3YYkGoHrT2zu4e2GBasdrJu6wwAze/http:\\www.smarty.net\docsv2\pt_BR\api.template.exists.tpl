http://www.smarty.net/docsv2/pt_BR/api.template.exists.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 20:07:41 GMT
...
<div class="sect1" title="template_exists">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="api.template.exists"></a>template_exists</h2></div></div></div>
<div class="funcsynopsis">
<table border="0" summary="Function synopsis" cellspacing="0" cellpadding="0" class="funcprototype-table"><tr>
<td><code class="funcdef">bool <b class="fsfunc">template_exists</b>(</code></td>
<td>
<var class="pdparam">template</var><code>)</code>;</td>
<td> </td>
</tr></table>
<div class="paramdef-list">
<code>string <var class="pdparam">template</var></code>;</div>
...
<td width="40%" align="right" valign="top"> unregister_block</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/api.template.exists.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01875 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
