http://www.smarty.net/docs/en/variable.debugging.ctrl.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 11:41:40 GMT
...
<p>
       This allows alternate ways to enable debugging. <code class="literal">NONE</code>
        ...
        invocation of the script. If <a class="link" href="variable.debugging.tpl" title="$debugging">
        <em class="parameter"><code>$debugging</code></em></a> is <code class="constant">TRUE</code>, this value is ignored.
      </p>
<div class="example">
<a name="idp14431984"></a><p class="title"><b>Example 13.3. $debugging_ctrl on localhost</b></p>
...
<br class="example-break"><p>
     See also <a class="link" href="chapter.debugging.console.tpl" title="Chapter 10. Debugging Console">debugging console</a>
     section,
     <a class="link" href="variable.debugging.tpl" title="$debugging"><em class="parameter"><code>$debugging</code></em></a> and
...
<td width="40%" align="right" valign="top"> $default_config_type</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 17 plus 10? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/variable.debugging.ctrl.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02719 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
