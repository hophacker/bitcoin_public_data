http://www.smarty.net/docs/en/variable.debugging.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 17:27:00 GMT
...
<p>
       ...
       <a class="link" href="language.function.assign.tpl" title="{assign}"><code class="varname">{assign}</code>
       </a> function.
      </p>
...
<td width="40%" align="right" valign="top"> $debugging_ctrl</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/variable.debugging.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01131 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
