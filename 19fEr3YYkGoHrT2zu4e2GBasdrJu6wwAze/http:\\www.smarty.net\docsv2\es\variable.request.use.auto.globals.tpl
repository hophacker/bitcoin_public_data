http://www.smarty.net/docsv2/es/variable.request.use.auto.globals.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 12:15:54 GMT
...
<html lang="en">
  <head>
    ...
    <title>$request_use_auto_globals | Smarty</title>
...
<a accesskey="p" href="variable.request.vars.order.tpl">Prev</a> </td>
...
<p>
    ...
    que hacen uso de 
    <a class="link" href="language.variables.smarty.tpl" title="La variable reservada {$smarty}">{$smarty.request.*}, {$smarty.get.*}</a> etc. .
    Atención: Si usted asigna $request_use_auto_globals a true,
    <a class="link" href="variable.request.vars.order.tpl" title="$request_vars_order">variable.request.vars.order </a> 
    no tendran efecto los valores de configuracion de php 
    <code class="literal">gpc_order</code> sera usados.
      </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $error_reporting</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 9 plus 19? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/variable.request.use.auto.globals.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03391 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
