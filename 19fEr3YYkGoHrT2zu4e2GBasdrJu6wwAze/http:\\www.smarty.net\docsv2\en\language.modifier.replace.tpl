...
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 10:40:16 GMT
...
<p>
     ...
     <a class="ulink" href="http://php.net/str_replace" target="_top">
     <code class="varname">str_replace()</code></a> function.
  </p>
...
<div class="example">
<a name="id2792545"></a><p class="title"><b>Example 5.16. replace</b></p>
...
<td width="40%" align="right" valign="top"> spacify</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/language.modifier.replace.tpl">
            </form>
            </div>
          </div>
