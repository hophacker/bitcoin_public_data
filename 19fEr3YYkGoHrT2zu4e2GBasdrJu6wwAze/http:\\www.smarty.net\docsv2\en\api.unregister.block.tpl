http://www.smarty.net/docsv2/en/api.unregister.block.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 10:42:40 GMT
...
<h2>Name</h2>
<p>unregister_block() — dynamically unregister block function plugins</p>
</div>
<div class="refsect1" title="Description">
<a name="id2861574"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">unregister_block</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">name</span></span>);</code><p>
   ...
   <a class="link" href="plugins.block.functions.tpl" title="Block Functions">block function plugin</a>.
   Pass in the block function <em class="parameter"><code>name</code></em>.
  </p>
<p>
      See also
      <a class="link" href="api.register.block.tpl" title="register_block()"><code class="varname">register_block()</code></a>
      and
...
<td width="40%" align="right" valign="top"> unregister_compiler_function()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 4 plus 17? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/api.unregister.block.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01723 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
