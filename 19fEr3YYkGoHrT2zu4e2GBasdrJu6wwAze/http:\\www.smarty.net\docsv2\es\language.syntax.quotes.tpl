http://www.smarty.net/docsv2/es/language.syntax.quotes.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 21:18:41 GMT
...
<html lang="en">
  <head>
    ...
    <title>Colocando variables entre comillas dobles | Smarty</title>
...
<tr><th colspan="3" align="center">Colocando variables entre comillas dobles</th></tr>
<tr>
...
<div class="sect1" title="Colocando variables entre comillas dobles">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.syntax.quotes"></a>Colocando variables entre comillas dobles</h2></div></div></div>
<p>
  Smarty puede reconocer <a class="link" href="language.syntax.variables.tpl" title="Variables">variables</a> 
  <a class="link" href="api.assign.tpl" title="assign()">asignadas</a> entre comillas aunque estas 
  solo tengan números, letras, guiones bajos y corchetes[].
  Con cualquier otro carácter(puntos, referencia de objetos, etc.) las 
  variables deben estar entre apostrofos.
  Usted no puede incrustar <a class="link" href="language.modifiers.tpl" title="Chapter 5. Modificadores de variables">modificadores</a>,
  Estos deben ser siempre aplicados fuera de las comillas.

 </p>
<div class="example">
<a name="id3065310"></a><p class="title"><b>Example 3.5. Sintaxis entre comillas</b></p>
...
<br class="example-break"><p>
  Ver también <a class="link" href="language.modifier.escape.tpl" title="escape">escape</a>.
 </p>
</div>
<div class="navfooter">
<hr>
...
<tr>
<td width="40%" align="left" valign="top">Atributos </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Matemáticas</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.syntax.quotes.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01822 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
