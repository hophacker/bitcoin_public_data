http://www.smarty.net/docsv2/fr/api.register.object.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 02:19:43 GMT
...
<html lang="en">
  <head>
    ...
    <title>register_object() | Smarty</title>
...
<tr><th colspan="3" align="center">register_object()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.register.modifier.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Méthodes</th>
<td width="20%" align="right"> <a accesskey="n" href="api.register.outputfilter.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="register_object()">
<a name="api.register.object"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>register_object() — Enregistre un objet à utiliser dans un template</p>
</div>
<div class="refsect1" title="Description">
<a name="id3014310"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">register_object</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">object_name</span></span>,<br>                     <span class="methodparam"><span class="type">object </span><span class="parameter">object</span></span>,<br>                     <span class="methodparam"><span class="type">array </span><span class="parameter">allowed_methods_properties</span></span>,<br>                     <span class="methodparam"><span class="type">boolean </span><span class="parameter">format</span></span>,<br>                     <span class="methodparam"><span class="type">array </span><span class="parameter">block_methods</span></span>);</code><p>
   Reportez-vous à la section
   <a class="link" href="advanced.features.tpl#advanced.features.objects" title="Objets">objet</a> de
   ce manuel pour plus d'informations.
  </p>
<p>
   Voir aussi
   <a class="link" href="api.get.registered.object.tpl" title="get_registered_object()"><code class="varname">get_registered_object()</code></a> et
   <a class="link" href="api.unregister.object.tpl" title="unregister_object()"><code class="varname">unregister_object()</code></a>.
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right"> <a accesskey="n" href="api.register.outputfilter.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">register_modifier() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> register_outputfilter()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 1 plus 9? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="3deefab5af187cee684e15424bd9dde0">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/api.register.object.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01927 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
