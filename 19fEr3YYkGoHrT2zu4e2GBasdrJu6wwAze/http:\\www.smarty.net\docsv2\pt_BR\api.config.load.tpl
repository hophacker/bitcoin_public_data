http://www.smarty.net/docsv2/pt_BR/api.config.load.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 01:39:42 GMT
...
<a name="api.config.load"></a>config_load</h2></div></div></div>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">config_load</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">file</span></span>,<br>                 <span class="methodparam"><span class="type">string </span><span class="parameter">section</span></span>);</code><p>
			...
			template. Isso funciona idêntico a função <a class="link" href="language.function.config.load.tpl" title="config_load">
			config_load</a>.
			</p>
...
<p>
		   ...
		   também são compilados para execução rápida, e repeita o <a class="link" href="variable.force.compile.tpl" title="$force_compile">force_compile</a> e <a class="link" href="variable.compile.check.tpl" title="$compile_check">compile_check</a> parâmetros de configuração.
    	  </p>
</div>
<div class="example">
<a name="id2757550"></a><p class="title"><b>Example 13.11. config_load</b></p>
<div class="example-contents"><pre class="programlisting">
// load config variables and assign them
$smarty-&gt;config_load('my.conf');

// load a section
$smarty-&gt;config_load('my.conf','foobar');</pre></div>
</div>
...
<td width="40%" align="right" valign="top"> display</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 18 plus 0? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/api.config.load.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01869 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
