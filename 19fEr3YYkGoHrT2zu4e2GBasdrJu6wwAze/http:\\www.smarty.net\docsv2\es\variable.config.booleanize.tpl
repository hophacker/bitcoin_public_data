http://www.smarty.net/docsv2/es/variable.config.booleanize.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 07:37:41 GMT
...
<p>
    Si es asignado true, los valores del archivo de configuración de
    on/true/yes y off/false/no se convierten en valores booleanos
    automáticamente. De esta forma usted puede usar los valores en un 
    template como: {if #foobar#} ... {/if}. Si foobar estuviera on, 
    true o yes, la condición {if} se ejecutara. true es el default.
      </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $config_read_hidden</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/variable.config.booleanize.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.18964 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
