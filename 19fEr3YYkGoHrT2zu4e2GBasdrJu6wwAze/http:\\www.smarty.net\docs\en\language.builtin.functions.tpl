...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 13:57:59 GMT
...
<html lang="en">
  <head>
    ...
    <title>Chapter 7. Built-in Functions | Smarty</title>
    <meta name="description" content="Chapter 7. Built-in Functions">
    <meta name="keywords" content="chapter, 7, built, in, functions">
...
<p>
  ...
  <a class="link" href="language.custom.functions.tpl" title="Chapter 8. Custom Functions">custom functions</a>
...
<p>
 ...
 much like the <a class="link" href="language.function.assign.tpl" title="{assign}">
...
<div class="example">
<a name="idp7804704"></a><p class="title"><b>Example 7.1. Simple assignment</b></p>
...
<a name="idp7807632"></a><p class="title"><b>Example 7.2. Assignment with math</b></p>
...
<br class="example-break"><div class="example">
<a name="idp7809264"></a><p class="title"><b>Example 7.3. Assignment of an array element</b></p>
<div class="example-contents"><pre class="programlisting">
...
<br class="example-break"><div class="example">
<a name="idp7810784"></a><p class="title"><b>Example 7.4. Assignment of an multidimensional array element</b></p>
<div class="example-contents"><pre class="programlisting">
...
<br class="example-break"><div class="example">
<a name="idp7812368"></a><p class="title"><b>Example 7.5. Appending an array</b></p>
<div class="example-contents"><pre class="programlisting">
...
<br class="example-break"><div class="example">
<a name="idp7813904"></a><p class="title"><b>Example 7.6. Assigment in the scope of calling template</b></p>
<div class="example-contents">
...
<br class="example-break"><p>
  See also <a class="link" href="language.function.assign.tpl" title="{assign}"><code class="varname">{assign}</code></a>
  and
...
<td width="40%" align="right" valign="top"> {append}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/language.builtin.functions.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01996 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
