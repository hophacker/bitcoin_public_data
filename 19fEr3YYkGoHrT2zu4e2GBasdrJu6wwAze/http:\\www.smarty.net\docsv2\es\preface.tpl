http://www.smarty.net/docsv2/es/preface.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 19:31:03 GMT
...
<tr><th colspan="3" align="center">Prólogo</th></tr>
<tr>
...
<a name="preface"></a>Prólogo</h2></div></div></div>
<p>
...
<p>
   ...
   Así nosotros escribimos un motor que es <span class="productname">SmartTemplate
   </span>™ nunca volvio a existir(nota: esa clase nunca fue
...
<td width="40%" align="right" valign="top"> Part I. Iniciando</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/preface.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02578 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
