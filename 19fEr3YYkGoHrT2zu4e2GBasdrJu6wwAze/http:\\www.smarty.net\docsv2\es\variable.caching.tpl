http://www.smarty.net/docsv2/es/variable.caching.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 12:23:00 GMT
...
<th width="60%" align="center">Chapter 12. Clase Variables de Smarty</th>
...
<p>
    ...
    en el <a class="link" href="variable.cache.dir.tpl" title="$cache_dir">$cache_dir</a>.
    ...
    <a class="link" href="caching.multiple.caches.tpl" title="Multiples caches por pagina">multiples</a> caches para el mismo template. 
    Un valor de 1 o 2 caching habilitados.
    1 anuncia a Smarty para usar la variable actual 
    <a class="link" href="variable.cache.lifetime.tpl" title="$cache_lifetime">$cache_lifetime</a> hasta 
    determinar si el cache expiro. Un valor 2 anuncia a Smarty para usar 
    el valor <a class="link" href="variable.cache.lifetime.tpl" title="$cache_lifetime">$cache_lifetime</a> 
    al tiempo en que le cache fue generado.
    De esta manera usted puede determinar el <a class="link" href="variable.cache.lifetime.tpl" title="$cache_lifetime">$cache_lifetime</a> inmediatamente 
    antes de  <a class="link" href="api.fetch.tpl" title="fetch()">buscar</a> el template para tener 
    el control cuando este cache en particular expira. 
    Vea también <a class="link" href="api.is.cached.tpl" title="is_cached()">is_cached()</a>.
      </p>
<p>
       Si <a class="link" href="variable.compile.check.tpl" title="$compile_check">$compile_check</a> está habilitado, 
       ...
       Si <a class="link" href="variable.force.compile.tpl" title="$force_compile">$force_compile</a> está habilitado, 
       el contenido del cache siempre sera regenerado.
      </p>
<p>
  Ver También 
  <a class="link" href="variable.cache.dir.tpl" title="$cache_dir">$cache_dir</a>,
  <a class="link" href="variable.cache.lifetime.tpl" title="$cache_lifetime">$cache_lifetime</a>,
  <a class="link" href="variable.cache.handler.func.tpl" title="$cache_handler_func">$cache_handler_func</a>,
  <a class="link" href="variable.cache.modified.check.tpl" title="$cache_modified_check">$cache_modified_check</a>
y <a class="link" href="caching.tpl" title="Chapter 14. Cache">Caching section</a>.
</p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $cache_dir</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="39bbda603239e4eb76989285db416208">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/variable.caching.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02275 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
