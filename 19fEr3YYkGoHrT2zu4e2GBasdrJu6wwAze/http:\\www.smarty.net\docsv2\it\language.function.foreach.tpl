http://www.smarty.net/docsv2/it/language.function.foreach.tpl
HTTP/1.1 200 OK
Date: Sat, 26 Jul 2014 19:14:59 GMT
...
<td>Array sul quale viene eseguito il ciclo</td>
</tr>
<tr>
...
<td align="center">sì</td>
<td align="center"><span class="emphasis"><em>nessuno</em></span></td>
<td>Nome della variabile che rappresenta
                        	l'elemento attuale</td>
</tr>
<tr>
...
<td align="center"><span class="emphasis"><em>nessuno</em></span></td>
<td>Nome della variabile che rappresenta la chiave attuale</td>
</tr>
<tr>
...
<td align="center">no</td>
<td align="center"><span class="emphasis"><em>nessuno</em></span></td>
<td>Nome del ciclo foreach per l'accesso alle sue proprietà</td>
</tr>
</tbody>
</table></div>
<p>
			I cicli <span class="emphasis"><em>foreach</em></span> sono un'alternativa ai cicli
			<span class="emphasis"><em>section</em></span>. <span class="emphasis"><em>foreach</em></span> si usa
			per ciclare su un singolo array associativo. La sintassi di
			<span class="emphasis"><em>foreach</em></span> è molto più semplice di
			<span class="emphasis"><em>session</em></span>, ma in compenso può essere usata solo
			per un array singolo. I tag <span class="emphasis"><em>foreach</em></span> devono
			essere chiusi con <span class="emphasis"><em>/foreach</em></span>. I parametri
			obbligatori sono <span class="emphasis"><em>from</em></span> e <span class="emphasis"><em>item</em></span>.
			Il nome del ciclo foreach può essere quello che preferite, composto
			di lettere, numeri e underscore. I cicli <span class="emphasis"><em>foreach</em></span>
			possono essere nidificati, ma i nomi dei cicli nidificati devono
			essere diversi tra di loro. La variabile <span class="emphasis"><em>from</em></span>
			(di solito un array di valori) determina quante volte verrà eseguito
			il ciclo <span class="emphasis"><em>foreach</em></span>.
			<span class="emphasis"><em>foreachelse</em></span> viene eseguito quando non ci sono
			valori nella variabile <span class="emphasis"><em>from</em></span>.
			</p>
<div class="example">
<a name="id3105021"></a><p class="title"><b>Example 7.4. foreach</b></p>
...
<a name="id3105037"></a><p class="title"><b>Example 7.5. foreach con key</b></p>
<div class="example-contents"><pre class="programlisting">
...
<br class="example-break"><p>
		...
		dove foreachname è il nome indicato come attributo <span class="emphasis"><em>name</em></span>
		del foreach
		</p>
...
<p>
        	<span class="emphasis"><em>first</em></span> vale true quando l'iterazione attuale è la prima del ciclo.
			</p>
</div>
...
<p>
        	<span class="emphasis"><em>last</em></span> vale true quando l'iterazione attuale è l'ultima del ciclo.
			</p>
</div>
...
<p>
        	<span class="emphasis"><em>show</em></span> si usa come parametro per il foreach.
        	<span class="emphasis"><em>show</em></span> è un valore booleano, true o false. Quando
...
<p>
			<span class="emphasis"><em>total</em></span> si usa per visualizzare il numero di iterazioni che il
...
<td width="40%" align="right" valign="top"> include</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/language.function.foreach.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02036 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
