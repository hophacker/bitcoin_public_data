http://www.smarty.net/docsv2/es/api.register.prefilter.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 11:41:27 GMT
...
<html lang="en">
  <head>
    ...
    <title>register_prefilter() | Smarty</title>
...
<tr><th colspan="3" align="center">register_prefilter()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.register.postfilter.tpl">Prev</a> </td>
...
<div class="refentry" title="register_prefilter()">
<a name="api.register.prefilter"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>register_prefilter() — Registra dinamicamente prefiltros</p>
</div>
<div class="refsect1" title="Descripción">
<a name="id3134846"></a><h2> Descripción</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">register_prefilter</span>(<span class="methodparam"><span class="type">mixed </span><span class="parameter">function</span></span>);</code><p>
   Use esto para registrar 
   <a class="link" href="advanced.features.prefilters.tpl" title="Prefilters">prefiltros</a> 
   dinámicamente para correr templates antes de que estos sean compilados. 
   Vea <a class="link" href="advanced.features.prefilters.tpl" title="Prefilters">template prefilters</a>
   para mayores informes de como configurar una función de prefiltering.
  </p>
<p>
   La llamada de la funcion-php <em class="parameter"><code>function</code></em> puede ser:
  </p>
...
<li class="listitem"><p>
       ...
       <code class="literal">array(&amp;$object, $method)</code> con
       <code class="literal">&amp;$object</code> siendo una referencia para un
       objeto y <code class="literal">$method</code> siendo una cadena conteniendo
       el nombre de un método 
     </p></li>
<li class="listitem"><p>
       un arreglo con la forma 
      <code class="literal">array(&amp;$class, $method)</code> con
      <code class="literal">$class</code> siendo un nombre de clase y
      <code class="literal">$method</code> siendo un método de esta clase.
     </p></li>
</ol></div>
<p>
    Ver también
    <a class="link" href="api.unregister.prefilter.tpl" title="unregister_prefilter()">unregister_prefilter()</a>,
    <a class="link" href="api.register.postfilter.tpl" title="register_postfilter()">register_postfilter()</a>,
    <a class="link" href="api.register.outputfilter.tpl" title="register_outputfilter()">register_ouputfilter()</a>,
    <a class="link" href="api.load.filter.tpl" title="load_filter()">load_filter()</a>,
    <a class="link" href="variable.autoload.filters.tpl" title="$autoload_filters">$autoload_filters</a>
    y <a class="link" href="advanced.features.outputfilters.tpl" title="Filtros de salida">template output filters</a>.
    </p>
</div>
</div>
<div class="navfooter">
...
<tr>
<td width="40%" align="left" valign="top">register_postfilter() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> register_resource</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 4 plus 12? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="90efb6ecf7c58791bdf1606ed6cb144b">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/api.register.prefilter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02899 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
