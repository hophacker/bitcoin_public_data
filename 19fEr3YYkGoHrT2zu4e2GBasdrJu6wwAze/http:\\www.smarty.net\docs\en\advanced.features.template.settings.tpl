http://www.smarty.net/docs/en/advanced.features.template.settings.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 19:31:33 GMT
...
<html lang="en">
  <head>
    ...
    <title>Changing settings by template | Smarty</title>
    <meta name="description" content="Changing settings by template">
    <meta name="keywords" content="changing, settings, by, template">
...
<tr><th colspan="3" align="center">Changing settings by template</th></tr>
<tr>
...
<div class="sect1" title="Changing settings by template">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="advanced.features.template.settings"></a>Changing settings by template</h2></div></div></div>
<p>
  Normally you configure the Smarty settings by modifying the <a class="link" href="api.variables.tpl" title="Chapter 13. Smarty Class Variables"><code class="varname">Smarty class variables</code></a>. Furthermore
  you can register plugins, filters etc. with <a class="link" href="api.functions.tpl" title="Chapter 14. Smarty Class Methods"><code class="varname">Smarty functions</code></a>. Modifications done to the Smarty object
...
<div class="example">
<a name="idp19212624"></a><p class="title"><b>Example 17.4. changing Smarty settings by template</b></p>
...
<div class="example">
<a name="idp19215136"></a><p class="title"><b>Example 17.5. register plugins by template</b></p>
<div class="example-contents"><pre class="programlisting">
...
<tr>
<td width="40%" align="left" valign="top">Chapter 17. Advanced Features </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Template Inheritance</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/advanced.features.template.settings.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02938 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
