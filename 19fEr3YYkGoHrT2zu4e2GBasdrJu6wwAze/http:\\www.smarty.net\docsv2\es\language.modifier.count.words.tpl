http://www.smarty.net/docsv2/es/language.modifier.count.words.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 12:25:06 GMT
...
<div class="example">
<a name="id3070610"></a><p class="title"><b>Example 5.7. count_words</b></p>
...
<br class="example-break"><p>
   ver también <a class="link" href="language.modifier.count.characters.tpl" title="count_characters">count_characters</a>,
   <a class="link" href="language.modifier.count.paragraphs.tpl" title="count_paragraphs">count_paragraphs</a> y 
   <a class="link" href="language.modifier.count.sentences.tpl" title="count_sentences">count_sentences</a>.
  </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> date_format</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 4 plus 20? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.modifier.count.words.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02309 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
