...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 09:51:22 GMT
...
<p>
  ...
  le dÃ©bogage. <code class="literal">NONE</code> signifie qu'aucune
  mÃ©thode alternative n'est autorisÃ©e. <code class="literal">URL</code>
  signifie que si <code class="literal">SMARTY_DEBUG</code> se
  trouve dans <code class="literal">QUERY_STRING</code>, le dÃ©bogage
  est activÃ© Ã  l'invocation du script. Si
  <a class="link" href="variable.debugging.tpl" title="$debugging">$debugging</a>
  est Ã  <code class="constant">TRUE</code>, cette valeur est sans effet.
 </p>
<div class="example">
<a name="id2995236"></a><p class="title"><b>Example 12.3. $debugging_ctrl sur localhost</b></p>
...
<br class="example-break"><p>
  Voir aussi
  la <a class="link" href="chapter.debugging.console.tpl" title="Chapter 10. Console de débogage">console de dÃ©bogage</a> et
...
<td width="40%" align="right" valign="top"> $autoload_filters</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/variable.debugging.ctrl.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02085 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
