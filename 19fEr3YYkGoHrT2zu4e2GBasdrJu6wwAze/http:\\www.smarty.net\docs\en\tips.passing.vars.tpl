http://www.smarty.net/docs/en/tips.passing.vars.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 11:41:23 GMT
...
<html lang="en">
  <head>
    ...
    <title>Passing variable title to header template | Smarty</title>
    <meta name="description" content="Passing variable title to header template">
    <meta name="keywords" content="passing, variable, title, to, header, template">
...
<tr><th colspan="3" align="center">Passing variable title to header template</th></tr>
<tr>
...
<div class="sect1" title="Passing variable title to header template">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="tips.passing.vars"></a>Passing variable title to header template</h2></div></div></div>
<p>
    When the majority of your templates use the same headers and footers, it
    is common to split those out into their own templates and
    <a class="link" href="language.function.include.tpl" title="{include}">
    ...
    as an <a class="link" href="language.syntax.attributes.tpl" title="Attributes">attribute</a> when
    it is included.
   </p>
<div class="example">
<a name="idp20406736"></a><p class="title"><b>Example 21.3. Passing the title variable to the header template</b></p>
<div class="example-contents">
<p>
    <code class="filename">mainpage.tpl</code> - When the main page is drawn,
...
<p>
    <code class="filename">header.tpl</code> - Notice that <span class="quote">“<span class="quote">Smarty News</span>”</span> is
    printed if the <code class="literal">$title</code> variable is not set, using the
    <a class="link" href="language.modifier.default.tpl" title="default"><code class="varname">default</code></a>
    variable modifier.
    </p>
<pre class="programlisting">
...
<tr>
<td width="40%" align="left" valign="top">Default Variable Handling </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Dates</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 17 plus 0? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/tips.passing.vars.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02183 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
