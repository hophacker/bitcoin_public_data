http://www.smarty.net/docsv2/it/api.unregister.prefilter.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 03:42:18 GMT
...
<h2>Name</h2>
<p>unregister_prefilter</p>
</div>
<div class="refsect1">
<a name="id3147468"></a><h2></h2>
...
<td width="40%" align="right" valign="top"> unregister_resource</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/api.unregister.prefilter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01589 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
