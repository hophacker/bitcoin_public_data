http://www.smarty.net/docs/en/bugs.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 09:51:14 GMT
...
<p>
   Check the <code class="filename">BUGS</code> file that comes with
...
<tr>
<td width="40%" align="left" valign="top">Chapter 22. Resources </td>
...
<td width="40%" align="right" valign="top"> </td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 12 plus 17? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/bugs.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03523 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
