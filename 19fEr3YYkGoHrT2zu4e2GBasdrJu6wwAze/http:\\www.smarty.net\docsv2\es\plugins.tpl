http://www.smarty.net/docsv2/es/plugins.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 19:58:06 GMT
...
<html lang="en">
  <head>
    ...
    <title>Chapter 16. Extendiendo Smarty con plugins | Smarty</title>
...
<tr><th colspan="3" align="center">Chapter 16. Extendiendo Smarty con plugins</th></tr>
<tr>
...
<div class="chapter" title="Chapter 16. Extendiendo Smarty con plugins">
<div class="titlepage"><div><div><h2 class="title">
<a name="plugins"></a>Chapter 16. Extendiendo Smarty con plugins</h2></div></div></div>
<div class="toc">
...
<li class="listitem">funciones</li>
<li class="listitem">modificadores</li>
<li class="listitem">funciones de bloque</li>
<li class="listitem">funciones de compilación</li>
<li class="listitem">prefiltros</li>
<li class="listitem">postfiltros</li>
<li class="listitem">filtros de salida</li>
<li class="listitem">recursos(fuentes)</li>
...
<p>
   ...
   <code class="literal">$custom_funcs</code>, <code class="literal">$custom_mods</code>, y otras 
...
<div class="sect1" title="Como funcionan los Plugins">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="plugins.howto"></a>Como funcionan los Plugins</h2></div></div></div>
<p>
...
<p>
    El <a class="link" href="variable.plugins.dir.tpl" title="$plugins_dir">directorio de directory</a> 
...
<tr>
<td width="40%" align="left" valign="top">Recursos </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Nombres convencionales</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 2 plus 20? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="c765fffe6b0fbfe416b3641e230401ac">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/plugins.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02041 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
