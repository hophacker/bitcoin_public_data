http://www.smarty.net/docsv2/fr/api.assign.by.ref.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 03:32:07 GMT
...
<html lang="en">
  <head>
    ...
    <title>assign_by_ref() | Smarty</title>
...
<h2>Name</h2>
<p>assign_by_ref() — Assigne des valeurs par référence</p>
</div>
<div class="refsect1" title="Description">
<a name="id3005473"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">assign_by_ref</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">varname</span></span>,<br>                   <span class="methodparam"><span class="type">mixed </span><span class="parameter">var</span></span>);</code><p>
   Utilisée pour <a class="link" href="api.assign.tpl" title="assign()">assigner</a> des valeurs aux
   templates par référence plutôt que par copie. Référez-vous au manuel PHP
   pour une explication plus précise sur les références des variables.
 </p>
...
<p>
   ...
   Pour les <a class="link" href="advanced.features.tpl#advanced.features.objects" title="Objets">objets</a>, 
   <code class="varname">assign_by_ref()</code> ne fait pas de copie en mémoire de l'objet
   assigné. Référez-vous au manuel PHP pour une explication plus précise sur
   les références de variable.
  </p>
</div>
<div class="example">
<a name="id3006978"></a><p class="title"><b>Example 13.4. Exemple avec assign_by_ref()</b></p>
...
<br class="example-break"><p>
   ...
   <a class="link" href="api.clear.all.assign.tpl" title="clear_all_assign()"><code class="varname">clear_all_assign()</code></a>,
   <a class="link" href="api.append.tpl" title="append()"><code class="varname">append()</code></a>,
   <a class="link" href="language.custom.functions.tpl#language.function.assign" title="{assign}"><code class="varname">{assign}</code></a> et
    <a class="link" href="api.get.template.vars.tpl" title="get_template_vars()"><code class="varname">get_template_vars()</code></a>.
   </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> clear_all_assign()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 20 plus 2? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/api.assign.by.ref.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02399 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
