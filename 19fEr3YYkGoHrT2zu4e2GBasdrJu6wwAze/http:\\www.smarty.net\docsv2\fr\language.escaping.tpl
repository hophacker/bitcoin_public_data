http://www.smarty.net/docsv2/fr/language.escaping.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 23:37:06 GMT
...
<html lang="en">
  <head>
    ...
    <title>Désactiver l'analyse de Smarty | Smarty</title>
...
<tr><th colspan="3" align="center">Désactiver l'analyse de Smarty</th></tr>
<tr>
...
<div class="sect1" title="Désactiver l'analyse de Smarty">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.escaping"></a>Désactiver l'analyse de Smarty</h2></div></div></div>
<p>
  ...
  <a class="link" href="language.function.ldelim.tpl" title="{ldelim},{rdelim}">délimiteurs</a> Smarty par défaut.
 </p>
<p>
...
<p>
  ...
  <a class="link" href="language.function.literal.tpl" title="{literal}"><code class="varname">{literal} .. {/literal}</code></a>.
  Similairement à l'utilisation d'entités HTML, vous pouvez utiliser
  <a class="link" href="language.function.ldelim.tpl" title="{ldelim},{rdelim}"><code class="varname">{ldelim}</code></a> et
  <a class="link" href="language.function.ldelim.tpl" title="{ldelim},{rdelim}"><code class="varname">{rdelim}</code></a>, ou
  <a class="link" href="language.variables.smarty.tpl#language.variables.smarty.ldelim" title="{$smarty.ldelim}, {$smarty.rdelim}"><code class="varname">{$smarty.ldelim}</code></a> 
  pour afficher les délimiteurs.
 </p>
<p>
  Il est souvent plus simple de modifier les délimiteurs de Smarty :
  <a class="link" href="variable.left.delimiter.tpl" title="$left_delimiter"><em class="parameter"><code>$left_delimiter</code></em></a> et
  <a class="link" href="variable.right.delimiter.tpl" title="$right_delimiter"><em class="parameter"><code>$right_delimiter</code></em></a>.
  </p>
<div class="example">
<a name="id2931162"></a><p class="title"><b>Example 3.8. Exemple de changement de délimiteur</b></p>
...
<tr>
<td width="40%" align="left" valign="top">Opérations mathématiques </td>
...
<td width="40%" align="right" valign="top"> Chapter 4. Variables</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 16 plus 17? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="309ddd7dac71f8d9ad37025d864c49f1">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/language.escaping.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02575 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
