http://www.smarty.net/docsv2/fr/variable.compiler.class.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 17:50:57 GMT
...
<td width="40%" align="right" valign="top"> $request_vars_order</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/variable.compiler.class.tpl">
            </form>
            </div>
          </div>
