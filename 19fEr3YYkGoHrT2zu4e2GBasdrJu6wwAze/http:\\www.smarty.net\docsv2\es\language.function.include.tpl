http://www.smarty.net/docsv2/es/language.function.include.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 18:04:57 GMT
...
<div class="example">
<a name="id3083183"></a><p class="title"><b>Example 7.7. funcion {include}</b></p>
...
<div class="example">
<a name="id3083199"></a><p class="title"><b>Example 7.8. Función {include} pasando variables</b></p>
...
<a name="id3083247"></a><p class="title"><b>Example 7.9. {include} y asignacion de variables</b></p>
<div class="example-contents">
...
<br class="example-break"><p>
			 Use la sintaxis de  <a class="link" href="template.resources.tpl" title="Recursos">template resources</a> 
...
<div class="example">
<a name="id3083299"></a><p class="title"><b>Example 7.10. Ejemplos de recursos para la función include</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<p>
  ver también
  <a class="link" href="language.function.include.php.tpl" title="{include_php}">{include_php}</a>,
  <a class="link" href="language.function.php.tpl" title="{php}">{php}</a>,
  <a class="link" href="template.resources.tpl" title="Recursos">Template Resources</a> y
  <a class="link" href="tips.componentized.templates.tpl" title="Templates con Componetes">Componentized Templates</a>.
 </p>
</div>
</div>
...
<td width="40%" align="right" valign="top"> {include_php}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 12 plus 12? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.function.include.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02577 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
