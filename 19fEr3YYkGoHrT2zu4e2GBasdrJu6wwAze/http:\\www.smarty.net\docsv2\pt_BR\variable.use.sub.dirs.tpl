http://www.smarty.net/docsv2/pt_BR/variable.use.sub.dirs.tpl
HTTP/1.1 200 OK
Date: Sat, 26 Jul 2014 19:15:04 GMT
...
<td width="40%" align="right" valign="top"> $default_modifiers</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="2ad2d5643cfd6d32adb543e4f8d0aaa6">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/variable.use.sub.dirs.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01898 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
