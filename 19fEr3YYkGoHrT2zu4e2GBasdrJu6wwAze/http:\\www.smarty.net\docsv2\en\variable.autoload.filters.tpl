http://www.smarty.net/docsv2/en/variable.autoload.filters.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 14:31:17 GMT
...
<td width="40%" align="right" valign="top"> $compile_check</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/variable.autoload.filters.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03505 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
