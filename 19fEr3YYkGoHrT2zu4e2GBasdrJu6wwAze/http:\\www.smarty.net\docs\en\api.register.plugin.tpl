...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 05:46:07 GMT
...
<a name="idp16718816"></a><h2>Description</h2>
...
<li class="listitem"><p>
     ...
     omitted in most cases. See <a class="link" href="caching.cacheable.tpl" title="Controlling Cacheability of Output">controlling cacheability of plugins output</a>
...
<div class="example">
<a name="idp16782656"></a><p class="title"><b>Example 14.39. register a function plugin</b></p>
...
<a name="idp16786208"></a><p class="title"><b>Example 14.40. register block function plugin</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<br class="example-break"><div class="example">
<a name="idp16789760"></a><p class="title"><b>Example 14.41. register modifier plugin</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<p>In the template, use <code class="literal">ss</code> to strip slashes.</p>
<pre class="programlisting">
...
<a class="link" href="plugins.functions.tpl" title="Template Functions">plugin functions</a>,
<a class="link" href="plugins.block.functions.tpl" title="Block Functions">plugin block functions</a>,
<a class="link" href="plugins.compiler.functions.tpl" title="Compiler Functions">plugin compiler functions</a>,
 and the
 <a class="link" href="plugins.modifiers.tpl" title="Modifiers">creating plugin modifiers</a> section.
</p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> registerObject()</td>
          ...
          <div class="commentInfo">
              ...
              <div class="commentAuthor">by <b>Karl</b> on Nov  1, 2011 at  9:48</div>
              <div class="commentBody"><strong>Example 14.40. register block function plugin</strong> 

<pre class="code">function do_translation ($params, $content, $smarty, &amp;$repeat, $template)</pre>

The last parameter ($template) is not used (with 3.1.4 at least)</div>
            </div>
                      <div class="commentWrapperEven">
              <div class="commentAuthor">by <b>raveren</b> on Oct 25, 2011 at  5:43</div>
              <div class="commentBody">Note, that this (sadly) does not support closures as the third parameter (v3.1.4):
...
&gt; Object of class Closure could not be converted to string
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/api.register.plugin.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02109 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
