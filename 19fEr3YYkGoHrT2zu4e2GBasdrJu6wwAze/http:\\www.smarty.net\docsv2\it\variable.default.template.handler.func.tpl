http://www.smarty.net/docsv2/it/variable.default.template.handler.func.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 06:24:39 GMT
...
<a accesskey="p" href="variable.config.fix.newlines.tpl">Prev</a> </td>
...
<p>
       Questa funzione viene chiamata quando Smarty non riesce a 
...
<tr>
<td width="40%" align="left" valign="top">$config_fix_newlines </td>
...
<td width="40%" align="right" valign="top"> $php_handling</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="8f2d604c68395cdbaad659d387616635">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/variable.default.template.handler.func.tpl">
            </form>
            </div>
          </div>
