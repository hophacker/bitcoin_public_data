...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 11:41:45 GMT
...
<p>
   <code class="varname">{ldelim}</code> and <code class="varname">{rdelim}</code> are used for
   <a class="link" href="language.escaping.tpl" title="Escaping Smarty Parsing">escaping</a>
   template delimiters, by default
   <span class="bold"><strong>{</strong></span> and <span class="bold"><strong>}</strong></span>.
   You can also use <a class="link" href="language.function.literal.tpl" title="{literal}"><code class="varname">{literal}{/literal}</code></a>
   to escape blocks of text eg Javascript or CSS.
    See also the complimentary <a class="link" href="language.variables.smarty.tpl#language.variables.smarty.ldelim" title="{$smarty.ldelim}, {$smarty.rdelim}"><em class="parameter"><code>{$smarty.ldelim}</code></em></a>.
  </p>
<div class="example">
<a name="idp9426800"></a><p class="title"><b>Example 7.57. {ldelim}, {rdelim}</b></p>
...
<p>Another example with some Javascript</p>
<pre class="programlisting">
...
<a name="idp9432352"></a><p class="title"><b>Example 7.58. Another Javascript example</b></p>
...
<br class="example-break"><p>See also
  ...
  and <a class="link" href="language.escaping.tpl" title="Escaping Smarty Parsing">escaping Smarty parsing</a>.
  </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> {literal}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/language.function.ldelim.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02611 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
