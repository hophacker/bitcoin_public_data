http://www.smarty.net/docsv2/fr/language.function.debug.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 17:51:12 GMT
...
<p>
  <code class="varname">{debug}</code> amène la console de débogage sur la page.
  Fonctionne quelle que soit la valeur du paramètre
  <a class="link" href="chapter.debugging.console.tpl" title="Chapter 10. Console de débogage">debug</a> de Smarty.
  Comme ce dernier est appelé lors de l'exécution, il n'est capable
  d'afficher que les variables <a class="link" href="api.assign.tpl" title="assign()">assignées</a>
...
<td>Type de sortie, html ou javascript</td>
</tr></tbody>
</table></div>
<p>
  Voir aussi
  <a class="link" href="chapter.debugging.console.tpl" title="Chapter 10. Console de débogage">la console de débogage</a>.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> {eval}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/language.function.debug.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03580 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
