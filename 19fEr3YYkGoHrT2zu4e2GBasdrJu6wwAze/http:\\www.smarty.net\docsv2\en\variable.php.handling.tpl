http://www.smarty.net/docsv2/en/variable.php.handling.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 15:51:23 GMT
...
<p>
       ...
       <code class="constant">SMARTY_PHP_PASSTHRU</code>. Note that this does NOT affect
       php code within <a class="link" href="language.function.php.tpl" title="{php}">
       <code class="varname">{php}{/php}</code></a> tags in the template.
      </p>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>
       <code class="constant">SMARTY_PHP_PASSTHRU</code> - Smarty echos tags as-is.
       </p></li>
<li class="listitem"><p>
       <code class="constant">SMARTY_PHP_QUOTE</code> - Smarty quotes the tags as
         html entities.
         </p></li>
<li class="listitem"><p>
       <code class="constant">SMARTY_PHP_REMOVE</code> - Smarty removes the tags from
         the templates.</p></li>
<li class="listitem"><p>
       <code class="constant">SMARTY_PHP_ALLOW</code> - Smarty will execute the tags
         as PHP code.</p></li>
</ul></div>
...
<p>
        ...
        Use <a class="link" href="plugins.functions.tpl" title="Template Functions">custom functions</a> or
        <a class="link" href="plugins.modifiers.tpl" title="Modifiers">modifiers</a> instead.
       </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> $security</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/variable.php.handling.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02346 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
