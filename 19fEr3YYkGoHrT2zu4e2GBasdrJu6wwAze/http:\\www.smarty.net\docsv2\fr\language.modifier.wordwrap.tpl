http://www.smarty.net/docsv2/fr/language.modifier.wordwrap.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 06:16:34 GMT
...
<th width="60%" align="center">Chapter 5. Modificateurs de variables</th>
...
<p>
  ...
  pour l'ajustement à la nouvelle ligne (retour chariot <code class="literal">"\n"</code> par défaut).
  Par défaut, <code class="varname">wordwrap</code> tente un ajustement à la fin d'un mot.
  Si vous voulez autoriser le découpage des mots pour un ajustement au caractère près,
  passez <code class="constant">TRUE</code> au troisième paramètre optionnel. Ceci est l'équivalent de la
  fonction PHP <a class="ulink" href="http://php.net/wordwrap" target="_top"><code class="varname">wordwrap()</code></a>.
 </p>
...
<thead><tr>
<th align="center">Position du paramètre</th>
...
<td>La nombre de colonnes sur lequel ajuster l'affichage.</td>
</tr>
<tr>
...
<td align="center">Non</td>
<td align="center">\n</td>
<td>chaîne de caractères utilisée pour l'ajustement.</td>
</tr>
<tr>
...
<td>Détermine si l'ajustement se fait en fin de mot
     (<code class="constant">FALSE</code>) ou au caractère exact (<code class="constant">TRUE</code>).</td>
</tr>
</tbody>
</table></div>
<div class="example">
<a name="id2944072"></a><p class="title"><b>Example 5.23. wordwrap</b></p>
...
<br class="example-break"><p>
  Voir aussi
  <a class="link" href="language.modifier.nl2br.tpl" title="nl2br"><code class="varname">nl2br</code></a> et
...
<td width="40%" align="right" valign="top"> Chapter 6. Combiner des modificateurs de variable.</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 7 plus 4? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="cb8e46a0119df3f005cffe4762c5302e">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/language.modifier.wordwrap.tpl">
            </form>
            </div>
          </div>
