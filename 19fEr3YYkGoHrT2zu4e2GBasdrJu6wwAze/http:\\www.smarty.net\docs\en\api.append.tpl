http://www.smarty.net/docs/en/api.append.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 05:33:55 GMT
...
<a name="idp15320128"></a><h2>Description</h2>
...
<div class="example">
<a name="idp15389648"></a><p class="title"><b>Example 14.4. append</b></p>
...
<td width="40%" align="right" valign="top"> appendByRef()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 7 plus 17? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/api.append.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02127 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
