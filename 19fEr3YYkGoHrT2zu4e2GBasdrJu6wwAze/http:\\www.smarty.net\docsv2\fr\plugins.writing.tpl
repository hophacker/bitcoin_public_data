http://www.smarty.net/docsv2/fr/plugins.writing.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 12:22:49 GMT
...
<html lang="en">
  <head>
    ...
    <title>Ecrire des plugins | Smarty</title>
...
<tr><th colspan="3" align="center">Ecrire des plugins</th></tr>
<tr>
...
<div class="sect1" title="Ecrire des plugins">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="plugins.writing"></a>Ecrire des plugins</h2></div></div></div>
<p>
...
<li class="listitem"><p>
 ...
 <em class="parameter"><code>$repeat</code></em> passé après l'objet Smarty afin de
...
<td width="40%" align="right" valign="top"> Les fonctions de templates</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 5 plus 5? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/plugins.writing.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02471 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
