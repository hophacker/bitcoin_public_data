http://www.smarty.net/docsv2/fr/plugins.outputfilters.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 03:41:57 GMT
...
<a name="plugins.outputfilters"></a>Filtres de sortie</h2></div></div></div>
<p>
...
<div class="example">
<a name="id3035721"></a><p class="title"><b>Example 16.9. Plugin de filtre de sortie</b></p>
...
<br class="example-break"><p>
  ...
  <code class="varname">register_outputfilter()</code></a> et
...
<tr>
<td width="40%" align="left" valign="top">filtres de pré-compilation/filtres de post-compilation </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Ressources</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/plugins.outputfilters.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01819 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
