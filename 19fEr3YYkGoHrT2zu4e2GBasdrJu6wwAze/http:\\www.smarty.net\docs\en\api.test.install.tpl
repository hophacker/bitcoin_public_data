...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 19:58:05 GMT
...
<h2>Name</h2>
<p>testInstall() — checks Smarty installation</p>
</div>
<div class="refsect1" title="Description">
<a name="idp17179136"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">testInstall</span>();</code><p>
   This function verifies that all required working folders of the Smarty installation can be accessed.
   It does output a corresponding protocoll.
  </p>
<div class="example">
<a name="idp17181712"></a><p class="title"><b>Example 14.52. testInstall()</b></p>
...
<td width="40%" align="right" valign="top"> Chapter 15. Caching</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/api.test.install.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02522 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
