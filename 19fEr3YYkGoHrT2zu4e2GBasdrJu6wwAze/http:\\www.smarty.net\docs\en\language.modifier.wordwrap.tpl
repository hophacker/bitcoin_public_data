...
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 10:40:30 GMT
...
<div class="example">
<a name="idp7120048"></a><p class="title"><b>Example 5.24. wordwrap</b></p>
...
<td width="40%" align="right" valign="top"> Chapter 6. Combining Modifiers</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/language.modifier.wordwrap.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02352 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
