...
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 06:25:06 GMT
...
<h2>Name</h2>
<p>clearAllAssign() — clears the values of all assigned variables</p>
</div>
<div class="refsect1" title="Description">
<a name="idp15512192"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">clearAllAssign</span>();</code><div class="example">
<a name="idp15514208"></a><p class="title"><b>Example 14.8. clearAllAssign()</b></p>
...
<td width="40%" align="right" valign="top"> clearAllCache()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/api.clear.all.assign.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02337 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
