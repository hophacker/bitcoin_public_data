...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 18:04:55 GMT
...
<div class="example">
<a name="id2792807"></a><p class="title"><b>Example 5.19. strip</b></p>
...
<td width="40%" align="right" valign="top"> strip_tags</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/language.modifier.strip.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01310 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
