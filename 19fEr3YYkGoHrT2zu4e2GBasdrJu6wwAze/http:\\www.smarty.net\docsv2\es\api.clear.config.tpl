http://www.smarty.net/docsv2/es/api.clear.config.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 12:23:05 GMT
...
<html lang="en">
  <head>
    ...
    <title>clear_config() | Smarty</title>
...
<tr><th colspan="3" align="center">clear_config()</th></tr>
<tr>
...
<div class="refentry" title="clear_config()">
<a name="api.clear.config"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>clear_config() — Esto limpia todas las variables de configuración</p>
</div>
<div class="refsect1" title="Descripción">
<a name="id3129033"></a><h2>Descripción</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">clear_config</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">var</span></span>);</code><p>
   Esto limpia todas las variables de 
   <a class="link" href="language.config.variables.tpl" title="Variables cargadas desde archivos de configuración">configuración asignadas</a>. 
   Si es proporcionado el nombre de una variable, solo esa variable es limpiada.
  </p>
<div class="example">
<a name="id3127935"></a><p class="title"><b>Example 13.10. clear_config()</b></p>
...
<br class="example-break"><p>
  ...
  <a class="link" href="api.config.load.tpl" title="config_load()">config_load()</a>
  y
  <a class="link" href="api.clear.assign.tpl" title="clear_assign()">clear_assign()</a>
  </p>
</div>
</div>
<div class="navfooter">
...
<tr>
<td width="40%" align="left" valign="top">clear_compiled_tpl() </td>
...
<td width="40%" align="right" valign="top"> config_load()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/api.clear.config.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02090 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
