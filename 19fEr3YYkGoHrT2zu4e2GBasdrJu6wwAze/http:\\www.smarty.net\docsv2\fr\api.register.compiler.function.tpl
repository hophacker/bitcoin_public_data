http://www.smarty.net/docsv2/fr/api.register.compiler.function.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 19:20:35 GMT
...
<th width="60%" align="center">Chapter 13. Méthodes</th>
...
<h2>Name</h2>
<p>register_compiler_function() — Déclare dynamiquement un plugin de fonction de compilation</p>
</div>
<div class="refsect1" title="Description">
<a name="id3012278"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">bool </span><span class="methodname">register_compiler_function</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">name</span></span>,<br>                                <span class="methodparam"><span class="type">mixed </span><span class="parameter">impl</span></span>,<br>                                <span class="methodparam"><span class="type">bool </span><span class="parameter">cacheable</span></span>);</code><p>
   Il faut passer en paramètres le nom de la <a class="link" href="plugins.compiler.functions.tpl" title="Fonctions de compilation">fonction
   de compilation</a>, suivi par la fonction PHP qui l'implémente.
  </p>
<p>
   La fonction PHP de callback <em class="parameter"><code>function</code></em> peut être soit :
   </p>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>
       Une chaîne de caractères contenant la fonction <em class="parameter"><code>name</code></em>
       </p></li>
<li class="listitem"><p>
       Un tableau sous la forme <code class="literal">array(&amp;$object, $method)</code> où
       <code class="literal">&amp;$object</code> est une référence d'objet et
       <code class="literal">$method</code> une chaîne contenant le nom de la méthode
       </p></li>
<li class="listitem"><p>
       Un tableau sous la forme
       <code class="literal">array($class, $method)</code> où
       <code class="literal">$class</code> est le nom de la classe et
       <code class="literal">$method</code> est une méthode de la classe.
       </p></li>
</ul></div>
<p>
  </p>
<p>
   Le paramètre <em class="parameter"><code>cacheable</code></em> peut être omis dans la
   plupart des cas. Voir <a class="link" href="caching.cacheable.tpl" title="Contrôler la mise en cache des sorties des Plugins">Contrôler la mise en cache des sorties des Plugins</a>
   pour plus d'informations concernant cette utilisation.
  </p>
<p>
   Voir aussi
   <a class="link" href="api.unregister.compiler.function.tpl" title="unregister_compiler_function()">
    <code class="varname">unregister_compiler_function()</code></a> et
   les <a class="link" href="plugins.compiler.functions.tpl" title="Fonctions de compilation">plugins de fonction de compilation</a>.
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> register_function()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/api.register.compiler.function.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02364 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
