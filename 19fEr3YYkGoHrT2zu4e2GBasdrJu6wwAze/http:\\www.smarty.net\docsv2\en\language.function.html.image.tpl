...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 09:51:39 GMT
...
<li class="listitem"><p>
  ...
  <a class="link" href="variable.secure.dir.tpl" title="$secure_dir">secure directory</a>.
 </p></li>
<li class="listitem"><p>
...
<div class="example">
<a name="id2822758"></a><p class="title"><b>Example 8.11. {html_image} example</b></p>
...
<td width="40%" align="right" valign="top"> {html_options}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/language.function.html.image.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01684 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
