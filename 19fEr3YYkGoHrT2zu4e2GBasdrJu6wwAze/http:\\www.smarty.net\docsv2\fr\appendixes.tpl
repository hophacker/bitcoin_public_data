http://www.smarty.net/docsv2/fr/appendixes.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 13:00:59 GMT
...
<html lang="en">
  <head>
    ...
    <title>Part IV. Appendices | Smarty</title>
...
<tr><th colspan="3" align="center">Part IV. Appendices</th></tr>
<tr>
...
<a name="appendixes"></a>Part IV. Appendices</h1></div></div></div>
<div class="toc">
...
<tr>
<td width="40%" align="left" valign="top">Insertions </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Chapter 17. Diagnostic des erreurs</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/appendixes.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01858 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
