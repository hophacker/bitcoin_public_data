http://www.smarty.net/docsv2/fr/language.function.include.php.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 06:16:21 GMT
...
<div class="note" title="Notes techniques" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Notes techniques</h3>
<p>
   <code class="varname">{include_php}</code> est presque obsolète dans Smarty.
   Vous pouvez obtenir des résultats équivalents en utilisant les fonctions utilisateur.
   La seule raison qui peut vous pousser à utiliser <code class="varname">{include_php}</code>
   est que vous avez besoin de mettre une de vos fonction en quarantaine vis à vis du 
   répertoire <a class="link" href="variable.plugins.dir.tpl" title="$plugins_dir"><code class="filename">plugins/</code></a>
   ou de votre application. Reportez-vous à l'exemple des
   <a class="link" href="tips.componentized.templates.tpl" title="Templates composants">templates composants</a>
...
<td>Le nom du fichier PHP à inclure</td>
</tr>
<tr>
<td align="center">once</td>
<td align="center">boléen</td>
<td align="center">Non</td>
<td align="center"><span class="emphasis"><em><code class="constant">TRUE</code></em></span></td>
<td>Inclure plusieurs fois ou non le fichier PHP si
      plusieurs demandes d'inclusions sont faîtes.</td>
</tr>
<tr>
...
<td align="center">Non</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>le nom de la variable PHP dans laquelle la sortie
      sera assignée plutôt que directement affichée.</td>
</tr>
</tbody>
</table></div>
<p>
  Les balises <code class="varname">{include_php}</code> sont utilisées pour inclure directement
  un script PHP dans vos templates. Si
  <a class="link" href="variable.security.tpl" title="$security"><em class="parameter"><code>$security</code></em></a> est activé,
  alors le script à exécuter doit être placé dans le chemin
  <a class="link" href="variable.trusted.dir.tpl" title="$trusted_dir"><em class="parameter"><code>$trusted_dir</code></em></a>. La balise
  <code class="varname">{include_php}</code> attends l'attribut <em class="parameter"><code>file</code></em>,
  qui contient le chemin du fichier PHP à inclure, relatif à
  <a class="link" href="variable.trusted.dir.tpl" title="$trusted_dir"><em class="parameter"><code>$trusted_dir</code></em></a>, ou absolu.
 </p>
<p>
  ...
  grâce à l'attribut <em class="parameter"><code>once</code></em>. Mettre l'attribut once à
  <code class="constant">FALSE</code> aura pour effet d'inclure le script PHP à chaque fois que demandé
  dans le template.
 </p>
<p>
  Vous pouvez donner une valeur à l'attribut optionnel
  <em class="parameter"><code>assign</code></em>, pour demander à la fonction
  <code class="varname">{include_php}</code> d'assigner la sortie du script PHP
  à la variable spécifiée plutôt que d'en afficher directement le résultat.
 </p>
<p>
  L'objet Smarty est disponible en tant que <em class="parameter"><code>$this</code></em> dans le script PHP inclus.
 </p>
<div class="example">
<a name="id2955199"></a><p class="title"><b>Example 7.21. Fonction {include_php}</b></p>
<div class="example-contents">
<p>Le fichier <code class="filename">load_nav.php</code></p>
...
<br class="example-break"><p>
  ...
  <a class="link" href="variable.security.tpl" title="$security"><em class="parameter"><code>$security</code></em></a>,
  ...
  <a class="link" href="language.builtin.functions.tpl#language.function.capture" title="{capture}"><code class="varname">{capture}</code></a>, les
  <a class="link" href="template.resources.tpl" title="Ressources">ressources de template</a> et les
  <a class="link" href="tips.componentized.templates.tpl" title="Templates composants">composants de templates</a>.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> {insert}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="08b628660095cf260a6158d28bc291b4">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/language.function.include.php.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02460 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
