http://www.smarty.net/docs/en/installation.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 07:20:53 GMT
...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Chapter 2. Installation">
    <meta name="keywords" content="chapter, 2, installation">
...
<div class="sect1" title="Requirements">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="installation.requirements"></a>Requirements</h2></div></div></div>
<p>
...
<tr>
<td width="40%" align="left" valign="top">Chapter 1. What is Smarty? </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Basic Installation</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/installation.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01575 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
