...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 01:39:17 GMT
...
<li class="listitem"><p>
    <em class="parameter"><code>$caching</code></em> doit être activé (soit 1 ou 2) pour que
    <em class="parameter"><code>$cache_lifetime</code></em> ait une quelconque utilité.
   </p></li>
<li class="listitem"><p>
    Avec une valeur de -1, le cache n'expire jamais.
   </p></li>
<li class="listitem"><p>Avec une valeur de 0, le cache est toujours regénéré (utile
    a des fins de tests seulement. Une meilleure façon de désactiver
    le cache est de mettre <a class="link" href="variable.caching.tpl" title="$caching"><em class="parameter"><code>$caching</code></em></a> = 0).
   </p></li>
<li class="listitem"><p>
    Si vous souhaitez donner a certains templates leur propre durée de vie
    en cache, vous pouvez le faire en réglant <a class="link" href="variable.caching.tpl" title="$caching">
     <em class="parameter"><code>$caching</code></em></a> à 2,
    puis <em class="parameter"><code>$cache_lifetime</code></em> à une unique valeur juste avant d'appeler
    <a class="link" href="api.display.tpl" title="display()"><code class="varname">display()</code>
    </a> ou <a class="link" href="api.fetch.tpl" title="fetch()"><code class="varname">fetch()</code></a>.
   </p></li>
</ul></div>
<p>
  Si <a class="link" href="variable.force.compile.tpl" title="$force_compile"><em class="parameter"><code>$force_compile</code></em></a> est
  ...
  ou de façon individuelle (ou groupée) avec la fonction <a class="link" href="api.clear.cache.tpl" title="clear_cache()"><code class="varname">clear_cache()</code></a>.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $cache_handler_func</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="4edb690c409d61c010e76b07a46063c1">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/variable.cache.lifetime.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02620 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
