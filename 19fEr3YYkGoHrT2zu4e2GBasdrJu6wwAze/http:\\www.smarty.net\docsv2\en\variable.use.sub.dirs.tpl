http://www.smarty.net/docsv2/en/variable.use.sub.dirs.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 20:07:04 GMT
...
<a class="link" href="variable.compile.dir.tpl" title="$compile_dir">compiled templates</a> and
<a class="link" href="variable.cache.dir.tpl" title="$cache_dir">cache</a>
directories if <em class="parameter"><code>$use_sub_dirs</code></em> is set to <code class="constant">TRUE</code>,
...
<li class="listitem"><p><code class="literal">$use_sub_dirs=true</code> doesn't work with
...
<li class="listitem"><p><code class="literal">$use_sub_dirs=true</code> on Windows can cause problems.</p></li>
<li class="listitem"><p>Safe_mode is being deprecated in PHP6.</p></li>
</ul></div>
</div>
<p>
  See also
...
<td width="40%" align="right" valign="top"> $default_modifiers</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/variable.use.sub.dirs.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01922 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
