http://www.smarty.net/docsv2/en/variable.debugging.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 03:42:08 GMT
...
<p>
       This enables the <a class="link" href="chapter.debugging.console.tpl" title="Chapter 10. Debugging Console">debugging console</a>.
       The console is a javascript popup window that informs you of the
       <a class="link" href="language.function.include.tpl" title="{include}">included</a>
       templates, variables <a class="link" href="api.assign.tpl" title="assign()">assigned</a>
       from php and
       <a class="link" href="language.config.variables.tpl" title="Variables loaded from config files">config file variables</a>
       for the current script. It does not show variables
       assigned within a template with the
       <a class="link" href="language.custom.functions.tpl#language.function.assign" title="{assign}"><code class="varname">{assign}</code>
       </a> function.
      </p>
<p>The console can also be enabled from the url with
      <a class="link" href="variable.debugging.ctrl.tpl" title="$debugging_ctrl">
...
<p>
      ...
      and <a class="link" href="variable.debugging.ctrl.tpl" title="$debugging_ctrl"><em class="parameter"><code>$debugging_ctrl</code></em></a>.
      </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $debug_tpl</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/variable.debugging.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02928 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
