http://www.smarty.net/docs/en/variable.trusted.dir.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 12:15:51 GMT
...
<p>
  <em class="parameter"><code>$trusted_dir</code></em> is only for use when
  security is enabled.
  ...
  with <a class="link" href="language.function.include.php.tpl" title="{include_php}"><code class="varname">{include_php}</code></a>.
      </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $use_include_path</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 0 plus 16? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/variable.trusted.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02670 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
