http://www.smarty.net/docsv2/fr/api.clear.all.cache.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 11:54:40 GMT
...
<html lang="en">
  <head>
    ...
    <title>clear_all_cache() | Smarty</title>
...
<h2>Name</h2>
<p>clear_all_cache() — Efface les fichiers de cache des templates</p>
</div>
<div class="refsect1" title="Description">
<a name="id3006769"></a><h2>Description</h2>
...
<div class="example">
<a name="id3007533"></a><p class="title"><b>Example 13.6. Exemple avec clear_all_cache</b></p>
...
<br class="example-break"><p>
  ...
  <a class="link" href="api.is.cached.tpl" title="is_cached()"><code class="varname">is_cached()</code></a> et
   le <a class="link" href="caching.tpl" title="Chapter 14. Cache">cache</a>.
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> clear_assign()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/api.clear.all.cache.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02638 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
