http://www.smarty.net/docsv2/it/variable.cache.modified.check.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 06:25:07 GMT
...
<p>
       Se è impostato a true, Smarty rispetterà l'header If-Modified-Since
       spedito dal client. Se il timestamp del file in cache non è
       cambiato dall'ultima visita, verrà inviato un header 
       "304 Not Modified" invece del contenuto. Questo funziona solo sul
       contenuto in cache senza tag <span class="command"><strong>insert</strong></span>.
      </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $config_overwrite</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/variable.cache.modified.check.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02537 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
