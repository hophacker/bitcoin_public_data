http://www.smarty.net/docs/en/language.function.nocache.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 14:30:49 GMT
...
<p>
   <code class="varname">{nocache}</code> is used to disable caching of a template section. 
   Every <code class="varname">{nocache}</code> must be paired with a matching
   <code class="varname">{/nocache}</code>.
  </p>
...
<div class="example">
<a name="idp9439632"></a><p class="title"><b>Example 7.60. Preventing a template section from being cached</b></p>
...
<td width="40%" align="right" valign="top"> {php}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/language.function.nocache.tpl">
            </form>
            </div>
          </div>
