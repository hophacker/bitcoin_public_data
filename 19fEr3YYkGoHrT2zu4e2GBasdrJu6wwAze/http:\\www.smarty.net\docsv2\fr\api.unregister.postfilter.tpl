http://www.smarty.net/docsv2/fr/api.unregister.postfilter.tpl
HTTP/1.1 200 OK
...
<html lang="en">
  <head>
    ...
    <title>unregister_postfilter() | Smarty</title>
...
<tr><th colspan="3" align="center">unregister_postfilter()</th></tr>
<tr>
...
<div class="refentry" title="unregister_postfilter()">
<a name="api.unregister.postfilter"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>unregister_postfilter() — Désallouer dynamiquement un filtre de post-compilation</p>
</div>
<div class="refsect1" title="Description">
<a name="id3018445"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">unregister_postfilter</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">function_name</span></span>);</code><p>
   Voir aussi
   <a class="link" href="api.unregister.postfilter.tpl" title="unregister_postfilter()"><code class="varname">register_postfilter()</code></a> et
   les <a class="link" href="plugins.prefilters.postfilters.tpl" title="filtres de pré-compilation/filtres de post-compilation">filtres de post-compilation</a>.
  </p>
</div>
</div>
<div class="navfooter">
...
<tr>
<td width="40%" align="left" valign="top">unregister_outputfilter() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> unregister_prefilter()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="b74bd2ec1d7458a672ad864f1950c8ab">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/api.unregister.postfilter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02126 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
