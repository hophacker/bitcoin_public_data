...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 07:37:21 GMT
...
<div class="example">
<a name="id2920416"></a><p class="title"><b>Example 13.15. get_config_vars</b></p>
...
<td width="40%" align="right" valign="top"> get_registered_object</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/api.get.config.vars.tpl">
            </form>
            </div>
          </div>
