...
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 08:25:28 GMT
...
<html lang="en">
  <head>
    ...
    <title>Embedding Vars in Double Quotes | Smarty</title>
...
<li class="listitem"><p>
  Smarty will recognize <a class="link" href="api.assign.tpl" title="assign()">assigned</a>
  <a class="link" href="language.syntax.variables.tpl" title="Variables">variables</a>
...
<li class="listitem"><p>You cannot embed
  <a class="link" href="language.modifiers.tpl" title="Chapter 5. Variable Modifiers">modifiers</a>, they must always
  be applied outside of quotes.
 </p></li>
</ul></div>
<div class="example">
<a name="id2782197"></a><p class="title"><b>Example 3.5. Syntax examples</b></p>
...
<a name="id2782208"></a><p class="title"><b>Example 3.6. Practical examples</b></p>
<div class="example-contents"><pre class="programlisting">
...
<br class="example-break"><p>
  See also <a class="link" href="language.modifier.escape.tpl" title="escape"><code class="varname">escape</code></a>.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> Math</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="d904edecf2ca9e95bb0c9f74188e671e">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/language.syntax.quotes.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01716 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
