http://www.smarty.net/docsv2/it/caching.multiple.caches.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 03:42:12 GMT
...
<html lang="en">
  <head>
    ...
    <title>Cache multiple per una pagina | Smarty</title>
...
<tr><th colspan="3" align="center">Cache multiple per una pagina</th></tr>
<tr>
...
<div class="sect1" title="Cache multiple per una pagina">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="caching.multiple.caches"></a>Cache multiple per una pagina</h2></div></div></div>
<p>
...
<div class="example">
<a name="id3152799"></a><p class="title"><b>Example 14.6. passare un cache_id a display()</b></p>
...
<p>
     ...
     secondo parametro a <a class="link" href="api.is.cached.tpl" title="is_cached">is_cached()</a> e
     <a class="link" href="api.clear.cache.tpl" title="clear_cache">clear_cache()</a>.
    </p>
<div class="example">
<a name="id3153093"></a><p class="title"><b>Example 14.7. passare un cache_id a is_cached()</b></p>
<div class="example-contents"><pre class="programlisting">
...
<div class="example">
<a name="id3153981"></a><p class="title"><b>Example 14.8. eliminare tutte le cache per un determinato cache_id</b></p>
<div class="example-contents"><pre class="programlisting">
...
<tr>
<td width="40%" align="left" valign="top">Chapter 14. Caching </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Gruppi di Cache</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/caching.multiple.caches.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01960 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
