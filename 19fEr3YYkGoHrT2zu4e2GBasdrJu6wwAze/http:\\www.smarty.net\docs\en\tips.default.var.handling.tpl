http://www.smarty.net/docs/en/tips.default.var.handling.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 12:15:39 GMT
...
<html lang="en">
  <head>
    ...
    <title>Default Variable Handling | Smarty</title>
    <meta name="description" content="Default Variable Handling">
    <meta name="keywords" content="default, variable, handling">
...
<tr><th colspan="3" align="center">Default Variable Handling</th></tr>
<tr>
...
<div class="sect1" title="Default Variable Handling">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="tips.default.var.handling"></a>Default Variable Handling</h2></div></div></div>
<p>
    If a variable is used frequently throughout your templates, applying
    the <a class="link" href="language.modifier.default.tpl" title="default"><code class="varname">default</code>
...
<div class="example">
<a name="idp20398640"></a><p class="title"><b>Example 21.2. Assigning a template variable its default value</b></p>
...
<br class="example-break"><p>
    ...
    <a class="link" href="language.modifier.default.tpl" title="default"><code class="varname">default</code></a>
     modifier and <a class="link" href="tips.tpl#tips.blank.var.handling" title="Blank Variable Handling">blank variable handling</a>.
   </p>
</div>
<div class="navfooter">
<hr>
...
<tr>
<td width="40%" align="left" valign="top">Chapter 21. Tips &amp; Tricks </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Passing variable title to header template</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/tips.default.var.handling.tpl">
            </form>
            </div>
          </div>
