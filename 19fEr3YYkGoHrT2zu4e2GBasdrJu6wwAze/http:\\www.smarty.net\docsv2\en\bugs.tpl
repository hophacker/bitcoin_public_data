http://www.smarty.net/docsv2/en/bugs.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 14:30:55 GMT
...
<tr>
<td width="40%" align="left" valign="top">Chapter 19. Resources </td>
...
<td width="40%" align="right" valign="top"> </td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/bugs.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02687 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
