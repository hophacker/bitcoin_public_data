...
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 04:22:48 GMT
...
<p>
  <code class="varname">{debug}</code> dumps the debug console to the page. This works
  regardless of the <a class="link" href="chapter.debugging.console.tpl" title="Chapter 10. Debugging Console">debug</a>
  settings in the php script. Since this gets executed at runtime, this is
  only able to show the <a class="link" href="api.assign.tpl" title="assign()">assigned</a>
...
<p>
  If caching is enabled and a page is loaded from cache <code class="varname">{debug}</code>
  does show only the variables which assigned for the cached page.
 </p>
<p>
  In order to see also the variables which have been locally assigned within the template it does make sense to place 
  the <code class="varname">{debug}</code> tag at the end of the template.
 </p>
<p>
 See also the
 <a class="link" href="chapter.debugging.console.tpl" title="Chapter 10. Debugging Console">debugging console page</a>.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> {extends}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 14 plus 8? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/language.function.debug.tpl">
            </form>
            </div>
          </div>
