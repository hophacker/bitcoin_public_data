http://www.smarty.net/docsv2/fr/api.unregister.block.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 17:51:29 GMT
...
<h2>Name</h2>
<p>unregister_block() — Désalloue dynamiquement un plugin de fonction de blocs</p>
</div>
<div class="refsect1" title="Description">
<a name="id3016678"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">unregister_block</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">name</span></span>);</code><p>
   Utilisée pour désallouer dynamiquement un <a class="link" href="plugins.block.functions.tpl" title="Fonctions de blocs">plugin de fonction
   de blocs</a>. Passez en paramètre le nom <em class="parameter"><code>name</code></em> du bloc.
  </p>
<p>
   Voir aussi
   <a class="link" href="api.register.block.tpl" title="register_block()"><code class="varname">register_block()</code></a> et
   les <a class="link" href="plugins.block.functions.tpl" title="Fonctions de blocs">plugins de fonctions de blocs</a>.
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> unregister_compiler_function()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/api.unregister.block.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02925 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
