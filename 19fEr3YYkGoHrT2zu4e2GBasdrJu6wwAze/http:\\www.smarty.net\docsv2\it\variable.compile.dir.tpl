http://www.smarty.net/docsv2/it/variable.compile.dir.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 15:51:36 GMT
...
<p>
     Questo è il nome della directory dove vengono messi i template
     compilati. Per default è "./templates_c", che significa che
     Smarty cercherà la directory di compilazione sotto la stessa
     directory dello script php in esecuzione.
    </p>
<div class="note" title="Nota tecnica" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Nota tecnica</h3>
<p>
       Questa impostazione deve essere un percorso relativo
       o assoluto. include_path non viene usata per i file
       in scrittura.
      </p>
</div>
<div class="note" title="Nota tecnica" style="margin-left: 0.5in; margin-right: 0.5in;">
...
<tr>
<td width="40%" align="left" valign="top">Chapter 12. Variabili </td>
...
<td width="40%" align="right" valign="top"> $config_dir</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/variable.compile.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01980 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
