http://www.smarty.net/docsv2/it/plugins.resources.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 11:41:12 GMT
...
<a name="plugins.resources"></a>Risorse</h2></div></div></div>
<p>
...
<p>
     ...
     restituisca <code class="literal">true</code> se è riuscita a recuperare
     la risorsa e <code class="literal">false</code> nel caso opposto.
    </p>
<p>
     ...
     restituisca <code class="literal">true</code> se è riuscita a determinare il
     timestamp, e <code class="literal">false</code> nel caso opposto.
    </p>
<p>
     La terza funzione deve restituire <code class="literal">true</code> o
     <code class="literal">false</code>, a seconda che la risorsa richiesta sia
     sicura o no. Questa funzione è usata solo per risorse di template ma
     deve ancora essere definita.
    </p>
<p>
     La quarta funzione deve restituire <code class="literal">true</code> o
     <code class="literal">false</code>, a seconda che la risorsa richiesta sia
     considerata affidabile o no. Questa funzione è usata solo per script
     PHP richiesti con i tag <span class="command"><strong>include_php</strong></span> o
     <span class="command"><strong>insert</strong></span> con l'attributo <em class="structfield"><code>src</code></em>.
...
<div class="example">
<a name="id3161561"></a><p class="title"><b>Example 16.10. plugin risorsa</b></p>
...
<tr>
<td width="40%" align="left" valign="top">Filtri di Output </td>
...
<td width="40%" align="right" valign="top"> Insert</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 10 plus 4? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="82245ebd6f2cc96815531411975bf3f8">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/plugins.resources.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01675 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
