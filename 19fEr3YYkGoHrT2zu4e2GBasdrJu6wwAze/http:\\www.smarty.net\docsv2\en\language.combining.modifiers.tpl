http://www.smarty.net/docsv2/en/language.combining.modifiers.tpl
HTTP/1.1 200 OK
...
<html lang="en">
  <head>
    ...
    <title>Chapter 6. Combining Modifiers | Smarty</title>
...
<div class="example">
<a name="id2798625"></a><p class="title"><b>Example 6.1. combining modifiers</b></p>
...
<td width="40%" align="right" valign="top"> Chapter 7. Built-in Functions</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/language.combining.modifiers.tpl">
            </form>
            </div>
          </div>
