http://www.smarty.net/docsv2/de/plugins.compiler.functions.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 03:32:14 GMT
...
<html lang="en">
  <head>
    ...
    <title>Compiler-Funktionen | Smarty</title>
...
<tr><th colspan="3" align="center">Compiler-Funktionen</th></tr>
<tr>
...
<div class="sect1" title="Compiler-Funktionen">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="plugins.compiler.functions"></a>Compiler-Funktionen</h2></div></div></div>
<p>
...
<p>
    ...
    Sehen Sie dazu:
    <a class="link" href="api.register.compiler.function.tpl" title="register_compiler_function (Compiler-Funktion registrieren)">register_compiler_function()</a>,
     <a class="link" href="api.unregister.compiler.function.tpl" title="unregister_compiler_function (Compiler-Funktion deaktivieren)">unregister_compiler_function()</a>.
   </p>
<div class="example">
<a name="id2938780"></a><p class="title"><b>Example 16.6. Einfache Compiler-Funktionen</b></p>
...
<tr>
<td width="40%" align="left" valign="top">Block-Funktionen </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> 'pre'/'post'-Filter</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 14 plus 12? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/plugins.compiler.functions.tpl">
            </form>
            </div>
          </div>
