HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 15:26:46 GMT
...
<p>
    ...
    mit <a class="link" href="language.function.include.php.tpl" title="include_php (PHP-Code einbinden)">{include_php}</a> aufruft,
    abgelegt werden.
   </p>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> $left_delimiter</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/variable.trusted.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01039 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
