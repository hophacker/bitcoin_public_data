http://www.smarty.net/docsv2/it/plugins.inserts.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 16:54:05 GMT
...
<a name="plugins.inserts"></a>Insert</h2></div></div></div>
<p>
     I plugin Insert sono usati per implementare le funzioni invocate dai
     tag <a class="link" href="language.function.insert.tpl" title="insert"><span class="command"><strong>insert</strong></span></a>
     nel template.
    </p>
...
<p>
     ...
     sarà posizionato in luogo del tag <span class="command"><strong>insert</strong></span> nel
     template.
    </p>
<div class="example">
<a name="id3161062"></a><p class="title"><b>Example 16.11. plugin insert</b></p>
...
<td width="40%" align="right" valign="top"> Part IV. Appendici</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/plugins.inserts.tpl">
            </form>
            </div>
          </div>
