http://www.smarty.net/docsv2/fr/language.modifier.spacify.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 10:40:32 GMT
...
<p>
  <code class="varname">spacify</code> est un moyen pour insérer un espace entre tous les caractères
...
<td align="center"><span class="emphasis"><em>espace</em></span></td>
<td>Ce qui est inséré entre chaque caractère de la variable.</td>
</tr></tbody>
</table></div>
<div class="example">
<a name="id2941839"></a><p class="title"><b>Example 5.17. spacify</b></p>
...
<br class="example-break"><p>
 Voir aussi 
 <a class="link" href="language.modifier.wordwrap.tpl" title="wordwrap"><code class="varname">wordwrap</code></a> et
...
<td width="40%" align="right" valign="top"> string_format</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/language.modifier.spacify.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03642 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
