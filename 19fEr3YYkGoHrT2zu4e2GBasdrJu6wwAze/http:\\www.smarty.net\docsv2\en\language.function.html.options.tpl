...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 22:00:52 GMT
...
<p>
   <code class="varname">{html_options}</code> is a
   <a class="link" href="language.custom.functions.tpl" title="Chapter 8. Custom Functions">custom function</a>
   that creates the html <code class="literal">&lt;select&gt;&lt;option&gt;</code> group
...
<li class="listitem"><p>
   ...
   <em class="parameter"><code>values</code></em> and <em class="parameter"><code>output</code></em>,
   unless you use the combined <em class="parameter"><code>options</code></em> instead.
 </p></li>
<li class="listitem"><p>
  If the optional <em class="parameter"><code>name</code></em> attribute is given, the
  <code class="literal">&lt;select&gt;&lt;/select&gt;</code> tags are created,
  otherwise ONLY the <code class="literal">&lt;option&gt;</code> list is generated.
 </p></li>
<li class="listitem"><p>
  If a given value is an array, it will treat it as an html
  <code class="literal">&lt;optgroup&gt;</code>, and display the groups.
  Recursion is supported with <code class="literal">&lt;optgroup&gt;</code>.
 </p></li>
<li class="listitem"><p>
  All parameters that are not in the list above are printed as name/value-pairs
  inside the <code class="literal">&lt;select&gt;</code> tag. They are ignored if
  the optional <em class="parameter"><code>name</code></em> is not given.
 </p></li>
<li class="listitem"><p>
...
<div class="example">
<a name="id2823553"></a><p class="title"><b>Example 8.12. Associative array with the <code class="varname">options</code> attribute</b></p>
...
<p>
  ...
  Note the presence of the <em class="parameter"><code>name</code></em> attribute
  which creates the <code class="literal">&lt;select&gt;</code> tags.
  </p>
<pre class="programlisting">
...
<a name="id2823616"></a><p class="title"><b>Example 8.13. Dropdown with seperate arrays for <code class="varname">values</code> and
...
<p>
  ...
  (note the use of the php <a class="ulink" href="http://php.net/function.count" target="_top">
  <code class="varname">count()</code></a> function as a modifier
...
<br class="example-break"><div class="example">
<a name="id2823688"></a><p class="title"><b>Example 8.14. Database example (eg ADODB or PEAR)</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<br class="example-break"><div class="example">
<a name="id2823740"></a><p class="title"><b>Example 8.15. Dropdown's with &lt;optgroup&gt; </b></p>
<div class="example-contents">
<pre class="programlisting">
...
<p>The script above and the following template
  </p>
<pre class="programlisting">
...
<td width="40%" align="right" valign="top"> {html_radios}</td>
          ...
          <div class="commentInfo">
              ...
              <div class="commentAuthor">by <b>Gogowitsch</b> on Apr 15, 2012 at  1:13</div>
              <div class="commentBody">Example 8.13 will not render as expected on Firefox 11 (invalid HTML), as {html_options} will create another &lt;select&gt; within the outer.</div>
            </div>
                      <div class="commentWrapperEven">
              <div class="commentAuthor">by <b>Lajos Pirk</b> on Dec 18, 2011 at  8:52</div>
              <div class="commentBody">Hello,

Is that possible to make this function work with multiple select option?

I mean, theoretically i can pass an array in the selected parameter, but if i do, the function makes nothing to selected in the result. :(</div>
            </div>
                              </div>
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 15 plus 6? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/language.function.html.options.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02154 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
