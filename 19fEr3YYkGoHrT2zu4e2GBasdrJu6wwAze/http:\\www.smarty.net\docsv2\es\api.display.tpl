http://www.smarty.net/docsv2/es/api.display.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 11:21:38 GMT
...
<h2>Name</h2>
<p>display() — Despliega el Template</p>
</div>
<div class="refsect1" title="Descripción">
<a name="id3129226"></a><h2>Descripción </h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">display</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">template</span></span>,<br>             <span class="methodparam"><span class="type">string </span><span class="parameter">cache_id</span></span>,<br>             <span class="methodparam"><span class="type">string </span><span class="parameter">compile_id</span></span>);</code><p>
   Este despliega el template diferente de <a class="link" href="api.fetch.tpl" title="fetch()">fetch()</a>. Cargando un tipo valido de path
   ...
   Vea el <a class="link" href="caching.tpl" title="Chapter 14. Cache">caching section</a> para mayor
   información.
  </p>
<p>
...
<div class="example">
<a name="id3129976"></a><p class="title"><b>Example 13.12. display()</b></p>
...
<br class="example-break"><p>
   Use la sintaxis <a class="link" href="template.resources.tpl" title="Recursos">template resources</a>
...
<div class="example">
<a name="id3130030"></a><p class="title"><b>Example 13.13. Ejemplos de recursos de la función display</b></p>
<div class="example-contents"><pre class="programlisting">
...
<br class="example-break"><p>
     Ver también <a class="link" href="api.fetch.tpl" title="fetch()">fetch()</a> y
...
<td width="40%" align="right" valign="top"> fetch()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/api.display.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02606 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
