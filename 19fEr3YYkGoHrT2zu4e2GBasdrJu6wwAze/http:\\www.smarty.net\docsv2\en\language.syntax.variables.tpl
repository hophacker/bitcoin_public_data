http://www.smarty.net/docsv2/en/language.syntax.variables.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 19:31:09 GMT
...
<div class="example">
<a name="id2780632"></a><p class="title"><b>Example 3.2. Variables</b></p>
...
<br class="example-break"><p>Request variables such as <code class="literal">$_GET</code>,
 ...
 reserved <a class="link" href="language.variables.smarty.tpl" title="{$smarty} reserved variable">
 <em class="parameter"><code>$smarty</code></em></a> variable.
 </p>
<p>
  See also <a class="link" href="language.variables.smarty.tpl" title="{$smarty} reserved variable">
...
<td width="40%" align="right" valign="top"> Functions</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/language.syntax.variables.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01820 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
