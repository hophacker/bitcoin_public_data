http://www.smarty.net/docsv2/de/api.unregister.resource.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 21:33:25 GMT
...
<html lang="en">
  <head>
    ...
    <title>unregister_resource (Ressource deaktivieren) | Smarty</title>
...
<tr><th colspan="3" align="center">unregister_resource (Ressource deaktivieren)</th></tr>
<tr>
...
<div class="refentry" title="unregister_resource (Ressource deaktivieren)">
<a name="api.unregister.resource"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>unregister_resource (Ressource deaktivieren)</p>
</div>
<div class="refsect1">
<a name="id2926271"></a><h2></h2>
...
<div class="example">
<a name="id2925911"></a><p class="title"><b>Example 13.27. unregister_resource (Ressource deaktivieren)</b></p>
...
<tr>
<td width="40%" align="left" valign="top">unregister_prefilter ('pre'-Filter deaktiviern) </td>
...
<td width="40%" align="right" valign="top"> Chapter 14. Caching</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/api.unregister.resource.tpl">
            </form>
            </div>
          </div>
