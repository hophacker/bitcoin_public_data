http://www.smarty.net/docs/en/variable.default.resource.type.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 09:17:23 GMT
...
<td width="40%" align="right" valign="top"> $default_config_handler_func</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/variable.default.resource.type.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03001 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
