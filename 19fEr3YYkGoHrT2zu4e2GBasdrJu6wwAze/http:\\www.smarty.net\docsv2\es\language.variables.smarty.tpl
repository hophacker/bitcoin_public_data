http://www.smarty.net/docsv2/es/language.variables.smarty.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 08:26:09 GMT
...
<html lang="en">
  <head>
    ...
    <title>La variable reservada {$smarty} | Smarty</title>
...
<tr><th colspan="3" align="center">La variable reservada {$smarty}</th></tr>
<tr>
...
<div class="sect1" title="La variable reservada {$smarty}">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.variables.smarty"></a>La variable reservada {$smarty}</h2></div></div></div>
<p>
...
<div class="sect2" title="Solicitud de Variables">
<div class="titlepage"><div><div><h3 class="title">
<a name="language.variables.smarty.request"></a>Solicitud de Variables</h3></div></div></div>
<p>
      La <a class="ulink" href="http://php.net/reserved.variables" target="_top">solicitud de variables</a> 
      como $_GET, $_POST, $_COOKIE, $_SERVER, $_ENV y $_SESSION 
      (Ver <a class="link" href="variable.request.vars.order.tpl" title="$request_vars_order">$request_vars_order</a>
...
<div class="example">
<a name="id3066764"></a><p class="title"><b>Example 4.6. Mostrando solicitud de variables</b></p>
...
<p>
    El <a class="ulink" href="http://php.net/function.time" target="_top">timestamp</a> 
    ...
    <a class="link" href="language.modifier.date.format.tpl" title="date_format">date_format</a> para 
    mostrar la fecha.
			</p>
<div class="example">
<a name="id3066842"></a><p class="title"><b>Example 4.7. Usando {$smarty.now}</b></p>
<div class="example-contents"><pre class="programlisting">
...
<p>
    ...
    Ver también <a class="link" href="smarty.constants.tpl" title="Chapter 11. Constantes">smarty constants</a>

			</p>
<div class="example">
<a name="id3067872"></a><p class="title"><b>Example 4.8. Usando {$smarty.const}</b></p>
<div class="example-contents"><pre class="programlisting">
...
<p>
    ...
    <a class="link" href="language.builtin.functions.tpl#language.function.capture" title="capture">{capture}..{/capture}</a> 
    puede ser accesada usando la variable {$smarty}. 
    vea la sección <a class="link" href="language.builtin.functions.tpl#language.function.capture" title="capture">{capture}</a>
    para un ejemplo.
			</p>
</div>
...
<p>
    ...
    <a class="link" href="language.config.variables.tpl" title="Variables cargadas desde archivos de configuración">variables de configuración</a> 
    cargadas. {$smarty.config.foo} es un sinónimo para {#foo#}. vea la sección
    sobre <a class="link" href="language.function.config.load.tpl" title="config_load">{config_load}</a> 
    para un ejemplo.
			</p>
</div>
...
<p>
    ...
    sobre <a class="link" href="language.function.section.tpl" title="section,sectionelse">section</a> y
    <a class="link" href="language.function.foreach.tpl" title="{foreach},{foreachelse}">foreach</a>.
			</p>
</div>
...
<p>
    ...
    Ver tambien <a class="link" href="language.function.ldelim.tpl" title="{ldelim},{rdelim}">{ldelim},{rdelim}</a>.
			</p>
<p>
    Ver también <a class="link" href="language.syntax.variables.tpl" title="Variables">Variables</a> 
...
<tr>
<td width="40%" align="left" valign="top">Variables cargadas desde archivos de configuración </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Chapter 5. Modificadores de variables</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 7 plus 13? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.variables.smarty.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02632 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
