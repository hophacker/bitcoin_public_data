...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 09:35:41 GMT
...
<html lang="en">
  <head>
    ...
    <title>get_template_vars() | Smarty</title>
...
<tr><th colspan="3" align="center">get_template_vars()</th></tr>
<tr>
...
<div class="refentry" title="get_template_vars()">
<a name="api.get.template.vars"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>get_template_vars() — Retourne la valeur assignée passée en paramètre</p>
</div>
<div class="refsect1" title="Description">
<a name="id3011002"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">array </span><span class="methodname">get_template_vars</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">varname</span></span>);</code><p>
   Si aucun paramètre n'est donné, un tableau de toutes les variables
   <a class="link" href="api.assign.tpl" title="assign()">assignées</a> est retourné.
  </p>
<div class="example">
<a name="id3011352"></a><p class="title"><b>Example 13.18. Exemple avec get_template_vars</b></p>
...
<br class="example-break"><p>
  ...
  <a class="link" href="api.clear.all.assign.tpl" title="clear_all_assign()"><code class="varname">clear_all_assign()</code></a> et
...
<tr>
<td width="40%" align="left" valign="top">get_registered_object() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> is_cached()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/api.get.template.vars.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02296 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
