...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 07:26:00 GMT
...
<html lang="en">
  <head>
    ...
    <title>Chapter 1. What is Smarty? | Smarty</title>
...
<li class="listitem"><p>
   ...
   presented. They are <a class="link" href="api.assign.tpl" title="assign()">passed</a> into Smarty
   by the application.
   </p></li>
<li class="listitem"><p>Then the
   template designer edits the templates and uses a combination of
   HTML tags and <a class="link" href="language.basic.syntax.tpl" title="Chapter 3. Basic Syntax">template tags</a>
   to format the presentation of these
   <a class="link" href="language.syntax.variables.tpl" title="Variables">variables</a> with elements
...
<li class="listitem"><p>
   ...
   <a class="link" href="language.function.include.tpl" title="{include}">including</a>
   other templates,
   <a class="link" href="language.function.cycle.tpl" title="{cycle}">alternating</a> table row colors,
   <a class="link" href="language.modifier.upper.tpl" title="upper">upper-casing</a> a variable,
   <a class="link" href="language.function.foreach.tpl" title="{foreach},{foreachelse}">looping</a>
   over an array of data and <a class="link" href="api.display.tpl" title="display()">displaying</a> it
...
<li class="listitem"><p>
     It is smart about <a class="link" href="variable.compile.check.tpl" title="$compile_check">recompiling</a>
     only the template files that have changed.
    </p></li>
<li class="listitem"><p>
     You can easily create your own custom <a class="link" href="language.custom.functions.tpl" title="Chapter 8. Custom Functions">functions</a>
     and <a class="link" href="language.modifiers.tpl" title="Chapter 5. Variable Modifiers">variable modifiers</a>, so the
     template language is extremely extensible.
    </p></li>
<li class="listitem"><p>
     Configurable template
     <a class="link" href="variable.left.delimiter.tpl" title="$left_delimiter">{delimiter}</a> tag
      syntax, so you can use
     <code class="literal">{$foo}</code>, <code class="literal">{{$foo}}</code>,
     <code class="literal">&lt;!--{$foo}--&gt;</code>, etc.
    </p></li>
<li class="listitem"><p>
     The <a class="link" href="language.function.if.tpl" title="{if},{elseif},{else}">
...
<li class="listitem"><p>
     Allows unlimited nesting of <a class="link" href="language.function.section.tpl" title="{section},{sectionelse}">
     <code class="varname">sections</code></a>, <code class="varname">if's</code> etc.
    </p></li>
<li class="listitem"><p>
     It is possible to
     <a class="link" href="language.function.php.tpl" title="{php}">embed PHP code</a>
     right in your template files, although
     this may not be needed (nor recommended) since the engine is so
     <a class="link" href="plugins.tpl" title="Chapter 16. Extending Smarty With Plugins">customizable</a>.
    </p></li>
<li class="listitem"><p>
     Built-in <a class="link" href="caching.tpl" title="Chapter 14. Caching">caching</a> support
    </p></li>
<li class="listitem"><p>
     Arbitrary <a class="link" href="template.resources.tpl" title="Resources">template</a> sources
    </p></li>
<li class="listitem"><p>
     Custom <a class="link" href="section.template.cache.handler.func.tpl" title="Cache Handler Function">cache handling</a>
     functions
    </p></li>
<li class="listitem"><p>
     <a class="link" href="plugins.tpl" title="Chapter 16. Extending Smarty With Plugins">Plugin</a> architecture
    </p></li>
</ul></div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> Chapter 2. Installation</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 20 plus 11? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="70bd6fa89b92a40534a19e2b71993cb2">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/what.is.smarty.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01840 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
