http://www.smarty.net/docsv2/es/api.load.filter.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 01:39:09 GMT
...
<h2>Name</h2>
<p>load_filter() — Carga un filtro de plugin</p>
</div>
<div class="refsect1" title="Descripción">
<a name="id3130905"></a><h2> Descripción</h2>
...
<div class="example">
<a name="id3132339"></a><p class="title"><b>Example 13.21. loading filter plugins</b></p>
...
<br class="example-break"><p>
  Ver también 
  <a class="link" href="api.register.prefilter.tpl" title="register_prefilter()">register_prefilter()</a>,
  <a class="link" href="api.register.postfilter.tpl" title="register_postfilter()">register_postfilter()</a>,
  <a class="link" href="api.register.outputfilter.tpl" title="register_outputfilter()">register_outputfilter()</a>,
  <a class="link" href="variable.autoload.filters.tpl" title="$autoload_filters">$autoload_filters</a>
  y 
  <a class="link" href="advanced.features.tpl" title="Chapter 15. Caracteristicas Avanzadas">Advanced features</a>.
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> register_block()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/api.load.filter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02201 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
