...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 03:42:16 GMT
...
<html lang="en">
  <head>
    ...
    <title>Attributes | Smarty</title>
    <meta name="description" content="Attributes">
    <meta name="keywords" content="attributes">
...
<p>
  Most of the <a class="link" href="language.syntax.functions.tpl" title="Functions">functions</a>
...
<div class="example">
<a name="idp5420768"></a><p class="title"><b>Example 3.4. function attribute syntax</b></p>
...
<td width="40%" align="right" valign="top"> Embedding Vars in Double Quotes</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/language.syntax.attributes.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01890 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
