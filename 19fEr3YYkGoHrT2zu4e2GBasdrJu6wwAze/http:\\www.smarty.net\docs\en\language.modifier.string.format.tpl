...
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 07:21:21 GMT
...
<td>This is what format to use. (sprintf)</td>
</tr></tbody>
</table></div>
<div class="example">
<a name="idp6814736"></a><p class="title"><b>Example 5.18. string_format</b></p>
...
<td width="40%" align="right" valign="top"> strip</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/language.modifier.string.format.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02339 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
