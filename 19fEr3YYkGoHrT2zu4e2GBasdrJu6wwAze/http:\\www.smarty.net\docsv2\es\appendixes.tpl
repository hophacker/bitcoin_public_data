http://www.smarty.net/docsv2/es/appendixes.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 20:07:49 GMT
...
<html lang="en">
  <head>
    ...
    <title>Part IV. Appendixes | Smarty</title>
...
<tr><th colspan="3" align="center">Part IV. Appendixes</th></tr>
<tr>
...
<div class="part" title="Part IV. Appendixes">
<div class="titlepage"><div><div><h1 class="title">
<a name="appendixes"></a>Part IV. Appendixes</h1></div></div></div>
<div class="toc">
...
<tr>
<td width="40%" align="left" valign="top">Inserts </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Chapter 17. Localización de Errores</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/appendixes.tpl">
            </form>
            </div>
          </div>
