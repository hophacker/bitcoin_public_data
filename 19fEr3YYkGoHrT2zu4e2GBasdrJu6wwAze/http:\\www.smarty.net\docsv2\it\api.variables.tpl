http://www.smarty.net/docsv2/it/api.variables.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 23:25:36 GMT
...
<html lang="en">
  <head>
    ...
    <title>Chapter 12. Variabili | Smarty</title>
...
<tr><th colspan="3" align="center">Chapter 12. Variabili</th></tr>
<tr>
...
<div class="chapter" title="Chapter 12. Variabili">
<div class="titlepage"><div><div><h2 class="title">
<a name="api.variables"></a>Chapter 12. Variabili</h2></div></div></div>
<div class="toc">
...
<p>
     Questo è il nome della directory di default dei template. Se
     non ne indicate una quando includete i file, verranno cercati
     qui. Per default è "./templates", che significa che Smarty
     cercherà la directory dei template nella stessa directory dello
...
<p>
      E' sconsigliato mettere questa directory sotto la
      document root del web server.
     </p>
</div>
</div>
</div>
...
<tr>
<td width="40%" align="left" valign="top">Chapter 11. Costanti </td>
...
<td width="40%" align="right" valign="top"> $compile_dir</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 13 plus 18? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/api.variables.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02194 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
