http://www.smarty.net/docsv2/es/language.modifier.cat.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 23:25:37 GMT
...
<thead><tr>
<th align="center">Posiscion del Parametro</th>
...
<td>Este es el valor para concatenar con la variable dada.</td>
</tr></tbody>
</table></div>
<p>
...
<div class="example">
<a name="id3069379"></a><p class="title"><b>Example 5.3. cat</b></p>
...
<tr>
<td width="40%" align="left" valign="top">Chapter 5. Modificadores de variables </td>
...
<td width="40%" align="right" valign="top"> count_characters</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 19 plus 12? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.modifier.cat.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02455 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
