http://www.smarty.net/docsv2/fr/plugins.prefilters.postfilters.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 09:51:50 GMT
...
<html lang="en">
  <head>
    ...
    <title>filtres de pré-compilation/filtres de post-compilation | Smarty</title>
...
<tr><th colspan="3" align="center">filtres de pré-compilation/filtres de post-compilation</th></tr>
<tr>
...
<div class="sect1" title="filtres de pré-compilation/filtres de post-compilation">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="plugins.prefilters.postfilters"></a>filtres de pré-compilation/filtres de post-compilation</h2></div></div></div>
<p>
...
<div class="example">
<a name="id3035874"></a><p class="title"><b>Example 16.7. Plugin de filtre de post-compilation</b></p>
...
<div class="example">
<a name="id3035891"></a><p class="title"><b>Example 16.8. Plugin de filtre de post-compilation</b></p>
<div class="example-contents"><pre class="programlisting">
...
<br class="example-break"><p>
  Voir aussi
  <a class="link" href="api.register.prefilter.tpl" title="register_prefilter()">
  <code class="varname">register_prefilter()</code></a>,
  <a class="link" href="api.unregister.prefilter.tpl" title="unregister_prefilter()">
  <code class="varname">unregister_prefilter()</code></a>
  <a class="link" href="api.register.postfilter.tpl" title="register_postfilter()">
  <code class="varname">register_postfilter()</code></a> et
  <a class="link" href="api.unregister.postfilter.tpl" title="unregister_postfilter()">
  <code class="varname">unregister_postfilter()</code></a>.
 </p>
</div>
<div class="navfooter">
<hr>
...
<tr>
<td width="40%" align="left" valign="top">Fonctions de compilation </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Filtres de sortie</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 2 plus 11? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/plugins.prefilters.postfilters.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02081 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
