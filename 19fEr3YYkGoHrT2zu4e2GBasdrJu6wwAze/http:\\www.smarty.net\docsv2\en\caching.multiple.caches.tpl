...
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 19:20:12 GMT
...
<html lang="en">
  <head>
    ...
    <title>Multiple Caches Per Page | Smarty</title>
...
<p>
     ...
     or <a class="link" href="api.fetch.tpl" title="fetch()"><code class="varname">fetch()</code></a>.
...
<div class="example">
<a name="id2870370"></a><p class="title"><b>Example 14.6. Passing a $cache_id to display()</b></p>
...
<p>
     ...
     second parameter to
     <a class="link" href="api.is.cached.tpl" title="is_cached()"><code class="varname">is_cached()</code></a> and
     <a class="link" href="api.clear.cache.tpl" title="clear_cache()"><code class="varname">clear_cache()</code></a>.
    </p>
<div class="example">
<a name="id2871667"></a><p class="title"><b>Example 14.7. Passing a cache_id to is_cached()</b></p>
<div class="example-contents"><pre class="programlisting">
...
<div class="example">
<a name="id2871716"></a><p class="title"><b>Example 14.8. Clearing all caches for a particular $cache_id</b></p>
<div class="example-contents"><pre class="programlisting">
...
<td width="40%" align="right" valign="top"> Cache Groups</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/caching.multiple.caches.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02775 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
