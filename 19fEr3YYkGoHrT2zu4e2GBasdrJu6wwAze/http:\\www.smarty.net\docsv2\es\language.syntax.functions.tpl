http://www.smarty.net/docsv2/es/language.syntax.functions.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 19:31:24 GMT
...
<tr><th colspan="3" align="center">Funciones</th></tr>
<tr>
...
<div class="sect1" title="Funciones">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.syntax.functions"></a>Funciones</h2></div></div></div>
<p>
  Cada etiqueta Smarty muestra una
  <a class="link" href="language.variables.tpl" title="Chapter 4. Variables">variable</a> o utiliza algún 
  tipo de función. Las funciones son procesadas y mostradas colocando 
  los <a class="link" href="language.syntax.attributes.tpl" title="Atributos">atributos</a> de
  la función entre delimitadores, así: 
  {funcname attr1="val" attr2="val"}.
 </p>
<div class="example">
<a name="id3064939"></a><p class="title"><b>Example 3.3. Sintaxis de Funciones</b></p>
...
<br class="example-break"><p>
  ...
  la misma sintaxis dentro del template. Las funciones <span class="bold"><strong>internas</strong></span> que 
  funcionan en Smarty, son: 
  <a class="link" href="language.function.if.tpl" title="if,elseif,else">{if}</a>,
  <a class="link" href="language.function.section.tpl" title="section,sectionelse">{section}</a> y
  <a class="link" href="language.function.strip.tpl" title="{strip}">{strip}</a>.
  Estas no pueden ser modificadas. 
  Las funciones habituales son 
  funciones <span class="bold"><strong>adicionales</strong></span> implementadas 
  por <a class="link" href="plugins.tpl" title="Chapter 16. Extendiendo Smarty con plugins">plugins</a>. Estas si pueden
  ser modificadas como usted quiera, o usted también puede 
  adicionar nuevas.
  <a class="link" href="language.function.html.options.tpl" title="{html_options}">{html_options}</a> y 
  <a class="link" href="language.function.popup.tpl" title="popup">{popup}</a>
...
<td width="40%" align="right" valign="top"> Atributos</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="fbda0ca3cbabc3a6fa9aefbf4772ea69">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.syntax.functions.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02890 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
