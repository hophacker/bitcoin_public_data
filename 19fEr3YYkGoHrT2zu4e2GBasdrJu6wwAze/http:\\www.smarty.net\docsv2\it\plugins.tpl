http://www.smarty.net/docsv2/it/plugins.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 16:03:37 GMT
...
<html lang="en">
  <head>
    ...
    <title>Chapter 16. Estendere Smarty con i Plugin | Smarty</title>
...
<tr><th colspan="3" align="center">Chapter 16. Estendere Smarty con i Plugin</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="template.resources.tpl">Prev</a> </td>
...
<div class="chapter" title="Chapter 16. Estendere Smarty con i Plugin">
<div class="titlepage"><div><div><h2 class="title">
<a name="plugins"></a>Chapter 16. Estendere Smarty con i Plugin</h2></div></div></div>
<div class="toc">
...
<p>
   ...
   viene usata per quasi tutte le funzionalità personalizzabili
   di Smarty. Queste comprendono:
   </p>
<div class="itemizedlist"><ul class="itemizedlist" type="disc" compact>
<li class="listitem">funzioni</li>
<li class="listitem">modificatori</li>
<li class="listitem">funzioni di blocco</li>
<li class="listitem">funzioni di compilazione</li>
<li class="listitem">prefiltri</li>
<li class="listitem">postfiltri</li>
<li class="listitem">filtri di output</li>
<li class="listitem">risorse</li>
<li class="listitem">insert</li>
</ul></div>
<p>
   Con l'eccezione delle risorse, viene preservata la compatibilità 
   ...
   modificavate direttamente le variabili di classe <code class="literal">$custom_funcs</code>,
   <code class="literal">$custom_mods</code> e altre, ora dovrete modificare i
   vostri script per usare l'API oppure convertire in plugin le vostre
   funzionalità personalizzate.
  </p>
<div class="sect1" title="Come funzionano i Plugin">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="plugins.howto"></a>Come funzionano i Plugin</h2></div></div></div>
<p>
...
<p>
    La <a class="link" href="variable.plugins.dir.tpl" title="$plugins_dir">$plugins_dir</a> può
...
<tr>
<td width="40%" align="left" valign="top">Risorse </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Convenzioni per i nomi</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 20 plus 7? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/plugins.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02872 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
