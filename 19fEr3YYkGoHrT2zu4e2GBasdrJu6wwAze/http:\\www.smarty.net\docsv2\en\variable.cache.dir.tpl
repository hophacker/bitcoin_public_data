http://www.smarty.net/docsv2/en/variable.cache.dir.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 14:39:55 GMT
...
<p>
     You can also use your own
       <a class="link" href="section.template.cache.handler.func.tpl" title="Cache Handler Function">
...
<td width="40%" align="right" valign="top"> $cache_lifetime</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/variable.cache.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01714 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
