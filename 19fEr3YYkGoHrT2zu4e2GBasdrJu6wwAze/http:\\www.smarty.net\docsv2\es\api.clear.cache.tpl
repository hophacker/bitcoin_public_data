http://www.smarty.net/docsv2/es/api.clear.cache.tpl
HTTP/1.1 200 OK
...
<h2>Name</h2>
<p>clear_cache() — Esto limpia el cache de un template especifico</p>
</div>
<div class="refsect1" title="Descripción">
<a name="id3128296"></a><h2>Descripción</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">clear_cache</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">template</span></span>,<br>                 <span class="methodparam"><span class="type">string </span><span class="parameter">cache_id</span></span>,<br>                 <span class="methodparam"><span class="type">string </span><span class="parameter">compile_id</span></span>,<br>                 <span class="methodparam"><span class="type">int </span><span class="parameter">expire_time</span></span>);</code><p>
   Si usted tiene <a class="link" href="caching.multiple.caches.tpl" title="Multiples caches por pagina">multiples</a> caches 
   en este archivo, usted puede limpiar un cache especifico proporcionando el 
   <em class="parameter"><code>cache_id</code></em> como segundo parámetro Usted también puede pasar 
   el  <a class="link" href="variable.compile.id.tpl" title="$compile_id"><em class="parameter"><code>$compile_id</code></em></a> 
   como un tercer parámetro. Usted puede <a class="link" href="caching.groups.tpl" title="Cache Groups">"agrupar"</a> 
   templates conjuntamente de esta manera estos pueden ser removidos como un grupo. 
   Vea el <a class="link" href="caching.tpl" title="Chapter 14. Cache">caching section</a> para mayor información.
...
<div class="example">
<a name="id3128681"></a><p class="title"><b>Example 13.8. clear_cache()</b></p>
...
<br class="example-break"><p>
  ...
  y
  <a class="link" href="caching.tpl" title="Chapter 14. Cache">caching</a>.
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> clear_compiled_tpl()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/api.clear.cache.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02326 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
