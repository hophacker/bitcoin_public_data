http://www.smarty.net/docsv2/it/variable.use.sub.dirs.tpl
HTTP/1.1 200 OK
...
<p>
          Impostate questo valore a false se il vostro ambiente PHP non consente
          la creazione di sottodirectory da parte di Smarty. Le sottodirectory sono
          più efficienti, quindi usatele se potete.
      </p>
<div class="note" title="Nota tecnica" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Nota tecnica</h3>
<p>
          A partire da Smarty-2.6.2 <code class="varname">use_sub_dirs</code> per default vale false.
      </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> $default_modifiers</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/variable.use.sub.dirs.tpl">
            </form>
            </div>
          </div>
