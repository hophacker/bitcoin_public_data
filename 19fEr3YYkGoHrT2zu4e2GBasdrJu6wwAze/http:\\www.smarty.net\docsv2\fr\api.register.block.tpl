http://www.smarty.net/docsv2/fr/api.register.block.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 22:10:41 GMT
...
<h2>Name</h2>
<p>register_block() — Déclare dynamiquement des plugins de fonction de blocs</p>
</div>
<div class="refsect1" title="Description">
<a name="id3011998"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">register_block</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">name</span></span>,<br>                    <span class="methodparam"><span class="type">mixed </span><span class="parameter">impl</span></span>,<br>                    <span class="methodparam"><span class="type">bool </span><span class="parameter">cacheable</span></span>,<br>                    <span class="methodparam"><span class="type">mixed </span><span class="parameter">cache_attrs</span></span>);</code><p>
   Utilisée pour déclarer dynamiquement des <a class="link" href="plugins.block.functions.tpl" title="Fonctions de blocs">plugins de fonction
   de blocs</a>. Il faut passer en paramètre le nom de la fonction
...
<p>
   Les paramètre <em class="parameter"><code>cacheable</code></em> et
   <em class="parameter"><code>cache_attrs</code></em> peuvent être omis dans la plupart
   des cas. Voir <a class="link" href="caching.cacheable.tpl" title="Contrôler la mise en cache des sorties des Plugins">Contrôler la mise en cache des sorties des Plugins</a>
   pour plus d'informations concernant cette utilisation.
  </p>
<div class="example">
<a name="id3012821"></a><p class="title"><b>Example 13.22. Exemple avec register_block()</b></p>
...
<br class="example-break"><p>
   Voir aussi
   <a class="link" href="api.unregister.block.tpl" title="unregister_block()"><code class="varname">unregister_block()</code></a> et
   les <a class="link" href="plugins.block.functions.tpl" title="Fonctions de blocs">plugins de fonction de blocs</a>.
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> register_compiler_function()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/api.register.block.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01985 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
