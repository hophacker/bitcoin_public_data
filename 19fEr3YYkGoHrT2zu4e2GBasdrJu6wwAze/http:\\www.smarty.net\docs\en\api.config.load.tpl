...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 16:03:42 GMT
...
<h2>Name</h2>
<p>configLoad() —  loads config file  data and assigns it to the template</p>
</div>
<div class="refsect1" title="Description">
<a name="idp15806176"></a><h2>Description</h2>
...
<p>
    ...
    <code class="varname">configLoad()</code> are always global in scope.
...
<div class="example">
<a name="idp15871248"></a><p class="title"><b>Example 14.16. configLoad()</b></p>
...
<td width="40%" align="right" valign="top"> createData()</td>
          ...
          <div class="commentInfo">
              ...
              <div class="commentAuthor">by <b>dark alex</b> on Jan  5, 2012 at  6:50</div>
              <div class="commentBody">I'd like to suggest using func_get_args to be able to specify more than one section:

$smarty-&gt;configLoad('my.conf', 'foo', 'bar', 'bell');</div>
            </div>
                              </div>
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/api.config.load.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.04237 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
