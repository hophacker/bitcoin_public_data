http://www.smarty.net/docsv2/es/variable.config.overwrite.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 07:37:19 GMT
...
<p>
       ...
       <a class="link" href="config.files.tpl" title="Chapter 9. Config Files">archivo de configuración</a> se 
...
<div class="example">
<a name="id3120635"></a><p class="title"><b>Example 12.2. Arreglo de variables de configuración</b></p>
<div class="example-contents">
<p>
      Este ejemplo utiliza 
      <a class="link" href="language.function.cycle.tpl" title="cycle">{cycle}</a> para
      la salida a una tabla alternando colores por renglon rojo/verde/azul 
      con $config_overwrite = false.
    </p>
<p>El archivo de configuración.</p>
...
<p>
      ...
      <a class="link" href="language.function.section.tpl" title="section,sectionelse">{section}</a>.
      </p>
<pre class="programlisting">
...
<td width="40%" align="right" valign="top"> $config_booleanize</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/variable.config.overwrite.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01804 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
