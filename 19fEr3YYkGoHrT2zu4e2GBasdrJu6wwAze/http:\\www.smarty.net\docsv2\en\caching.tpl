...
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 11:22:35 GMT
...
<p>
   Caching is used to speed up a call to <a class="link" href="api.display.tpl" title="display()"><code class="varname">display()</code></a> or <a class="link" href="api.fetch.tpl" title="fetch()"><code class="varname">fetch()</code></a> by saving its output
   to a file. If a
   ...
   <a class="link" href="api.fetch.tpl" title="fetch()"><code class="varname">fetch()</code></a> is cached,
...
<p>
    The first thing to do is enable caching by setting <a class="link" href="variable.caching.tpl" title="$caching">
    <em class="parameter"><code>$caching</code></em></a><code class="literal"> = 1 (or 2)</code>.
   </p>
<div class="example">
<a name="id2870065"></a><p class="title"><b>Example 14.1. Enabling caching</b></p>
...
<p>
    Each cached page has a limited lifetime determined by <a class="link" href="variable.cache.lifetime.tpl" title="$cache_lifetime"><em class="parameter"><code>$cache_lifetime</code></em></a>.
    ...
    See <a class="link" href="variable.cache.lifetime.tpl" title="$cache_lifetime"><em class="parameter"><code>$cache_lifetime</code></em></a>
    for more details.
   </p>
<div class="example">
<a name="id2870800"></a><p class="title"><b>Example 14.2. Setting $cache_lifetime per cache</b></p>
<div class="example-contents"><pre class="programlisting">
...
<br class="example-break"><p>
    If <a class="link" href="variable.compile.check.tpl" title="$compile_check">
...
<div class="example">
<a name="id2870875"></a><p class="title"><b>Example 14.3. Enabling $compile_check</b></p>
<div class="example-contents"><pre class="programlisting">
...
<br class="example-break"><p>
    If <a class="link" href="variable.force.compile.tpl" title="$force_compile">
    ...
    <a class="link" href="chapter.debugging.console.tpl" title="Chapter 10. Debugging Console">debugging</a>
    purposes only, a more  efficient way of disabling caching is to set <a class="link" href="variable.caching.tpl" title="$caching"><em class="parameter"><code>$caching</code></em>
    </a><code class="literal"> = 0</code>.
   </p>
<p>
    The <a class="link" href="api.is.cached.tpl" title="is_cached()"><code class="varname">is_cached()</code></a>
    function
...
<div class="example">
<a name="id2870964"></a><p class="title"><b>Example 14.4. Using is_cached()</b></p>
<div class="example-contents"><pre class="programlisting">
...
<br class="example-break"><p>
    You can keep parts of a page dynamic with the <a class="link" href="language.function.insert.tpl" title="{insert}"><code class="varname">{insert}</code></a>
...
<p>
    You can clear all the cache files with the <a class="link" href="api.clear.all.cache.tpl" title="clear_all_cache()"><code class="varname">clear_all_cache()</code></a>
    function, or
    individual cache files
    <a class="link" href="caching.groups.tpl" title="Cache Groups">and groups</a>
    with the <a class="link" href="api.clear.cache.tpl" title="clear_cache()"><code class="varname">clear_cache()</code></a> function.
   </p>
<div class="example">
<a name="id2871051"></a><p class="title"><b>Example 14.5. Clearing the cache</b></p>
<div class="example-contents"><pre class="programlisting">
...
<td width="40%" align="right" valign="top"> Multiple Caches Per Page</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="044e68eb15d110e60e1862529e313c4c">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/caching.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01483 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
