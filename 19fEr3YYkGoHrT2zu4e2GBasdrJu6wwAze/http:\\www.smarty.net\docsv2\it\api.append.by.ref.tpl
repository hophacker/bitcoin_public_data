http://www.smarty.net/docsv2/it/api.append.by.ref.tpl
HTTP/1.1 200 OK
...
<div class="example">
<a name="id3140218"></a><p class="title"><b>Example 13.2. append_by_ref</b></p>
...
<td width="40%" align="right" valign="top"> assign</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/api.append.by.ref.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03196 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
