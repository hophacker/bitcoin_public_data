http://www.smarty.net/docsv2/en/variable.caching.tpl
HTTP/1.1 200 OK
...
<p>
       ...
       <em class="parameter"><code>$caching</code></em>, as this  will result in significant
       performance gains.
	   </p>
<p>
	   You can also have
...
<li class="listitem"><p>A value of 2 tells Smarty to use the
       <a class="link" href="variable.cache.lifetime.tpl" title="$cache_lifetime"><em class="parameter"><code>$cache_lifetime</code></em></a>
   ...
   the template to have granular control over when that particular cache expires.
	   See also <a class="link" href="api.is.cached.tpl" title="is_cached()"><code class="varname">is_cached()</code></a>.
           </p></li>
<li class="listitem"><p>
...
<td width="40%" align="right" valign="top"> $cache_dir</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/variable.caching.tpl">
            </form>
            </div>
          </div>
