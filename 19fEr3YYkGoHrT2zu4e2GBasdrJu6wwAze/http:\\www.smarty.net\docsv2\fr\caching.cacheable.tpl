http://www.smarty.net/docsv2/fr/caching.cacheable.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 06:25:09 GMT
...
<html lang="en">
  <head>
    ...
    <title>Contrôler la mise en cache des sorties des Plugins | Smarty</title>
...
<tr><th colspan="3" align="center">Contrôler la mise en cache des sorties des Plugins</th></tr>
<tr>
...
<div class="sect1" title="Contrôler la mise en cache des sorties des Plugins">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="caching.cacheable"></a>Contrôler la mise en cache des sorties des Plugins</h2></div></div></div>
<p>
  ...
  et <a class="link" href="api.register.block.tpl" title="register_block()"><code class="varname">register_function()</code></a> sont appelés
  <em class="parameter"><code>$cacheable</code></em> et valent <code class="constant">TRUE</code> par défaut, ce qui est
  aussi le comportement par défaut des versions de Smarty précédent la 2.6.0
 </p>
<p>
  Lors de l'inscription d'un plugin avec <code class="literal">$cacheable=false</code>, le plugin est
  ...
  <a class="link" href="plugins.inserts.tpl" title="Insertions"><code class="varname">{insert}</code></a>.
  </p>
<p>
   Contrairement à <a class="link" href="plugins.inserts.tpl" title="Insertions"><code class="varname">{insert}</code></a>
...
<div class="example">
<a name="id3027727"></a><p class="title"><b>Example 14.10. Eviter la mise en cache du résultat d'un plugin</b></p>
...
<p>
    Où <code class="filename">index.tpl</code> contient :
   </p>
<pre class="programlisting">
...
<p>
    Le nombre de secondes avant que la date de fin de <code class="literal">$obj</code> ne soit atteinte
...
<a name="id3027799"></a><p class="title"><b>Example 14.11. Eviter la mise en cache d'une portion du template</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<br class="example-break"><p>
   ...
   différentes. L'une est <span class="quote">“<span class="quote">dynamic</span>”</span> et l'autre est <span class="quote">“<span class="quote">static</span>”</span>.
   Vous pouvez faire ce que vous voulez entre <code class="literal">{dynamic}...{/dynamic}</code>
...
<tr>
<td width="40%" align="left" valign="top">Groupes de fichiers de cache </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Chapter 15. Fonctionnalités avancées</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/caching.cacheable.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03542 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
