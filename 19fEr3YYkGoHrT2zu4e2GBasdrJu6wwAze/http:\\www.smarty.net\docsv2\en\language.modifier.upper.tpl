http://www.smarty.net/docsv2/en/language.modifier.upper.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 09:51:33 GMT
...
<div class="example">
<a name="id2793999"></a><p class="title"><b>Example 5.22. upper</b></p>
...
<td width="40%" align="right" valign="top"> wordwrap</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 17 plus 19? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/language.modifier.upper.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.00862 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
