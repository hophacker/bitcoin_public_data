http://www.smarty.net/docsv2/fr/language.syntax.quotes.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 01:39:26 GMT
...
<html lang="en">
  <head>
    ...
    <title>Variables insérées dans des chaînes de caractères | Smarty</title>
...
<tr><th colspan="3" align="center">Variables insérées dans des chaînes de caractères</th></tr>
<tr>
...
<div class="sect1" title="Variables insérées dans des chaînes de caractères">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.syntax.quotes"></a>Variables insérées dans des chaînes de caractères</h2></div></div></div>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>
  Smarty est capable d'interpréter les
  <a class="link" href="language.syntax.variables.tpl" title="Variables">variables</a>  <a class="link" href="api.assign.tpl" title="assign()">assignées</a> à l'intérieur de
  chaînes entre guillemets, du moment que leur nom est exclusivement composé
  de chiffres, lettres, underscores et crochets
  Voir le <a class="ulink" href="http://php.net/language.variables" target="_top">nommage</a> pour plus de détails.
  </p></li>
<li class="listitem"><p>
  Si le nom de la variable
  contient tout autre caractère (point, référence à un objet, etc.)
  la variable doit être entourée <a class="link" href="language.syntax.quotes.tpl" title="Variables insérées dans des chaînes de caractères">d'apostrophes
  inverses</a> (`).
  </p></li>
<li class="listitem"><p>
  Vous ne pouvez jamais insérer de
  <a class="link" href="language.modifiers.tpl" title="Chapter 5. Modificateurs de variables">modificateurs</a>, ils doivent toujours être appliquer à
  l'extérieur des guillemets.
 </p></li>
</ul></div>
<div class="example">
<a name="id2930704"></a><p class="title"><b>Example 3.5. Exemples de synthaxes</b></p>
...
<a name="id2930715"></a><p class="title"><b>Example 3.6. Exemples pratiques</b></p>
<div class="example-contents"><pre class="programlisting">
...
<tr>
<td width="40%" align="left" valign="top">Paramètres </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Opérations mathématiques</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 7 plus 0? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/language.syntax.quotes.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01664 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
