http://www.smarty.net/docsv2/it/language.function.ldelim.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 11:55:13 GMT
...
<p>
   ...
   "{" o "}". Potete usare anche <a class="link" href="language.function.literal.tpl" title="literal">{literal}{/literal}</a> per fare l'escape su
    blocchi di testo.
    Vedere anche <a class="link" href="language.variables.smarty.tpl#language.variables.smarty.ldelim" title="{$smarty.ldelim}">{$smarty.ldelim}</a>
    e <a class="link" href="language.variables.smarty.tpl#language.variables.smarty.rdelim" title="{$smarty.rdelim}">{$smarty.rdelim}</a>
  </p>
<div class="example">
<a name="id3107208"></a><p class="title"><b>Example 7.12. ldelim, rdelim</b></p>
...
<td width="40%" align="right" valign="top"> literal</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/language.function.ldelim.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03525 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
