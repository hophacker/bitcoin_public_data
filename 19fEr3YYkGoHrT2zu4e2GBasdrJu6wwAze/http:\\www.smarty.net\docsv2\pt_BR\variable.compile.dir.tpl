http://www.smarty.net/docsv2/pt_BR/variable.compile.dir.tpl
HTTP/1.1 200 OK
...
<tr>
<td width="40%" align="left" valign="top">Chapter 12. Variáveis </td>
...
<td width="40%" align="right" valign="top"> $config_dir</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/variable.compile.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02698 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
