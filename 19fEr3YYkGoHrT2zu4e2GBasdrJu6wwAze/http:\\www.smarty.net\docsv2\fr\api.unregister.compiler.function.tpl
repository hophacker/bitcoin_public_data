http://www.smarty.net/docsv2/fr/api.unregister.compiler.function.tpl
HTTP/1.1 200 OK
...
<h2>Name</h2>
<p>unregister_compiler_function() — Désalloue dynamiquement une fonction de compilation</p>
</div>
<div class="refsect1" title="Description">
<a name="id3016972"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">unregister_compiler_function</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">name</span></span>);</code><p>
   Passez en paramètre le nom <em class="parameter"><code>name</code></em> de
   la fonction de compilation.
  </p>
<p>
   Voir aussi
   <a class="link" href="api.register.compiler.function.tpl" title="register_compiler_function()">
    <code class="varname">register_compiler_function()</code></a> et
...
<td width="40%" align="right" valign="top"> unregister_function()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/api.unregister.compiler.function.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02415 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
