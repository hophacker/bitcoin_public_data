...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 09:35:56 GMT
...
<p>
     ...
     <code class="filename">./templates_c</code>, meaning that Smarty
     will look for the <code class="filename">templates_c/</code>
      directory in the same directory as
     the executing php script. <span class="bold"><strong>This directory must
...
<p>
     See also <a class="link" href="variable.compile.id.tpl" title="$compile_id"><em class="parameter"><code>$compile_id</code></em></a>
     and
...
<tr>
<td width="40%" align="left" valign="top">Chapter 12. Smarty Class Variables </td>
...
<td width="40%" align="right" valign="top"> $config_dir</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/variable.compile.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02008 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
