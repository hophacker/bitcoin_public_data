http://www.smarty.net/docsv2/es/language.syntax.variables.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 14:43:02 GMT
...
<p>
  ...
  Pueden contener números, letras y guiones bajos, muy parecido a 
  las <a class="ulink" href="http://php.net/language.variables" target="_top">variables de PHP</a>. 
  Usted también puede hacer referencia a arreglos que puden ser numericos o 
  no-numericos. También puede hacer referencia a métodos y propiedades de objetos. 
  <a class="link" href="language.config.variables.tpl" title="Variables cargadas desde archivos de configuración">Config file variables</a> es una 
  excepción de la sintaxis del signo de pesos. 
  También puede ser referenciado entre #signos de numeros#, o con la
  variable especial <a class="link" href="language.variables.smarty.tpl#language.variables.smarty.config" title="{$smarty.config}">$smarty.config</a>.
 </p>
<div class="example">
<a name="id3064747"></a><p class="title"><b>Example 3.2. Variables</b></p>
...
<br class="example-break"><p>
   Vea también <a class="link" href="language.variables.smarty.tpl" title="La variable reservada {$smarty}">$smarty reserved variables</a>
   y <a class="link" href="language.config.variables.tpl" title="Variables cargadas desde archivos de configuración">Config Variables</a>.
  </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> Funciones</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="0ac7bef13f8e050ba90f7df95ffc2785">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.syntax.variables.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01550 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
