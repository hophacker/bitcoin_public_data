...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 03:42:21 GMT
...
<html lang="en">
  <head>
    ...
    <title>Controlling Cacheability of Output | Smarty</title>
    <meta name="description" content="Controlling Cacheability of Output">
    <meta name="keywords" content="controlling, cacheability, of, output">
...
<tr><th colspan="3" align="center">Controlling Cacheability of Output</th></tr>
<tr>
...
<p>
    A larger section of your template can easily excluded from caching by using the <a class="link" href="language.function.nocache.tpl" title="{nocache}"><code class="varname">{nocache}</code></a>
    and <a class="link" href="language.function.nocache.tpl" title="{nocache}"><code class="varname">{/nocache}</code></a> tags.
   </p>
<div class="example">
<a name="idp18375760"></a><p class="title"><b>Example 15.10. Preventing a template section from being cached</b></p>
...
<div class="example">
<a name="idp18432496"></a><p class="title"><b>Example 15.11. Preventing tag output from being cached</b></p>
...
<p>
    You can <a class="link" href="api.assign.tpl" title="assign()"><code class="varname">assign()</code></a> variables as not cachable.
...
<div class="example">
<a name="idp18439456"></a><p class="title"><b>Example 15.12. Nocache Variables</b></p>
<div class="example-contents"><pre class="programlisting">
...
<p>
   ...
   <a class="link" href="plugins.inserts.tpl" title="Inserts"><code class="varname">{insert}</code></a> function.
  </p>
<div class="note" title="Note" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Note</h3>
<p>
...
<p>
   In contrast to <a class="link" href="plugins.inserts.tpl" title="Inserts"><code class="varname">{insert}</code>
   </a>
...
<div class="example">
<a name="idp18452640"></a><p class="title"><b>Example 15.13. Preventing a plugin's output from being cached</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<a name="idp18458736"></a><p class="title"><b>Example 15.14. Preventing a whole passage of a template from being cached</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<p>
    ...
    See <a class="link" href="caching.cacheable.tpl#cacheability.sections" title="Cacheability of Template Section"><em class="parameter"><code>Cacheability of Template Section</code></em></a> on how to disable 
    caching of a template section by the built-in <a class="link" href="language.function.nocache.tpl" title="{nocache}"><code class="varname">{nocache}</code></a>
    and <a class="link" href="language.function.nocache.tpl" title="{nocache}"><code class="varname">{/nocache}</code></a> tags.
   </p>
</div>
</div>
...
<td width="40%" align="right" valign="top"> Custom Cache Implementation</td>
</tr>
</table>
</div>
          ...
          <div class="commentInfo">
              ...
              <div class="commentAuthor">by <b>bordeux</b> on May  7, 2012 at 11:08</div>
              <div class="commentBody">great, but i would prefer {cache} tag.</div>
            </div>
                              </div>
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="789f976b5f78f75afd3730e72490f0f1">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/caching.cacheable.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02069 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
