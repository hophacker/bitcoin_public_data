http://www.smarty.net/docsv2/fr/api.unregister.resource.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 18:04:32 GMT
...
<h2>Name</h2>
<p>unregister_resource() — Désalloue dynamiquement un plugin ressource</p>
</div>
<div class="refsect1" title="Description">
<a name="id3018797"></a><h2>Description</h2>
...
<div class="example">
<a name="id3018716"></a><p class="title"><b>Example 13.29. Exemple avec unregister_resource()</b></p>
...
<br class="example-break"><p>
   Voir aussi
   <a class="link" href="api.register.resource.tpl" title="register_resource()"><code class="varname">register_resource()</code></a> et
...
<td width="40%" align="right" valign="top"> Chapter 14. Cache</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/api.unregister.resource.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02457 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
