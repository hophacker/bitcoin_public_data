http://www.smarty.net/docsv2/fr/language.modifier.nl2br.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 06:15:50 GMT
...
<p>
  Transforme toutes les fins de lignes en balises <code class="literal">&lt;br /&gt;</code>.
  Équivalent à la fonction PHP
  <a class="ulink" href="http://php.net/nl2br" target="_top"><code class="varname">nl2br()</code></a>.
 </p>
<div class="example">
<a name="id2939787"></a><p class="title"><b>Example 5.14. nl2br</b></p>
...
<br class="example-break"><p>
  ...
  <a class="link" href="language.modifier.count.paragraphs.tpl" title="count_paragraphs"><code class="varname">count_paragraphs</code></a> et
...
<td width="40%" align="right" valign="top"> regex_replace</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/language.modifier.nl2br.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02759 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
