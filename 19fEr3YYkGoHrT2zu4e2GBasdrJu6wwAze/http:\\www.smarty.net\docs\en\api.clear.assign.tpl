...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 15:51:40 GMT
...
<h2>Name</h2>
<p>clearAssign() — clears the value of an assigned variable</p>
</div>
<div class="refsect1" title="Description">
<a name="idp15562176"></a><h2>Description</h2>
...
<div class="example">
<a name="idp15620880"></a><p class="title"><b>Example 14.10. clearAssign()</b></p>
...
<td width="40%" align="right" valign="top"> clearCache()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/api.clear.assign.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02436 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
