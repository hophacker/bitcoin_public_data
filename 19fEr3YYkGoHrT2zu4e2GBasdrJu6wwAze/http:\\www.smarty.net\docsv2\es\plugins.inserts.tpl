http://www.smarty.net/docsv2/es/plugins.inserts.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 12:23:14 GMT
...
<p>
    ...
    <a class="link" href="language.function.insert.tpl" title="insert"><span class="command"><strong>insert</strong></span></a>
    en el template.
    </p>
...
<p>
     El primer parámetro de la función es un arreglo asociativo de
     atributos pasados al insert. 
    </p>
<p>
     La función insert debe retornar el resultado que ira a sustituir
     el lugar de la etiqueta <span class="command"><strong>insert</strong></span> en el template.
    </p>
<div class="example">
<a name="id3154040"></a><p class="title"><b>Example 16.11. insert plugin</b></p>
...
<tr>
<td width="40%" align="left" valign="top">Fuentes </td>
...
<td width="40%" align="right" valign="top"> Part IV. Appendixes</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/plugins.inserts.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03874 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
