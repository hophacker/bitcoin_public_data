...
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 19:20:14 GMT
...
<p>
  The <code class="varname">{php}</code> tags allow PHP code to be embedded directly into the template. They
  will not be escaped, regardless of the <a class="link" href="variable.php.handling.tpl" title="$php_handling"><em class="parameter"><code>$php_handling</code></em></a> setting. This
...
<p>
   To access PHP variables in <code class="varname">{php}</code> blocks you will need to use the PHP
   <a class="ulink" href="http://php.net/global" target="_top"><code class="literal">global</code></a>
   keyword.
</p>
</div>
<div class="example">
<a name="id2807119"></a><p class="title"><b>Example 7.28. php code within {php} tags</b></p>
...
<a name="id2807132"></a><p class="title"><b>Example 7.29. {php} tags with global and assigning a variable</b></p>
<div class="example-contents"><pre class="programlisting">
...
<br class="example-break"><p>
  ...
  and
  <a class="link" href="tips.componentized.templates.tpl" title="Componentized Templates">componentized templates</a>.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> {section},{sectionelse}</td>
          ...
          <div class="commentInfo">
              ...
              <div class="commentAuthor">by <b>Bojan</b> on Apr 27, 2012 at  8:34</div>
              <div class="commentBody">Do not forget to include global $smarty inside {php} tags!</div>
            </div>
                      <div class="commentWrapperEven">
              <div class="commentAuthor">by <b>greg</b> on Dec 13, 2011 at  8:35</div>
              <div class="commentBody">isn't this deprecated now?  what is the substitute for file includes?</div>
            </div>
                              </div>
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/language.function.php.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02681 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
