http://www.smarty.net/docsv2/en/variable.config.overwrite.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 14:40:19 GMT
...
<p>
    If set to <code class="constant">TRUE</code>, the default then variables read in from
    <a class="link" href="config.files.tpl" title="Chapter 9. Config Files">config files</a> will overwrite each
...
<div class="example">
<a name="id2843016"></a><p class="title"><b>Example 12.4. Array of config #variables#</b></p>
...
<p>
      ...
      with <em class="parameter"><code>$config_overwrite</code></em> = <code class="constant">FALSE</code>.
    </p>
<p>The config file.</p>
...
<p>
      The template with a <a class="link" href="language.function.section.tpl" title="{section},{sectionelse}">
      <code class="varname">{section}</code></a> loop.
      </p>
<pre class="programlisting">
...
<br class="example-break"><p>
    ...
    and the <a class="link" href="config.files.tpl" title="Chapter 9. Config Files">config files section</a>.
  </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $config_booleanize</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 20 plus 13? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/variable.config.overwrite.tpl">
            </form>
            </div>
          </div>
