http://www.smarty.net/docs/en/variable.cache.dir.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 13:45:43 GMT
...
<p>
     ...
     <a class="link" href="installing.smarty.basic.tpl" title="Basic Installation">see install</a> for more info.
     </p>
<p>
     You can also use your own <a class="link" href="caching.custom.tpl" title="Custom Cache Implementation">custom cache implementation</a>
...
<p>
        ...
        <a class="link" href="api.get.cache.dir.tpl" title="getCacheDir()"><code class="varname">getCacheDir()</code></a> and 
        <a class="link" href="api.set.cache.dir.tpl" title="setCacheDir()"><code class="varname">setCacheDir()</code></a> instead.
       </p>
</div>
<p>
  See also
...
<td width="40%" align="right" valign="top"> $cache_id</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/variable.cache.dir.tpl">
            </form>
            </div>
          </div>
