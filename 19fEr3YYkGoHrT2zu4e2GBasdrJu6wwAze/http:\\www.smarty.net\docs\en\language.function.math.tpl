...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 13:45:09 GMT
...
<p>
   <code class="varname">{math}</code> allows the template designer to do math equations
   in the template.
   </p>
...
<li class="listitem"><p>+, -, /, *, abs, ceil, cos,  exp, floor, log, log10, max, min,
   ...
   <a class="ulink" href="http://php.net/eval" target="_top">math</a> functions.
  </p></li>
<li class="listitem"><p>
   If you supply the <em class="parameter"><code>assign</code></em> attribute, the output of the
   <code class="varname">{math}</code> function will be assigned to this template
...
<p>
   <code class="varname">{math}</code> is an expensive function in performance due to
   its use of the php <a class="ulink" href="http://php.net/eval" target="_top">
   <code class="varname">eval()</code></a> function. Doing the math in PHP is much
   more  efficient, so whenever possible do the math calculations in the script
   and <a class="link" href="api.assign.tpl" title="assign()"><code class="varname">assign()</code></a>
   the results to the template. Definitely avoid  repetitive
   <code class="varname">{math}</code> function calls, eg within
    <a class="link" href="language.function.section.tpl" title="{section},{sectionelse}">
    <code class="varname">{section}</code></a> loops.
  </p>
</div>
...
<div class="example">
<a name="idp12790336"></a><p class="title"><b>Example 8.21. {math}</b></p>
...
<td width="40%" align="right" valign="top"> {textformat}</td>
          ...
          <div class="commentInfo">
              ...
              <div class="commentAuthor">by <b>unreal4u</b> on Mar 13, 2013 at  3:46</div>
              <div class="commentBody">Don't forget that from Smarty 3 expressions can be used almost anywhere, so instead of using {math}:
...
Greetings.</div>
              ...
              <div class="commentAuthor">by <b>Rishad</b> on Aug 10, 2012 at  8:57</div>
              <div class="commentBody">If you want to use the pow operator:
{math assign=&quot;b&quot; equation=&quot;pow(2,$y)&quot;}
</div>
            </div>
                              </div>
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/language.function.math.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02543 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
