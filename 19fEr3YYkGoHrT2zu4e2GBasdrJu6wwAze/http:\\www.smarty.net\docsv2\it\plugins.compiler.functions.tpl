http://www.smarty.net/docsv2/it/plugins.compiler.functions.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 22:10:20 GMT
...
<html lang="en">
  <head>
    ...
    <title>Funzioni di Compilazione | Smarty</title>
...
<tr><th colspan="3" align="center">Funzioni di Compilazione</th></tr>
<tr>
...
<div class="sect1" title="Funzioni di Compilazione">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="plugins.compiler.functions"></a>Funzioni di Compilazione</h2></div></div></div>
<p>
...
<p>
     See also
     <a class="link" href="api.register.compiler.function.tpl" title="register_compiler_function">register_compiler_function()</a>,
     <a class="link" href="api.unregister.compiler.function.tpl" title="unregister_compiler_function">unregister_compiler_function()</a>.
    </p>
<div class="example">
<a name="id3160455"></a><p class="title"><b>Example 16.6. semplice funzione di compilazione</b></p>
...
<tr>
<td width="40%" align="left" valign="top">Funzioni sui blocchi </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Prefiltri/Postfiltri</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 14 plus 4? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/plugins.compiler.functions.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01806 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
