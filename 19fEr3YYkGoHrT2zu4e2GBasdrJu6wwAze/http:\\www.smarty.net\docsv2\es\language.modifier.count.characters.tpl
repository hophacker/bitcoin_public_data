http://www.smarty.net/docsv2/es/language.modifier.count.characters.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 17:50:55 GMT
...
<td>Este determina cuando incluir o no los espacios
       en blanco al contar.</td>
</tr></tbody>
</table></div>
<p>
...
<div class="example">
<a name="id3069272"></a><p class="title"><b>Example 5.4. count_characters</b></p>
...
<br class="example-break"><p>
   ver también
   <a class="link" href="language.modifier.count.words.tpl" title="count_words">count_words</a>,
   <a class="link" href="language.modifier.count.sentences.tpl" title="count_sentences">count_sentences</a> y
...
<td width="40%" align="right" valign="top"> count_paragraphs</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 13 plus 2? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.modifier.count.characters.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02708 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
