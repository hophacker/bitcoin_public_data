http://www.smarty.net/docsv2/en/plugins.resources.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 19:29:26 GMT
...
<li class="listitem"><p>
     ...
     components requested by <a class="link" href="language.function.include.php.tpl" title="{include_php}">
...
<div class="example">
<a name="id2881804"></a><p class="title"><b>Example 16.10. resource plugin</b></p>
...
<br class="example-break"><p>
 See also
 <a class="link" href="api.register.resource.tpl" title="register_resource()"><code class="varname">register_resource()</code></a>,
...
<td width="40%" align="right" valign="top"> Inserts</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/plugins.resources.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02191 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
