http://www.smarty.net/docsv2/it/variable.default.modifiers.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 13:45:25 GMT
...
<p>
          E' un array di modificatori da applicare implicitamente ad ogni variabile
          in un template. Ad esempio, per fare l'escape HTML ad ogni variabile per
          default, usate array('escape:"htmlall"'); per rendere una variabile
          esente dai modificatori di default, passatele lo speciale modificatore 
          "smarty" con il parametro "nodefaults", così: {$var|smarty:nodefaults}.
      </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $default_resource_type</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/variable.default.modifiers.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02252 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
