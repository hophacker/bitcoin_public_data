http://www.smarty.net/docsv2/fr/variable.debugging.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 21:33:08 GMT
...
<p>
  ...
  <a class="link" href="language.function.include.tpl" title="{include}">inclus</a> et des variables
  <a class="link" href="api.assign.tpl" title="assign()">assignées</a> depuis PHP et des
  <a class="link" href="language.config.variables.tpl" title="Variables chargées depuis des fichiers de configuration">variables des fichiers de configuration</a>
  pour le script courant. Il ne montre pas les variables assignées
...
<p>
  ...
  sur la façon d'activer le débogage depuis l'url.
 </p>
<p>
  Voir aussi
  <a class="link" href="language.function.debug.tpl" title="{debug}"><code class="varname">{debug}</code></a>,
  <a class="link" href="variable.debug.tpl.tpl" title="$debug_tpl"><em class="parameter"><code>$debug_tpl</code></em></a> et
  <a class="link" href="variable.debugging.ctrl.tpl" title="$debugging_ctrl"><em class="parameter"><code>$debugging_ctrl</code></em></a>.
 </p>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> $debug_tpl</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/variable.debugging.tpl">
            </form>
            </div>
          </div>
