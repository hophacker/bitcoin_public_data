http://www.smarty.net/docsv2/fr/language.function.config.load.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 15:21:36 GMT
...
<p>
  <code class="varname">{config_load}</code> est utiliseé pour charger des variables
  <a class="link" href="language.config.variables.tpl" title="Variables chargées depuis des fichiers de configuration"><em class="parameter"><code>#variables#</code></em></a>
  depuis un <a class="link" href="config.files.tpl" title="Chapter 9. Fichiers de configuration">fichier de configuration</a>
  dans un template.
 </p>
...
<td>Le nom du fichier de configuration à inclure</td>
</tr>
<tr>
...
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Le nom de la section à charger</td>
</tr>
<tr>
...
<div class="example">
<a name="id2950050"></a><p class="title"><b>Example 7.3. Fonction {config_load}</b></p>
<div class="example-contents">
<p>
   Le fichier <code class="filename">example.conf</code>
  </p>
...
<br class="example-break"><p>
  Les <a class="link" href="config.files.tpl" title="Chapter 9. Fichiers de configuration">fichiers de configuration</a> peuvent contenir des sections.
  Vous pouvez charger des variables d'une section donnée avec le
  nouvel attribut <em class="parameter"><code>section</code></em>.
 </p>
<div class="note" title="Note" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Note</h3>
<p>
   Les <span class="emphasis"><em>sections</em></span> des fichiers de configuration
...
<div class="example">
<a name="id2950144"></a><p class="title"><b>Example 7.4. fonction {config_load} avec section</b></p>
...
<br class="example-break"><p>
  Voir aussi <a class="link" href="variable.config.overwrite.tpl" title="$config_overwrite"><em class="parameter"><code>$config_overwrite</code></em></a>
  pour les tableaux de variables de configuration.
</p>
<p>
  Voir aussi
  les <a class="link" href="config.files.tpl" title="Chapter 9. Fichiers de configuration">fichiers de configuration</a>,
  ...
  <a class="link" href="api.get.config.vars.tpl" title="get_config_vars()"><code class="varname">get_config_vars()</code></a> et
...
<tr>
<td width="40%" align="left" valign="top">Chapter 7. Fonctions natives </td>
...
<td width="40%" align="right" valign="top"> {foreach},{foreachelse}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/language.function.config.load.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03017 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
