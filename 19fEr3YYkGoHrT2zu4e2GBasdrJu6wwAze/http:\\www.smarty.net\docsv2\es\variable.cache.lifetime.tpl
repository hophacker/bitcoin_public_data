http://www.smarty.net/docsv2/es/variable.cache.lifetime.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 13:45:26 GMT
...
<p>
     ...
     es asignar <a class="link" href="variable.caching.tpl" title="$caching">$caching</a> = false.)
    </p>
<p>
     Si <a class="link" href="variable.force.compile.tpl" title="$force_compile">$force_compile</a> 
     ...
     <a class="link" href="api.clear.all.cache.tpl" title="clear_all_cache">clear_all_cache()</a>,
     o archivos individuales de cache (o grupos) con la función 
     <a class="link" href="api.clear.cache.tpl" title="clear_cache()">clear_cache()</a>.
    </p>
...
<p>
       ...
       <a class="link" href="variable.caching.tpl" title="$caching">$caching</a> = 2, entonces 
       determina $cache_lifetime a un único valor justo antes de llamar 
       <a class="link" href="api.display.tpl" title="display()">display()</a>
       o <a class="link" href="api.fetch.tpl" title="fetch()">fetch()</a>.
     </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> $cache_handler_func</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 4 plus 0? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/variable.cache.lifetime.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01863 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
