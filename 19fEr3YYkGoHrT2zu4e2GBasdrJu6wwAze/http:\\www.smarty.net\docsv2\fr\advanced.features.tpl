http://www.smarty.net/docsv2/fr/advanced.features.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 06:16:20 GMT
...
<html lang="en">
  <head>
    ...
    <title>Chapter 15. Fonctionnalités avancées | Smarty</title>
...
<tr><th colspan="3" align="center">Chapter 15. Fonctionnalités avancées</th></tr>
<tr>
...
<div class="chapter" title="Chapter 15. Fonctionnalités avancées">
<div class="titlepage"><div><div><h2 class="title">
<a name="advanced.features"></a>Chapter 15. Fonctionnalités avancées</h2></div></div></div>
<div class="toc">
...
<div class="sect1" title="Objets">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="advanced.features.objects"></a>Objets</h2></div></div></div>
<p>
  Smarty donne l'accès aux <a class="ulink" href="http://php.net/object" target="_top">objets</a>
...
<li class="listitem"><p>
  ...
  <a class="link" href="api.register.object.tpl" title="register_object()">allouer les objets</a>
  au template puis de les utiliser avec une syntaxe similaire a celles
  des <a class="link" href="language.custom.functions.tpl" title="Chapter 8. Fonctions utilisateur">fonctions personnalisées</a>.
 </p></li>
<li class="listitem"><p>
  Le deuxième moyen consiste à <a class="link" href="api.assign.tpl" title="assign()">assigner</a> des objets
...
<p>
  ...
  <span class="bold"><strong>un objet alloué ne peut pas avoir de lien sur lui-même 
  ou être mis dans un tableau d'objet</strong></span>, etc.
...
<p>
  Si l'option de <a class="link" href="variable.security.tpl" title="$security">sécurité</a>
...
<p>
  ...
  même façon que les <a class="link" href="language.custom.functions.tpl" title="Chapter 8. Fonctions utilisateur">fonctions utilisateurs</a> 
  les récupèrent.
  ...
  à <code class="constant">FALSE</code>.
 </p>
<p>
  Le cinquième paramètre optionnel n'a d'effet que si le paramètre
  <em class="parameter"><code>format</code></em> vaut <code class="literal">true</code> et il contient
  ...
  (<code class="literal">{foobar-&gt;meth2}...{/foobar-&gt;meth2}</code>) et que les paramètres
  de ces méthodes fonctionnent de la même façon que les paramètres des
  <a class="link" href="plugins.block.functions.tpl" title="Fonctions de blocs">blocks de fonctions des plugins</a> :
  Ils contiennent 4 paramètres
  <em class="parameter"><code>$params</code></em>,
  <em class="parameter"><code>$content</code></em>,
  <em class="parameter"><code>&amp;$smarty</code></em> et
  <em class="parameter"><code>&amp;$repeat</code></em> et ils fonctionnent de la même
  façon que les blocks de fonctions des plugins.
 </p>
<div class="example">
<a name="id3029520"></a><p class="title"><b>Example 15.1. Utilisation d'un objet alloué ou assigné</b></p>
...
<p>
   Et voici comment accéder à vos objets dans <code class="filename">index.tpl</code> :
  </p>
<pre class="programlisting">
...
<br class="example-break"><p>
  Voir aussi
  <a class="link" href="api.register.object.tpl" title="register_object()"><code class="varname">register_object()</code></a> et
...
<tr>
<td width="40%" align="left" valign="top">Contrôler la mise en cache des sorties des Plugins </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Filtres de pré-compilation</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="c94c5f0bf63bd0612b34d0ef57c66530">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/advanced.features.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01845 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
