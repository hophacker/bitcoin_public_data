http://www.smarty.net/docsv2/fr/language.function.cycle.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 05:45:34 GMT
...
<a accesskey="p" href="language.function.counter.tpl">Prev</a> </td>
...
<p>
  <code class="varname">{cycle}</code> est utilisé pour boucler sur un ensemble de valeurs.
...
<td>Les valeurs sur lesquelles boucler, soit une liste
      séparée par des virgules, (voir l'attribut delimiter),
     soit un tableau de valeurs</td>
</tr>
<tr>
...
<td>S'il faut afficher ou non cette valeur</td>
</tr>
<tr>
...
<td align="center">Non</td>
<td align="center"><span class="emphasis"><em><code class="constant">TRUE</code></em></span></td>
<td>Oui ou non aller à la prochaîne valeur</td>
</tr>
<tr>
...
<td>Le délimiteur à utiliser dans la liste.</td>
</tr>
<tr>
...
<td align="center">Non</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>La variable de template dans laquelle la sortie
     sera assignée</td>
</tr>
<tr>
...
<td>Le cycle sera défini à la première valeur</td>
</tr>
</tbody>
</table></div>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>
  Vous pouvez définir plusieurs <code class="varname">{cycle}</code> dans votre template, en leur
  donnant des noms uniques (attribut <em class="parameter"><code>name</code></em>).
 </p></li>
<li class="listitem"><p>
  Vous pouvez empêcher la valeur courante de s'afficher en définissant
  l'attribut <em class="parameter"><code>print</code></em> à <code class="constant">FALSE</code>. Ce procédé peut être
  utile pour discrètement passer outre une valeur de la liste.
 </p></li>
<li class="listitem"><p>
  L'attribut <em class="parameter"><code>advance</code></em> est utilisé pour répéter une valeur. Lorsque
  définit à <code class="constant">FALSE</code>, le prochain appel de <code class="varname">{cycle}</code> ramènera la même valeur.
 </p></li>
<li class="listitem"><p>
   Si vous définissez l'attribut spécial <em class="parameter"><code>assign</code></em>, la sortie de la fonction
   <code class="varname">{cycle}</code> y sera assignée plutôt que d'être directement affichée.
  </p></li>
</ul></div>
<div class="example">
<a name="id2969058"></a><p class="title"><b>Example 8.5. {cycle}</b></p>
...
<p>Le template ci-dessus affichera :</p>
<pre class="screen">
...
<td width="40%" align="right" valign="top"> {debug}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 16 plus 13? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/language.function.cycle.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02430 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
