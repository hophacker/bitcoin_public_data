http://www.smarty.net/docsv2/en/api.unregister.outputfilter.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 06:16:33 GMT
...
<html lang="en">
  <head>
    ...
    <title>unregister_outputfilter() | Smarty</title>
...
<td width="20%" align="right"> <a accesskey="n" href="api.unregister.postfilter.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<h2>Name</h2>
<p>unregister_outputfilter() — dynamically unregister an output filter</p>
</div>
<div class="refsect1" title="Description">
<a name="id2863120"></a><h2>Description</h2>
...
<p>
  See also
  <a class="link" href="api.register.outputfilter.tpl" title="register_outputfilter()">
  <code class="varname">register_outputfilter()</code></a>
  and
...
<td width="40%" align="right"> <a accesskey="n" href="api.unregister.postfilter.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> unregister_postfilter()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="5a80f31564b3550d556c6b559b794a49">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/api.unregister.outputfilter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02980 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
