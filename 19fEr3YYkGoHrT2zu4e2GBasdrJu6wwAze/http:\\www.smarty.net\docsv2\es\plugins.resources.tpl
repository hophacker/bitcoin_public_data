http://www.smarty.net/docsv2/es/plugins.resources.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 07:20:59 GMT
...
<div class="example">
<a name="id3153546"></a><p class="title"><b>Example 16.10. Plugin resource (recurso)</b></p>
...
<td width="40%" align="right" valign="top"> Inserts</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/plugins.resources.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.23034 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
