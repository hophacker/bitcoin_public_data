http://www.smarty.net/docsv2/fr/api.get.config.vars.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 21:18:37 GMT
...
<h2>Name</h2>
<p>get_config_vars() — Retourne la valeur de la variable de configuration passée en paramètre</p>
</div>
<div class="refsect1" title="Description">
<a name="id3010066"></a><h2>Description</h2>
...
<div class="example">
<a name="id3009860"></a><p class="title"><b>Example 13.16. Exemple avec get_config_vars()</b></p>
...
<td width="40%" align="right" valign="top"> get_registered_object()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/api.get.config.vars.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.19203 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
