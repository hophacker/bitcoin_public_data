http://www.smarty.net/docsv2/it/language.function.textformat.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 00:03:32 GMT
...
<a accesskey="p" href="language.function.popup.tpl">Prev</a> </td>
...
<td>numero di caratteri da rientrare ad ogni riga</td>
</tr>
<tr>
...
<td align="center">no</td>
<td align="center"><span class="emphasis"><em>0</em></span></td>
<td>numero di caratteri da rientrare alla prima riga</td>
</tr>
<tr>
<td align="center">indent_char</td>
<td align="center">stringa</td>
<td align="center">no</td>
<td align="center"><span class="emphasis"><em>(spazio singolo)</em></span></td>
<td>carattere (o stringa di caratteri) da usare come rientro</td>
</tr>
<tr>
...
<td>a quanti caratteri spezzare ogni riga</td>
</tr>
<tr>
...
<td>caratteri (o stringa di caratteri) da usare per
                                         spezzare le righe</td>
</tr>
<tr>
...
<td>se vero, le righe verranno spezzate al carattere esatto
                                  invece che al termine di una parola</td>
</tr>
<tr>
...
<td align="center">no</td>
<td align="center"><span class="emphasis"><em>nessuno</em></span></td>
<td>variabile del template cui assegnare l'output</td>
</tr>
</tbody>
</table></div>
<p>
...
<div class="example">
<a name="id3126936"></a><p class="title"><b>Example 8.18. textformat</b></p>
...
<tr>
<td width="40%" align="left" valign="top">popup </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Chapter 9. File di configurazione</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/language.function.textformat.tpl">
            </form>
            </div>
          </div>
