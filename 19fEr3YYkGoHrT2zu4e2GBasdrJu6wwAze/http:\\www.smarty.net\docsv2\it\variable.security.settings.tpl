http://www.smarty.net/docsv2/it/variable.security.settings.tpl
HTTP/1.1 200 OK
Date: Sat, 26 Jul 2014 19:14:45 GMT
...
<p>
       Sono valori usati per modificare o specificare le impostazioni di
       sicurezza quando $security è abilitata. Queste sono le impostazioni
       possibili:
      </p>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>PHP_HANDLING - true/false. Se è impostato a true,
         l'impostazione di $php_handling non viene verificata per la 
         sicurezza.</p></li>
<li class="listitem"><p>IF_FUNCS - E' un array con i nomi delle funzioni PHP
         consentite nelle istruzioni IF.</p></li>
<li class="listitem"><p>INCLUDE_ANY - true/false. Se impostata a true, qualsiasi
         template può essere incluso dal filesystem, indipendentemente dalla
        lista di $secure_dir.</p></li>
<li class="listitem"><p>PHP_TAGS - true/false. Se impostato a true, è consentito
         l'uso dei tag {php}{/php} nei template.</p></li>
<li class="listitem"><p>MODIFIER_FUNCS - E' un array coi nomi delle funzioni PHP
         di cui è consentito l'uso come modificatori delle variabili.</p></li>
</ul></div>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $trusted_dir</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="b7b723821c302b14ff6d20c9ee260aff">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/variable.security.settings.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02655 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
