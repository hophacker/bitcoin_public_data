http://www.smarty.net/docsv2/it/api.is.cached.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 22:11:05 GMT
...
<code class="methodsynopsis"><span class="type">bool </span><span class="methodname">is_cached</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">template</span></span>,<br>               <span class="methodparam"><span class="type">string </span><span class="parameter">cache_id</span></span>,<br>               <span class="methodparam"><span class="type">string </span><span class="parameter">compile_id</span></span>);</code><p>
   Restituisce <code class="constant">TRUE</code> se è presente una cache valida per questo template.
   Funziona soltanto se <a class="link" href="variable.caching.tpl" title="$caching">caching</a> è
   impostato a true.
  </p>
<div class="example">
<a name="id3143736"></a><p class="title"><b>Example 13.18. is_cached</b></p>
...
<p>
   ...
   <a class="link" href="variable.compile.id.tpl" title="$compile_id">$compile_id</a>.
  </p>
<p>
   Se non volete passare una cache id ma volete passare un compile
   id dovete passare <code class="literal">null</code> come cache id.
  </p>
<div class="example">
<a name="id3143787"></a><p class="title"><b>Example 13.19. is_cached con template a cache multiple</b></p>
<div class="example-contents"><pre class="programlisting">
...
<br class="example-break"><div class="note" title="Nota tecnica" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Nota tecnica</h3>
<p>
   Se <code class="literal">is_cached</code> restituisce true, in realtà carica
   l'output in cache e lo memorizza internamente. Ogni chiamata
   successiva a <a class="link" href="api.display.tpl" title="display">display()</a> o a 
   <a class="link" href="api.fetch.tpl" title="fetch">fetch()</a> restituirà questo output
   ...
   <a class="link" href="api.clear.cache.tpl" title="clear_cache">clear_cache()</a> ed altre
   modifiche fatte sulle impostazioni della cache potrebbero non avere
   effetto dopo che <code class="literal">is_cached</code> ha restituito true.
  </p>
</div>
</div>
</div>
...
<td width="40%" align="right" valign="top"> load_filter</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 1 plus 16? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/api.is.cached.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02423 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
