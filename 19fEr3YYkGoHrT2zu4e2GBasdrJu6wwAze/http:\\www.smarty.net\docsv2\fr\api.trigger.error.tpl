http://www.smarty.net/docsv2/fr/api.trigger.error.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 09:35:48 GMT
...
<h2>Name</h2>
<p>trigger_error() — Affiche un message d'erreur</p>
</div>
<div class="refsect1" title="Description">
<a name="id3015830"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">trigger_error</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">error_msg</span></span>,<br>                   <span class="methodparam"><span class="type">int </span><span class="parameter">level</span></span>);</code><p>
   ...
   en utilisant Smarty. Le paramètre <em class="parameter"><code>level</code></em>
   peut prendre l'une des valeures utilisées par la fonction PHP
   <a class="ulink" href="http://php.net/trigger_error" target="_top"><code class="varname">trigger_error()</code></a>,
   i.e. <code class="literal">E_USER_NOTICE</code>, <code class="literal">E_USER_WARNING</code>, etc. Par défaut
   il s'agit de <code class="literal">E_USER_WARNING</code>.
  </p>
<p>
   Voir aussi
   ...
   <a class="link" href="troubleshooting.tpl#smarty.php.errors" title="Erreurs Smarty/PHP">Troubleshooting</a>.
 </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> template_exists()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/api.trigger.error.tpl">
            </form>
            </div>
          </div>
