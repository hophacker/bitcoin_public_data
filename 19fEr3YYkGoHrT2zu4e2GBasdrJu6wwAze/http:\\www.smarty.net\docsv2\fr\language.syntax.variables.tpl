http://www.smarty.net/docsv2/fr/language.syntax.variables.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 06:16:36 GMT
...
<p>
  Les variables de template commence par un signe dollar (<code class="literal">$</code>).
  Elles peuvent contenir des nombres, des lettres et des underscores, tout
  comme une <a class="ulink" href="http://php.net/language.variables" target="_top">variable PHP</a>.
...
<p>
  Les <a class="link" href="language.config.variables.tpl" title="Variables chargées depuis des fichiers de configuration">variables des fichiers de
  configuration</a> sont une exception à la synthaxe utilisant un signe dollar. Elles peuvent être
  référencées en les entourant du signe dièse (<code class="literal">#</code>) ou via la variable spéciale
  <a class="link" href="language.variables.smarty.tpl#language.variables.smarty.config" title="{$smarty.config}"><em class="parameter"><code>$smarty.config</code></em></a>.
 </p>
<div class="example">
<a name="id2929744"></a><p class="title"><b>Example 3.2. Variables</b></p>
...
<br class="example-break"><p>
  Les variables spéciales comme <code class="literal">$_GET</code>, <code class="literal">$_SESSION</code>, etc.
  sont également disponibles, lisez le chapitre sur les variables réservées
  <span class="emphasis"><em><a class="link" href="language.variables.smarty.tpl" title="Variable réservée {$smarty}"><em class="parameter"><code>$smarty</code></em></a></em></span>
  pour plus de détails.
 </p>
<p>
  Voir aussi
  <a class="link" href="language.variables.smarty.tpl" title="Variable réservée {$smarty}"><em class="parameter"><code>$smarty</code></em></a>,
...
<tr>
<td width="40%" align="left" valign="top">Chapter 3. Bases syntaxiques </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Fonctions</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/language.syntax.variables.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03347 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
