http://www.smarty.net/docsv2/fr/language.config.variables.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 16:02:41 GMT
...
<html lang="en">
  <head>
    ...
    <title>Variables chargées depuis des fichiers de configuration | Smarty</title>
...
<tr><th colspan="3" align="center">Variables chargées depuis des fichiers de configuration</th></tr>
<tr>
...
<div class="sect1" title="Variables chargées depuis des fichiers de configuration">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.config.variables"></a>Variables chargées depuis des fichiers de configuration</h2></div></div></div>
<p>
  Les variables récupérées depuis un 
  <a class="link" href="config.files.tpl" title="Chapter 9. Fichiers de configuration">fichier de configuration</a> sont utilisées
...
<div class="example">
<a name="id2932141"></a><p class="title"><b>Example 4.6. variables de fichiers de configuration</b></p>
<div class="example-contents">
<p>
   Exemple de fichier de configuration - <code class="filename">foo.conf</code> :
  </p>
...
<br class="example-break"><p>
  ...
  plus loin dans le document, voir <a class="link" href="api.config.load.tpl" title="config_load()"><code class="varname">{config_load}</code></a>.
 </p>
<p>
  Voir aussi
  les <a class="link" href="language.syntax.variables.tpl" title="Variables">variables</a> et
  les <a class="link" href="language.variables.smarty.tpl" title="Variable réservée {$smarty}">variables réservées $smarty</a>.
</p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> Variable réservée {$smarty}</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/language.config.variables.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02259 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
