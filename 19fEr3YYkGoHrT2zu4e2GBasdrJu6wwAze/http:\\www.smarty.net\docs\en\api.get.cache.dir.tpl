...
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 12:25:43 GMT
...
<h2>Name</h2>
<p>getCacheDir() — return the directory where the rendered template's output is stored</p>
</div>
<div class="refsect1" title="Description">
<a name="idp16139008"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">string </span><span class="methodname">getCacheDir</span>();</code><div class="example">
<a name="idp16141024"></a><p class="title"><b>Example 14.23. getCacheDir()</b></p>
...
<br class="example-break"><p>
   See also
   <a class="link" href="api.set.cache.dir.tpl" title="setCacheDir()"><code class="varname">setCacheDir()</code></a> and
...
<td width="40%" align="right" valign="top"> getCompileDir()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/api.get.cache.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02909 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
