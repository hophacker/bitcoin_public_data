http://www.smarty.net/docs/en/variable.caching.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 11:22:25 GMT
...
<p>
	   ...
	   to the <a class="link" href="variable.cache.dir.tpl" title="$cache_dir">
...
<p>
	   You can also have
	   <a class="link" href="caching.multiple.caches.tpl" title="Multiple Caches Per Page">multiple</a>
...
<li class="listitem"><p>A value of Smarty::CACHING_LIFETIME_SAVED tells Smarty to use the
      ...
      <a class="link" href="variable.cache.lifetime.tpl" title="$cache_lifetime"> <em class="parameter"><code>$cache_lifetime</code></em></a>
   just before <a class="link" href="api.fetch.tpl" title="fetch()">fetching</a>
   the template to have granular control over when that particular cache expires.
	   See also <a class="link" href="api.is.cached.tpl" title="isCached()"><code class="varname">isCached()</code></a>.
           </p></li>
<li class="listitem"><p>
	   If <a class="link" href="variable.compile.check.tpl" title="$compile_check"><em class="parameter"><code>$compile_check</code></em></a>
...
<td width="40%" align="right" valign="top"> $caching_type</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 9 plus 13? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/variable.caching.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01990 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
