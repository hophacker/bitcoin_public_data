http://www.smarty.net/docsv2/de/variable.cache.handler.func.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 11:22:23 GMT
...
<p>
    ...
    statt nur mit der <a class="link" href="variable.cache.dir.tpl" title="$cache_dir">$cache_dir</a>-Variable
    ein eigenes Verzeichnis festzulegen.
    Siehe Abschnitt zur <a class="link" href="section.template.cache.handler.func.tpl" title="Cache Handler Funktion">custom cache handler</a> Funktion.
   </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $cache_modified_check</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/variable.cache.handler.func.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.20742 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
