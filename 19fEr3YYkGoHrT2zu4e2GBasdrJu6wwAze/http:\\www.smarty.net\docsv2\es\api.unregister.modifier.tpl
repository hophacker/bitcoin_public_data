http://www.smarty.net/docsv2/es/api.unregister.modifier.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 02:10:31 GMT
...
<h2>Name</h2>
<p>unregister_modifier() — des-registrar dinámicamente un modificador de plugin</p>
</div>
<div class="refsect1" title="Descripción">
<a name="id3137356"></a><h2>Descripción </h2>
...
<div class="example">
<a name="id3137388"></a><p class="title"><b>Example 13.28. unregister_modifier()</b></p>
...
<br class="example-break"><p>
    Ver también <a class="link" href="api.register.modifier.tpl" title="register_modifier()">register_modifier()</a>
    y <a class="link" href="plugins.modifiers.tpl" title="Modificadores">Plugin modifiers</a>,
   </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> unregister_object()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/api.unregister.modifier.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01690 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
