http://www.smarty.net/docsv2/es/language.modifier.lower.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 19:31:16 GMT
...
<div class="example">
<a name="id3072501"></a><p class="title"><b>Example 5.12. lower</b></p>
...
<br class="example-break"><p>
   ver también <a class="link" href="language.modifier.upper.tpl" title="upper">upper</a> y
   <a class="link" href="language.modifiers.tpl#language.modifier.capitalize" title="capitalize">Capitalize</a>.
  </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> nl2br</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.modifier.lower.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02610 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
