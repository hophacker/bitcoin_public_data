http://www.smarty.net/docsv2/it/plugins.writing.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 22:10:28 GMT
...
<html lang="en">
  <head>
    ...
    <title>Scrivere Plugin | Smarty</title>
...
<tr><th colspan="3" align="center">Scrivere Plugin</th></tr>
<tr>
...
<div class="sect1" title="Scrivere Plugin">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="plugins.writing"></a>Scrivere Plugin</h2></div></div></div>
<p>
...
<p>
     ...
     <em class="parameter"><code>&amp;$repeat</code></em> dopo l'oggetto Smarty, per 
...
<tr>
<td width="40%" align="left" valign="top">Convenzioni per i nomi </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Funzioni per i template</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 3 plus 2? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="3963ac0abd6920fb9652c119fedc6baf">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/plugins.writing.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02223 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
