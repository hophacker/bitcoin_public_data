http://www.smarty.net/docsv2/en/api.config.load.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 16:53:59 GMT
...
<h2>Name</h2>
<p>config_load() —  loads config file  data and assigns it to the template</p>
</div>
<div class="refsect1" title="Description">
<a name="id2853208"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">config_load</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">file</span></span>,<br>                 <span class="methodparam"><span class="type">string </span><span class="parameter">section</span></span>);</code><p>
   This loads
   <a class="link" href="config.files.tpl" title="Chapter 9. Config Files">config file</a>
   ...
   <code class="varname">{config_load}</code></a> function.
  </p>
...
<p>
    ...
    and <a class="link" href="api.display.tpl" title="display()"><code class="varname">display()</code></a>.
    Config vars loaded from
    <code class="varname">config_load()</code> are always global in scope.
    ...
    <em class="parameter"><code>$force_compile</code></em></a> and
    <a class="link" href="variable.compile.check.tpl" title="$compile_check">
    <em class="parameter"><code>$compile_check</code></em></a> settings.
   </p>
</div>
<div class="example">
<a name="id2853339"></a><p class="title"><b>Example 13.11. config_load()</b></p>
...
<br class="example-break"><p>
  ...
  <a class="link" href="api.clear.config.tpl" title="clear_config()"><code class="varname">clear_config()</code></a>,
  and
  <a class="link" href="language.config.variables.tpl" title="Variables loaded from config files"><code class="varname">config variables</code></a>
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> display()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 14 plus 19? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="5aa2e4d364b1441317d0b50534ae69a4">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/api.config.load.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01959 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
