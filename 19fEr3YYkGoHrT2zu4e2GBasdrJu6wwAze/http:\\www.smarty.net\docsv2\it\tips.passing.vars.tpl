http://www.smarty.net/docsv2/it/tips.passing.vars.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 19:19:55 GMT
...
<html lang="en">
  <head>
    ...
    <title>Passare una variabile titolo ad un template di intestazione | Smarty</title>
...
<tr><th colspan="3" align="center">Passare una variabile titolo ad un template di intestazione</th></tr>
<tr>
...
<div class="sect1" title="Passare una variabile titolo ad un template di intestazione">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="tips.passing.vars"></a>Passare una variabile titolo ad un template di intestazione</h2></div></div></div>
<p>
...
<div class="example">
<a name="id3163868"></a><p class="title"><b>Example 18.3. Passare la variabile titolo al template dell'intestazione</b></p>
...
<br class="example-break"><p>
    ...
    il modificatore di variabile <span class="emphasis"><em>default</em></span>.
   </p>
</div>
<div class="navfooter">
<hr>
...
<tr>
<td width="40%" align="left" valign="top">Gestione dei default delle variabili </td>
...
<td width="40%" align="right" valign="top"> Date</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/tips.passing.vars.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01830 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
