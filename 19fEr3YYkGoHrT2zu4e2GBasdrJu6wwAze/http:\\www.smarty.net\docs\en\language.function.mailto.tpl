...
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 17:26:23 GMT
...
<div class="example">
<a name="idp12700240"></a><p class="title"><b>Example 8.20. {mailto} example lines followed by the result</b></p>
...
<td width="40%" align="right" valign="top"> {math}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/language.function.mailto.tpl">
            </form>
            </div>
          </div>
