http://www.smarty.net/docsv2/es/api.variables.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 08:26:15 GMT
...
<html lang="en">
  <head>
    ...
    <title>Chapter 12. Clase Variables de Smarty | Smarty</title>
...
<tr><th colspan="3" align="center">Chapter 12. Clase Variables de Smarty</th></tr>
<tr>
...
<div class="chapter" title="Chapter 12. Clase Variables de Smarty">
<div class="titlepage"><div><div><h2 class="title">
<a name="api.variables"></a>Chapter 12. Clase Variables de Smarty</h2></div></div></div>
<div class="toc">
...
<p>
     ...
     entonces estos se encontraran aquí. 
     Por default <code class="filename">"./templates"</code>, 
     esto significa que lo buscara en el directorio del 
     <code class="filename">templates</code> en el mismo 
     directorio que esta ejecutando el script PHP.
    </p>
...
<td width="40%" align="right" valign="top"> $compile_dir</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/api.variables.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02474 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
