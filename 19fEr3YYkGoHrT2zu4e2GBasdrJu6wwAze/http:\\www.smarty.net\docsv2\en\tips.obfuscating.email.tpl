http://www.smarty.net/docsv2/en/tips.obfuscating.email.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 12:23:08 GMT
...
<div class="example">
<a name="id2885671"></a><p class="title"><b>Example 18.8. Example of template the Obfuscating an email address</b></p>
...
<td width="40%" align="right" valign="top"> Chapter 19. Resources</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/tips.obfuscating.email.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01774 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
