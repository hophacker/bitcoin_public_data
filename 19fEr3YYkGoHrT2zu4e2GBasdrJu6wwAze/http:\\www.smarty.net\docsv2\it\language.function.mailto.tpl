http://www.smarty.net/docsv2/it/language.function.mailto.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 05:33:50 GMT
...
<td align="center"><span class="emphasis"><em>nessuno</em></span></td>
<td>il testo da visualizzare sul link; il default
                              è l'indirizzo e-mail</td>
</tr>
<tr>
...
<td>Come codificare l'indirizzo. Può essere
     <code class="literal">none</code>, <code class="literal">hex</code> o
     <code class="literal">javascript</code>.</td>
</tr>
<tr>
...
<td align="center">no</td>
<td align="center"><span class="emphasis"><em>nessuno</em></span></td>
<td>indirizzi e-mail da mettere 'per conoscenza'.
         Separateli con una virgola.</td>
</tr>
<tr>
...
<td align="center">no</td>
<td align="center"><span class="emphasis"><em>nessuno</em></span></td>
<td>indirizzi e-mail da mettere 'in copia nascosta'.
	       Separateli con una virgola.</td>
</tr>
<tr>
...
<td align="center">no</td>
<td align="center"><span class="emphasis"><em>nessuno</em></span></td>
<td>newsgroups a cui scrivere. Separateli con una virgola.</td>
</tr>
<tr>
...
<td>indirizzi per il follow up to. Separateli con una virgola.</td>
</tr>
<tr>
...
<td align="center">no</td>
<td align="center"><span class="emphasis"><em>nessuno</em></span></td>
<td>qualsiasi informazione ulteriore che vogliate passare
         al link, ad esempio classi per i fogli di stile</td>
</tr>
</tbody>
</table></div>
<p>
...
<div class="example">
<a name="id3123557"></a><p class="title"><b>Example 8.15. mailto</b></p>
...
&lt;a href="mailto:me@example.com" class="email"&gt;me@domain.com&lt;/a&gt;</pre></div>
</div>
...
<td width="40%" align="right" valign="top"> popup_init</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/language.function.mailto.tpl">
            </form>
            </div>
          </div>
