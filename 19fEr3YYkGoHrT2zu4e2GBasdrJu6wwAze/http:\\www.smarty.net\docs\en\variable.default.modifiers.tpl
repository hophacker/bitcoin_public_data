...
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 12:16:00 GMT
...
<td width="40%" align="right" valign="top"> $default_resource_type</td>
          ...
          <div class="commentInfo">
              ...
              <div class="commentAuthor">by <b>Tyler Crompton</b> on Mar 19, 2013 at  9:37</div>
              <div class="commentBody">It's important to note that these default modifiers are applied *after* explicit modifiers. For example, if $default_modifiers = array('escape') and in my template I do {$var|base64_decode}, what will happen is {$var|base64_decode|escape}. Remember that multiple modifiers are evaluated from left to right.</div>
            </div>
                              </div>
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/variable.default.modifiers.tpl">
            </form>
            </div>
          </div>
