http://www.smarty.net/docsv2/es/api.template.exists.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 02:19:12 GMT
...
<h2>Name</h2>
<p>template_exists() — Verifica si el template especificado existe</p>
</div>
<div class="refsect1" title="Descripción">
<a name="id3135985"></a><h2>Descripción</h2>
...
<div class="example">
<a name="id3136018"></a><p class="title"><b>Example 13.26. template_exists()</b></p>
...
<p>
    El <code class="filename">page_container.tpl</code>
    </p>
...
<br class="example-break"><p>
  ...
  <a class="link" href="api.fetch.tpl" title="fetch()">fetch()</a>,
  <a class="link" href="language.function.include.tpl" title="include">{include}</a>
   y <a class="link" href="language.function.insert.tpl" title="insert">{insert}</a>
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> unregister_block</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/api.template.exists.tpl">
            </form>
            </div>
          </div>
