http://www.smarty.net/docsv2/pt_BR/api.register.modifier.tpl
HTTP/1.1 200 OK
...
<html lang="en">
  <head>
    ...
    <title>register_modifier | Smarty</title>
...
<tr><th colspan="3" align="center">register_modifier</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.register.function.tpl">Prev</a> </td>
...
<div class="sect1" title="register_modifier">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="api.register.modifier"></a>register_modifier</h2></div></div></div>
<div class="funcsynopsis">
<table border="0" summary="Function synopsis" cellspacing="0" cellpadding="0" class="funcprototype-table">
<tr>
<td><code class="funcdef">void <b class="fsfunc">register_modifier</b>(</code></td>
<td>
...
<td> </td>
<td>
<var class="pdparam">impl</var><code>)</code>;</td>
<td> </td>
</tr>
</table>
<div class="paramdef-list">
<code>string <var class="pdparam">name</var></code>;<br><code>mixed <var class="pdparam">impl</var></code>;</div>
...
<p>
	  A chamada da função-php <em class="parameter"><code>impl</code></em> 
	  ...
	  <code class="literal">$method</code> sendo um método desta classe.
	</p>
<div class="example">
<a name="id2759644"></a><p class="title"><b>Example 13.23. register_modifier</b></p>
<div class="example-contents"><pre class="programlisting">
// let's map PHP's stripslashes function to a Smarty modifier.

$smarty-&gt;register_modifier("sslash","stripslashes");

// now you can use {$var|sslash} to strip slashes from variables</pre></div>
</div>
...
<tr>
<td width="40%" align="left" valign="top">register_function </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> register_object</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 5 plus 1? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="89edb16bf891251b3b9237fc3499b2ce">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/api.register.modifier.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03231 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
