...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 07:37:38 GMT
...
<h2>Name</h2>
<p>addPluginsDir() — add a directory to the list of directories where plugins are stored</p>
</div>
<div class="refsect1" title="Description">
<a name="idp15272896"></a><h2>Description</h2>
...
<a name="idp15325744"></a><p class="title"><b>Example 14.2. addPluginsDir()</b></p>
...
<br class="example-break"><p>
   ...
   <a class="link" href="api.set.plugins.dir.tpl" title="setPluginsDir()"><code class="varname">setPluginsDir()</code></a> and
...
<td width="40%" align="right" valign="top"> addTemplateDir()</td>
          ...
          <div class="commentInfo">
              ...
              <div class="commentAuthor">by <b>Flip</b> on Nov 17, 2011 at  9:40</div>
              <div class="commentBody">Setting your include path by either of these 3 options do not help:
1. ini_set('include_path', 'paths'); // for older PHP versions
2. set_include_path('paths'); // for newer PHP versions
3. setting include_path = &quot;paths&quot; in php.ini

You have to set either the full path or the path relative to the script execution directory.
I don't know why, i feel like setting an include path should work.</div>
            </div>
                              </div>
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/api.add.plugins.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01912 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
