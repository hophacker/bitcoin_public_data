http://www.smarty.net/docsv2/de/api.register.resource.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 09:35:26 GMT
...
<html lang="en">
  <head>
    ...
    <title>register_resource (Ressource registrieren) | Smarty</title>
...
<tr><th colspan="3" align="center">register_resource (Ressource registrieren)</th></tr>
<tr>
...
<div class="refentry" title="register_resource (Ressource registrieren)">
<a name="api.register.resource"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>register_resource (Ressource registrieren)</p>
</div>
<div class="refsect1">
<a name="id2924377"></a><h2></h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">register_resource</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">name</span></span>,<br>                       <span class="methodparam"><span class="type">array </span><span class="parameter">resource_funcs</span></span>);</code><p>
    ...
    Konsultieren Sie den Abschnitt <a class="link" href="template.resources.tpl" title="Ressourcen">template resources</a>
...
<p>
   Der Parameter <em class="parameter"><code>resource_funcs</code></em> muss aus 4 oder 5 Elementen bestehen. Wenn 4 Elemente übergeben werden,
...
<div class="example">
<a name="id2924434"></a><p class="title"><b>Example 13.24. register_resource (Ressource registrieren)</b></p>
...
<tr>
<td width="40%" align="left" valign="top">register_prefilter ('pre'-Filter registrieren) </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> trigger_error (Fehler auslösen)</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/api.register.resource.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02791 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
