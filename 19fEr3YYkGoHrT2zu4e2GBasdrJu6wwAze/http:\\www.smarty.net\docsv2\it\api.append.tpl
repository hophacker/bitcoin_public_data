http://www.smarty.net/docsv2/it/api.append.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 15:26:48 GMT
...
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">append</span>(<span class="methodparam"><span class="type">mixed </span><span class="parameter">var</span></span>);</code><br><code class="methodsynopsis"><span class="type">void </span><span class="methodname">append</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">varname</span></span>,<br>            <span class="methodparam"><span class="type">mixed </span><span class="parameter">var</span></span>,<br>            <span class="methodparam"><span class="type">bool </span><span class="parameter">merge</span></span>);</code><p>
   ...
   stringa, verrà convertito in un elemento di array e aggiunto. Potete 
   ...
   a true, il valore verrà fuso nell'array corrente invece che aggiunto.
  </p>
<div class="note" title="Nota tecnica" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Nota tecnica</h3>
<p>
  Il parametro <em class="parameter"><code>merge</code></em> rispetta le chiavi degli array,
...
<div class="example">
<a name="id3139887"></a><p class="title"><b>Example 13.1. append</b></p>
...
<tr>
<td width="40%" align="left" valign="top">Chapter 13. Methods </td>
...
<td width="40%" align="right" valign="top"> append_by_ref</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/api.append.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01886 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
