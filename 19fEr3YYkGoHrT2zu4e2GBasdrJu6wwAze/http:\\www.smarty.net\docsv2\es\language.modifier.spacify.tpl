http://www.smarty.net/docsv2/es/language.modifier.spacify.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 10:39:47 GMT
...
<td>Este se inserta entre cada carácter de la variable.</td>
</tr></tbody>
</table></div>
<p>
...
<div class="example">
<a name="id3074599"></a><p class="title"><b>Example 5.16. spacify</b></p>
...
<br class="example-break"><p>
    Ver también <a class="link" href="language.modifier.wordwrap.tpl" title="wordwrap">wordwrap</a>
    y <a class="link" href="language.modifier.nl2br.tpl" title="nl2br">nl2br</a>.
    </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> string_format</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.modifier.spacify.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03214 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
