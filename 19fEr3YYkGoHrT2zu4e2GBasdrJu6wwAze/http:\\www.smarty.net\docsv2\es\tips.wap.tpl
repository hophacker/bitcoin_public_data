http://www.smarty.net/docsv2/es/tips.wap.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 18:04:46 GMT
...
<p>
    ...
    <a class="link" href="caching.tpl" title="Chapter 14. Cache">cache</a>, este no funcionara, entonces 
    nosotros haremos esto usando una etiqueta de 
    <a class="link" href="language.function.insert.tpl" title="insert">{insert}</a> (recuerde que 
...
<div class="example">
<a name="id3156786"></a><p class="title"><b>Example 18.6. Usando insert para escribir un encabezado WML Content-Type</b></p>
...
<td width="40%" align="right" valign="top"> Templates con Componetes</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/tips.wap.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01027 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
