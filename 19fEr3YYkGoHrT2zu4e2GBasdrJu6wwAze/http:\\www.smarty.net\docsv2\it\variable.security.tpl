http://www.smarty.net/docsv2/it/variable.security.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 13:45:55 GMT
...
<li class="listitem"><p>Se $php_handling è impostato a SMARTY_PHP_ALLOW viene
         implicitamente modificato a SMARTY_PHP_PASSTHRU</p></li>
<li class="listitem"><p>Non sono ammesse funzioni PHP nelle istruzioni IF,
         ad esclusione di quelle specificate in $security_settings</p></li>
<li class="listitem"><p>I file dei template possono essere inclusi solo dalle
         directory elencate nell'array $secure_dir</p></li>
<li class="listitem"><p>I file locali possono essere letti con {fetch} solo dalle
         directory elencate nell'array $secure_dir</p></li>
<li class="listitem"><p>I tag {php}{/php} non sono consentiti</p></li>
<li class="listitem"><p>Non è possibile usare funzioni PHP come modificatori,
         ad esclusione di quelle specificate in $security_settings</p></li>
</ul></div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> $secure_dir</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/variable.security.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02503 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
