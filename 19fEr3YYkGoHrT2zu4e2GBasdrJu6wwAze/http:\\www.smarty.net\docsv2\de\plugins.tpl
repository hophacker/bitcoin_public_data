HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 15:26:40 GMT
...
<html lang="en">
  <head>
    ...
    <title>Chapter 16. Smarty durch Plugins erweitern | Smarty</title>
...
<tr><th colspan="3" align="center">Chapter 16. Smarty durch Plugins erweitern</th></tr>
<tr>
...
<div class="chapter" title="Chapter 16. Smarty durch Plugins erweitern">
<div class="titlepage"><div><div><h2 class="title">
<a name="plugins"></a>Chapter 16. Smarty durch Plugins erweitern</h2></div></div></div>
<div class="toc">
...
<li class="listitem">Funktionen</li>
<li class="listitem">Modifikatoren</li>
<li class="listitem">Block-Funktionen</li>
<li class="listitem">Compiler-Funktionen</li>
<li class="listitem">'pre'-Filter</li>
<li class="listitem">'post'-Filter</li>
<li class="listitem">Ausgabefilter</li>
<li class="listitem">Ressourcen</li>
...
<p>
   ...
   <code class="literal">$custom_funcs</code>, <code class="literal">$custom_mods</code> und andere direkt 
...
<div class="sect1" title="Wie Plugins funktionieren">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="plugins.howto"></a>Wie Plugins funktionieren</h2></div></div></div>
<p>
...
<p>
    Die <a class="link" href="variable.plugins.dir.tpl" title="$plugins_dir">plugins directory</a> Variable kann eine Zeichenkette,
...
<tr>
<td width="40%" align="left" valign="top">Ressourcen </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Namenskonvention</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/plugins.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02518 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
