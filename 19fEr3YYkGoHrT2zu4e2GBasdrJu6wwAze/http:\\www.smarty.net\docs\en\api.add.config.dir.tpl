...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 13:45:37 GMT
...
<h2>Name</h2>
<p>addConfigDir() — add a directory to the list of directories where config files are stored</p>
</div>
<div class="refsect1" title="Description">
<a name="idp15255968"></a><h2>Description</h2>
...
<a name="idp15298032"></a><p class="title"><b>Example 14.1. addConfigDir()</b></p>
...
<br class="example-break"><p>
   ...
   <a class="link" href="api.set.config.dir.tpl" title="setConfigDir()"><code class="varname">setConfigDir()</code></a> and
...
<tr>
<td width="40%" align="left" valign="top">Chapter 14. Smarty Class Methods </td>
...
<td width="40%" align="right" valign="top"> addPluginsDir()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/api.add.config.dir.tpl">
            </form>
            </div>
          </div>
