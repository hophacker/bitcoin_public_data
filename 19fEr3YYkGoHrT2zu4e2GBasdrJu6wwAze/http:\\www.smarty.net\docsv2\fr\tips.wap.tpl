http://www.smarty.net/docsv2/fr/tips.wap.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 16:03:13 GMT
...
<p>
    ...
    <a class="ulink" href="http://php.net/header" target="_top">Content-Type</a> qui doit être
    ...
    <a class="link" href="caching.tpl" title="Chapter 14. Cache">cache</a>,
    celà ne fonctionnera pas. Nous utiliserons donc une balise d'insertion
    (<a class="link" href="language.function.insert.tpl" title="{insert}">{insert}</a>)
...
<div class="example">
<a name="id3040822"></a><p class="title"><b>Example 18.6. Utilisation d'{insert} pour écrire un en-tête Content-Type WML</b></p>
...
<p>
     votre template Smarty <span class="emphasis"><em>doit</em></span> commencer avec la balise d'insertion :
    </p>
<pre class="programlisting">
...
<td width="40%" align="right" valign="top"> Templates composants</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/tips.wap.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02261 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
