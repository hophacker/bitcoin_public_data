http://www.smarty.net/docsv2/en/api.unregister.object.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 15:26:57 GMT
...
<h2>Name</h2>
<p>unregister_object() — dynamically unregister an object</p>
</div>
<div class="refsect1" title="Description">
<a name="id2862850"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">unregister_object</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">object_name</span></span>);</code><p>
 ...
 and
 <a class="link" href="advanced.features.tpl#advanced.features.objects" title="Objects">objects section</a>
 </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> unregister_outputfilter()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/api.unregister.object.tpl">
            </form>
            </div>
          </div>
