http://www.smarty.net/docsv2/fr/advanced.features.outputfilters.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 00:16:48 GMT
...
<html lang="en">
  <head>
    ...
    <title>Filtres de sortie | Smarty</title>
...
<tr><th colspan="3" align="center">Filtres de sortie</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="advanced.features.postfilters.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 15. Fonctionnalités avancées</th>
<td width="20%" align="right"> <a accesskey="n" href="section.template.cache.handler.func.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="Filtres de sortie">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="advanced.features.outputfilters"></a>Filtres de sortie</h2></div></div></div>
<p>
  ...
  Ils diffèrent des <a class="link" href="advanced.features.postfilters.tpl" title="Filtres de post-compilation">filtres
   de post-compilation</a> dans le sens où ils agissent sur la sortie
  des templates, une fois exécutés, et non sur les sources des templates.
 </p>
<p>
  Les filtres de sortie peuvent être soit
  <a class="link" href="api.register.outputfilter.tpl" title="register_outputfilter()">déclarés</a> soit
  chargés depuis les <a class="link" href="variable.plugins.dir.tpl" title="$plugins_dir">répertoires
  des plugins</a> en utilisant la fonction
  <a class="link" href="api.load.filter.tpl" title="load_filter()"><code class="varname">load_filter()</code></a>
...
<div class="example">
<a name="id3030546"></a><p class="title"><b>Example 15.4. Utilisation d'un filtre de sortie</b></p>
...
<br class="example-break"><p>
  Voir aussi
  <a class="link" href="api.register.outputfilter.tpl" title="register_outputfilter()"><code class="varname">register_outpurfilter()</code></a>,
  <a class="link" href="api.load.filter.tpl" title="load_filter()"><code class="varname">load_filter()</code></a>,
  <a class="link" href="variable.autoload.filters.tpl" title="$autoload_filters"><em class="parameter"><code>$autoload_filters</code></em></a>,
  les <a class="link" href="advanced.features.postfilters.tpl" title="Filtres de post-compilation">filtres de post-compilation</a> et
...
<td width="40%" align="right"> <a accesskey="n" href="section.template.cache.handler.func.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">Filtres de post-compilation </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Fonction de gestion du cache</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 2 plus 7? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="6c86b85889835b4c77841c48b4c79ba9">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/advanced.features.outputfilters.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01929 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
