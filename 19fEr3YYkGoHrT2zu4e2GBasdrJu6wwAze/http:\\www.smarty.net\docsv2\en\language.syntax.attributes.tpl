http://www.smarty.net/docsv2/en/language.syntax.attributes.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 14:30:41 GMT
...
<p>
  ...
  can be specified
  as either unquoted <code class="literal">true</code>,
  <code class="literal">on</code>, and <code class="literal">yes</code>, or
  <code class="literal">false</code>, <code class="literal">off</code>, and
  <code class="literal">no</code>.
 </p>
<div class="example">
<a name="id2780915"></a><p class="title"><b>Example 3.4. function attribute syntax</b></p>
...
<td width="40%" align="right" valign="top"> Embedding Vars in Double Quotes</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/language.syntax.attributes.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02607 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
