http://www.smarty.net/docsv2/fr/language.modifier.cat.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 19:30:24 GMT
...
<td>Valeur à concaténer à la variable donnée.</td>
</tr></tbody>
</table></div>
<div class="example">
<a name="id2936303"></a><p class="title"><b>Example 5.3. cat</b></p>
...
<tr>
<td width="40%" align="left" valign="top">Chapter 5. Modificateurs de variables </td>
...
<td width="40%" align="right" valign="top"> count_characters</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/language.modifier.cat.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02293 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
