http://www.smarty.net/docsv2/fr/variable.error.reporting.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 13:59:09 GMT
...
<p>
  ...
  sa valeur est utilisée comme le
  <a class="ulink" href="http://php.net/error_reporting" target="_top"><code class="varname">error_reporting</code></a>-level
  de PHP à l'intérieur de <a class="link" href="api.display.tpl" title="display()"><code class="varname">display()</code></a>
  et <a class="link" href="api.fetch.tpl" title="fetch()"><code class="varname">fetch()</code></a>. Lorsque le <a class="link" href="chapter.debugging.console.tpl" title="Chapter 10. Console de débogage">déboguage</a>
  est ignoré, cette valeur est ignorée et error-level est non-modifié.
 </p>
<p>
  Voir aussi
  <a class="link" href="api.trigger.error.tpl" title="trigger_error()"><code class="varname">trigger_error()</code></a>,
  le <a class="link" href="chapter.debugging.console.tpl" title="Chapter 10. Console de débogage">débogage</a> et
...
<td width="40%" align="right" valign="top"> $compile_id</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/variable.error.reporting.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01813 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
