http://www.smarty.net/docsv2/de/api.unregister.outputfilter.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 09:16:13 GMT
...
<html lang="en">
  <head>
    ...
    <title>unregister_outputfilter (Ausgabefilter deaktivieren) | Smarty</title>
...
<tr><th colspan="3" align="center">unregister_outputfilter (Ausgabefilter deaktivieren)</th></tr>
<tr>
...
<div class="refentry" title="unregister_outputfilter (Ausgabefilter deaktivieren)">
<a name="api.unregister.outputfilter"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>unregister_outputfilter (Ausgabefilter deaktivieren)</p>
</div>
<div class="refsect1">
<a name="id2925677"></a><h2></h2>
...
<td width="40%" align="right" valign="top"> unregister_postfilter ('post'-Filter deaktivieren)</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/api.unregister.outputfilter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01460 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
