http://www.smarty.net/docsv2/en/variable.debugging.ctrl.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 00:03:38 GMT
...
<div class="example">
<a name="id2840434"></a><p class="title"><b>Example 12.3. $debugging_ctrl on localhost</b></p>
...
<td width="40%" align="right" valign="top"> $autoload_filters</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/variable.debugging.ctrl.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03464 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
