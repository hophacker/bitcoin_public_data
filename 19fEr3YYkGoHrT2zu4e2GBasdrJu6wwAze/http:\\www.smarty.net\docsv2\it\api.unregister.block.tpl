http://www.smarty.net/docsv2/it/api.unregister.block.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 23:36:41 GMT
...
<h2>Name</h2>
<p>unregister_block</p>
</div>
<div class="refsect1">
<a name="id3146555"></a><h2></h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">unregister_block</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">name</span></span>);</code><p>
   ...
   per i blocchi. Passate in <em class="parameter"><code>name</code></em> il
...
<td width="40%" align="right" valign="top"> unregister_compiler_function</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 2 plus 6? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/api.unregister.block.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.19234 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
