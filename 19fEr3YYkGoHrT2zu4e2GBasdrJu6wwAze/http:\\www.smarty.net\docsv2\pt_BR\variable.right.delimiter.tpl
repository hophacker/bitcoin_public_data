http://www.smarty.net/docsv2/pt_BR/variable.right.delimiter.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 09:35:45 GMT
...
<td width="40%" align="right" valign="top"> $compiler_class</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/variable.right.delimiter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03113 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
