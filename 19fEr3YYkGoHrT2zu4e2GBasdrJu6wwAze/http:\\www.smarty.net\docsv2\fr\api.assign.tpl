...
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 06:24:44 GMT
...
<h2>Name</h2>
<p>assign() — Assigne des valeurs au template</p>
</div>
<div class="refsect1" title="Description">
<a name="id3005239"></a><h2>Description</h2>
...
<div class="example">
<a name="id3005618"></a><p class="title"><b>Example 13.3. Exemple avec assign()</b></p>
...
<p>
   Voir aussi
 <a class="link" href="api.assign.by.ref.tpl" title="assign_by_ref()"><code class="varname">assign_by_ref()</code></a>,
 ...
 <a class="link" href="api.append.tpl" title="append()"><code class="varname">append()</code></a> et
...
<td width="40%" align="right" valign="top"> assign_by_ref()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/api.assign.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02673 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
