http://www.smarty.net/docsv2/en/api.register.prefilter.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 03:24:02 GMT
...
<h2>Name</h2>
<p>register_prefilter() — dynamically register prefilters</p>
</div>
<div class="refsect1" title="Description">
<a name="id2859762"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">register_prefilter</span>(<span class="methodparam"><span class="type">mixed </span><span class="parameter">function</span></span>);</code><p>
   ...
   <a class="link" href="advanced.features.prefilters.tpl" title="Prefilters">prefilters</a>
   to run templates through before they are compiled. See <a class="link" href="advanced.features.prefilters.tpl" title="Prefilters">template prefilters</a> for
...
<p>
    See also
    <a class="link" href="api.unregister.prefilter.tpl" title="unregister_prefilter()"><code class="varname">unregister_prefilter()</code></a>,
    <a class="link" href="api.register.postfilter.tpl" title="register_postfilter()"><code class="varname">register_postfilter()</code></a>,
    <a class="link" href="api.register.outputfilter.tpl" title="register_outputfilter()"><code class="varname">register_ouputfilter()</code></a>,
    ...
    and
    <a class="link" href="advanced.features.outputfilters.tpl" title="Output Filters">template output filters</a>
    section.
    </p>
</div>
</div>
...
<td width="40%" align="right" valign="top"> register_resource()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 18 plus 4? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/api.register.prefilter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03282 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
