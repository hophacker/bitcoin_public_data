...
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 12:25:07 GMT
...
<h2>Name</h2>
<p>assign() — assign values to the templates</p>
</div>
<div class="refsect1" title="Description">
<a name="id2850921"></a><h2>Description</h2>
...
<div class="example">
<a name="id2851022"></a><p class="title"><b>Example 13.3. assign()</b></p>
...
<td width="40%" align="right" valign="top"> assign_by_ref()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 9 plus 2? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/api.assign.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01384 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
