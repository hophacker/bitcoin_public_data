...
<p>
    Las etiquetas {php} permiten a suetdd incrustar código php directamente
   en el template.  No será escapado, no importando la definición de
...
<div class="example">
<a name="id3086340"></a><p class="title"><b>Example 7.16. Etiqueta {php}</b></p>
...
<p>
   ...
   <a class="ulink" href="http://php.net/global" target="_top">global</a> de PHP.
</p>
</div>
<p>
  ver También
...
<td width="40%" align="right" valign="top"> section,sectionelse</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.function.php.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02937 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
