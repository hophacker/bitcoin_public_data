http://www.smarty.net/docsv2/it/language.escaping.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 04:12:36 GMT
...
<html lang="en">
  <head>
    ...
    <title>Evitare il parsing di Smarty | Smarty</title>
...
<tr><th colspan="3" align="center">Evitare il parsing di Smarty</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="language.math.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 3. Sintassi di base</th>
...
<div class="sect1" title="Evitare il parsing di Smarty">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.escaping"></a>Evitare il parsing di Smarty</h2></div></div></div>
<p>
...
<p>
  ...
  <a class="link" href="language.function.literal.tpl" title="literal">{literal} .. {/literal}</a>.
  Potete anche usare, in modo simile alle entità HTML, <a class="link" href="language.function.ldelim.tpl" title="ldelim,rdelim">{ldelim}</a>,<a class="link" href="language.function.ldelim.tpl" title="ldelim,rdelim">{rdelim}</a> oppure <a class="link" href="language.variables.smarty.tpl#language.variables.smarty.ldelim" title="{$smarty.ldelim}">{$smarty.ldelim}</a>,<a class="link" href="language.variables.smarty.tpl#language.variables.smarty.rdelim" title="{$smarty.rdelim}">{$smarty.rdelim}</a>
  per visualizzare i delimitatori senza che Smarty ne analizzi il contenuto.
 </p>
<p>
  Spesso risulta semplicemente conveniente cambiare il <a class="link" href="variable.left.delimiter.tpl" title="$left_delimiter">$left_delimiter</a> ed il
  <a class="link" href="variable.right.delimiter.tpl" title="$right_delimiter">$right_delimiter</a> di Smarty.
 </p>
<div class="example">
<a name="id3089998"></a><p class="title"><b>Example 3.6. esempio di cambio dei delimitatori</b></p>
...
<tr>
<td width="40%" align="left" valign="top">Funzioni aritmetiche </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Chapter 4. Variabili</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/language.escaping.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02262 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
