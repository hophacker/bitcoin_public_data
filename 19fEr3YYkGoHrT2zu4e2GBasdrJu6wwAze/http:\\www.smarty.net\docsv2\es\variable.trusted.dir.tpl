http://www.smarty.net/docsv2/es/variable.trusted.dir.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 07:48:58 GMT
...
<p>
       $trusted_dir  solamente es usado cuando 
       <a class="link" href="variable.security.tpl" title="$security">$security</a> está habilitado.
...
<td width="40%" align="right" valign="top"> $left_delimiter</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/variable.trusted.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02794 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
