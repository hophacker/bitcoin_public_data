http://www.smarty.net/docsv2/pt_BR/api.fetch.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 09:35:24 GMT
...
<a name="api.fetch"></a>fetch</h2></div></div></div>
<code class="methodsynopsis"><span class="type">string </span><span class="methodname">fetch</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">template</span></span>,<br>             <span class="methodparam"><span class="type">string </span><span class="parameter">cache_id</span></span>,<br>             <span class="methodparam"><span class="type">string </span><span class="parameter">compile_id</span></span>);</code><p>
		...
		Fornecendo um tipo ou path válido  <a class="link" href="template.resources.tpl" title="Recursos (Resources)">template resource</a>. 
		Como um segundo parâmetro opcional, você pode passar o cache id.
		Veja o <a class="link" href="caching.tpl" title="Chapter 14. Caching">caching
                section</a> para maiores informações.
			</p>
<p>
				...
				pode também setar a variável <a class="link" href="variable.compile.id.tpl" title="$compile_id">$compile_id</a> ao invés
				de passá-la para cada chamada de fetch().
			</p>
<div class="example">
<a name="id2757488"></a><p class="title"><b>Example 13.14. fetch</b></p>
...
<td width="40%" align="right" valign="top"> get_config_vars</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/api.fetch.tpl">
            </form>
            </div>
          </div>
