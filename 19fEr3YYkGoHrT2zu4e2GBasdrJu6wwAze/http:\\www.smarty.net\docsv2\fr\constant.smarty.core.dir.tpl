http://www.smarty.net/docsv2/fr/constant.smarty.core.dir.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 19:20:23 GMT
...
<p>
   Il doit s'agir du <span class="emphasis"><em>chemin complet</em></span> du répertoire où
   ...
   <a class="link" href="smarty.constants.tpl#constant.smarty.dir" title="SMARTY_DIR"><code class="constant">SMARTY_DIR</code></a>. S'il est
   défini, le chemin doit se terminer par un slash. Utilisez cette
   constante lorsque vous incluez manuellement n'importe
   quel fichier core.*.
  </p>
<div class="example">
<a name="id2994422"></a><p class="title"><b>Example 11.2. SMARTY_CORE_DIR</b></p>
...
<td width="40%" align="right" valign="top"> Chapter 12. Variables</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/constant.smarty.core.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01958 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
