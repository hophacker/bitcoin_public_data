http://www.smarty.net/docsv2/de/variable.config.dir.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 09:35:14 GMT
...
<p>
    ...
    <a class="link" href="config.files.tpl" title="Chapter 9. Konfigurationsdateien">Konfigurationsdateien</a> abgelegt sind.
    Die Voreinstellung ist <code class="filename">"./configs"</code>.
...
<td width="40%" align="right" valign="top"> $plugins_dir</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 17 plus 7? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/variable.config.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02345 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
