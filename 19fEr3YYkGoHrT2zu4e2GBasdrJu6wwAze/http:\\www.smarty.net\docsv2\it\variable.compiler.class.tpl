http://www.smarty.net/docsv2/it/variable.compiler.class.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 19:31:40 GMT
...
<td width="20%" align="right"> <a accesskey="n" href="variable.request.vars.order.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
       Specifica il nome della classe del compilatore che Smarty userà
       per compilare i template. Il default è 'Smarty_Compiler'. Solo per
       utenti avanzati.
      </p>
</div>
<div class="navfooter">
...
<td width="40%" align="right"> <a accesskey="n" href="variable.request.vars.order.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">$right_delimiter </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> $request_vars_order</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/variable.compiler.class.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02786 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
