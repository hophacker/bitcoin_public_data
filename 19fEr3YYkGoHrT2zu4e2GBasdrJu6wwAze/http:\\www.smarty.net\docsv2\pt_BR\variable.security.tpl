http://www.smarty.net/docsv2/pt_BR/variable.security.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 09:16:59 GMT
...
<li class="listitem"><p>Se $php_handling está setado para SMARTY_PHP_ALLOW, isso é implicitamente
         alterado para SMARTY_PHP_PASSTHRU</p></li>
<li class="listitem"><p>Funçõs PHP não são permitidas em blocos IF,
         exceto estes especificados no $security_settings</p></li>
<li class="listitem"><p>templates podem ser somente incluidos no diretório
         listado em $secure_dir array</p></li>
<li class="listitem"><p>Arquivos locais podem ser somente trazidos do diretório
         listado em $secure_dir usando no array {fetch}</p></li>
<li class="listitem"><p>Estas tags {php}{/php} não são permitidas</p></li>
<li class="listitem"><p>Funções PHP não são permitidas como modificadores, exceto 
         estes especificados no $security_settings</p></li>
</ul></div>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $secure_dir</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/variable.security.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02512 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
