http://www.smarty.net/docsv2/fr/variable.cache.modified.check.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 01:39:22 GMT
...
<p>
  Si cette variable est à <code class="constant">TRUE</code>, Smarty respectera l'en-tête
  ...
  visite, alors un en-tête <code class="literal">'304: Not Modified'</code> sera envoyé à la place
  du contenu. Celà ne fonctionne qu'avec du contenu mis en cache hors de la
  balise <a class="link" href="language.function.insert.tpl" title="{insert}"><code class="varname">{insert}</code></a>.
 </p>
<p>
  Voir aussi
  ...
  et la <a class="link" href="caching.tpl" title="Chapter 14. Cache">section sur le cache</a>.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $config_overwrite</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/variable.cache.modified.check.tpl">
            </form>
            </div>
          </div>
