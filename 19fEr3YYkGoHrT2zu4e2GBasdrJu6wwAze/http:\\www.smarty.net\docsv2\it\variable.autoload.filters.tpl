http://www.smarty.net/docsv2/it/variable.autoload.filters.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 02:19:22 GMT
...
<p>
       Se ci sono alcuni filtri che volete caricare ad ogni chiamata del
       template, potete specificarli usando questa variabile e Smarty li
       caricherà automaticamente. La variabile è un array associativo
       dove le chiavi sono i tipi di filtro ed i valori sono array con i
       nomi dei filtri. Ad esempio:
       </p>
...
<td width="40%" align="right" valign="top"> $compile_check</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 9 plus 11? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/variable.autoload.filters.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02050 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
