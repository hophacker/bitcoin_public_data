http://www.smarty.net/docsv2/pt_BR/plugins.outputfilters.tpl
HTTP/1.1 200 OK
...
<html lang="en">
  <head>
    ...
    <title>Filtros de saída | Smarty</title>
...
<tr><th colspan="3" align="center">Filtros de saída</th></tr>
<tr>
...
<div class="sect1" title="Filtros de saída">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="plugins.outputfilters"></a>Filtros de saída</h2></div></div></div>
<p>
...
<div class="example">
<a name="id2773669"></a><p class="title"><b>Example 16.9. output filter plugin</b></p>
...
<tr>
<td width="40%" align="left" valign="top">Prefiltros/Posfiltros </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Recursos (Resources)</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/plugins.outputfilters.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02641 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
