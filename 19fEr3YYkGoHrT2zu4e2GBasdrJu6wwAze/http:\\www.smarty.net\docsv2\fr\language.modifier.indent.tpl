http://www.smarty.net/docsv2/fr/language.modifier.indent.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 06:16:18 GMT
...
<p>
  ...
  <code class="literal">"\t"</code> pour les tabulations).
 </p>
...
<td>De combien de caractères l'indentation doit être effectuée.</td>
</tr>
<tr>
<td align="center">2</td>
<td align="center">chaîne de caractère</td>
<td align="center">Non</td>
<td align="center">(espace)</td>
<td>Caractère à utiliser pour l'indentation.</td>
</tr>
</tbody>
</table></div>
<div class="example">
<a name="id2940115"></a><p class="title"><b>Example 5.12. indent</b></p>
...
<td width="40%" align="right" valign="top"> lower</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/language.modifier.indent.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02614 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
