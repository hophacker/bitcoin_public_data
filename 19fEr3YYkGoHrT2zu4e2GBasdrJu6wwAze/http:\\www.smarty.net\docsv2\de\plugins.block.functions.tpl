http://www.smarty.net/docsv2/de/plugins.block.functions.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 17:26:46 GMT
...
<html lang="en">
  <head>
    ...
    <title>Block-Funktionen | Smarty</title>
...
<tr><th colspan="3" align="center">Block-Funktionen</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="plugins.modifiers.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 16. Smarty durch Plugins erweitern</th>
...
<div class="sect1" title="Block-Funktionen">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="plugins.block.functions"></a>Block-Funktionen</h2></div></div></div>
...
<p>
    ...
    für das schliessende Tag. (konsultieren Sie den Abschnitt zu <code class="literal">&amp;$repeat</code>
    um zu erfahren wie Sie dies ändern können.)
   </p>
<p>
    Nur das Öffnungs-Tag kann Attribute enthalten. Alle so übergebenen Attribute
    werden als assoziatives Array <em class="parameter"><code>$params</code></em> der Template-Funktion
    übergeben. Sie können auf die Werte entweder direkt mit <code class="varname">$params['start']</code>
    zugreifen oder sie mit <code class="varname">extract($params)</code> in die Symbol-Tabelle
    importieren. Die Attribute aus dem Öffnungs-Tag stehen auch beim Aufruf für das
    schliessende Tag zur Verfügung.
   </p>
<p>
    Der Inhalt der <em class="parameter"><code>$content</code></em> Variable hängt davon
    ab, ob die Funktion für das öffnende Tag oder für das schliessende
    Tag aufgerufen wird. Für das öffnende Tag ist der Wert <code class="literal">null</code>,
...
<p>
    Der Parameter <em class="parameter"><code>&amp;$repeat</code></em> wird als Referenz übergeben und
    kontrolliert wie oft ein Block dargestellt werden soll. Standardwert von <em class="parameter"><code>$repeat</code></em>
    ist beim ersten Aufruf (für das öffnende Tag) <code class="literal">true</code>, danach immer
    <code class="literal">false</code>.
    Jedes Mal wenn eine Funktion für <em class="parameter"><code>&amp;$repeat</code></em> TRUE zurück gibt,
    wird der Inhalt zwischen {func} .. {/func} erneut mit dem veränderten
    Inhalt als <em class="parameter"><code>$content</code></em> Parameter aufgerufen.
   </p>
<p>
    Wenn Sie verschachtelte Block-Funktionen haben, können Sie 
    die Eltern-Block-Funktion mit der <code class="varname">$smarty-&gt;_tag_stack</code> Variable 
...
<p>
    ...
    Sehen Sie dazu:
    <a class="link" href="api.register.block.tpl" title="register_block (Block-Funktion registrieren)">register_block()</a>,
    <a class="link" href="api.unregister.block.tpl" title="unregister_block (Block-Funktion deaktivieren)">unregister_block()</a>.
   </p>
<div class="example">
<a name="id2938412"></a><p class="title"><b>Example 16.5. Block-Funktionen</b></p>
...
<tr>
<td width="40%" align="left" valign="top">Variablen-Modifikatoren </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Compiler-Funktionen</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 10 plus 11? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="3286c9f05bc0a23addf78717383fe4b8">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/plugins.block.functions.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01879 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
