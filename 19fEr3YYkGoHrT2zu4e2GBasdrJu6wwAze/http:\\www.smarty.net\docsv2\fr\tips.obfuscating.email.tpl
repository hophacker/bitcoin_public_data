http://www.smarty.net/docsv2/fr/tips.obfuscating.email.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 13:57:51 GMT
...
<html lang="en">
  <head>
    ...
    <title>Dissimuler les adresses email | Smarty</title>
...
<tr><th colspan="3" align="center">Dissimuler les adresses email</th></tr>
<tr>
...
<div class="sect1" title="Dissimuler les adresses email">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="tips.obfuscating.email"></a>Dissimuler les adresses email</h2></div></div></div>
<p>
...
<div class="example">
<a name="id3041074"></a><p class="title"><b>Example 18.8. Exemple de dissimulation d'une adresse email</b></p>
...
<p>
    Voir aussi
    <a class="link" href="language.modifier.escape.tpl" title="escape"><code class="varname">escape</code></a> et
    <a class="link" href="language.function.mailto.tpl" title="{mailto}"><code class="varname">{mailto}</code></a>.
   </p>
</div>
<div class="navfooter">
...
<tr>
<td width="40%" align="left" valign="top">Templates composants </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Chapter 19. Ressources</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/tips.obfuscating.email.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02241 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
