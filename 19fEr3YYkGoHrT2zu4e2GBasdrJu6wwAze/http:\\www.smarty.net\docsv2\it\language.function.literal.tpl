http://www.smarty.net/docsv2/it/language.function.literal.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 18:05:00 GMT
...
<th width="60%" align="center">Chapter 7. Funzioni incorporate</th>
...
<p>
   I tag literal vi consentono di far sì che un blocco di dati venga letto
   "letteralmente". Ciò è utile tipicamente quando avete un blocco javascript
   o CSS nel quale le parentesi graffe si confonderebbero con i delimitatori
   del template. Tutto ciò che si trova fra {literal} e {/literal} non viene
   interpretato, ma visualizzato così com'è. Se avete bisogno di usare tag
   del template all'interno del blocco literal, considerate la possibilità di
   usare invece <a class="link" href="language.function.ldelim.tpl" title="ldelim,rdelim">{ldelim}{rdelim}</a>
   per fare l'escape dei singoli delimitatori.
  </p>
<div class="example">
<a name="id3107703"></a><p class="title"><b>Example 7.13. tag literal</b></p>
...
<td width="40%" align="right" valign="top"> php</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/language.function.literal.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02431 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
