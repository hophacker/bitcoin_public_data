...
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 14:43:19 GMT
...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Compiler Functions">
    <meta name="keywords" content="compiler, functions">
...
<div class="example">
<a name="idp19940368"></a><p class="title"><b>Example 18.6. A simple compiler function</b></p>
...
<td width="40%" align="right" valign="top"> Prefilters/Postfilters</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/plugins.compiler.functions.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02752 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
