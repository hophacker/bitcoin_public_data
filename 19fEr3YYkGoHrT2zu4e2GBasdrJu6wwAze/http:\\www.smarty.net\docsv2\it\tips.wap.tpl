http://www.smarty.net/docsv2/it/tips.wap.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 12:23:21 GMT
...
<div class="example">
<a name="id3164072"></a><p class="title"><b>Example 18.6. usare insert per scrivere un header Content-Type WML</b></p>
...
<p>
     il template <span class="emphasis"><em>deve</em></span> iniziare con il tag insert:
    </p>
<pre class="programlisting">
...
<td width="40%" align="right" valign="top"> Template a componenti</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/tips.wap.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02975 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
