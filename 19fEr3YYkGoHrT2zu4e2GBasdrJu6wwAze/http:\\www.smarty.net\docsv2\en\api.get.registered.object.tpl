http://www.smarty.net/docsv2/en/api.get.registered.object.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 10:42:53 GMT
...
<h2>Name</h2>
<p>get_registered_object() — returns a reference to a registered object</p>
</div>
<div class="refsect1" title="Description">
<a name="id2854827"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">array </span><span class="methodname">get_registered_object</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">object_name</span></span>);</code><p>
   ...
   <a class="link" href="api.register.object.tpl" title="register_object()">registered object</a>. See the
   <a class="link" href="advanced.features.tpl#advanced.features.objects" title="Objects">objects</a> page for more info.
  </p>
<div class="example">
<a name="id2855916"></a><p class="title"><b>Example 13.17. get_registered_object()</b></p>
...
<br class="example-break"><p>
  ...
  and
  <a class="link" href="advanced.features.tpl#advanced.features.objects" title="Objects">objects page</a>
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> get_template_vars()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/api.get.registered.object.tpl">
            </form>
            </div>
          </div>
