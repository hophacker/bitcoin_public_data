http://www.smarty.net/docsv2/es/language.modifier.wordwrap.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 14:31:19 GMT
...
<td>Este determina en cuantas columnas cortar.</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center">\n</td>
<td>Esta es la cadena usada para cortar.</td>
</tr>
<tr>
...
<td>Este determina cuando cortar o no, o al final de una
...
<p>
   Este <span class="command"><strong>wordwrap</strong></span> corta una cadena para un ancho de columna, 
   ...
   Este es equivalente a la función <a class="ulink" href="http://php.net/wordwrap" target="_top">wordwrap()</a> de PHP.
  </p>
<div class="example">
<a name="id3076574"></a><p class="title"><b>Example 5.22. wordwrap</b></p>
...
<br class="example-break"><p>
     Ver También <a class="link" href="language.modifier.nl2br.tpl" title="nl2br">nl2br</a>
...
<td width="40%" align="right" valign="top"> Chapter 6. Combinando Modificadores</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.modifier.wordwrap.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01786 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
