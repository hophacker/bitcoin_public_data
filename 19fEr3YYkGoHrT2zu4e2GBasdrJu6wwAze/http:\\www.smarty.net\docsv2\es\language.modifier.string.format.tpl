http://www.smarty.net/docsv2/es/language.modifier.string.format.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 04:22:38 GMT
...
<td>Este es el formato que debera usar. (sprintf)</td>
</tr></tbody>
</table></div>
<p>
   Esta es una manera de formatear cadenas, como números decimales y otros.
   Use la sintaxis de <a class="ulink" href="http://php.net/sprintf" target="_top">sprintf</a> para formatearlo.
  </p>
<div class="example">
<a name="id3074975"></a><p class="title"><b>Example 5.17. string_format</b></p>
...
<br class="example-break"><p>
    Ver también <a class="link" href="language.modifier.date.format.tpl" title="date_format">date_format</a>.
    </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> strip</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.modifier.string.format.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01105 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
