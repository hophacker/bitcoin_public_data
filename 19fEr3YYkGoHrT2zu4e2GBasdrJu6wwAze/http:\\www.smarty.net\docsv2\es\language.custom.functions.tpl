http://www.smarty.net/docsv2/es/language.custom.functions.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 03:32:21 GMT
...
<div class="example">
<a name="id3093904"></a><p class="title"><b>Example 8.1. {assign}</b></p>
...
<a name="id3093931"></a><p class="title"><b>Example 8.2. Accesando variables desde un script de PHP. {assign}</b></p>
<div class="example-contents">
<p>
...
<p>
  ...
  <a class="link" href="language.function.include.tpl" title="include">{include}</a>,
  ...
  <a class="link" href="language.function.counter.tpl" title="{counter}">{counter}</a>,
  <a class="link" href="language.function.cycle.tpl" title="cycle">{cycle}</a>,
  ...
  <a class="link" href="language.function.math.tpl" title="math">{math}</a>,
...
<p>
 ...
 y <a class="link" href="api.get.template.vars.tpl" title="get_template_vars()">get_template_vars()</a>.
 </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> {counter}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.custom.functions.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03187 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
