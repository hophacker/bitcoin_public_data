...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 13:59:07 GMT
...
<p>
     ...
     meaning that Smarty
     will look for the
     <code class="filename">templates/</code> directory in
     the same directory as the executing php script. <span class="property">$template_dir</span>
     can also be an array of directory paths: Smarty will traverse the
     directories and stop on the first matching template found.
    </p>
...
<h3 class="title">Technical Note</h3>
<p>
      If the directories known to <em class="parameter"><code>$template_dir</code></em> 
      are relative to directories known to the
...
<p>
      As of Smarty 3.1 the attribute $template_dir is no longer accessible directly. Use 
      <a class="link" href="api.get.template.dir.tpl" title="getTemplateDir()"><code class="varname">getTemplateDir()</code></a>, 
      <a class="link" href="api.set.template.dir.tpl" title="setTemplateDir()"><code class="varname">setTemplateDir()</code></a> and
      <a class="link" href="api.add.template.dir.tpl" title="addTemplateDir()"><code class="varname">addTemplateDir()</code></a> instead.
     </p>
</div>
<p>
     See also 
     <a class="link" href="resources.tpl" title="Chapter 16. Resources"><code class="varname">Template Resources</code></a>, 
     <a class="link" href="variable.use.include.path.tpl" title="$use_include_path"><em class="parameter"><code>$use_include_path</code></em></a>, 
     <a class="link" href="api.get.template.dir.tpl" title="getTemplateDir()"><code class="varname">getTemplateDir()</code></a>, 
     <a class="link" href="api.set.template.dir.tpl" title="setTemplateDir()"><code class="varname">setTemplateDir()</code></a> and
...
<td width="40%" align="right" valign="top"> $trusted_dir</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 16 plus 2? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/variable.template.dir.tpl">
            </form>
            </div>
          </div>
