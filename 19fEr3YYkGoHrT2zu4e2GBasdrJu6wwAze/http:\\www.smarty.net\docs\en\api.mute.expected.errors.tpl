...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 01:29:45 GMT
...
<a name="idp16505488"></a><h2>Description</h2>
...
<td width="40%" align="right" valign="top"> registerCacheResource()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/api.mute.expected.errors.tpl">
            </form>
            </div>
          </div>
