...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 03:31:59 GMT
...
<p>
  Les balises <code class="varname">{php}</code> permettent de rajouter du code PHP
  directement dans le template. Ils ne seront pas ignorés, quelle que soit la valeur de <a class="link" href="variable.php.handling.tpl" title="$php_handling"><em class="parameter"><code>$php_handling</code></em></a>. Pour les
...
<p>
   Pour accéder aux variables PHP dans les blocks <code class="varname">{php}</code>, vous devriez avoir besoin
   d'utiliser le mot clé PHP <a class="ulink" href="http://php.net/global" target="_top"><code class="literal">global</code></a>.
  </p>
</div>
<div class="example">
<a name="id2956570"></a><p class="title"><b>Example 7.28. Exemple avec la balise {php}</b></p>
...
<a name="id2956582"></a><p class="title"><b>Example 7.29. Balises {php} avec le mot clé global et assignement d'une variable</b></p>
<div class="example-contents"><pre class="programlisting">
...
<br class="example-break"><p>
  ...
  <a class="link" href="language.function.insert.tpl" title="{insert}"><code class="varname">{insert}</code></a> et
  <a class="link" href="tips.componentized.templates.tpl" title="Templates composants">les templates composantes</a>.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> {section},{sectionelse}</td>
          ...
          <div class="commentInfo">
              ...
              <div class="commentAuthor">by <b>anonymous</b> on Feb  7, 2012 at  7:18</div>
              <div class="commentBody">Bonjour,

Dans le fichier &quot;product-list.tpl&quot;,

dans la boucle &quot;{foreach from=$products item=product name=products}&quot;,

je voudrais rÃ©cupÃ©rÃ© dans mes balises &quot;{php} {/php}&quot; la variable &quot;$product-&gt;id&quot; que j'utiliserai dans une fonction php que j'ai crÃ©Ã©e.
...
Merci</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 12 plus 13? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/language.function.php.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03096 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
