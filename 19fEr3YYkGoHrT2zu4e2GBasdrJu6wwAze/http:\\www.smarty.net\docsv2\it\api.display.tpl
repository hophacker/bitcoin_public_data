http://www.smarty.net/docsv2/it/api.display.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 22:01:07 GMT
...
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">display</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">template</span></span>,<br>             <span class="methodparam"><span class="type">string </span><span class="parameter">cache_id</span></span>,<br>             <span class="methodparam"><span class="type">string </span><span class="parameter">compile_id</span></span>);</code><p>
   ...
   corretti per la <a class="link" href="template.resources.tpl" title="Risorse">risorsa del template</a>.
...
<div class="example">
<a name="id3141932"></a><p class="title"><b>Example 13.12. display</b></p>
...
<br class="example-break"><p>
   Usate la sintassi delle <a class="link" href="template.resources.tpl" title="Risorse">risorse dei template</a>
   per visualizzare file che si trovano al di fuori della
   directory $template_dir.
  </p>
<div class="example">
<a name="id3141919"></a><p class="title"><b>Example 13.13. esempi di visualizzazione di risorse di template</b></p>
<div class="example-contents"><pre class="programlisting">
...
<td width="40%" align="right" valign="top"> fetch</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/api.display.tpl">
            </form>
            </div>
          </div>
