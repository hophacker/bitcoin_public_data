http://www.smarty.net/docsv2/it/variable.secure.dir.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 18:04:54 GMT
...
<p>
       E' un array contenente tutte le directory locali che sono considerate
       sicure. {include} e {fetch} lo usano quando $security è abilitata.
      </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $security_settings</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/variable.secure.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02649 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
