http://www.smarty.net/docsv2/en/plugins.compiler.functions.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 15:19:50 GMT
...
<html lang="en">
  <head>
    ...
    <title>Compiler Functions | Smarty</title>
...
<p>
     ...
     <a class="link" href="language.custom.functions.tpl" title="Chapter 8. Custom Functions">custom function</a> registered
...
<div class="example">
<a name="id2879997"></a><p class="title"><b>Example 16.6. A simple compiler function</b></p>
...
<td width="40%" align="right" valign="top"> Prefilters/Postfilters</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/plugins.compiler.functions.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03895 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
