http://www.smarty.net/docsv2/es/language.math.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 05:45:30 GMT
...
<html lang="en">
  <head>
    ...
    <title>Matemáticas | Smarty</title>
...
<tr><th colspan="3" align="center">Matemáticas</th></tr>
<tr>
...
<div class="sect1" title="Matemáticas">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.math"></a>Matemáticas</h2></div></div></div>
<p>
  Las matemáticas pueden ser aplicadas directamente al los valores de
  las variables.
 </p>
<div class="example">
<a name="id3065464"></a><p class="title"><b>Example 3.6. Ejemplos de matemáticas</b></p>
...
<br class="example-break"><p>
 Ver también la función<a class="link" href="language.function.math.tpl" title="math">{math}</a>.
</p>
</div>
<div class="navfooter">
<hr>
...
<tr>
<td width="40%" align="left" valign="top">Colocando variables entre comillas dobles </td>
...
<td width="40%" align="right" valign="top"> Escaping Smarty Parsing</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.math.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03285 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
