http://www.smarty.net/docsv2/pt_BR/api.get.template.vars.tpl
HTTP/1.1 200 OK
...
<div class="sect1" title="get_template_vars">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="api.get.template.vars"></a>get_template_vars</h2></div></div></div>
...
<div class="example">
<a name="id2757969"></a><p class="title"><b>Example 13.17. get_template_vars</b></p>
...
<td width="40%" align="right" valign="top"> is_cached</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/api.get.template.vars.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02690 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
