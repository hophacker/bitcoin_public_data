http://www.smarty.net/docsv2/pt_BR/variable.config.fix.newlines.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 09:16:52 GMT
...
<html lang="en">
  <head>
    ...
    <title>$config_fix_newlines | Smarty</title>
...
<tr><th colspan="3" align="center">$config_fix_newlines</th></tr>
<tr>
...
<div class="sect1" title="$config_fix_newlines">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="variable.config.fix.newlines"></a>$config_fix_newlines</h2></div></div></div>
<p>
...
<td width="40%" align="right" valign="top"> $default_template_handler_func</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/variable.config.fix.newlines.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02477 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
