http://www.smarty.net/docsv2/es/api.register.outputfilter.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 13:24:34 GMT
...
<h2>Name</h2>
<p>register_outputfilter() — Registra dinamicamente filtros de salida</p>
</div>
<div class="refsect1" title="Descripción">
<a name="id3133909"></a><h2>Descripción </h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">register_outputfilter</span>(<span class="methodparam"><span class="type">mixed </span><span class="parameter">function</span></span>);</code><p>
   Use este para registrar dinámicamente <a class="link" href="plugins.outputfilters.tpl" title="Filtros de Salida">filtros de salida</a> para
   operaciones en la <a class="link" href="api.display.tpl" title="display()">salida</a> 
   del template antes de mostrarlo.
   Vea  <a class="link" href="advanced.features.outputfilters.tpl" title="Filtros de salida">Filtros de 
   Salida de Templates</a> para mayores informes de como 
...
<li class="listitem"><p>
    un arreglo con la forma 
     ...
     <code class="literal">&amp;$object</code> siendo referencia a un objeto y
     <code class="literal">$method</code> siendo una cadena conteniendo el nombre de un metodo
     </p></li>
<li class="listitem"><p>
    un arreglo con la forma
     <code class="literal">array(&amp;$class, $method)</code> con
     <code class="literal">$class</code> siendo el nombre de la clase y
     <code class="literal">$method</code> siendo un método de esta clase.
     </p></li>
</ol></div>
<p>
Vea también 
<a class="link" href="api.unregister.outputfilter.tpl" title="unregister_outputfilter()">unregister_outputfilter()</a>,
...
y
<a class="link" href="advanced.features.outputfilters.tpl" title="Filtros de salida">template output filters</a>.
</p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> register_postfilter()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/api.register.outputfilter.tpl">
            </form>
            </div>
          </div>
