http://www.smarty.net/docs/en/language.modifier.count.sentences.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 15:21:16 GMT
...
<p>
   ...
   A sentence being delimited by a dot, question- or exclamation-mark (.?!).
  </p>
<div class="example">
<a name="idp6200048"></a><p class="title"><b>Example 5.6. count_sentences</b></p>
...
<td width="40%" align="right" valign="top"> count_words</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/language.modifier.count.sentences.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02427 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
