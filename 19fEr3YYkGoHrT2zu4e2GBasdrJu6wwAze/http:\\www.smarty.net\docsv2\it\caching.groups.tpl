http://www.smarty.net/docsv2/it/caching.groups.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 17:26:28 GMT
...
<html lang="en">
  <head>
    ...
    <title>Gruppi di Cache | Smarty</title>
...
<tr><th colspan="3" align="center">Gruppi di Cache</th></tr>
<tr>
...
<div class="sect1" title="Gruppi di Cache">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="caching.groups"></a>Gruppi di Cache</h2></div></div></div>
<p>
...
<div class="example">
<a name="id3153604"></a><p class="title"><b>Example 14.9. gruppi di cache_id</b></p>
...
<tr>
<td width="40%" align="left" valign="top">Cache multiple per una pagina </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Mettere in Cache l'output dei Plugin</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 16 plus 20? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="a92e50703c9e03e9d19ea76856883fb2">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/caching.groups.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01947 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
