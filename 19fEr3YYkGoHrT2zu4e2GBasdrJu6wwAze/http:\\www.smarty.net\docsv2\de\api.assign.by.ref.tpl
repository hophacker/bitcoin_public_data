http://www.smarty.net/docsv2/de/api.assign.by.ref.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 10:40:05 GMT
...
<html lang="en">
  <head>
    ...
    <title>assign_by_ref (Referenz zuweisen) | Smarty</title>
...
<tr><th colspan="3" align="center">assign_by_ref (Referenz zuweisen)</th></tr>
<tr>
...
<div class="refentry" title="assign_by_ref (Referenz zuweisen)">
<a name="api.assign.by.ref"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>assign_by_ref (Referenz zuweisen)</p>
</div>
<div class="refsect1">
<a name="id2918072"></a><h2></h2>
...
<div class="example">
<a name="id2918760"></a><p class="title"><b>Example 13.4. assign_by_ref (via Referenz zuweisen)</b></p>
...
<td width="40%" align="right" valign="top"> clear_all_assign (alle Zuweisungen löschen)</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/api.assign.by.ref.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02244 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
