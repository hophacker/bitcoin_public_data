http://www.smarty.net/docsv2/it/language.function.if.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 18:04:22 GMT
...
<p>
			Le istruzioni <span class="emphasis"><em>{if}</em></span> in Smarty hanno praticamente la 
			stessa flessibilità delle istruzioni if PHP, con qualche caratteristica
			aggiuntiva per il motore di template.
			Ogni <span class="emphasis"><em>{if}</em></span> deve essere chiuso con un
			<span class="emphasis"><em>{/if}</em></span>. Sono previsti anche <span class="emphasis"><em>{else}</em></span>
			e <span class="emphasis"><em>{elseif}</em></span>. Sono riconosciuti tutti gli operatori condizionali
			di PHP, come <span class="emphasis"><em>||</em></span>, <span class="emphasis"><em>or</em></span>,
            <span class="emphasis"><em>&amp;&amp;</em></span>, <span class="emphasis"><em>and</em></span>, ecc.
			</p>
<p>
...
<td align="center"> </td>
<td>$a is not even</td>
<td>[non] è un numero pari (unario)</td>
<td>$a % 2 == 0</td>
</tr>
<tr>
...
<td>livello di raggruppamento [non] pari</td>
<td>($a / $b) % 2 == 0</td>
</tr>
<tr>
...
<td align="center"> </td>
<td>$a is not odd</td>
<td>[non] è un numero dispari (unario)</td>
<td>$a % 2 != 0</td>
</tr>
<tr>
...
<td>livello di raggruppamento [non] dispari</td>
<td>($a / $b) % 2 != 0</td>
</tr>
</tbody>
</table></div>
<div class="example">
<a name="id3107610"></a><p class="title"><b>Example 7.11. Istruzioni if</b></p>
...
<td width="40%" align="right" valign="top"> ldelim,rdelim</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/language.function.if.tpl">
            </form>
            </div>
          </div>
