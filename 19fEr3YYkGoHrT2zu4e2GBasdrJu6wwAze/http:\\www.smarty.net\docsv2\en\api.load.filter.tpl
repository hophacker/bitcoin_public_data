http://www.smarty.net/docsv2/en/api.load.filter.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 14:40:04 GMT
...
<html lang="en">
  <head>
    ...
    <title>load_filter() | Smarty</title>
...
<tr><th colspan="3" align="center">load_filter()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.is.cached.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty Class Methods()</th>
<td width="20%" align="right"> <a accesskey="n" href="api.register.block.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="load_filter()">
<a name="api.load.filter"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>load_filter() — load a filter plugin</p>
</div>
<div class="refsect1" title="Description">
<a name="id2856285"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">load_filter</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">type</span></span>,<br>                 <span class="methodparam"><span class="type">string </span><span class="parameter">name</span></span>);</code><p>
   The first argument specifies the type of the filter to load and can be one
   of the following: <code class="literal">pre</code>, <code class="literal">post</code> or
   <code class="literal">output</code>.
   The second argument specifies the <em class="parameter"><code>name</code></em> of the
   filter plugin.
  </p>
<div class="example">
<a name="id2856531"></a><p class="title"><b>Example 13.21. Loading filter plugins</b></p>
...
<br class="example-break"><p>
  See also
  <a class="link" href="api.register.prefilter.tpl" title="register_prefilter()"><code class="varname">register_prefilter()</code></a>,
  <a class="link" href="api.register.postfilter.tpl" title="register_postfilter()"><code class="varname">register_postfilter()</code></a>,
  <a class="link" href="api.register.outputfilter.tpl" title="register_outputfilter()"><code class="varname">register_outputfilter()</code></a>,
  ...
  and
  <a class="link" href="advanced.features.tpl" title="Chapter 15. Advanced Features">advanced features</a>.
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right"> <a accesskey="n" href="api.register.block.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">is_cached() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> register_block()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 13 plus 19? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="5a106e10437ba2ed3a5e9c2caf861fb0">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/api.load.filter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02056 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
