...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 07:37:29 GMT
...
<p>
  Les balises <code class="varname">{literal}</code> permettent à un bloc de données
  d'être pris tel
  ...
  entre les balises <code class="varname">{literal}{/literal}</code> ne sera pas interprété, et
  affiché comme du contenu statique. Si vous voulez inclure des tags de template
  dans votre block <code class="varname">{literal}</code>, utilisez plutôt
...
<div class="example">
<a name="id2956697"></a><p class="title"><b>Example 7.25. Balises {literal}</b></p>
...
<a name="id2956709"></a><p class="title"><b>Example 7.26. Exemple avec Javascript</b></p>
<div class="example-contents"><pre class="programlisting">
...
<br class="example-break"><div class="example">
<a name="id2956729"></a><p class="title"><b>Example 7.27. Un peu de css dans un template</b></p>
<div class="example-contents"><pre class="programlisting">
...
<br class="example-break"><p>
  Voir aussi
  <a class="link" href="language.function.ldelim.tpl" title="{ldelim},{rdelim}"><code class="varname">{ldelim} {rdelim}</code></a> et
  la <a class="link" href="language.escaping.tpl" title="Désactiver l'analyse de Smarty">désactivation de l'analyse de Smarty</a>.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> {php}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/language.function.literal.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02531 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
