http://www.smarty.net/docsv2/en/tips.default.var.handling.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 12:23:30 GMT
...
<div class="example">
<a name="id2885019"></a><p class="title"><b>Example 18.2. Assigning a template variable its default value</b></p>
...
<tr>
<td width="40%" align="left" valign="top">Chapter 18. Tips &amp; Tricks </td>
...
<td width="40%" align="right" valign="top"> Passing variable title to header template</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/tips.default.var.handling.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03169 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
