http://www.smarty.net/docsv2/pt_BR/api.register.function.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 20:08:13 GMT
...
<html lang="en">
  <head>
    ...
    <title>register_function | Smarty</title>
...
<a accesskey="p" href="api.register.compiler.function.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Métodos</th>
<td width="20%" align="right"> <a accesskey="n" href="api.register.modifier.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="register_function">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="api.register.function"></a>register_function</h2></div></div></div>
<div class="funcsynopsis">
<table border="0" summary="Function synopsis" cellspacing="0" cellpadding="0" class="funcprototype-table">
<tr>
<td><code class="funcdef">void <b class="fsfunc">register_function</b>(</code></td>
<td>
...
<td> </td>
<td>
<var class="pdparam">cacheable</var>, </td>
<td> </td>
</tr>
<tr>
<td> </td>
<td>
<var class="pdparam">cache_attrs</var><code>)</code>;</td>
<td> </td>
</tr>
</table>
<div class="paramdef-list">
<code>string <var class="pdparam">name</var></code>;<br><code>mixed <var class="pdparam">impl</var></code>;<br><code>bool <var class="pdparam">cacheable</var></code>;<br><code>array or null <var class="pdparam">cache_attrs</var></code>;</div>
...
<p>
             A chamada para função-php <em class="parameter"><code>impl</code></em> pode ser (a) 
	     uma string contendo o nome da função ou (b) um array no formato
	     <code class="literal">array(&amp;$object, $method)</code> com
             ...
             <code class="literal">$method</code> sendo um método
             desta classe.
                        </p>
<p>
<em class="parameter"><code>$cacheable</code></em> e <em class="parameter"><code>$cache_attrs</code></em> podem ser omitidos na maioria dos casos. Veja <a class="link" href="caching.cacheable.tpl" title="Controlling Cacheability of Plugins' Output">Controlando modos de Saída Cache dos Plugins</a> para obter informações apropriadas.
			</p>
<div class="example">
<a name="id2760002"></a><p class="title"><b>Example 13.22. register_function</b></p>
...
// ou, {date_now format="%Y/%m/%d"} para formatar isso.</pre></div>
</div>
...
<td width="40%" align="right"> <a accesskey="n" href="api.register.modifier.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> register_modifier</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="fbde99c9ef478d8473edb7a2c8189bb3">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/api.register.function.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01784 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
