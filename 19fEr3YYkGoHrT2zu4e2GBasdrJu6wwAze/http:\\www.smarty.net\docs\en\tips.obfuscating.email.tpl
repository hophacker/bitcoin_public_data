http://www.smarty.net/docs/en/tips.obfuscating.email.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 02:10:29 GMT
...
<html lang="en">
  <head>
    ...
    <title>Obfuscating E-mail Addresses | Smarty</title>
    <meta name="description" content="Obfuscating E-mail Addresses">
    <meta name="keywords" content="obfuscating, e, mail, addresses">
...
<div class="example">
<a name="idp20376512"></a><p class="title"><b>Example 21.8. Example of template the Obfuscating an email address</b></p>
...
<td width="40%" align="right" valign="top"> Chapter 22. Resources</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/tips.obfuscating.email.tpl">
            </form>
            </div>
          </div>
