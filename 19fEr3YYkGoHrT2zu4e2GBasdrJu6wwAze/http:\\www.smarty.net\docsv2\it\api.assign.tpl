http://www.smarty.net/docsv2/it/api.assign.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 01:29:01 GMT
...
<div class="example">
<a name="id3139669"></a><p class="title"><b>Example 13.3. assign</b></p>
...
<td width="40%" align="right" valign="top"> assign_by_ref</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/api.assign.tpl">
            </form>
            </div>
          </div>
