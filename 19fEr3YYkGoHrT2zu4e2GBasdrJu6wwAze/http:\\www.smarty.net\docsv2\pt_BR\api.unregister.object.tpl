http://www.smarty.net/docsv2/pt_BR/api.unregister.object.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 11:22:19 GMT
...
<div class="sect1" title="unregister_object">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="api.unregister.object"></a>unregister_object</h2></div></div></div>
<div class="funcsynopsis">
<table border="0" summary="Function synopsis" cellspacing="0" cellpadding="0" class="funcprototype-table"><tr>
<td><code class="funcdef">void <b class="fsfunc">unregister_object</b>(</code></td>
<td>
...
<td width="40%" align="right" valign="top"> unregister_outputfilter</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/api.unregister.object.tpl">
            </form>
            </div>
          </div>
