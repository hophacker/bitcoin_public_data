http://www.smarty.net/docsv2/pt_BR/plugins.prefilters.postfilters.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 16:03:19 GMT
...
<html lang="en">
  <head>
    ...
    <title>Prefiltros/Posfiltros | Smarty</title>
...
<tr><th colspan="3" align="center">Prefiltros/Posfiltros</th></tr>
<tr>
...
<div class="sect1" title="Prefiltros/Posfiltros">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="plugins.prefilters.postfilters"></a>Prefiltros/Posfiltros</h2></div></div></div>
<p>
...
<div class="example">
<a name="id2773261"></a><p class="title"><b>Example 16.7. Plugin prefilter</b></p>
...
<div class="example">
<a name="id2773286"></a><p class="title"><b>Example 16.8. Plugin postfilter</b></p>
<div class="example-contents"><pre class="programlisting">
&lt;?php
/*
 * Smarty plugin
...
<tr>
<td width="40%" align="left" valign="top">Funções Compiladoras </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Filtros de saída</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/plugins.prefilters.postfilters.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02323 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
