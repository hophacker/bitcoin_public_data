http://www.smarty.net/docsv2/es/language.function.debug.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 21:18:49 GMT
...
<td align="center"><span class="emphasis"><em>javascript</em></span></td>
<td>Tipo de salida, html o javascript</td>
</tr></tbody>
</table></div>
<p>
  {debug} Muestra el debug de la consola en la pagina. 
  Esto funciona independente de la definición de 
  <a class="link" href="chapter.debugging.console.tpl" title="Chapter 10. Debugging Console">debug</a>.
...
<p>
   Ver también <a class="link" href="chapter.debugging.console.tpl" title="Chapter 10. Debugging Console">Debugging console</a>
  </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> {eval}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 6 plus 10? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="b5d3453e66b0ec632a299aea4154999a">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.function.debug.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02652 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
