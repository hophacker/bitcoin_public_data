http://www.smarty.net/docsv2/es/api.unregister.postfilter.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 07:49:15 GMT
...
<h2>Name</h2>
<p>unregister_postfilter() — Des-registra dinamicamente un postfiltro</p>
</div>
<div class="refsect1" title="Descripción">
<a name="id3138015"></a><h2>Descripción </h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">unregister_postfilter</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">function_name</span></span>);</code><p>
    Ver también 
    <a class="link" href="api.unregister.postfilter.tpl" title="unregister_postfilter()">register_postfilter()</a>
    y <a class="link" href="plugins.prefilters.postfilters.tpl" title="Prefiltros/Postfiltros">template post filters</a>.
</p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> unregister_prefilter()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/api.unregister.postfilter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01502 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
