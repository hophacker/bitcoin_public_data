http://www.smarty.net/docsv2/es/variable.default.template.handler.func.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 00:16:25 GMT
...
<p>
      Esta función es llamada cuando un template no puede ser obtenido
      desde su recurso.
      </p>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> $php_handling</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/variable.default.template.handler.func.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01989 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
