http://www.smarty.net/docsv2/it/language.variables.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 07:49:38 GMT
...
<html lang="en">
  <head>
    ...
    <title>Chapter 4. Variabili | Smarty</title>
...
<tr><th colspan="3" align="center">Chapter 4. Variabili</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="language.escaping.tpl">Prev</a> </td>
<th width="60%" align="center">Part II. Smarty Per Progettisti di Template</th>
...
<div class="chapter" title="Chapter 4. Variabili">
<div class="titlepage"><div><div><h2 class="title">
<a name="language.variables"></a>Chapter 4. Variabili</h2></div></div></div>
<div class="toc">
...
<p>
  ...
  è sufficiente includerla fra i delimitatori in modo che sia l'unica 
...
<div class="sect1" title="Variabili valorizzate da PHP">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.assigned.variables"></a>Variabili valorizzate da PHP</h2></div></div></div>
<p>
         Le variabili valorizzate da PHP sono referenziate facendole precedere
         da un segno di dollaro <code class="literal">$</code>. Anche le variabili
         valorizzate internamente al template con la funzione <a class="link" href="language.custom.functions.tpl#language.function.assign" title="assign">assign</a> vengono visualizzate
         in questo modo.
    </p>
<div class="example">
<a name="id3089415"></a><p class="title"><b>Example 4.1. variabili valorizzate</b></p>
...
<br class="example-break"><div class="sect2" title="Array associativi">
<div class="titlepage"><div><div><h3 class="title">
<a name="language.variables.assoc.arrays"></a>Array associativi</h3></div></div></div>
<p>
			Potete fare riferimento ad array associativi valorizzati da 
			PHP specificando l'indice dopo il punto '.'
			</p>
<div class="example">
<a name="id3091540"></a><p class="title"><b>Example 4.2. accesso ad array associativi</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<div class="sect2" title="Array con indici numerici">
<div class="titlepage"><div><div><h3 class="title">
<a name="language.variables.array.indexes"></a>Array con indici numerici</h3></div></div></div>
<p>
			Potete referenziare gli array con il loro indice, come in PHP.
			</p>
<div class="example">
<a name="id3091607"></a><p class="title"><b>Example 4.3. accesso agli array per indice numerico</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<div class="sect2" title="Oggetti">
<div class="titlepage"><div><div><h3 class="title">
<a name="language.variables.objects"></a>Oggetti</h3></div></div></div>
<p>
...
<div class="example">
<a name="id3091674"></a><p class="title"><b>Example 4.4. accesso alle proprietà degli oggetti</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<tr>
<td width="40%" align="left" valign="top">Evitare il parsing di Smarty </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Variabili caricate da file di configurazione</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 7 plus 18? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/language.variables.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01897 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
