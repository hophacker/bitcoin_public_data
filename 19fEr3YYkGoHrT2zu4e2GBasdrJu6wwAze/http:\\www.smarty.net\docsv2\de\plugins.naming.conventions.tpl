http://www.smarty.net/docsv2/de/plugins.naming.conventions.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 02:10:07 GMT
...
<html lang="en">
  <head>
    ...
    <title>Namenskonvention | Smarty</title>
...
<tr><th colspan="3" align="center">Namenskonvention</th></tr>
<tr>
...
<div class="sect1" title="Namenskonvention">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="plugins.naming.conventions"></a>Namenskonvention</h2></div></div></div>
<p>
...
<p>
    ...
    Wobei <code class="literal">Typ</code> einen der folgenden Werte haben kann:
    </p>
...
<p>
    und <code class="literal">Name</code> ein erlaubter Identifikator (bestehend
    aus Buchstaben, Zahlen und Unterstrichen) ist.
   </p>
<p>
     Ein paar Beispiele: <code class="literal">function.html_select_date.php</code>,
...
<p>
    <code class="literal">type</code> und <code class="literal">name</code> haben die selbe Bedeutung wie bei den Plugin-Dateien.
   </p>
<p>
...
<tr>
<td width="40%" align="left" valign="top">Chapter 16. Smarty durch Plugins erweitern </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Plugins schreiben</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/plugins.naming.conventions.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02027 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
