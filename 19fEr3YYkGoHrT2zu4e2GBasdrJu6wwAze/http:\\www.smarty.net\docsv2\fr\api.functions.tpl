http://www.smarty.net/docsv2/fr/api.functions.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 16:03:38 GMT
...
<html lang="en">
  <head>
    ...
    <title>Chapter 13. Méthodes | Smarty</title>
...
<tr><th colspan="3" align="center">Chapter 13. Méthodes</th></tr>
<tr>
...
<div class="chapter" title="Chapter 13. Méthodes">
<div class="titlepage"><div><div><h2 class="title">
<a name="api.functions"></a>Chapter 13. Méthodes</h2></div></div></div>
<div class="toc">
...
<td width="40%" align="right" valign="top"> append()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 1 plus 11? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/api.functions.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01107 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
