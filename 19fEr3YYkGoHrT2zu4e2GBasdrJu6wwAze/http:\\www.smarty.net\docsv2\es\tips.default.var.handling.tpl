http://www.smarty.net/docsv2/es/tips.default.var.handling.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 04:12:31 GMT
...
<html lang="en">
  <head>
    ...
    <title>Manipulación del valor default de una variable | Smarty</title>
...
<tr><th colspan="3" align="center">Manipulación del valor default de una variable</th></tr>
<tr>
...
<div class="sect1" title="Manipulación del valor default de una variable">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="tips.default.var.handling"></a>Manipulación del valor default de una variable</h2></div></div></div>
<p>
    ...
    <a class="link" href="language.custom.functions.tpl#language.function.assign" title="{assign}">{assign}</a>.
   </p>
<div class="example">
<a name="id3156375"></a><p class="title"><b>Example 18.2. Atribuyendo el valor por default a una variable en el template</b></p>
...
<br class="example-break"><p>
    Vea tambiéen <a class="link" href="language.modifier.default.tpl" title="default">default</a> y
    <a class="link" href="tips.tpl#tips.blank.var.handling" title="Manipulación de Variables Vacias">Blank Variable Handling</a>.
   </p>
</div>
<div class="navfooter">
<hr>
...
<tr>
<td width="40%" align="left" valign="top">Chapter 18. Consejos y Trucos </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Pasando la variable titulo a la cabecera del template</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/tips.default.var.handling.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01772 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
