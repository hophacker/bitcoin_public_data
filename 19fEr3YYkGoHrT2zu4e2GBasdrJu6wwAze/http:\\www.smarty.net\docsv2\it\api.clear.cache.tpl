http://www.smarty.net/docsv2/it/api.clear.cache.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 06:16:29 GMT
...
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">clear_cache</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">template</span></span>,<br>                 <span class="methodparam"><span class="type">string </span><span class="parameter">cache_id</span></span>,<br>                 <span class="methodparam"><span class="type">string </span><span class="parameter">compile_id</span></span>,<br>                 <span class="methodparam"><span class="type">int </span><span class="parameter">expire_time</span></span>);</code><p>
   Elimina la cache per un <em class="parameter"><code>template</code></em> specifico. Se
   avete più cache per questo template, potete eliminarne una specifica
   fornendo il <em class="parameter"><code>cache_id</code></em> come secondo parametro.
   Potete anche passare un <em class="parameter"><code>compile_id</code></em> come terzo
   parametro. Potete "raggruppare" i template in modo da rimuoverli in
   gruppo. Leggete la <a class="link" href="caching.tpl" title="Chapter 14. Caching">sezione sul caching</a>
...
<div class="example">
<a name="id3141471"></a><p class="title"><b>Example 13.8. clear_cache</b></p>
...
<td width="40%" align="right" valign="top"> clear_compiled_tpl</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/api.clear.cache.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03861 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
