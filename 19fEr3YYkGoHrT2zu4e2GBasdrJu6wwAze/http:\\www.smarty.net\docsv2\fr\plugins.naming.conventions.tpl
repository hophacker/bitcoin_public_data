http://www.smarty.net/docsv2/fr/plugins.naming.conventions.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 01:29:16 GMT
...
<html lang="en">
  <head>
    ...
    <title>Conventions de nommage | Smarty</title>
...
<div class="sect1" title="Conventions de nommage">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="plugins.naming.conventions"></a>Conventions de nommage</h2></div></div></div>
<p>
...
<p>
  Les fichiers de <span class="bold"><strong>plugins</strong></span> doivent être nommés de la façon suivante :
  </p>
<div class="blockquote"><blockquote class="blockquote"><p>
    <code class="filename">
     <em class="replaceable"><code>type</code></em>.<em class="replaceable"><code>nom</code></em>.php
    </code>
   </p></blockquote></div>
<p>
 </p>
...
<li class="listitem">
<p>
    Où <code class="literal">type</code> est l'une des valeurs suivantes :
    </p>
...
<li class="listitem"><p>
    Et <code class="literal">nom</code> doit être un identifiant valide : lettres, nombres
    et underscore seulement, voir les
    <a class="ulink" href="http://php.net/language.variables" target="_top">variables php</a>.
   </p></li>
<li class="listitem"><p>
    Quelques exemples : <code class="filename">function.html_select_date.php</code>,
    <code class="filename">resource.db.php</code>,
    <code class="filename">modifier.spacify.php</code>.
   </p></li>
</ul></div>
<p>
  Les fonctions de <span class="bold"><strong>plugins</strong></span> dans les fichiers de plugins doivent être
  nommées de la façon suivante :
  </p>
<div class="blockquote"><blockquote class="blockquote"><p>
    <code class="function">smarty_<em class="replaceable"><code>type</code></em>, _<em class="replaceable"><code>nom</code></em></code>
   </p></blockquote></div>
<p>
 </p>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>
    Les significations de <code class="literal">type</code> et de <code class="literal">nom</code> sont les mêmes
    que précédemment.
   </p></li>
<li class="listitem"><p>
    Un exemple de nom de modificateur <code class="varname">foo</code> serait
    <code class="literal">function smarty_modifier_foo()</code>.
   </p></li>
</ul></div>
<p>
...
<tr>
<td width="40%" align="left" valign="top">Chapter 16. Etendre Smarty avec des plugins </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Ecrire des plugins</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/plugins.naming.conventions.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02028 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
