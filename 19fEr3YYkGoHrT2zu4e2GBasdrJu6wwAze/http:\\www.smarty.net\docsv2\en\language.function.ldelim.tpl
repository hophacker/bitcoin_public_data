...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 05:33:21 GMT
...
<div class="example">
<a name="id2807380"></a><p class="title"><b>Example 7.23. {ldelim}, {rdelim}</b></p>
...
<a name="id2807434"></a><p class="title"><b>Example 7.24. Another Javascript example</b></p>
...
<td width="40%" align="right" valign="top"> {literal}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/language.function.ldelim.tpl">
            </form>
            </div>
          </div>
