http://www.smarty.net/docsv2/es/language.config.variables.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 14:31:11 GMT
...
<html lang="en">
  <head>
    ...
    <title>Variables cargadas desde archivos de configuración | Smarty</title>
...
<tr><th colspan="3" align="center">Variables cargadas desde archivos de configuración</th></tr>
<tr>
...
<div class="sect1" title="Variables cargadas desde archivos de configuración">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.config.variables"></a>Variables cargadas desde archivos de configuración</h2></div></div></div>
<p>
    Las variables que son cargadas de 
    <a class="link" href="config.files.tpl" title="Chapter 9. Config Files">archivos de configuración</a> son
    referenciadas incluyendo entre ellas el signo(#), o como variables 
    de Smarty
    <a class="link" href="language.variables.smarty.tpl#language.variables.smarty.config" title="{$smarty.config}">$smarty.config</a>.
    La segunda sintaxis es util para incrustar valores de un atributo
    dentro de comillas.
			</p>
<div class="example">
<a name="id3066575"></a><p class="title"><b>Example 4.5. Variables de configuración</b></p>
...
<br class="example-break"><p>
    ...
    <a class="link" href="language.function.config.load.tpl" title="config_load"><span class="command"><strong>{config_load}</strong></span></a>.
			</p>
<p>
    Ver también <a class="link" href="language.syntax.variables.tpl" title="Variables">Variables</a> y
    <a class="link" href="language.variables.smarty.tpl" title="La variable reservada {$smarty}">$smarty reserved variables</a>
   </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> La variable reservada {$smarty}</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.config.variables.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02080 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
