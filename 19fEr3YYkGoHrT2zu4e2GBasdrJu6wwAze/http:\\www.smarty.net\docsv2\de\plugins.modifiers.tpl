http://www.smarty.net/docsv2/de/plugins.modifiers.tpl
HTTP/1.1 200 OK
...
<html lang="en">
  <head>
    ...
    <title>Variablen-Modifikatoren | Smarty</title>
...
<tr><th colspan="3" align="center">Variablen-Modifikatoren</th></tr>
<tr>
...
<div class="sect1" title="Variablen-Modifikatoren">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="plugins.modifiers"></a>Variablen-Modifikatoren</h2></div></div></div>
<p>
...
<p>
    Sehen Sie dazu:
    <a class="link" href="api.register.modifier.tpl" title="register_modifier (Modifikator-Plugin registrieren)">register_modifier()</a>,
     <a class="link" href="api.unregister.modifier.tpl" title="unregister_modifier (Modifikator deaktivieren)">unregister_modifier()</a>.
   </p>
<div class="example">
<a name="id2937520"></a><p class="title"><b>Example 16.3. Einfaches Modifikator-Plugin</b></p>
...
<div class="example">
<a name="id2937981"></a><p class="title"><b>Example 16.4. Komplexes Modifikator-Plugin</b></p>
...
<tr>
<td width="40%" align="left" valign="top">Template-Funktionen </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Block-Funktionen</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/plugins.modifiers.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01204 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
