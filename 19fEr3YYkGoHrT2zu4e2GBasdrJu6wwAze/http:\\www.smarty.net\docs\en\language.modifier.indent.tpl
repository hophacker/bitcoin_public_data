http://www.smarty.net/docs/en/language.modifier.indent.tpl
HTTP/1.1 200 OK
...
<p>
     ...
     character to use to indent with eg use <code class="literal">"\t"</code> for a tab.
  </p>
...
<td>This determines how many characters to indent
       to.</td>
</tr>
<tr>
...
<div class="example">
<a name="idp6579488"></a><p class="title"><b>Example 5.12. indent</b></p>
...
<td width="40%" align="right" valign="top"> lower</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/language.modifier.indent.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02271 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
