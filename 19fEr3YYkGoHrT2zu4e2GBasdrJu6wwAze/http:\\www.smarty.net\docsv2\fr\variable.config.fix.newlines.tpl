http://www.smarty.net/docsv2/fr/variable.config.fix.newlines.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 07:49:45 GMT
...
<p>
  Si cette variable est mise à <code class="constant">TRUE</code>, les caractéres de nouvelles lignes mac et dos
  (<code class="literal">'\r'</code> et <code class="literal">'\r\n'</code>) sont convertis en
  <code class="literal">'\n'</code> quand ils sont analysés. <code class="constant">TRUE</code> par défaut.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $default_template_handler_func</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/variable.config.fix.newlines.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02464 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
