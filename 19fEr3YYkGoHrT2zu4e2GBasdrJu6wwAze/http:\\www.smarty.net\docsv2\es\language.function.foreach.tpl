...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 13:58:48 GMT
...
<p>
    ...
    <a class="link" href="language.function.section.tpl" title="section,sectionelse"><span class="emphasis"><em>{section}</em></span></a>. 
...
<div class="example">
<a name="id3082180"></a><p class="title"><b>Example 7.4. foreach</b></p>
...
<a name="id3082220"></a><p class="title"><b>Example 7.5. foreach key</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<br class="example-break"><div class="example">
<a name="id3082271"></a><p class="title"><b>Example 7.6. Ejemplo de {foreach} - con base de datos (eg PEAR o ADODB)</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<br class="example-break"><p>
   ...
   <a class="link" href="language.variables.smarty.tpl#language.variables.smarty.loops" title="{$smarty.section}, {$smarty.foreach}">{$smarty.foreach.foreachname.varname}</a> 
   con foreachname siendo el nombre especificado del atributo
   <span class="emphasis"><em>name</em></span> del foreach.
		</p>
<p>Ver <a class="link" href="language.function.section.tpl#section.property.index" title="index">{section}</a>
...
<p>
   Ver tambien <a class="link" href="language.function.section.tpl" title="section,sectionelse">{section}</a> y
   <a class="link" href="language.variables.smarty.tpl#language.variables.smarty.loops" title="{$smarty.section}, {$smarty.foreach}">$smarty.foreach</a>.
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> include</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.function.foreach.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01859 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
