http://www.smarty.net/docsv2/pt_BR/variable.config.booleanize.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 09:51:36 GMT
...
<td width="40%" align="right" valign="top"> $config_read_hidden</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 20 plus 12? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/variable.config.booleanize.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02074 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
