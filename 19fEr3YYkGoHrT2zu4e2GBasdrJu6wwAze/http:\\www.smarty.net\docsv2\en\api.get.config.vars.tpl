http://www.smarty.net/docsv2/en/api.get.config.vars.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 14:40:02 GMT
...
<html lang="en">
  <head>
    ...
    <title>get_config_vars() | Smarty</title>
...
<a name="id2854900"></a><h2>Description</h2>
...
<div class="example">
<a name="id2854695"></a><p class="title"><b>Example 13.16. get_config_vars()</b></p>
...
<td width="40%" align="right" valign="top"> get_registered_object()</td>
          ...
          <div class="commentInfo">
              ...
              <div class="commentAuthor">by <b>Betsy Gamrat</b> on Apr 13, 2012 at  7:52</div>
              <div class="commentBody">If the requested variable is not set, $smarty-&gt;get_config_vars('not_set') returns NULL.</div>
            </div>
                              </div>
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/api.get.config.vars.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02945 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
