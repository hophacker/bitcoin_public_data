http://www.smarty.net/docsv2/it/advanced.features.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 19:20:24 GMT
...
<html lang="en">
  <head>
    ...
    <title>Chapter 15. Funzioni avanzate | Smarty</title>
...
<tr><th colspan="3" align="center">Chapter 15. Funzioni avanzate</th></tr>
<tr>
...
<div class="chapter" title="Chapter 15. Funzioni avanzate">
<div class="titlepage"><div><div><h2 class="title">
<a name="advanced.features"></a>Chapter 15. Funzioni avanzate</h2></div></div></div>
<div class="toc">
...
<div class="sect1" title="Oggetti">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="advanced.features.objects"></a>Oggetti</h2></div></div></div>
<p>
...
<p>
	...
	<em class="parameter"><code>format</code></em> è <code class="literal">true</code> e
	...
	(<code class="literal">{foobar-&gt;meth2}...{/foobar-&gt;meth2}</code>) e i
	parametri passati al metodo hanno la stessa struttura di
	quelli per le funzioni plugin per i blocchi. Questi metodi
        quindi ricevono 4 parametri <em class="parameter"><code>$params</code></em>,
	<em class="parameter"><code>$content</code></em>, <em class="parameter"><code>&amp;$smarty</code></em> 
        e <em class="parameter"><code>&amp;$repeat</code></em> e si comportano come 
        funzioni plugin per i blocchi.
	</p>
<div class="example">
<a name="id3155711"></a><p class="title"><b>Example 15.1. usare un oggetto registrato o assegnato</b></p>
...
<tr>
<td width="40%" align="left" valign="top">Mettere in Cache l'output dei Plugin </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Prefiltri</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 14 plus 20? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="2c6f6cc84bdfe62ce10daab6da1a84a0">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/advanced.features.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02897 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
