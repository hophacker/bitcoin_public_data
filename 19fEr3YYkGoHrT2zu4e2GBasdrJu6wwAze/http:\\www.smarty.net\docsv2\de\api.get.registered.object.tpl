http://www.smarty.net/docsv2/de/api.get.registered.object.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 04:12:32 GMT
...
<h2>Name</h2>
<p>get_registered_object</p>
</div>
<div class="refsect1">
<a name="id2920833"></a><h2></h2>
...
<div class="example">
<a name="id2920597"></a><p class="title"><b>Example 13.16. get_registered_object</b></p>
...
<td width="40%" align="right" valign="top"> get_template_vars (Template-Variablen extrahieren)</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="753d3755ccce655db24019c9d80d98f0">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/api.get.registered.object.tpl">
            </form>
            </div>
          </div>
