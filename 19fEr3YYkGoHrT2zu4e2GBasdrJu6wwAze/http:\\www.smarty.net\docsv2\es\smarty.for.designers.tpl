http://www.smarty.net/docsv2/es/smarty.for.designers.tpl
HTTP/1.1 200 OK
...
<tr>
<td width="40%" align="left" valign="top">Expandiendo la configuración </td>
...
<td width="40%" align="right" valign="top"> Chapter 3. Basic Syntax</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/smarty.for.designers.tpl">
            </form>
            </div>
          </div>
