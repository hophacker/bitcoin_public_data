...
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 12:20:20 GMT
...
<html lang="en">
  <head>
    ...
    <title>Chapter 16. Extending Smarty With Plugins | Smarty</title>
...
<p>
    The <a class="link" href="variable.plugins.dir.tpl" title="$plugins_dir">plugins directory</a>
...
<td width="40%" align="right" valign="top"> Naming Conventions</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/plugins.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01708 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
