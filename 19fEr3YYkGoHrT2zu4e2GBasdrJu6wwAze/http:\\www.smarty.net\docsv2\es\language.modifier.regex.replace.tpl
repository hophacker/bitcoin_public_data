http://www.smarty.net/docsv2/es/language.modifier.regex.replace.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 15:21:27 GMT
...
<td>Esta es la expresión regular a ser substituida.</td>
</tr>
<tr>
...
<td align="center">Si</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Esta es la cadena que sustituira a la expresión regular.</td>
</tr>
</tbody>
</table></div>
<p>
   Localiza una expresión regular y la remplaza en la variable. Use la sintaxis para 
   <a class="ulink" href="http://php.net/preg_replace" target="_top">preg_replace()</a> del manual de PHP.
  </p>
<div class="example">
<a name="id3073789"></a><p class="title"><b>Example 5.14. regex_replace</b></p>
...
<br class="example-break"><p>
   Vea también <a class="link" href="language.modifier.replace.tpl" title="replace">replace</a>
   y <a class="link" href="language.modifier.escape.tpl" title="escape">escape</a>.
  </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> replace</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.modifier.regex.replace.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03261 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
