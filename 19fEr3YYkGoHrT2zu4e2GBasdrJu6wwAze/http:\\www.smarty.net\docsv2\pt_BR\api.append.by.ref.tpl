http://www.smarty.net/docsv2/pt_BR/api.append.by.ref.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 07:37:36 GMT
...
<html lang="en">
  <head>
    ...
    <title>append_by_ref | Smarty</title>
...
<div class="sect1" title="append_by_ref">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="api.append.by.ref"></a>append_by_ref</h2></div></div></div>
<div class="funcsynopsis">
<table border="0" summary="Function synopsis" cellspacing="0" cellpadding="0" class="funcprototype-table">
<tr>
<td><code class="funcdef">void <b class="fsfunc">append_by_ref</b>(</code></td>
<td>
<var class="pdparam">varname</var>, </td>
<td> </td>
</tr>
<tr>
<td> </td>
<td>
<var class="pdparam">var</var><code>)</code>;</td>
<td> </td>
</tr>
</table>
<div class="paramdef-list">
<code>string <var class="pdparam">varname</var></code>;<br><code>mixed <var class="pdparam">var</var></code>;</div>
...
<td> </td>
<td>
<var class="pdparam">var</var>, </td>
<td> </td>
</tr>
<tr>
<td> </td>
<td>
<var class="pdparam">merge</var><code>)</code>;</td>
<td> </td>
</tr>
</table>
<div class="paramdef-list">
<code>string <var class="pdparam">varname</var></code>;<br><code>mixed <var class="pdparam">var</var></code>;<br><code>boolean <var class="pdparam">merge</var></code>;</div>
<div class="funcprototype-spacer"> </div>
</div>
<p>
...
<div class="example">
<a name="id2755470"></a><p class="title"><b>Example 13.2. append_by_ref</b></p>
<div class="example-contents"><pre class="programlisting">
// appending name/value pairs
$smarty-&gt;append_by_ref("Name",$myname);
$smarty-&gt;append_by_ref("Address",$address);</pre></div>
</div>
...
<tr>
<td width="40%" align="left" valign="top">Chapter 13. Métodos </td>
...
<td width="40%" align="right" valign="top"> assign</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 1 plus 3? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="eb66ef0d4fceadc3a2c7b48a14f7e850">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/api.append.by.ref.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02790 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
