http://www.smarty.net/docsv2/fr/config.files.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 06:24:29 GMT
...
<html lang="en">
  <head>
    ...
    <title>Chapter 9. Fichiers de configuration | Smarty</title>
...
<tr><th colspan="3" align="center">Chapter 9. Fichiers de configuration</th></tr>
<tr>
...
<div class="chapter" title="Chapter 9. Fichiers de configuration">
<div class="titlepage"><div><div><h2 class="title">
<a name="config.files"></a>Chapter 9. Fichiers de configuration</h2></div></div></div>
<p>
...
<div class="example">
<a name="id2992801"></a><p class="title"><b>Example 9.1. Exemple de fichier de configuration</b></p>
...
<br class="example-break"><p>
  Les valeurs des <a class="link" href="language.config.variables.tpl" title="Variables chargées depuis des fichiers de configuration">variables de fichiers de configuration</a> 
  ...
  Nous recommandons l'utilisation de <code class="literal">#</code> (dièse) en début
  de ligne.
 </p>
<p>
  ...
  des chaînes, ne contenant aucun des symboles <code class="literal">[</code> et
  <code class="literal">]</code>. Dans notre exemple, les 4 variables du début sont
...
<p>
  ...
  fonctions <a class="link" href="language.function.config.load.tpl" title="{config_load}"><code class="varname">{config_load}</code></a>
  (voir aussi <a class="link" href="api.config.load.tpl" title="config_load()"><code class="varname">config_load()</code></a>).
 </p>
<p>
...
<p>
  ...
  <a class="link" href="api.clear.config.tpl" title="clear_config()"><code class="varname">clear_config()</code></a> et
...
<td width="40%" align="right" valign="top"> Chapter 10. Console de débogage</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="401e511a0ea6c07ada4de7dc780a8dc7">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/config.files.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03771 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
