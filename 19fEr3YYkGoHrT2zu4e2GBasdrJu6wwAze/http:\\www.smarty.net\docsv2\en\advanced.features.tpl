...
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 00:03:22 GMT
...
<html lang="en">
  <head>
    ...
    <title>Chapter 15. Advanced Features | Smarty</title>
...
<li class="listitem"><p>
 One way is to <a class="link" href="api.register.object.tpl" title="register_object()">register objects</a> to
...
<li class="listitem"><p>
 The other way is to <a class="link" href="api.assign.tpl" title="assign()"><code class="varname">assign()</code>
...
<p>
  If <a class="link" href="variable.security.tpl" title="$security"><em class="parameter"><code>$security</code></em></a>
...
<p>
  ...
  the same way
  <a class="link" href="language.custom.functions.tpl" title="Chapter 8. Custom Functions">custom functions</a> get them.
...
<p>
  ...
  parameters for
  <a class="link" href="plugins.block.functions.tpl" title="Block Functions">
...
<div class="example">
<a name="id2874352"></a><p class="title"><b>Example 15.1. Using a registered or assigned object</b></p>
...
<br class="example-break"><p>
  See also <a class="link" href="api.register.object.tpl" title="register_object()"><code class="varname">register_object()</code></a>
  and
...
<td width="40%" align="right" valign="top"> Prefilters</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/advanced.features.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02896 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
