http://www.smarty.net/docsv2/es/api.get.config.vars.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 01:39:19 GMT
...
<h2>Name</h2>
<p>get_config_vars() — retorna el valor asignado a la variable de configuración</p>
</div>
<div class="refsect1" title="Descripción">
<a name="id3130178"></a><h2>Descripción</h2>
<code class="methodsynopsis"><span class="type">array </span><span class="methodname">get_config_vars</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">varname</span></span>);</code><p>
   ...
   <a class="link" href="language.config.variables.tpl" title="Variables cargadas desde archivos de configuración">variables
    de los archivos de configuración</a> es retornado.
  </p>
<div class="example">
<a name="id3130382"></a><p class="title"><b>Example 13.16. get_config_vars()</b></p>
...
<td width="40%" align="right" valign="top"> get_registered_object()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/api.get.config.vars.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03217 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
