http://www.smarty.net/docsv2/it/advanced.features.postfilters.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 19:58:28 GMT
...
<tr><th colspan="3" align="center">Postfiltri</th></tr>
<tr>
...
<div class="sect1" title="Postfiltri">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="advanced.features.postfilters"></a>Postfiltri</h2></div></div></div>
<p>
  ...
  <a class="link" href="api.register.postfilter.tpl" title="register_postfilter">registrati</a> oppure caricati
  dalla directory plugins con la funzione <a class="link" href="api.load.filter.tpl" title="load_filter">load_filter()</a> o impostando la variabile
  <a class="link" href="variable.autoload.filters.tpl" title="$autoload_filters">$autoload_filters</a>.
  Smarty passerà il codice del template compilato come primo parametro,
  e si aspetterà che la funzione restituisca il template risultante.
 </p>
<div class="example">
<a name="id3155233"></a><p class="title"><b>Example 15.3. uso di un postfiltro</b></p>
...
<tr>
<td width="40%" align="left" valign="top">Prefiltri </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Filtri di output</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 13 plus 16? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/advanced.features.postfilters.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02378 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
