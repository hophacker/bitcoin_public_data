http://www.smarty.net/docsv2/it/language.function.insert.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 04:12:41 GMT
...
<td>Nome della funzione di insert (insert_name)</td>
</tr>
<tr>
...
<td align="center"><span class="emphasis"><em>nessuno</em></span></td>
<td>Nome della variabile del template cui verrà
                                                assegnato l'output</td>
</tr>
<tr>
...
<td align="center">no</td>
<td align="center"><span class="emphasis"><em>nessuno</em></span></td>
<td>Nome dello script php che viene incluso prima
                                                della chiamata alla funzione di insert</td>
</tr>
<tr>
...
<td align="center">no</td>
<td align="center"><span class="emphasis"><em>nessuno</em></span></td>
<td>Variabile da passare alla funzione di insert</td>
</tr>
</tbody>
</table></div>
<p>
			...
			cache quando avete il <a class="link" href="caching.tpl" title="Chapter 14. Caching">caching</a>
...
<div class="example">
<a name="id3106834"></a><p class="title"><b>Example 7.10. funzione insert</b></p>
<div class="example-contents"><pre class="programlisting">
{* esempio di caricamento di un banner *}
{insert name="getBanner" lid=#banner_location_id# sid=#site_id#}</pre></div>
</div>
...
<p>
	    ...
	    avete il <a class="link" href="caching.tpl" title="Chapter 14. Caching">caching</a> abilitato,
...
<td width="40%" align="right" valign="top"> if,elseif,else</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/language.function.insert.tpl">
            </form>
            </div>
          </div>
