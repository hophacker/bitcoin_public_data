http://www.smarty.net/docsv2/pt_BR/advanced.features.postfilters.tpl
HTTP/1.1 200 OK
Date: Sat, 26 Jul 2014 19:15:11 GMT
...
<html lang="en">
  <head>
    ...
    <title>Postfilters | Smarty</title>
...
<tr><th colspan="3" align="center">Postfilters</th></tr>
<tr>
...
<div class="sect1" title="Postfilters">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="advanced.features.postfilters"></a>Postfilters</h2></div></div></div>
<p>
     ...
     <a class="link" href="api.register.postfilter.tpl" title="register_postfilter">registrado</a>carrgados do diretório de
     plugins usando a função
     <a class="link" href="api.load.filter.tpl" title="load_filter">load_filter()</a> ou pela
...
<div class="example">
<a name="id2768680"></a><p class="title"><b>Example 15.3. usando um postfilter de template</b></p>
...
&lt;!-- Created by Smarty! --&gt;
{* rest of template content... *}</pre></div>
</div>
...
<tr>
<td width="40%" align="left" valign="top">Prefilters </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Output Filters (Filtros de Saída)</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="0bc4b614436590a4133dc97eb222dcd5">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/advanced.features.postfilters.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02135 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
