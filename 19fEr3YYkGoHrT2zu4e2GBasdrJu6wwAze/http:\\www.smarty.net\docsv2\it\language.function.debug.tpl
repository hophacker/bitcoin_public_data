http://www.smarty.net/docsv2/it/language.function.debug.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 16:53:56 GMT
...
<td align="center"><span class="emphasis"><em>html</em></span></td>
<td>tipo di output: html o javascript</td>
</tr></tbody>
</table></div>
<p>
  {debug} produce un dump sulla pagina della console di debug. Funziona
  indipendentemente dall'impostazione <a class="link" href="chapter.debugging.console.tpl" title="Chapter 10. Console di Debugging">debug</a>
  di Smarty. Siccome viene eseguita a runtime, è in grado di 
...
<td width="40%" align="right" valign="top"> eval</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/language.function.debug.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03466 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
