http://www.smarty.net/docsv2/fr/variable.php.handling.tpl
HTTP/1.1 200 OK
...
<p>
  ...
  défaut <code class="constant">SMARTY_PHP_PASSTHRU</code>. Notez
  que celà n'affecte PAS le code PHP entouré des balises
  <a class="link" href="language.function.php.tpl" title="{php}"><code class="varname">{php}{/php}</code></a>
  dans le template.
 </p>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p><code class="constant">SMARTY_PHP_PASSTHRU</code> - Smarty écrit les balises
   telles quelles.</p></li>
<li class="listitem"><p><code class="constant">SMARTY_PHP_QUOTE</code> - Smarty transforme les balises
   en entités HTML.</p></li>
<li class="listitem"><p><code class="constant">SMARTY_PHP_REMOVE</code> - Smarty supprime les balises
   des templates.</p></li>
<li class="listitem"><p><code class="constant">SMARTY_PHP_ALLOW</code> - Smarty exécute les balises
   comme du code PHP.</p></li>
</ul></div>
...
<p>
   ...
   <a class="link" href="language.custom.functions.tpl" title="Chapter 8. Fonctions utilisateur">fonctions utilisateurs</a> ou les
   <a class="link" href="language.modifiers.tpl" title="Chapter 5. Modificateurs de variables">modificateurs de variables</a>.
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> $security</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/variable.php.handling.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01833 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
