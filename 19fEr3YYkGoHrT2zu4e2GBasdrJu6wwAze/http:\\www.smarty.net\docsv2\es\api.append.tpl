http://www.smarty.net/docsv2/es/api.append.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 07:37:24 GMT
...
<h2>Name</h2>
<p>append() — agregando elementos a una matriz asignada</p>
</div>
<div class="refsect1" title="Descripción">
<a name="id3125849"></a><h2>Descripción</h2>
...
<p>
  El parametro <em class="parameter"><code>merge</code></em> es la llave respectiva del arreglo, asi si
...
<div class="example">
<a name="id3126522"></a><p class="title"><b>Example 13.1. append</b></p>
...
<br class="example-break"><p>Ver también
       <a class="link" href="api.append.by.ref.tpl" title="append_by_ref">append_by_ref()</a>,
...
<tr>
<td width="40%" align="left" valign="top">Chapter 13. La clase Methods() de Smarty </td>
...
<td width="40%" align="right" valign="top"> append_by_ref</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/api.append.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02951 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
