http://www.smarty.net/docsv2/fr/language.function.if.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 08:26:00 GMT
...
<p>
  L'instruction <code class="varname">{if}</code> dans Smarty dispose de la même flexibilité que l'instruction
  PHP <a class="ulink" href="http://php.net/if" target="_top">if</a>,
  avec quelques fonctionnalités supplémentaires pour le
  moteur de template. Tous les <code class="varname">{if}</code> doivent être
  utilisés de pair avec un <code class="varname">{/if}</code>.
  <code class="varname">{else}</code> et <code class="varname">{elseif}</code> sont également
  des balises autorisées. Toutes les conditions et fonctions PHP sont reconnues,
  comme <span class="emphasis"><em>||</em></span>, <span class="emphasis"><em>or</em></span>,
  <span class="emphasis"><em>&amp;&amp;</em></span>, <span class="emphasis"><em>and</em></span>,
  <span class="emphasis"><em>is_array()</em></span>, etc.
 </p>
<p>
  Si <a class="link" href="variable.security.tpl" title="$security"><em class="parameter"><code>$security</code></em></a> est actif,
  alors le tableau <span class="emphasis"><em>IF_FUNCS</em></span> dans le tableau
...
<th align="center">Syntaxe alternative</th>
<th>Exemple de syntaxe</th>
<th>Signification</th>
<th>Equivalent PHP</th>
</tr></thead>
<tbody>
<tr>
<td align="center">==</td>
...
<td align="center"> </td>
<td>$a is not even</td>
<td>est [ou non] un nombre pair</td>
<td>$a % 2 == 0</td>
</tr>
<tr>
...
<td align="center"> </td>
<td>$a is not odd</td>
<td>est [ou non] un nombre impair</td>
<td>$a % 2 != 0</td>
</tr>
<tr>
...
<td>est [ou non] un groupe impair</td>
<td>($a / $b) % 2 != 0</td>
</tr>
</tbody>
</table></div>
<div class="example">
<a name="id2953340"></a><p class="title"><b>Example 7.15. Instruction {if}</b></p>
...
<a name="id2953353"></a><p class="title"><b>Example 7.16. Plus d'exemples avec {if}</b></p>
<div class="example-contents"><pre class="programlisting">
...
<td width="40%" align="right" valign="top"> {include}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="6b9620a8f5b84a4f9cc655202a512b54">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/language.function.if.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02079 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
