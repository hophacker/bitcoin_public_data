http://www.smarty.net/docsv2/en/tips.dates.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 13:59:00 GMT
...
<p>
    ...
    allows template designers to use the <a class="link" href="language.modifier.date.format.tpl" title="date_format"><code class="varname">date_format</code>
    </a> modifier for full control over date formatting, and also makes it
    easy to compare dates if necessary.
   </p>
<div class="example">
<a name="id2885249"></a><p class="title"><b>Example 18.4. Using date_format</b></p>
...
<br class="example-break"><p>
    When using <a class="link" href="language.function.html.select.date.tpl" title="{html_select_date}">
...
<div class="example">
<a name="id2885319"></a><p class="title"><b>Example 18.5. Converting form date elements back to a timestamp</b></p>
...
<br class="example-break"><p>
   ...
   and <a class="link" href="language.variables.smarty.tpl#language.variables.smarty.now" title="{$smarty.now}">
...
<td width="40%" align="right" valign="top"> WAP/WML</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/tips.dates.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02051 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
