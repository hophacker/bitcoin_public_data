http://www.smarty.net/docsv2/es/language.function.include.php.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 13:58:04 GMT
...
<p>
            ...
            directorio de <a class="link" href="variable.plugins.dir.tpl" title="$plugins_dir">plugins</a> y 
            su codigo de la aplicación. 
            Vea un <a class="link" href="tips.componentized.templates.tpl" title="Templates con Componetes">ejemplo</a> 
            de templates componentizados para detalles.
            </p>
</div>
<p>
    Las etiquetas {include_php} son usadas para incluir un script PHP 
   dentro de su template. <a class="link" href="variable.security.tpl" title="$security">
   Si la seguridad estuviera activada</a>, entonces 
   el script PHP debe estar localizado en la ruta <a class="link" href="variable.trusted.dir.tpl" title="$trusted_dir">$trusted_dir</a>.
   La etiqueta include_php debe tener el atributo "file", el cual 
   contiene la ruta del archivo PHP a ser incluido, o el relativo 
   al <a class="link" href="variable.trusted.dir.tpl" title="$trusted_dir">$trusted_dir</a>, o 
   una ruta absoluta.
			</p>
<p>
...
<div class="example">
<a name="id3083978"></a><p class="title"><b>Example 7.11. funcion {include_php}</b></p>
...
<br class="example-break"><p>
  Ver también <a class="link" href="language.function.include.tpl" title="include">{include}</a>,
  <a class="link" href="language.function.php.tpl" title="{php}">{php}</a>, <a class="link" href="language.builtin.functions.tpl#language.function.capture" title="capture">{capture}</a>, <a class="link" href="template.resources.tpl" title="Recursos">Template Resources</a> y <a class="link" href="tips.componentized.templates.tpl" title="Templates con Componetes">Componentized Templates</a> 
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> insert</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.function.include.php.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02693 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
