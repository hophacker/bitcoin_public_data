http://www.smarty.net/docsv2/es/language.modifier.strip.tags.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 09:35:49 GMT
...
<td>Este determina cuando las etiquetas seran remplazadas por ' ' o por ''</td>
</tr></tbody>
</table></div>
<p>
...
<div class="example">
<a name="id3075505"></a><p class="title"><b>Example 5.19. strip_tags</b></p>
...
<td width="40%" align="right" valign="top"> truncate</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 4 plus 19? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.modifier.strip.tags.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03123 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
