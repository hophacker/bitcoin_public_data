http://www.smarty.net/docsv2/en/tips.componentized.templates.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 03:32:06 GMT
...
<html lang="en">
  <head>
    ...
    <title>Componentized Templates | Smarty</title>
...
<p>
    ...
    Smarty object, <a class="link" href="api.assign.tpl" title="assign()"><code class="varname">assign()</code></a>
    the variables and <a class="link" href="api.display.tpl" title="display()"><code class="varname">display()</code>
...
<div class="example">
<a name="id2885543"></a><p class="title"><b>Example 18.7. componentized template</b></p>
...
<td width="40%" align="right" valign="top"> Obfuscating E-mail Addresses</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/tips.componentized.templates.tpl">
            </form>
            </div>
          </div>
