...
<html lang="en">
  <head>
    ...
    <title>Output Filters | Smarty</title>
...
<div class="example">
<a name="id2880509"></a><p class="title"><b>Example 16.9. An output filter plugin</b></p>
...
<br class="example-break"><p>
     ...
     <a class="link" href="api.unregister.outputfilter.tpl" title="unregister_outputfilter()">
     <code class="varname">unregister_outputfilter()</code></a>.
     </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> Resources</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/plugins.outputfilters.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02319 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
