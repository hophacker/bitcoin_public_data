http://www.smarty.net/docsv2/it/plugins.block.functions.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 21:32:14 GMT
...
<html lang="en">
  <head>
    ...
    <title>Funzioni sui blocchi | Smarty</title>
...
<tr><th colspan="3" align="center">Funzioni sui blocchi</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="plugins.modifiers.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 16. Estendere Smarty con i Plugin</th>
...
<div class="sect1" title="Funzioni sui blocchi">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="plugins.block.functions"></a>Funzioni sui blocchi</h2></div></div></div>
...
<p>
     ...
     (guardate sotto <code class="literal">&amp;$repeat</code> per capire come
...
<p>
     ...
     contenuti in <em class="parameter"><code>$params</code></em> nella forma di array 
     associativo. Potete accedere a questi valori, ad esempio, con
     <code class="varname">$params['start']</code>. Gli attributi del tag di apertura
     sono accessibili alla funzione anche in fase di elaborazione del tag
     di chiusura.
    </p>
<p>
     Il valore di <em class="parameter"><code>$content</code></em> dipende se la funzione 
     viene chiamata per il tag di apertura o per quello di chiusura. Nel
     caso del tag di apertura, sarà <code class="literal">null</code>, mentre nel
...
<p>
     Il parametro <em class="parameter"><code>&amp;$repeat</code></em> è passato alla 
     ...
     <em class="parameter"><code>$repeat</code></em> è <code class="literal">true</code> alla prima
     chiamata della funzione (al tag di apertura), e <code class="literal">false</code>
     per tutte le chiamate successive (al tag di chiusura).
     Ogni volta che la funzione termina con il valore di
     <em class="parameter"><code>&amp;$repeat</code></em> a true, il contenuto compreso
...
<p>
     ...
     <code class="varname">$smarty-&gt;_tag_stack</code>. Fate un var_dump() su
     questa variabile e la struttura dovrebbe apparirvi evidente.
    </p>
<p>
     Vedere anche:
     <a class="link" href="api.register.block.tpl" title="register_block">register_block()</a>,
     <a class="link" href="api.unregister.block.tpl" title="unregister_block">unregister_block()</a>.
    </p>
<div class="example">
<a name="id3160087"></a><p class="title"><b>Example 16.5. funzione di blocco</b></p>
...
<tr>
<td width="40%" align="left" valign="top">Modificatori </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Funzioni di Compilazione</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 14 plus 17? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="150dc44c2c9a0cfb9629a5fa6db4c0a3">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/plugins.block.functions.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03139 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
