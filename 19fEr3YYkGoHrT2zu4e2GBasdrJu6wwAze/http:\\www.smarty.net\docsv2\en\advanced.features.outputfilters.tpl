http://www.smarty.net/docsv2/en/advanced.features.outputfilters.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 06:15:57 GMT
...
<a name="advanced.features.outputfilters"></a>Output Filters</h2></div></div></div>
<p>
    When the template is invoked via
    <a class="link" href="api.display.tpl" title="display()"><code class="varname">display()</code></a> or
    <a class="link" href="api.fetch.tpl" title="fetch()"><code class="varname">fetch()</code></a>, its output can
    be  sent through one or more output filters. This differs from
    <a class="link" href="advanced.features.postfilters.tpl" title="Postfilters">
    <code class="varname">postfilters</code></a>
...
<p>
    ...
    <a class="link" href="api.register.outputfilter.tpl" title="register_outputfilter()">registered</a> or loaded
    from the
    <a class="link" href="variable.plugins.dir.tpl" title="$plugins_dir">plugins directory</a> by using the
    <a class="link" href="api.load.filter.tpl" title="load_filter()"><code class="varname">load_filter()</code></a>
    method or by setting the  <a class="link" href="variable.autoload.filters.tpl" title="$autoload_filters">
...
<div class="example">
<a name="id2874661"></a><p class="title"><b>Example 15.4. Using a template outputfilter</b></p>
...
<br class="example-break"><p>
   ...
   <a class="link" href="advanced.features.postfilters.tpl" title="Postfilters">postfilters</a> and
...
<td width="40%" align="right" valign="top"> Cache Handler Function</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 1 plus 12? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/advanced.features.outputfilters.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02161 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
