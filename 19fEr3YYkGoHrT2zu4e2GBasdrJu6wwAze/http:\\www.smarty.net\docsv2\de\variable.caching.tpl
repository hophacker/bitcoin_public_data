http://www.smarty.net/docsv2/de/variable.caching.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 07:21:22 GMT
...
<th width="60%" align="center">Chapter 12. Smarty Klassenvariablen (Objekteigenschaften)</th>
...
<p>
    ...
    <a class="link" href="variable.cache.dir.tpl" title="$cache_dir">$cache_dir</a>cachen soll.
    ...
    Sie können auch <a class="link" href="caching.multiple.caches.tpl" title="Multiple Caches für eine Seite">mehrere (multiple)</a>
    ...
    Der Wert 2 weist Smarty an, den Wert von <a class="link" href="variable.cache.lifetime.tpl" title="$cache_lifetime">$cache_lifetime</a>
    ...
    Siehe dazu auch: <a class="link" href="api.is.cached.tpl" title="is_cached (gecachte Version existiert)">is_cached()</a>.
   </p>
<p>
    Wenn <a class="link" href="variable.compile.check.tpl" title="$compile_check">$compile_check</a> aktiviert ist,
    wird der Cache regeneriert sobald ein Template
    oder eine Konfigurations-Variable geändert wurde.
    Wenn <a class="link" href="variable.force.compile.tpl" title="$force_compile">$force_compile</a> aktiviert ist,
...
<p>
    ...
    und
    das Kapitel zum <a class="link" href="caching.tpl" title="Chapter 14. Caching">Caching</a>.
   </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $cache_dir</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 5 plus 14? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="288766c743d38d9cd5a86003cede0935">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/variable.caching.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02344 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
