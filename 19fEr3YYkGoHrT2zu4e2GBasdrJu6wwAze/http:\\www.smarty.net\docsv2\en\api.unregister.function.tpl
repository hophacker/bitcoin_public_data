http://www.smarty.net/docsv2/en/api.unregister.function.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 07:20:44 GMT
...
<h2>Name</h2>
<p>unregister_function — dynamically unregister template function plugin</p>
</div>
<div class="refsect1" title="Description">
<a name="id2862032"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">unregister_function</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">name</span></span>);</code><p>
   Pass in the template function <em class="parameter"><code>name</code></em>.
  </p>
<div class="example">
<a name="id2861988"></a><p class="title"><b>Example 13.27. unregister_function</b></p>
...
<br class="example-break"><p>
  See also <a class="link" href="api.register.function.tpl" title="register_function()">
  <code class="varname">register_function()</code></a>.
</p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> unregister_modifier()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/api.unregister.function.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.19204 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
