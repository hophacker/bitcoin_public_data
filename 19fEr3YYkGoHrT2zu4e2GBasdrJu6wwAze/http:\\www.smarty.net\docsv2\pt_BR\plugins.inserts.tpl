http://www.smarty.net/docsv2/pt_BR/plugins.inserts.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 04:12:50 GMT
...
<p>
     O primeiro parâmetro para a função é um array
      ...
      i.e. <code class="varname">$params['start']</code> ou usa
     <code class="varname">extract($params)</code> para importá-los para dentro da tabela símbolo.
    </p>
<p>
     A função insert deve retornar o
      resultado que será substituído  no lugar da tag
      <span class="command"><strong>insert</strong></span> no template.
    </p>
<div class="example">
<a name="id2775361"></a><p class="title"><b>Example 16.11. Plugin insert</b></p>
...
<td width="40%" align="right" valign="top"> Part IV. Apêndices</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/plugins.inserts.tpl">
            </form>
            </div>
          </div>
