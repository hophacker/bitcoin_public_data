http://www.smarty.net/docsv2/fr/api.fetch.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 23:25:06 GMT
...
<h2>Name</h2>
<p>fetch() — Retourne le résultat du template</p>
</div>
<div class="refsect1" title="Description">
<a name="id3009120"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">string </span><span class="methodname">fetch</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">template</span></span>,<br>             <span class="methodparam"><span class="type">string </span><span class="parameter">cache_id</span></span>,<br>             <span class="methodparam"><span class="type">string </span><span class="parameter">$compile_id</span></span>);</code><p>
   ...
   l'<a class="link" href="api.display.tpl" title="display()">afficher</a>.
   Il faut passer un type et un chemin de <a class="link" href="template.resources.tpl" title="Ressources">ressource template</a>
   valides. Vous pouvez passer un identifiant de cache <em class="parameter"><code>$cache id</code></em> en deuxième
   paramètre. Reportez-vous à la section <a class="link" href="caching.tpl" title="Chapter 14. Cache">cache
   </a> pour plus de renseignements.
  </p>
<p>
En tant que troisième paramètre optionnel, vous pouvez passer un
identifiant de compilation <em class="parameter"><code>$compile_id</code></em>.
...
<em class="parameter"><code>$compile_id</code></em> est lorsque vous utilisez plus d'un
<a class="link" href="api.variables.tpl#variable.template.dir" title="$template_dir"><em class="parameter"><code>$template_dir</code></em></a> mais
seulement un <a class="link" href="variable.compile.dir.tpl" title="$compile_dir"><em class="parameter"><code>$compile_dir</code></em></a>.
Définissez un <em class="parameter"><code>$compile_id</code></em>
séparé pour chaque
...
définir la variable <a class="link" href="variable.compile.id.tpl" title="$compile_id">$compile_id</a> une seule 
fois plutôt que de la passer à chaque appel à la fonction.</p>
<p>
   </p>
<div class="example">
<a name="id3010216"></a><p class="title"><b>Example 13.14. Exemple avec fetch()</b></p>
...
<div class="example">
<a name="id3010234"></a><p class="title"><b>Example 13.15. Utilisation de fetch() pour envoyer un email</b></p>
<div class="example-contents">
<p>
     Le template <code class="filename">email_body.tpl</code> :
    </p>
...
<p>
     Le template <code class="filename">email_disclaimer.tpl</code> qui utilise le modificateur
...
<p>
     ...
     <a class="ulink" href="http://php.net/function.mail" target="_top"><code class="varname">mail()</code></a>
    </p>
<pre class="programlisting">
...
<p>
   ...
   <a class="link" href="language.function.eval.tpl" title="{eval}"><code class="varname">{eval}</code></a> et
...
<td width="40%" align="right" valign="top"> get_config_vars()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/api.fetch.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03140 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
