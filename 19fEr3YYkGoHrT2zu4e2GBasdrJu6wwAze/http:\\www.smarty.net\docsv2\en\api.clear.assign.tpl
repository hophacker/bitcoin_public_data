http://www.smarty.net/docsv2/en/api.clear.assign.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 10:40:40 GMT
...
<h2>Name</h2>
<p>clear_assign() — clears the value of an assigned variable</p>
</div>
<div class="refsect1" title="Description">
<a name="id2851836"></a><h2>Description</h2>
...
<div class="example">
<a name="id2852668"></a><p class="title"><b>Example 13.7. clear_assign()</b></p>
...
<td width="40%" align="right" valign="top"> clear_cache()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/api.clear.assign.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01626 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
