http://www.smarty.net/docsv2/en/api.clear.cache.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 07:25:52 GMT
...
<a name="id2852512"></a><h2>Description</h2>
...
<li class="listitem"><p>
   If you have <a class="link" href="caching.multiple.caches.tpl" title="Multiple Caches Per Page">multiple caches</a>
...
<li class="listitem"><p>
   ...
   You can <a class="link" href="caching.groups.tpl" title="Cache Groups">group templates together</a>
    so they can be removed as a group, see the
   <a class="link" href="caching.tpl" title="Chapter 14. Caching">caching section</a> for more
   information.
   </p></li>
<li class="listitem"><p>
...
<div class="example">
<a name="id2852644"></a><p class="title"><b>Example 13.8. clear_cache()</b></p>
...
<br class="example-break"><p>
  ...
  and
  <a class="link" href="caching.tpl" title="Chapter 14. Caching"><code class="varname">caching</code></a> section.
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> clear_compiled_tpl()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/api.clear.cache.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01906 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
