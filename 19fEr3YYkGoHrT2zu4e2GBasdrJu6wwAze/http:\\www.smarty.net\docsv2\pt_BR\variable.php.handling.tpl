http://www.smarty.net/docsv2/pt_BR/variable.php.handling.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 09:51:41 GMT
...
<th width="60%" align="center">Chapter 12. Variáveis</th>
...
<p>
       ...
       dentro de tags <a class="link" href="language.function.php.tpl" title="php">{php}{/php}</a>
       no template.
      </p>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>SMARTY_PHP_PASSTHRU - Smarty echos tags as-is.</p></li>
<li class="listitem"><p>SMARTY_PHP_QUOTE - Smarty quotes the
       tags as html entities.</p></li>
<li class="listitem"><p>SMARTY_PHP_REMOVE - Smarty
       irá remover as tags do template.</p></li>
<li class="listitem"><p>SMARTY_PHP_ALLOW - Smarty irá executar as 
       tags como códigos PHP.</p></li>
</ul></div>
<p>
       NOTE: Usando códigos PHP code dentro de templates é altamente desencorajado.
       Use <a class="link" href="language.custom.functions.tpl" title="Chapter 8. Funções Personalizadas">custom functions</a> ou
       <a class="link" href="language.modifiers.tpl" title="Chapter 5. Modificadores de variáveis">modifiers</a> ao invés disso.
      </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $security</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/variable.php.handling.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02105 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
