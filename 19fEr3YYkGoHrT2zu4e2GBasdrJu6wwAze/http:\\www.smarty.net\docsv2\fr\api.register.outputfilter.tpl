http://www.smarty.net/docsv2/fr/api.register.outputfilter.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 12:25:05 GMT
...
<h2>Name</h2>
<p>register_outputfilter() — Déclare dynamiquement des filtres de sortie</p>
</div>
<div class="refsect1" title="Description">
<a name="id3014149"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">register_outputfilter</span>(<span class="methodparam"><span class="type">mixed </span><span class="parameter">function</span></span>);</code><p>
   ...
   <a class="link" href="plugins.outputfilters.tpl" title="Filtres de sortie">filtres de sortie</a>, pour
   agir sur la sortie d'un template avant qu'il ne soit <a class="link" href="api.display.tpl" title="display()">affiché</a>.
   Reportez-vous à la section <a class="link" href="advanced.features.outputfilters.tpl" title="Filtres de sortie">
   filtres de sortie</a> pour plus d'information sur le sujet.
  </p>
<p>
...
<td width="40%" align="right" valign="top"> register_postfilter()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/api.register.outputfilter.tpl">
            </form>
            </div>
          </div>
