http://www.smarty.net/docsv2/pt_BR/api.register.compiler.function.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 04:12:30 GMT
...
<th width="60%" align="center">Chapter 13. Métodos</th>
...
<div class="sect1" title="register_compiler_function">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="api.register.compiler.function"></a>register_compiler_function</h2></div></div></div>
<div class="funcsynopsis">
<table border="0" summary="Function synopsis" cellspacing="0" cellpadding="0" class="funcprototype-table">
<tr>
<td><code class="funcdef">void <b class="fsfunc">register_compiler_function</b>(</code></td>
<td>
...
<td> </td>
<td>
<var class="pdparam">impl</var>, </td>
<td> </td>
</tr>
<tr>
<td> </td>
<td>
<var class="pdparam">cacheable</var><code>)</code>;</td>
<td> </td>
</tr>
</table>
<div class="paramdef-list">
<code>string <var class="pdparam">name</var></code>;<br><code>mixed <var class="pdparam">impl</var></code>;<br><code>bool <var class="pdparam">cacheable</var></code>;</div>
...
<p>
                A chamada para função-php <em class="parameter"><code>impl</code></em> 
		pode ser uma string contendo o nome da função ou (b) um array
		no formato <code class="literal">array(&amp;$object, $method)</code> com
		<code class="literal">&amp;$object</code> sendo uma referência para um
		objeto e <code class="literal">$method</code> sendo uma string
		contendo o nome do método ou (c) um array no formato
		<code class="literal">array(&amp;$class, $method)</code> com
		<code class="literal">$class</code> sendo um nome de classe e 
		<code class="literal">$method</code> sendo o método
		desta classe.
			</p>
<p>
                <em class="parameter"><code>$cacheable</code></em> pode ser omitido na maioria
                dos casos. Veja <a class="link" href="caching.cacheable.tpl" title="Controlling Cacheability of Plugins' Output">Controlando modos de Saída de Cache dos Plugins</a> 
...
<td width="40%" align="right" valign="top"> register_function</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 1 plus 10? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="9e358fc7f25111ced6a468b36e7c9da5">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/api.register.compiler.function.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01939 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
