http://www.smarty.net/docs/en/advanced.features.postfilters.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 23:25:29 GMT
...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Postfilters">
    <meta name="keywords" content="postfilters">
...
<p>
  ...
  <span class="emphasis"><em>after they are compiled</em></span>. Postfilters can be either
  <a class="link" href="api.register.filter.tpl" title="registerFilter()">registered</a> or loaded
  from the <a class="link" href="variable.plugins.dir.tpl" title="$plugins_dir">plugins directory</a>
  by using the
  <a class="link" href="api.load.filter.tpl" title="loadFilter()"><code class="varname">loadFilter()</code></a>
   function or by setting the <a class="link" href="variable.autoload.filters.tpl" title="$autoload_filters">
...
<div class="example">
<a name="idp19432336"></a><p class="title"><b>Example 17.12. Using a template postfilter</b></p>
...
<p>
   ...
   <code class="filename">index.tpl</code> look like:
  </p>
<pre class="screen">
...
<br class="example-break"><p>
 ...
 <a class="link" href="advanced.features.outputfilters.tpl" title="Output Filters">outputfilters</a>,
 and
 <a class="link" href="api.load.filter.tpl" title="loadFilter()"><code class="varname">loadFilter()</code></a>.
 </p>
</div>
...
<td width="40%" align="right" valign="top"> Output Filters</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/advanced.features.postfilters.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02282 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
