http://www.smarty.net/docsv2/de/chapter.debugging.console.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 06:25:31 GMT
...
<html lang="en">
  <head>
    ...
    <title>Chapter 10. Debugging Konsole | Smarty</title>
...
<tr><th colspan="3" align="center">Chapter 10. Debugging Konsole</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="config.files.tpl">Prev</a> </td>
<th width="60%" align="center">Part II. Smarty für Template Designer</th>
...
<div class="chapter" title="Chapter 10. Debugging Konsole">
<div class="titlepage"><div><div><h2 class="title">
<a name="chapter.debugging.console"></a>Chapter 10. Debugging Konsole</h2></div></div></div>
<p>
  Smarty wird mit einer eingebauten Debugging Konsole
  ausgeliefert. Diese Konsole informiert über die im aufgerufenen
  Template <a class="link" href="language.function.include.tpl" title="include (einbinden)">eingebundenen</a> Templates,
  die <a class="link" href="api.assign.tpl" title="assign">zugewiesenen</a> Variablen und die
  <a class="link" href="language.config.variables.tpl" title="Verwendung von Variablen aus Konfigurationsdateien">Konfigurations-Variablen</a>.
  Die Formatierung der Konsole wird über das Template <a class="link" href="variable.debug.tpl.tpl" title="$debug_tpl">debug.tpl</a> gesteuert. Um
  debugging zu aktivieren, setzten Sie <a class="link" href="variable.debugging.tpl" title="$debugging">$debugging</a> auf 'true' und (falls
  nötig) übergeben in <a class="link" href="variable.debug.tpl.tpl" title="$debug_tpl">$debug_tpl</a> den Pfad zum
  Debugtemplate (normalerweise <a class="link" href="smarty.constants.tpl#constant.smarty.dir" title="SMARTY_DIR">SMARTY_DIR</a>debug.tpl). Wenn Sie
  ...
  wollen, können Sie dazu die Funktion <a class="link" href="language.function.debug.tpl" title="{debug}">{debug}</a> verwenden. Um
  debugging auszuschalten, können Sie <a class="link" href="variable.debugging.tpl" title="$debugging">$debugging</a> auf 'false' setzen.
  Sie können debugging auch temporär aktivieren, in dem Sie der
  aufgerufenen URL SMARTY_DEBUG mit übergeben, dies muss jedoch
  zuerst mit <a class="link" href="variable.debugging.ctrl.tpl" title="$debugging_ctrl">$debugging_ctrl</a> aktiviert
  werden.
 </p>
<div class="note" title="Technische Bemerkung" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Technische Bemerkung</h3>
<p>
   Die Debugging Konsole funktioniert nicht für Daten die via <a class="link" href="api.fetch.tpl" title="fetch">fetch()</a> geladen wurden, sondern nur
   für Daten die via <a class="link" href="api.display.tpl" title="display (ausgeben)">display()</a>
...
<tr>
<td width="40%" align="left" valign="top">Chapter 9. Konfigurationsdateien </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Part III. Smarty für Programmierer</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/chapter.debugging.console.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02547 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
