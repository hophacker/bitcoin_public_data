http://www.smarty.net/docsv2/it/api.register.function.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 13:00:11 GMT
...
<div class="example">
<a name="id3145277"></a><p class="title"><b>Example 13.22. register_function</b></p>
...
<td width="40%" align="right" valign="top"> register_modifier</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/api.register.function.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02136 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
