http://www.smarty.net/docsv2/fr/api.template.exists.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 14:43:33 GMT
...
<html lang="en">
  <head>
    ...
    <title>template_exists() | Smarty</title>
...
<a accesskey="p" href="api.trigger.error.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Méthodes</th>
<td width="20%" align="right"> <a accesskey="n" href="api.unregister.block.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<h2>Name</h2>
<p>template_exists() — Vérifie si un template spécifique existe</p>
</div>
<div class="refsect1" title="Description">
<a name="id3016200"></a><h2>Description</h2>
...
<div class="example">
<a name="id3016247"></a><p class="title"><b>Example 13.26. template_exists()</b></p>
<div class="example-contents">
<p>
    Cet exemple utilise <code class="literal">$_GET['page']</code> pour inclure le contenu d'un template.
    Si le template n'existe pas, une page d'erreur sera affiché à la place.
    Le fichier <code class="filename">page_container.tpl</code> :
   </p>
...
<br class="example-break"><p>
  ...
  <a class="link" href="language.function.include.tpl" title="{include}"><code class="varname">{include}</code></a> et
...
<td width="40%" align="right"> <a accesskey="n" href="api.unregister.block.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> unregister_block()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/api.template.exists.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03691 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
