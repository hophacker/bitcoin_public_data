http://www.smarty.net/docs/en/resources.streams.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 23:25:41 GMT
...
<html lang="en">
  <head>
    ...
    <title>Stream Template Resources | Smarty</title>
    <meta name="description" content="Stream Template Resources">
    <meta name="keywords" content="stream, template, resources">
...
<tr><th colspan="3" align="center">Stream Template Resources</th></tr>
<tr>
...
<div class="sect1" title="Stream Template Resources">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="resources.streams"></a>Stream Template Resources</h2></div></div></div>
<p>
...
<p>You can further define allowed streams with security enabled.</p>
</div>
<p>
  </p>
<div class="example">
<a name="idp18835840"></a><p class="title"><b>Example 16.7. Stream from PHP</b></p>
<div class="example-contents">
<p>Using a PHP stream for a template resource from the display() function.</p>
...
<a name="idp18841248"></a><p class="title"><b>Example 16.8. Stream from Template</b></p>
<div class="example-contents">
<p>Using a PHP stream for a template resource from within a template.</p>
<pre class="programlisting">
...
<tr>
<td width="40%" align="left" valign="top">String Template Resources </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Extends Template Resources</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 11 plus 9? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/resources.streams.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02239 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
