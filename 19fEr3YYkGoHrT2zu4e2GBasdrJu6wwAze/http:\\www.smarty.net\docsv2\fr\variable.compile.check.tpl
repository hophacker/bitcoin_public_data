http://www.smarty.net/docsv2/fr/variable.compile.check.tpl
HTTP/1.1 200 OK
Date: Sat, 26 Jul 2014 19:14:32 GMT
...
<p>
  ...
  Par défaut cette valeur est à <code class="constant">TRUE</code>.
 </p>
<p>
 Quand une application est mise en production (les templates
  ne changent plus), cette vérification n'est pas nécessaire.
  Assurez-vous de mettre <em class="parameter"><code>$compile_check</code></em> à <code class="constant">FALSE</code>
  pour des performances maximales. Notez que si vous mettez ce paramètre à <code class="constant">FALSE</code> et qu'un
  template est modifié, vous ne verrez *pas* le changement
  car le template ne sera *pas* recompilé. Si le processus de cache
  est activé et que <em class="parameter"><code>$compile_check</code></em> l'est aussi, alors les fichiers
  du cache seront regénérés si un template concerné ou un fichier de
  configuration concerné est modifié. Voir aussi <a class="link" href="variable.force.compile.tpl" title="$force_compile"><em class="parameter"><code>$force_compile</code></em></a> ou <a class="link" href="api.clear.compiled.tpl.tpl" title="clear_compiled_tpl()"><code class="varname">clear_compiled_tpl()</code></a>.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $force_compile</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="221225644c5b56659ef723e7905b77ea">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/variable.compile.check.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.19977 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
