...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 01:29:18 GMT
...
<html lang="en">
  <head>
    ...
    <title>Chapter 10. Debugging Console | Smarty</title>
...
<p>
  ...
  of all the
  <a class="link" href="language.function.include.tpl" title="{include}">included</a> templates,
  <a class="link" href="api.assign.tpl" title="assign()">assigned</a> variables and
  <a class="link" href="language.config.variables.tpl" title="Variables loaded from config files">config</a>
...
<p>
  Set  <a class="link" href="variable.debugging.tpl" title="$debugging"><em class="parameter"><code>$debugging</code></em></a>
  to <code class="constant">TRUE</code> in Smarty, and if needed set <a class="link" href="variable.debug.tpl.tpl" title="$debug_tpl">
  <em class="parameter"><code>$debug_tpl</code></em></a> to the template resource path to
  <code class="literal">debug.tpl</code> (this is in <a class="link" href="smarty.constants.tpl#constant.smarty.dir" title="SMARTY_DIR">
...
<p>To see the available variables for a particular
  template, see the <a class="link" href="language.function.debug.tpl" title="{debug}">
  <code class="varname">{debug}</code></a> template function.
  To disable the debugging console, set
  <a class="link" href="variable.debugging.tpl" title="$debugging"><em class="parameter"><code>$debugging</code></em></a> to
...
<p>
   ...
   API, only when using  <a class="link" href="api.display.tpl" title="display()">
...
<p>
    See also
    <a class="link" href="troubleshooting.tpl" title="Chapter 17. Troubleshooting">troubleshooting</a>,
    <a class="link" href="variable.error.reporting.tpl" title="$error_reporting">
    <em class="parameter"><code>$error_reporting</code></em></a>
    and
    <a class="link" href="api.trigger.error.tpl" title="trigger_error()"><code class="varname">trigger_error()</code></a>.
   </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> Part III. Smarty For Programmers</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/chapter.debugging.console.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03057 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
