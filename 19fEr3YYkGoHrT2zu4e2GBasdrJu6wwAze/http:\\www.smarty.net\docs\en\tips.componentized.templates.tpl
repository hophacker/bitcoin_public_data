...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Componentized Templates">
    <meta name="keywords" content="componentized, templates">
...
<div class="example">
<a name="idp20453824"></a><p class="title"><b>Example 21.7. componentized template</b></p>
...
<td width="40%" align="right" valign="top"> Obfuscating E-mail Addresses</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 9 plus 18? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/tips.componentized.templates.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01154 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
