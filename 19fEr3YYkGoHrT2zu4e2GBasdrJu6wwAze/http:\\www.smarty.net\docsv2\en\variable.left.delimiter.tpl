http://www.smarty.net/docsv2/en/variable.left.delimiter.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 08:25:55 GMT
...
<td width="40%" align="right" valign="top"> $right_delimiter</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/variable.left.delimiter.tpl">
            </form>
            </div>
          </div>
