http://www.smarty.net/docs/en/variable.config.booleanize.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 17:26:36 GMT
...
<p>
	   If set to <code class="constant">TRUE</code>, <a class="link" href="config.files.tpl" title="Chapter 9. Config Files">config files</a>
        values of <code class="literal">on/true/yes</code>
        and <code class="literal">off/false/no</code> get
	   converted to boolean values automatically. This way you can use the
	   values in the template like so:
       <code class="literal">{if #foobar#}...{/if}</code>. If foobar was
	   <code class="literal">on</code>, <code class="literal">true</code> or <code class="literal">yes</code>,
       the <code class="varname">{if}</code> statement will execute.
       Defaults to <code class="constant">TRUE</code>.
      </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $config_dir</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="25e43503219321d960805dc5740270ff">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/variable.config.booleanize.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02511 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
