http://www.smarty.net/docsv2/fr/variable.security.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 12:25:14 GMT
...
<th width="60%" align="center">Chapter 12. Variables</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.secure.dir.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
  Cette variable vaut <code class="constant">FALSE</code> par défaut. La sécurité est de rigueur
  ...
  <a class="link" href="variable.security.settings.tpl" title="$security_settings"><em class="parameter"><code>$security_settings</code></em></a>
  ne spécifie le contraire :
 </p>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>
    Si <a class="link" href="variable.php.handling.tpl" title="$php_handling"><em class="parameter"><code>$php_handling</code></em></a>
    est réglée à <code class="constant">SMARTY_PHP_ALLOW</code>, cela est implicitement
    changé à <code class="constant">SMARTY_PHP_PASSTHRU</code>.
   </p></li>
<li class="listitem"><p>
    Les fonctions PHP ne sont pas autorisées dans les
    instructions <a class="link" href="language.function.if.tpl" title="{if},{elseif},{else}"><code class="varname">{if}</code></a>,
...
<li class="listitem"><p>
    ...
    <a class="link" href="variable.secure.dir.tpl" title="$secure_dir"><em class="parameter"><code>$secure_dir</code></em></a>.
   </p></li>
<li class="listitem"><p>
    Les fichiers locaux ne peuvent être récupérés que depuis
    les répertoires listés dans le tableau
    <a class="link" href="variable.secure.dir.tpl" title="$secure_dir"><em class="parameter"><code>$secure_dir</code></em></a> en
    utilisant <a class="link" href="language.function.fetch.tpl" title="{fetch}"><code class="varname">{fetch}</code></a>.
   </p></li>
<li class="listitem"><p>
    Les balises <a class="link" href="language.function.php.tpl" title="{php}"><code class="varname">{php}{/php}</code></a>
...
<td width="40%" align="right"> <a accesskey="n" href="variable.secure.dir.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> $secure_dir</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 20 plus 3? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="174f2519c473888d33cd5039b44c07da">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/variable.security.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01743 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
