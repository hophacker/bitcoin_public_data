http://www.smarty.net/docsv2/en/language.function.html.select.time.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 15:21:12 GMT
...
<div class="example">
<a name="id2827529"></a><p class="title"><b>Example 8.21. {html_select_time}</b></p>
...
<td width="40%" align="right" valign="top"> {html_table}</td>
          ...
          <div class="commentInfo">
              ...
              <div class="commentAuthor">by <b>Matthew Waygood</b> on Feb 17, 2012 at  5:50</div>
              <div class="commentBody">If you specify an interval, the current value will be rounded down to the nearest value. ie interval 5 with a value of 12 rounds down to 10.
It would be nice to be able to choose which direction or method of rounding to use. I am currently using this for a start and end time. Because of the rounding down the end time may not be included in my processing.

ie 5:11 to 6:12 - results in 5:10 to 6:10 
Including the extra minute for start is fine, but missing out 2 minutes on the end is NOT.
Yes, I can add 5 minutes in php, but this defeats the object of using templates.</div>
            </div>
                              </div>
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 19 plus 2? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/language.function.html.select.time.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02321 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
