http://www.smarty.net/docsv2/it/language.config.variables.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 07:20:45 GMT
...
<html lang="en">
  <head>
    ...
    <title>Variabili caricate da file di configurazione | Smarty</title>
...
<tr><th colspan="3" align="center">Variabili caricate da file di configurazione</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="language.variables.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 4. Variabili</th>
...
<div class="sect1" title="Variabili caricate da file di configurazione">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.config.variables"></a>Variabili caricate da file di configurazione</h2></div></div></div>
<p>
			 ...
			 la variabile <a class="link" href="language.variables.smarty.tpl#language.variables.smarty.config" title="{$smarty.config}">$smarty.config</a>.
			 La seconda sintassi è utile per includerle in valori di attributi
			 indicati fra virgolette.
			</p>
<div class="example">
<a name="id3091134"></a><p class="title"><b>Example 4.5. variabili di configurazione</b></p>
...
<br class="example-break"><p>
			...
			Questa procedura viene spiegata più avanti in questo documento, 
			in <span class="command"><strong>config_load</strong></span>.
			</p>
</div>
<div class="navfooter">
<hr>
...
<tr>
<td width="40%" align="left" valign="top">Chapter 4. Variabili </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> La variabile riservata {$smarty}</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/language.config.variables.tpl">
            </form>
            </div>
          </div>
