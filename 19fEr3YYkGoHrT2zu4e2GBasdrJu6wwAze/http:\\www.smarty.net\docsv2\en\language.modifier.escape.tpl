...
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 11:22:21 GMT
...
<p>
    <code class="varname">escape</code> is used to encode or escape a variable to for example <code class="literal">html</code>,
     <code class="literal">url</code>, <code class="literal">single quotes</code>,
     <code class="literal">hex</code>, <code class="literal">hexentity</code>,
     <code class="literal">javascript</code> and <code class="literal">mail</code>.
     By default its <code class="literal">html</code>.
  </p>
...
<div class="example">
<a name="id2790540"></a><p class="title"><b>Example 5.10. escape</b></p>
...
<p>
   These are example <code class="literal">escape</code> template lines followed by the output
   </p>
<pre class="programlisting">
...
<a name="id2790574"></a><p class="title"><b>Example 5.11. Other examples</b></p>
<div class="example-contents">
<p>PHP functions can be used as modifiers,
   <a class="link" href="variable.security.tpl" title="$security">
   <code class="varname">$security</code></a> permitting.
    </p>
<pre class="screen">
...
<p>This snippet is useful for emails, but see also
...
<br class="example-break"><p>
   ...
   and the
   <a class="link" href="tips.obfuscating.email.tpl" title="Obfuscating E-mail Addresses">obfuscating email addresses</a> page.
  </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> indent</td>
          ...
          <div class="commentInfo">
              ...
              <div class="commentAuthor">by <b>Matthew Waygood</b> on Feb 13, 2012 at  3:45</div>
              <div class="commentBody">As we know multi-line comments start &lt;!-- and end --&gt;
So having --&gt; within a comment is a bad thing, as the rest will be displayed. Add the following to modifier.escape.php
<pre class="code">        case 'comment':
            // escape double dashes- which denotes the start-tag for the end of the comment
            return strtr($string, array('--'=&gt;'- - '));
</pre>
To make it easier to understand I used the javascript escape method and replaced '--' with '- - '.
The comment will only be visible in the source, so we still need human readable characters, rather than hex/octal codes.
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 19 plus 10? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/language.modifier.escape.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03142 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
