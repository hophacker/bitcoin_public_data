...
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 15:21:24 GMT
...
<p>
  ...
  Defina <a class="link" href="variable.debugging.tpl" title="$debugging">$debugging</a> en true en 
  el Smarty, y si es necesario defina 
  <a class="link" href="variable.debug.tpl.tpl" title="$debug_tpl">$debug_tpl</a> para la ruta 
  ...
  <a class="link" href="language.function.debug.tpl" title="{debug}">{debug}</a>. Para desabilitar 
...
<p>
   La consola de debug no funciona cuando usted usa la API <a class="link" href="api.fetch.tpl" title="fetch()">fetch()</a>, solo cuando estuviera usando  
...
<p>
    ...
    y <a class="link" href="api.trigger.error.tpl" title="trigger_error">trigger_error()</a>.
   </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> Part III. Smarty For Programmers</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/chapter.debugging.console.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03172 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
