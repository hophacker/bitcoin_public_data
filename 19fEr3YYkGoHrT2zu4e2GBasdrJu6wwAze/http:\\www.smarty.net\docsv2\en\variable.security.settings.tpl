http://www.smarty.net/docsv2/en/variable.security.settings.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 20:08:12 GMT
...
<a class="link" href="variable.security.tpl" title="$security"><em class="parameter"><code>$security</code></em></a> is enabled.
These are the possible settings:
      </p>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>
  <code class="constant">PHP_HANDLING</code> - boolean. If set to <code class="constant">TRUE</code>, the
...
<li class="listitem"><p>
  <code class="constant">IF_FUNCS</code> - array. The names of permitted PHP functions in
  <a class="link" href="language.function.if.tpl" title="{if},{elseif},{else}"><code class="varname">{if}</code></a> statements.
 </p></li>
<li class="listitem"><p>
  <code class="constant">INCLUDE_ANY</code> - boolean. If set to <code class="constant">TRUE</code>, any
         template can be <a class="link" href="language.function.include.tpl" title="{include}">included</a>
          from the file system, regardless of the
  <a class="link" href="variable.secure.dir.tpl" title="$secure_dir"><em class="parameter"><code>$secure_dir</code></em></a> list.
 </p></li>
<li class="listitem"><p>
  <code class="constant">PHP_TAGS</code> - boolean. If set to <code class="constant">TRUE</code>,
  <a class="link" href="language.function.php.tpl" title="{php}"><code class="varname">{php}{/php}</code></a>
  tags are permitted in the templates.
 </p></li>
<li class="listitem"><p>
  <code class="constant">MODIFIER_FUNCS</code> - array. The names of permitted
  PHP functions that can be used as variable modifiers.
 </p></li>
<li class="listitem"><p>
  <code class="constant">ALLOW_CONSTANTS</code> - boolean. If set to <code class="constant">TRUE</code>, constants via
  <a class="link" href="language.variables.smarty.tpl#language.variables.smarty.const" title="{$smarty.const}"><em class="parameter"><code>{$smarty.const.FOO}</code></em></a>
...
<td width="40%" align="right" valign="top"> $trusted_dir</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/variable.security.settings.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03710 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
