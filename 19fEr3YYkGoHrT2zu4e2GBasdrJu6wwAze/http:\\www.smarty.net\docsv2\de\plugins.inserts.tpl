http://www.smarty.net/docsv2/de/plugins.inserts.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 04:22:35 GMT
...
<p>
    ...
    via <a class="link" href="language.function.insert.tpl" title="insert (einfügen)"><span class="command"><strong>insert</strong></span></a> aufgerufen werden.
   </p>
...
<p>
    ...
    oder sie mit <code class="varname">extract($params)</code> importieren.
   </p>
<p>
    Als Rückgabewert muss das Resultat der Ausführung geliefert werden,
    das danach den Platz des <span class="command"><strong>insert</strong></span>-Tags im Template einnimmt.
   </p>
<div class="example">
<a name="id2940323"></a><p class="title"><b>Example 16.11. Insert-Plugin</b></p>
...
<td width="40%" align="right" valign="top"> Part IV. Anhänge</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/plugins.inserts.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02108 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
