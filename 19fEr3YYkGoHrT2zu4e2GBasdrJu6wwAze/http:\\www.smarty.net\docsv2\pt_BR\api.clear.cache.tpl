http://www.smarty.net/docsv2/pt_BR/api.clear.cache.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 11:41:25 GMT
...
<html lang="en">
  <head>
    ...
    <title>clear_cache | Smarty</title>
...
<div class="sect1" title="clear_cache">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="api.clear.cache"></a>clear_cache</h2></div></div></div>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">clear_cache</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">template</span></span>,<br>                 <span class="methodparam"><span class="type">string </span><span class="parameter">cache id</span></span>,<br>                 <span class="methodparam"><span class="type">string </span><span class="parameter">compile id</span></span>,<br>                 <span class="methodparam"><span class="type">int </span><span class="parameter">expire time</span></span>);</code><p>
				...
				como um grupo. Veja o <a class="link" href="caching.tpl" title="Chapter 14. Caching">caching section</a> para maiores informações. Como um quarto
				parâmetro opcional, você pode fornecer um ano mínimo em segundos 
				que o arquivo de cache deve
				ter antes dele ser apagado.
			</p>
<div class="example">
<a name="id2756997"></a><p class="title"><b>Example 13.8. clear_cache</b></p>
<div class="example-contents"><pre class="programlisting">
// clear the cache for a template
$smarty-&gt;clear_cache("index.tpl");

// clear the cache for a particular cache id in an multiple-cache template
$smarty-&gt;clear_cache("index.tpl","CACHEID");</pre></div>
</div>
...
<td width="40%" align="right" valign="top"> clear_compiled_tpl</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/api.clear.cache.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02251 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
