http://www.smarty.net/docs/en/variable.config.read.hidden.tpl
HTTP/1.1 200 OK
...
<p>
       If set to <code class="constant">TRUE</code>, hidden sections ie section names beginning with a period(.)
	   in <a class="link" href="config.files.tpl" title="Chapter 9. Config Files">config files</a>
	   can be read from templates. Typically you would leave
	   this <code class="constant">FALSE</code>, that way you can store sensitive data in the config files
	   such as database parameters and not worry about the template loading
	   them. <code class="constant">FALSE</code> by default.
	   </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $debug_tpl</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 10 plus 0? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/variable.config.read.hidden.tpl">
            </form>
            </div>
          </div>
