http://www.smarty.net/docsv2/es/language.function.config.load.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 23:25:21 GMT
...
<td width="40%" align="right" valign="top"> {foreach},{foreachelse}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.function.config.load.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03162 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
