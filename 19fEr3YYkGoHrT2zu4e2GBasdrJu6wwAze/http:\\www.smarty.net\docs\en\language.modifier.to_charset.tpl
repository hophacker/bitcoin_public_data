http://www.smarty.net/docs/en/language.modifier.to_charset.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 11:21:51 GMT
...
<p>
   <code class="varname">to_charset</code> is used to transcode a string from the internal charset to a given charset.
   This is the exact opposite of the <a class="link" href="language.modifier.from_charset.tpl" title="from_charset">from_charset modifier</a>.
  </p>
...
<td width="40%" align="right" valign="top"> truncate</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 8 plus 16? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/language.modifier.to_charset.tpl">
            </form>
            </div>
          </div>
