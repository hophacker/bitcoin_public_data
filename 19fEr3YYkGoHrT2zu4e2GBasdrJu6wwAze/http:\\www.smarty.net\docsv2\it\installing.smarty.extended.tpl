http://www.smarty.net/docsv2/it/installing.smarty.extended.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 01:39:29 GMT
...
<html lang="en">
  <head>
    ...
    <title>Installazione avanzata | Smarty</title>
...
<tr><th colspan="3" align="center">Installazione avanzata</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="installing.smarty.basic.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 2. Installazione</th>
...
<div class="sect1" title="Installazione avanzata">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="installing.smarty.extended"></a>Installazione avanzata</h2></div></div></div>
<p>
    Questo è il seguito della <a class="link" href="installing.smarty.basic.tpl" title="Installazione di base">installazione di base</a>, siete pregati
    di leggerla prima!
   </p>
<p>
    ...
    <code class="filename">setup.php</code>. Nel nostro ambiente di esempio, "/php/includes" fa parte
    dell'include_path. Assicuratevi che sia così anche per voi, oppure usate percorsi
    assoluti.
   </p>
<div class="example">
<a name="id3088344"></a><p class="title"><b>Example 2.10. Edit di /php/includes/guestbook/setup.php</b></p>
...
<div class="example">
<a name="id3088363"></a><p class="title"><b>Example 2.11. Edit di /web/www.example.com/docs/guestbook/index.php</b></p>
<div class="example-contents"><pre class="programlisting">
...
<tr>
<td width="40%" align="left" valign="top">Installazione di base </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Part II. Smarty Per Progettisti di Template</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 0 plus 7? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/installing.smarty.extended.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01934 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
