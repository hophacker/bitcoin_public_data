http://www.smarty.net/docsv2/es/api.register.postfilter.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 15:21:03 GMT
...
<h2>Name</h2>
<p>register_postfilter() — Resgistr dinamicamente postfiltros</p>
</div>
<div class="refsect1" title="Descripción">
<a name="id3134474"></a><h2> Descripción</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">register_postfilter</span>(<span class="methodparam"><span class="type">mixed </span><span class="parameter">function</span></span>);</code><p>
   Use esto para registrar dinámicamente  <a class="link" href="advanced.features.postfilters.tpl" title="Postfilters">postfiltros</a> para 
   correr templates directos después de ser compilados.
   Vea <a class="link" href="advanced.features.postfilters.tpl" title="Postfilters">postfiltros 
   de template</a> para mayores informes de como configurar 
...
<p>
  Vea También
  <a class="link" href="api.unregister.postfilter.tpl" title="unregister_postfilter()">unregister_postfilter()</a>,
...
<td width="40%" align="right" valign="top"> register_prefilter()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/api.register.postfilter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01773 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
