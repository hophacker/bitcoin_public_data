http://www.smarty.net/docsv2/de/variable.cache.dir.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 17:26:51 GMT
...
<p>
    ...
    angelegt werden. Normalerweise ist dies <code class="filename">'./cache'</code>.
    Das heisst, dass Smarty das Cache-Verzeichnis im selben Verzeichnis
    wie das ausgeführte PHP-Skript erwartet.
    <span class="bold"><strong>Der Webserver muss Schreibrechte für dieses
      Verzeichnis haben</strong></span>
     (siehe auch Kapitel <a class="link" href="installing.smarty.basic.tpl" title="Basis Installation">Installation</a>).
    Sie können auch einen eigenen Cache-Handler zur Kontrolle
    der Cache-Dateien definieren, der diese Einstellung ignoriert.
       Siehe auch
       <a class="link" href="variable.use.sub.dirs.tpl" title="$use_sub_dirs">$use_sub_dirs</a>.
   </p>
...
<p>
  Siehe auch
  <a class="link" href="variable.caching.tpl" title="$caching">$caching</a>,
  <a class="link" href="variable.use.sub.dirs.tpl" title="$use_sub_dirs">$use_sub_dirs</a>,
  ...
  <a class="link" href="caching.tpl" title="Chapter 14. Caching">Caching</a>.
  </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $cache_lifetime</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/variable.cache.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01625 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
