http://www.smarty.net/docsv2/it/api.load.filter.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 22:00:56 GMT
...
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">load_filter</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">type</span></span>,<br>                 <span class="methodparam"><span class="type">string </span><span class="parameter">name</span></span>);</code><p>
   Questa funzione può essere usata per caricare un plugin filtro. 
   Il primo parametro specifica il tipo di filtro da caricare e può
   avere uno di questi valori: 'pre', 'post' o 'output'. Il secondo
   parametro specifica il nome del plugin filtro, ad esempio 'trim'.
  </p>
<div class="example">
<a name="id3143331"></a><p class="title"><b>Example 13.20. caricamento di plugin filtro</b></p>
...
<td width="40%" align="right" valign="top"> register_block</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 19 plus 15? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/api.load.filter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02118 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
