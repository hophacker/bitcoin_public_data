http://www.smarty.net/docsv2/en/section.template.cache.handler.func.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 12:15:59 GMT
...
<html lang="en">
  <head>
    ...
    <title>Cache Handler Function | Smarty</title>
...
<p>
    ...
    <a class="link" href="variable.cache.handler.func.tpl" title="$cache_handler_func">
...
<li class="listitem"><p>
    The sixth is the optional <a class="link" href="variable.compile.id.tpl" title="$compile_id">
...
<div class="example">
<a name="id2875766"></a><p class="title"><b>Example 15.5. Example using MySQL as a cache source</b></p>
...
<td width="40%" align="right" valign="top"> Resources</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/section.template.cache.handler.func.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02581 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
