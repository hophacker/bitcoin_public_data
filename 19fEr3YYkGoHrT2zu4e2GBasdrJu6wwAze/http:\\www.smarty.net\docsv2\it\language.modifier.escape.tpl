http://www.smarty.net/docsv2/it/language.modifier.escape.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 23:37:11 GMT
...
<th width="60%" align="center">Chapter 5. Modificatori delle variabili</th>
...
<thead><tr>
<th align="center">Posizione del Parametro</th>
<th align="center">Tipo</th>
<th align="center">Obbligatorio</th>
<th align="center">Valori possibili</th>
...
<td>E' il tipo di escape da utilizzare.</td>
</tr></tbody>
</table></div>
<p>
   E' usato per fare un escape di tipo html, url, su apici per una variabile
   su cui non sia già stato fatto l'escape, hex (esadecimale), hexentity o 
   javascript.
   Per default viene applicato un escape di tipo html.
  </p>
<div class="example">
<a name="id3096083"></a><p class="title"><b>Example 5.10. escape</b></p>
...
<td width="40%" align="right" valign="top"> indent</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/language.modifier.escape.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01781 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
