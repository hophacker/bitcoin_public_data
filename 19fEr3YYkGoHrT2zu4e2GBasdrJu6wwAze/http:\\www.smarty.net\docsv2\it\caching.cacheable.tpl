http://www.smarty.net/docsv2/it/caching.cacheable.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 15:16:05 GMT
...
<html lang="en">
  <head>
    ...
    <title>Mettere in Cache l'output dei Plugin | Smarty</title>
...
<tr><th colspan="3" align="center">Mettere in Cache l'output dei Plugin</th></tr>
<tr>
...
<div class="sect1" title="Mettere in Cache l'output dei Plugin">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="caching.cacheable"></a>Mettere in Cache l'output dei Plugin</h2></div></div></div>
<p> 
   ...
   <em class="parameter"><code>$cacheable</code></em> e per default vale true, il che
...
<p>
   ...
   così un poco come una funzione <a class="link" href="plugins.inserts.tpl" title="Insert">insert</a>.
  </p>
<p>
   Al contrario di ciò che avviene in <a class="link" href="language.function.insert.tpl" title="insert">{insert}</a>, gli attributi passati
...
<div class="example">
<a name="id3154498"></a><p class="title"><b>Example 14.10. Evitare che l'output di un plugin vada in cache</b></p>
...
<a name="id3154558"></a><p class="title"><b>Example 14.11. Evitare che un intero blocco di template vada in cache</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<tr>
<td width="40%" align="left" valign="top">Gruppi di Cache </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Chapter 15. Funzioni avanzate</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="aca681af55cd89652f6d61b48be86016">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/caching.cacheable.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01727 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
