http://www.smarty.net/docsv2/pt_BR/caching.multiple.caches.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 15:21:17 GMT
...
<div class="example">
<a name="id2766612"></a><p class="title"><b>Example 14.6. Passando um cache_id para display()</b></p>
...
$smarty-&gt;display('index.tpl',$my_cache_id);</pre></div>
</div>
...
<p>
	...
	parâmetro para <a class="link" href="api.is.cached.tpl" title="is_cached">is_cached()</a> e
	<a class="link" href="api.clear.cache.tpl" title="clear_cache">clear_cache()</a>.
	</p>
<div class="example">
<a name="id2767586"></a><p class="title"><b>Example 14.7. Passando um cache_id para is_cached()</b></p>
<div class="example-contents"><pre class="programlisting">
require('Smarty.class.php');
$smarty = new Smarty;
...
<div class="example">
<a name="id2767612"></a><p class="title"><b>Example 14.8. Limpando todos os caches para um cache_id em particular</b></p>
<div class="example-contents"><pre class="programlisting">
require('Smarty.class.php');
$smarty = new Smarty;
...
$smarty-&gt;display('index.tpl',"sports");</pre></div>
</div>
<br class="example-break"><p>
...
<td width="40%" align="right" valign="top"> Grupos de Cache</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/caching.multiple.caches.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02450 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
