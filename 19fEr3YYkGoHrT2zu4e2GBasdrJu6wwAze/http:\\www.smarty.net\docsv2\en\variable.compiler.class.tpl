http://www.smarty.net/docsv2/en/variable.compiler.class.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 00:03:26 GMT
...
<td width="40%" align="right" valign="top"> $request_vars_order</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/variable.compiler.class.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02843 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
