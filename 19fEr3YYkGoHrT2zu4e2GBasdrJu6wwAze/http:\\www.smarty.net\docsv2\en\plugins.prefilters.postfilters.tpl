http://www.smarty.net/docsv2/en/plugins.prefilters.postfilters.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 14:40:01 GMT
...
<html lang="en">
  <head>
    ...
    <title>Prefilters/Postfilters | Smarty</title>
...
<div class="example">
<a name="id2880595"></a><p class="title"><b>Example 16.7. prefilter plugin</b></p>
...
<div class="example">
<a name="id2880612"></a><p class="title"><b>Example 16.8. postfilter plugin</b></p>
<div class="example-contents"><pre class="programlisting">
...
<td width="40%" align="right" valign="top"> Output Filters</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/plugins.prefilters.postfilters.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02281 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
