http://www.smarty.net/docsv2/es/variable.force.compile.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 19:57:57 GMT
...
<p>
       ...
       Esta configuración sobrescribe 
       <a class="link" href="variable.compile.check.tpl" title="$compile_check">$compile_check</a>. 
       Por default este
       es desabilitado. Es útil para el desarrollo y 
       <a class="link" href="chapter.debugging.console.tpl" title="Chapter 10. Debugging Console">debug</a>. 
       Nunca debe ser usado en ambiente de producción. Si el  
       <a class="link" href="variable.caching.tpl" title="$caching">cache</a> esta habilitado, 
       los archivo(s) de cache seran regenerados todo el tiempo.
      </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $caching</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/variable.force.compile.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01809 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
