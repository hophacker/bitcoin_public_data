http://www.smarty.net/docsv2/es/variable.security.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 11:41:47 GMT
...
<p>
      ...
      <a class="link" href="variable.security.settings.tpl" title="$security_settings">$security_settings</a>:
      </p>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>
           Si <a class="link" href="variable.php.handling.tpl" title="$php_handling">$php_handling</a> está 
...
<li class="listitem"><p>
          ...
          <a class="link" href="variable.secure.dir.tpl" title="$secure_dir">$secure_dir</a>
          </p></li>
<li class="listitem"><p>
          Los archivos locales solamente pueden ser traidos del
          directorio listado en 
          <a class="link" href="variable.secure.dir.tpl" title="$secure_dir">$secure_dir</a> usando 
          el arreglo <a class="link" href="language.function.fetch.tpl" title="{fetch}">{fetch}</a>
          </p></li>
<li class="listitem"><p>
           Estas etiquetas 
           <a class="link" href="language.function.php.tpl" title="{php}">{php}{/php}</a> no son permitidas
          </p></li>
<li class="listitem"><p>
...
<td width="40%" align="right" valign="top"> $secure_dir</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/variable.security.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03293 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
