HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 15:15:30 GMT
...
<p>
   Este es usado para contar el número de parrafos en la variable.
  </p>
<div class="example">
<a name="id3069720"></a><p class="title"><b>Example 5.5. count_paragraphs</b></p>
...
<td width="40%" align="right" valign="top"> count_sentences</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.modifier.count.paragraphs.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02605 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
