...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 22:10:32 GMT
...
<p>
  ...
  <a class="link" href="language.function.ldelim.tpl" title="{ldelim},{rdelim}"><code class="varname">{ldelim}{rdelim}</code></a> to escape the
  individual delimiters instead.
 </p>
<div class="example">
<a name="id2807250"></a><p class="title"><b>Example 7.25. {literal} tags</b></p>
...
<a name="id2807263"></a><p class="title"><b>Example 7.26. Javascript function example</b></p>
<div class="example-contents"><pre class="programlisting">
...
<br class="example-break"><div class="example">
<a name="id2807283"></a><p class="title"><b>Example 7.27. Some css style in a template</b></p>
<div class="example-contents"><pre class="programlisting">
...
<br class="example-break"><p>
  ...
  and the
  <a class="link" href="language.escaping.tpl" title="Escaping Smarty Parsing">escaping Smarty parsing</a> page.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> {php}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/language.function.literal.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01496 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
