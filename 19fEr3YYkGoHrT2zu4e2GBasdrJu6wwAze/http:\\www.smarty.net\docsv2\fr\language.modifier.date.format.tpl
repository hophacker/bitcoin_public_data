http://www.smarty.net/docsv2/fr/language.modifier.date.format.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 19:19:59 GMT
...
<p>
  ...
  <a class="ulink" href="http://php.net/strftime" target="_top"><code class="varname">strftime()</code></a> donné.
  Les dates peuvent être passées à smarty en tant que
  <a class="ulink" href="http://php.net/function.time" target="_top">timestamp</a> unix,
  ...
  Les concepteurs de templates peuvent utiliser <code class="varname">date_format</code> pour contrôler
  parfaitement le format de sortie de la date.
  Si la date passée à <code class="varname">date_format</code> est vide, et qu'un
...
<td>Format de sortie de la date.</td>
</tr>
<tr>
...
<td>Date par défaut si aucune n'est spécifiée en entrée.</td>
</tr>
</tbody>
</table></div>
<p>
...
<p>
    Depuis Smarty 2.6.10, les valeurs numériques passées à <code class="varname">date_format</code>
    sont <span class="emphasis"><em>toujours</em></span> (excepté pour les timestamps mysql, voir
    ci-dessous) interprétées comme un timestamp Unix.
   </p>
<p>
    Avant la version 2.6.10 de Smarty, les chaînes numériques qui étaient
    également analysables par <code class="varname">strtotime()</code>
    en PHP (comme <code class="literal">YYYYMMDD</code>),
    étaient, parfois, dépendament de l'implémentation de <code class="varname">strtotime()</code>,
...
<p>
    ...
    et d'une longueur de 14 caractères (<code class="literal">YYYYMMDDHHMMSS</code>). Les timestamps
    MySQL ont la priorité sur les timestamps Unix.
   </p>
</div>
<p>
  </p>
<div class="note" title="Note pour les développeurs" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Note pour les développeurs</h3>
<p>
    <code class="varname">date_format</code> est essentiellement un gestionnaire pour la fonction PHP
    ...
    la fonction PHP <a class="ulink" href="http://php.net/strftime" target="_top"><code class="varname">strftime()</code></a>
...
<div class="example">
<a name="id2937775"></a><p class="title"><b>Example 5.8. date_format</b></p>
...
<br class="example-break"><p>
   Conversion de <span class="command"><strong>date_format</strong></span> :
   </p>
...
<td width="40%" align="right" valign="top"> default</td>
          ...
          <div class="commentInfo">
              ...
              <div class="commentAuthor">by <b>PHLanglois</b> on Apr 29, 2013 at 11:49</div>
              <div class="commentBody">Take care when using date_format as it relies on your local time configuration.

For example, in french, on my local setup, I simply use:
setlocale (LC_TIME, 'fr_FR');

But when on a real server (OVH), accents where messed up and I have to use :
setlocale (LC_TIME, 'fr_FR.utf8','fra'); 
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/language.modifier.date.format.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01965 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
