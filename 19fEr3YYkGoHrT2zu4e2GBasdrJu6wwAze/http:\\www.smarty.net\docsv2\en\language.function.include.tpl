...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 18:04:56 GMT
...
<li class="listitem"><p>
  Use the syntax for <a class="link" href="template.resources.tpl" title="Resources">template resources</a> to
  <code class="varname">{include}</code> files outside of the
  <a class="link" href="api.variables.tpl#variable.template.dir" title="$template_dir"><em class="parameter"><code>$template_dir</code></em></a>  directory.
  </p></li>
</ul></div>
...
<div class="example">
<a name="id2805073"></a><p class="title"><b>Example 7.17. Simple {include} example</b></p>
...
<a name="id2805085"></a><p class="title"><b>Example 7.18. {include} passing variables</b></p>
...
<br class="example-break"><div class="example">
<a name="id2805127"></a><p class="title"><b>Example 7.19. {include} and assign to variable</b></p>
<div class="example-contents">
...
<br class="example-break"><div class="example">
<a name="id2805159"></a><p class="title"><b>Example 7.20. Various {include} resource examples</b></p>
<div class="example-contents"><pre class="programlisting">
...
<br class="example-break"><p>
  ...
  <a class="link" href="template.resources.tpl" title="Resources">template resources</a> and
...
<td width="40%" align="right" valign="top"> {include_php}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/language.function.include.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01905 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
