...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 20:08:22 GMT
...
<a name="idp15714272"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">string </span><span class="methodname">compileAllConfig</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">extension</span></span>,<br>                        <span class="methodparam"><span class="type">boolean </span><span class="parameter">force</span></span>,<br>                        <span class="methodparam"><span class="type">integer </span><span class="parameter">timelimit</span></span>,<br>                        <span class="methodparam"><span class="type">integer </span><span class="parameter">maxerror</span></span>);</code><p>
    This function compiles config files found in the <a class="link" href="variable.config.dir.tpl" title="$config_dir"><code class="varname">$config_dir</code></a> folder.
    It uses the following parameters:
    </p>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>
       <em class="parameter"><code>extension</code></em> is an optional string which defines the file extension for the config files. 
       The default is ".conf".
      </p></li>
<li class="listitem"><p>
...
<div class="example">
<a name="idp15778400"></a><p class="title"><b>Example 14.14. compileAllConfig()</b></p>
...
<td width="40%" align="right" valign="top"> compileAllTemplates()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/api.compile.all.config.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01530 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
