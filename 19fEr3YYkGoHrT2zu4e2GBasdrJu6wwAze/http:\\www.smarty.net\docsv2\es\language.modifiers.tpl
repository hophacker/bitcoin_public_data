http://www.smarty.net/docsv2/es/language.modifiers.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 22:00:53 GMT
...
<html lang="en">
  <head>
    ...
    <title>Chapter 5. Modificadores de variables | Smarty</title>
...
<div class="example">
<a name="id3066210"></a><p class="title"><b>Example 5.1. Ejemplo de modificador</b></p>
...
<p>
  ...
  <a class="link" href="variable.plugins.dir.tpl" title="$plugins_dir">$plugins_dir</a> (vea también:
  <a class="link" href="plugins.naming.conventions.tpl" title="Nombres convencionales">Naming Conventions</a>) 
  o pueden ser registrados explicitamente (vea: 
  <a class="link" href="api.register.modifier.tpl" title="register_modifier()">register_modifier</a>). 
  ...
  Segundo: con <a class="link" href="variable.security.tpl" title="$security">$security</a> activado, 
  todas las funciones de php que sean utilizadas como modificadores deben 
  ser declaradas como variables de una matriz 
  <a class="link" href="variable.security.settings.tpl" title="$security_settings">$security_settings['MODIFIER_FUNCS']
  </a>.
 </p>
<p>
  Ver también
  ...
  <a class="link" href="plugins.tpl" title="Chapter 16. Extendiendo Smarty con plugins">Extending Smarty with plugins</a>
  y <a class="link" href="plugins.modifiers.tpl" title="Modificadores">modifiers</a>,
 </p>
...
<div class="example">
<a name="id3069471"></a><p class="title"><b>Example 5.2. capitalize</b></p>
...
<br class="example-break"><p>Ver también <a class="link" href="language.modifier.lower.tpl" title="lower">lower</a> 
                     <a class="link" href="language.modifier.upper.tpl" title="upper">upper</a> 
   </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> cat</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="18c4b6d0081f10a495200d39a9693fba">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.modifiers.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02290 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
