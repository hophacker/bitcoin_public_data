http://www.smarty.net/docsv2/fr/api.register.resource.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 23:24:43 GMT
...
<h2>Name</h2>
<p>register_resource() — Déclare dynamiquement une ressource plugin</p>
</div>
<div class="refsect1" title="Description">
<a name="id3015382"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">register_resource</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">name</span></span>,<br>                       <span class="methodparam"><span class="type">array </span><span class="parameter">resource_funcs</span></span>);</code><p>
   Utilisée pour déclarer dynamiquement une <a class="link" href="template.resources.tpl" title="Ressources">ressource plugin</a>
   ...
   à la section <a class="link" href="template.resources.tpl" title="Ressources">ressources templates</a>
...
<li class="listitem"><p>
   Le tableau de fonctions PHP <em class="parameter"><code>resource_funcs</code></em>
...
<li class="listitem"><p>
   ...
   <code class="literal">source</code>, <code class="literal">timestamp</code>, <code class="literal">secure</code> et
   <code class="literal">trusted</code> de la ressource.
   </p></li>
<li class="listitem"><p>
   ...
   les noms des méthodes implémentant <code class="literal">source</code>,
   <code class="literal">timestamp</code>, <code class="literal">secure</code>
   et <code class="literal">trusted</code>.
  </p></li>
</ul></div>
<div class="example">
<a name="id3016462"></a><p class="title"><b>Example 13.25. Exemple avec register_resource()</b></p>
...
<br class="example-break"><p>
   Voir aussi
   <a class="link" href="api.unregister.resource.tpl" title="unregister_resource()"><code class="varname">unregister_resource()</code></a> et
   les <a class="link" href="template.resources.tpl" title="Ressources">ressources de template</a>.
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> trigger_error()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 6 plus 11? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/api.register.resource.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02601 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
