...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 16:03:41 GMT
...
<h2>Name</h2>
<p>compileAllTemplates() — compiles all known templates</p>
</div>
<div class="refsect1" title="Description">
<a name="idp15756384"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">string </span><span class="methodname">compileAllTemplates</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">extension</span></span>,<br>                           <span class="methodparam"><span class="type">boolean </span><span class="parameter">force</span></span>,<br>                           <span class="methodparam"><span class="type">integer </span><span class="parameter">timelimit</span></span>,<br>                           <span class="methodparam"><span class="type">integer </span><span class="parameter">maxerror</span></span>);</code><p>
    This function compiles template files found in the <a class="link" href="variable.template.dir.tpl" title="$template_dir"><code class="varname">$template_dir</code></a> folder.
    It uses the following parameters:
    </p>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>
       <em class="parameter"><code>extension</code></em> is an optional string which defines the file extension for the template files. 
       The default is ".tpl".
      </p></li>
<li class="listitem"><p>
       <em class="parameter"><code>force</code></em> is an optional boolean which controls if only modified (false) or all (true) templates shall be compiled. 
...
<li class="listitem"><p>
       <em class="parameter"><code>maxerror</code></em> is an optional integer to set an error limit. If more templates failed to compile the function
...
<div class="example">
<a name="idp15826496"></a><p class="title"><b>Example 14.15. compileAllTemplates()</b></p>
...
<td width="40%" align="right" valign="top"> configLoad()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 11 plus 16? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/api.compile.all.templates.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01302 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
