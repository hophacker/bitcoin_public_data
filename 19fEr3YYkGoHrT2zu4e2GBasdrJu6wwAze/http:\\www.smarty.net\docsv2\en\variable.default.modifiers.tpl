...
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 12:59:16 GMT
...
<p>
	  ...
	  modifiers, pass the special <code class="literal">smarty</code> modifier with a
      parameter value of
	  <code class="literal">nodefaults</code> modifier to it, such as
	  <code class="literal">{$var|smarty:nodefaults}</code>.
      </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $default_resource_type</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/variable.default.modifiers.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02164 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
