http://www.smarty.net/docsv2/en/language.syntax.functions.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 07:49:48 GMT
...
<tr><th colspan="3" align="center">Functions</th></tr>
<tr>
...
<a name="language.syntax.functions"></a>Functions</h2></div></div></div>
<p>
  Every Smarty tag either prints a
  <a class="link" href="language.variables.tpl" title="Chapter 4. Variables">variable</a> or invokes some sort
  of function. These are processed and displayed by enclosing the
  function and its
  <a class="link" href="language.syntax.attributes.tpl" title="Attributes">attributes</a>
  within delimiters like so:
  <code class="literal">{funcname attr1='val1' attr2='val2'}</code>.
 </p>
<div class="example">
<a name="id2780683"></a><p class="title"><b>Example 3.3. function syntax </b></p>
...
<li class="listitem"><p>
  Both <a class="link" href="language.builtin.functions.tpl" title="Chapter 7. Built-in Functions">built-in functions</a>
  and <a class="link" href="language.custom.functions.tpl" title="Chapter 8. Custom Functions">custom functions</a>
  have the same syntax within templates.
  </p></li>
<li class="listitem"><p>Built-in functions are the
  <span class="bold"><strong>inner</strong></span> workings of Smarty, such as
  <a class="link" href="language.function.if.tpl" title="{if},{elseif},{else}"><code class="varname">{if}</code></a>,
  <a class="link" href="language.function.section.tpl" title="{section},{sectionelse}"><code class="varname">{section}</code></a> and
...
<li class="listitem"><p>Custom functions are
  <span class="bold"><strong>additional</strong></span>
  functions implemented via <a class="link" href="plugins.tpl" title="Chapter 16. Extending Smarty With Plugins">plugins</a>.
  ...
  <code class="varname">{html_options}</code></a>
  is an example of a custom function.
 </p></li>
</ul></div>
<p>
 See also <a class="link" href="api.register.function.tpl" title="register_function()"><code class="varname">register_function()</code></a>
 </p>
</div>
<div class="navfooter">
<hr>
...
<tr>
<td width="40%" align="left" valign="top">Variables </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Attributes</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/language.syntax.functions.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01795 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
