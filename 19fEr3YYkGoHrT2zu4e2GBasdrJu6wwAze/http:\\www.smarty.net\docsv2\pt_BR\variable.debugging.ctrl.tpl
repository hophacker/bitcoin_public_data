http://www.smarty.net/docsv2/pt_BR/variable.debugging.ctrl.tpl
HTTP/1.1 200 OK
...
<td width="40%" align="right" valign="top"> $autoload_filters</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/variable.debugging.ctrl.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02254 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
