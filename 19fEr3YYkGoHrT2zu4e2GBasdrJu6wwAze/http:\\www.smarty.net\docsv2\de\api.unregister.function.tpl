http://www.smarty.net/docsv2/de/api.unregister.function.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 22:01:23 GMT
...
<html lang="en">
  <head>
    ...
    <title>unregister_function (Template-Funktion deaktivieren) | Smarty</title>
...
<tr><th colspan="3" align="center">unregister_function (Template-Funktion deaktivieren)</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.unregister.compiler.function.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Methoden der Klasse Smarty</th>
<td width="20%" align="right"> <a accesskey="n" href="api.unregister.modifier.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="unregister_function (Template-Funktion deaktivieren)">
<a name="api.unregister.function"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>unregister_function (Template-Funktion deaktivieren)</p>
</div>
<div class="refsect1">
<a name="id2924975"></a><h2></h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">unregister_function</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">name</span></span>);</code><p>
  Wird verwendet, um registrierte Template-Funktionen auszuschalten.
  Übergeben Sie dazu den Namen der Template-Funktion.
  </p>
<div class="example">
<a name="id2924764"></a><p class="title"><b>Example 13.25. unregister_function</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="api.unregister.modifier.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">unregister_compiler_function (Compiler-Funktion deaktivieren) </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> unregister_modifier (Modifikator deaktivieren)</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 8 plus 0? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="a5593afac74363d236d1fa8346c35aee">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/api.unregister.function.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01961 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
