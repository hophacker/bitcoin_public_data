...
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 23:25:45 GMT
...
<html lang="en">
  <head>
    ...
    <title>Chapter 8. Custom Functions | Smarty</title>
...
<td width="20%" align="right"> <a accesskey="n" href="language.function.counter.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<div class="example">
<a name="id2817947"></a><p class="title"><b>Example 8.1. {assign}</b></p>
...
<a name="id2817973"></a><p class="title"><b>Example 8.2. {assign} with some maths</b></p>
<div class="example-contents">
...
<br class="example-break"><div class="example">
<a name="id2817993"></a><p class="title"><b>Example 8.3. Accessing {assign} variables from a PHP script</b></p>
<div class="example-contents">
<p>
  To access <code class="varname">{assign}</code> variables from a php script use
    <a class="link" href="api.get.template.vars.tpl" title="get_template_vars()">
...
<p>
  <a class="link" href="language.builtin.functions.tpl#language.function.capture" title="{capture}"><code class="varname">{capture}</code></a>,
 ...
 <a class="link" href="language.function.counter.tpl" title="{counter}"><code class="varname">{counter}</code></a>,
...
<p>
 See also <a class="link" href="api.assign.tpl" title="assign()"><code class="varname">assign()</code></a>
   and
...
<td width="40%" align="right"> <a accesskey="n" href="language.function.counter.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> {counter}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/language.custom.functions.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02756 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
