http://www.smarty.net/docsv2/es/variable.error.reporting.tpl
HTTP/1.1 200 OK
...
<p>
           ...
           Cuando <a class="link" href="chapter.debugging.console.tpl" title="Chapter 10. Debugging Console">debugging</a> es 
...
<p>
  ...
  y
  <a class="link" href="troubleshooting.tpl" title="Chapter 17. Localización de Errores">Troubleshooting</a>.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $compile_id</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 10 plus 8? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/variable.error.reporting.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01968 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
