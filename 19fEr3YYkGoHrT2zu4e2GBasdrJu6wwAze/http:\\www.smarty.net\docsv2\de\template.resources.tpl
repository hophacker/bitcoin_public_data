...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 13:58:58 GMT
...
<tr><th colspan="3" align="center">Ressourcen</th></tr>
<tr>
...
<div class="sect1" title="Ressourcen">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="template.resources"></a>Ressourcen</h2></div></div></div>
<p>
    ...
    wird, wird <a class="link" href="variable.default.resource.type.tpl" title="$default_resource_type">$default_resource_type</a>
    verwendet.
   </p>
<div class="sect2" title="Templates aus dem '$template_dir'">
<div class="titlepage"><div><div><h3 class="title">
<a name="templates.from.template.dir"></a>Templates aus dem '$template_dir'</h3></div></div></div>
<p>
...
<div class="example">
<a name="id2935226"></a><p class="title"><b>Example 15.6. Templates aus '$template_dir' verwenden</b></p>
<div class="example-contents"><pre class="programlisting">
      ...
      {include file="file:index.tpl"} {* entspricht der vorigen Zeile *}</pre></div>
</div>
<br class="example-break">
</div>
<div class="sect2" title="Templates aus beliebigen Verzeichnissen">
<div class="titlepage"><div><div><h3 class="title">
<a name="templates.from.any.dir"></a>Templates aus beliebigen Verzeichnissen</h3></div></div></div>
<p>
     Templates ausserhalb von '$template_dir' benötigen den 'file:' Ressourcen-Typ,
     gefolgt von absolutem Pfadnamen und Templatenamen.
    </p>
<div class="example">
<a name="id2935261"></a><p class="title"><b>Example 15.7. Templates aus beliebigen Verzeichnissen benutzen</b></p>
<div class="example-contents"><pre class="programlisting">
      ...
      {* im Smarty Template *}
      {include file="file:/usr/local/share/templates/navigation.tpl"}</pre></div>
</div>
<br class="example-break"><div class="sect3" title="Windows Dateipfade">
<div class="titlepage"><div><div><h4 class="title">
<a name="templates.windows.filepath"></a>Windows Dateipfade</h4></div></div></div>
<p>
...
<div class="example">
<a name="id2935296"></a><p class="title"><b>Example 15.8. Templates aus Windows Dateipfaden verwenden</b></p>
<div class="example-contents"><pre class="programlisting">
       ...
       {* im Smarty Template *}
       {include file="file:D:/usr/local/share/templates/navigation.tpl"}</pre></div>
</div>
<br class="example-break">
</div>
</div>
<div class="sect2" title="Templates aus anderen Quellen">
<div class="titlepage"><div><div><h3 class="title">
<a name="templates.from.elsewhere"></a>Templates aus anderen Quellen</h3></div></div></div>
<p>
...
<p>
     Konsultieren Sie den Abschnitt über <a class="link" href="plugins.resources.tpl" title="Ressourcen">Ressource-Plugins</a>
     für mehr Informationen über die Funktionalitäten, die ein derartiges Plugin bereitstellen muss.
    </p>
<div class="note" title="Note" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Note</h3>
<p>
      Achtung: Sie können die interne <code class="literal">file</code> Ressource nicht
...
<div class="example">
<a name="id2935363"></a><p class="title"><b>Example 15.9. Eigene Quellen verwenden</b></p>
<div class="example-contents"><pre class="programlisting">
      ...
      {include file="db:/extras/navigation.tpl"}</pre></div>
</div>
<br class="example-break">
</div>
<div class="sect2" title="Standard Template-Handler">
<div class="titlepage"><div><div><h3 class="title">
<a name="default.template.handler.function"></a>Standard Template-Handler</h3></div></div></div>
<p>
...
<div class="example">
<a name="id2935394"></a><p class="title"><b>Example 15.10. Standard Template-Handler verwenden</b></p>
<div class="example-contents"><pre class="programlisting">
      &lt;?php
...
<tr>
<td width="40%" align="left" valign="top">Cache Handler Funktion </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Chapter 16. Smarty durch Plugins erweitern</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/template.resources.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01814 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
