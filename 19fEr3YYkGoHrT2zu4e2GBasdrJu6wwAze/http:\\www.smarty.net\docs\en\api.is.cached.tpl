...
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 04:22:06 GMT
...
<h2>Name</h2>
<p>isCached() — returns true if there is a valid cache for this template</p>
</div>
<div class="refsect1" title="Description">
<a name="idp16396944"></a><h2>Description</h2>
...
<li class="listitem"><p>
   This only works if <a class="link" href="variable.caching.tpl" title="$caching">
    <em class="parameter"><code>$caching</code></em></a> is set to one of <code class="literal">Smarty::CACHING_LIFETIME_CURRENT</code> or <code class="literal">Smarty::CACHING_LIFETIME_SAVED</code> to enable caching. See the
   <a class="link" href="caching.tpl" title="Chapter 15. Caching">caching section</a> for more info.
  </p></li>
<li class="listitem"><p>
   You can also pass a <em class="parameter"><code>$cache_id</code></em> as an optional second
   parameter in case you want
   <a class="link" href="caching.multiple.caches.tpl" title="Multiple Caches Per Page">multiple caches</a>
...
<li class="listitem"><p>
   ...
   pass a <a class="link" href="variable.compile.id.tpl" title="$compile_id">
...
<p>
   If <code class="varname">isCached()</code> returns <code class="constant">TRUE</code> it actually loads the
   ...
   <code class="varname">isCached()</code> and to
   ...
   <code class="varname">isCached()</code> returned <code class="constant">TRUE</code>.
  </p>
</div>
<div class="example">
<a name="idp16456784"></a><p class="title"><b>Example 14.32. isCached()</b></p>
...
<a name="idp16458960"></a><p class="title"><b>Example 14.33. isCached() with multiple-cache template</b></p>
<div class="example-contents"><pre class="programlisting">
...
<br class="example-break"><p>
    ...
    and
    <a class="link" href="caching.tpl" title="Chapter 15. Caching">caching section</a>.
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> loadFilter()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/api.is.cached.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02120 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
