...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 11:54:59 GMT
...
<a name="idp15413424"></a><h2>Description</h2>
...
<p>
   ...
   See <a class="link" href="caching.cacheable.tpl#cacheability.variables" title="Cacheability of Variables"><em class="parameter"><code>Cacheability of Variables</code></em></a> for details.
  </p>
...
<div class="example">
<a name="idp15481712"></a><p class="title"><b>Example 14.6. assign()</b></p>
...
<td width="40%" align="right" valign="top"> assignByRef()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 15 plus 2? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/api.assign.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01424 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
