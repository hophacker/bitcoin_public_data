http://www.smarty.net/docsv2/de/variable.default.template.handler.func.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 12:25:01 GMT
...
<td width="40%" align="right" valign="top"> $php_handling</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/variable.default.template.handler.func.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.04168 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
