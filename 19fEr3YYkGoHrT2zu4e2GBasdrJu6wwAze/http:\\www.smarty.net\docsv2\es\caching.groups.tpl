http://www.smarty.net/docsv2/es/caching.groups.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 13:00:51 GMT
...
<html lang="en">
  <head>
    ...
    <title>Cache Groups | Smarty</title>
...
<div class="example">
<a name="id3145102"></a><p class="title"><b>Example 14.9. Grupos de cache_id</b></p>
...
<td width="40%" align="right" valign="top"> Controlando salida de Cacheabilidad de plugins</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/caching.groups.tpl">
            </form>
            </div>
          </div>
