http://www.smarty.net/docsv2/es/advanced.features.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 10:40:45 GMT
...
<html lang="en">
  <head>
    ...
    <title>Chapter 15. Caracteristicas Avanzadas | Smarty</title>
...
<p>
      ...
      <a class="link" href="api.register.object.tpl" title="register_object()">registrando objetos</a> para el 
      template, entonces acceselos mediante sintaxis similar a las funciones
      habituales. La otra es <a class="link" href="api.assign.tpl" title="assign()">asignar objetos</a> al 
...
<p>
  Si <a class="link" href="variable.security.tpl" title="$security">$security</a> esta habilitada, 
...
<p>
  ...
  <a class="link" href="language.custom.functions.tpl" title="Chapter 8. Custom Functions">funciones de costumbre</a> 
...
<p>
  ...
  los parámetros de <a class="link" href="plugins.block.functions.tpl" title="Block Functions">block-function-plugins</a>: 
...
<div class="example">
<a name="id3147427"></a><p class="title"><b>Example 15.1. usando un objeto registrado o atribuido</b></p>
...
<td width="40%" align="right" valign="top"> Prefilters</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/advanced.features.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03346 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
