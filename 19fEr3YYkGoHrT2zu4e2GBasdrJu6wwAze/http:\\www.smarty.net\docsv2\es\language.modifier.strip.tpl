http://www.smarty.net/docsv2/es/language.modifier.strip.tpl
HTTP/1.1 200 OK
...
<p>
    ...
    función <a class="link" href="language.function.strip.tpl" title="{strip}">{strip}</a>.
   </p>
</div>
<div class="example">
<a name="id3074466"></a><p class="title"><b>Example 5.18. strip</b></p>
...
<td width="40%" align="right" valign="top"> strip_tags</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 0 plus 15? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.modifier.strip.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02052 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
