http://www.smarty.net/docsv2/de/variable.security.settings.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 01:29:12 GMT
...
<html lang="en">
  <head>
    ...
    <title>$security_settings | Smarty</title>
...
<tr><th colspan="3" align="center">$security_settings</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="variable.secure.dir.tpl">Prev</a> </td>
...
<div class="sect1" title="$security_settings">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="variable.security.settings"></a>$security_settings</h2></div></div></div>
<p>
    Wird verwendet um spezifische Sicherheits-Einstellungen zu ändern,
    wenn <a class="link" href="variable.security.tpl" title="$security">$security</a> eingeschaltet ist.
  </p>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>
        PHP_HANDLING - true/false.
        Wenn auf 'true' gesetzt, wird <a class="link" href="variable.php.handling.tpl" title="$php_handling">$php_handling</a> ignoriert.
      </p></li>
<li class="listitem"><p>
        IF_FUNCS - Ein Array aller erlaubter Funktionen in
        <a class="link" href="language.function.if.tpl" title="{if},{elseif},{else}">{if}</a>-Statements.
      </p></li>
<li class="listitem"><p>
        INCLUDE_ANY - true/false.
        Wenn 'true', kann das Template aus jedem beliebigen Verzeichnis geladen werden,
        auch außerhalb der <a class="link" href="variable.secure.dir.tpl" title="$secure_dir">$secure_dir</a>-Liste.</p></li>
<li class="listitem"><p>
        PHP_TAGS - true/false.
        Wenn 'true', sind <a class="link" href="language.function.php.tpl" title="php">{php}{/php}</a>-Tags
...
<li class="listitem"><p>
        ...
        <a class="link" href="language.variables.smarty.tpl#language.variables.smarty.const" title="{$smarty.const}">{$smarty.const.name}</a>
...
<tr>
<td width="40%" align="left" valign="top">$secure_dir </td>
...
<td width="40%" align="right" valign="top"> $trusted_dir</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 4 plus 16? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/variable.security.settings.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03159 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
