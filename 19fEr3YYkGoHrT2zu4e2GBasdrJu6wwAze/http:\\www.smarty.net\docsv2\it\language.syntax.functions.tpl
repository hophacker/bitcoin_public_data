http://www.smarty.net/docsv2/it/language.syntax.functions.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 21:18:56 GMT
...
<tr><th colspan="3" align="center">Funzioni</th></tr>
<tr>
...
<div class="sect1" title="Funzioni">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.syntax.functions"></a>Funzioni</h2></div></div></div>
<p>
  Ogni tag di Smarty può stampare una <a class="link" href="language.variables.tpl" title="Chapter 4. Variabili">variable</a>
...
<div class="example">
<a name="id3089466"></a><p class="title"><b>Example 3.2. sintassi delle funzioni</b></p>
...
<br class="example-break"><p>
  ...
  di Smarty, ad esempio <span class="command"><strong>if</strong></span>, <span class="command"><strong>section</strong></span> e
  <span class="command"><strong>strip</strong></span>. Non possono essere modificate. Le funzioni
  utente sono funzioni addizionali sviluppate attraverso i plugin. Potete
  modificarle a piacere, e potete crearne di nuove. <span class="command"><strong>html_options</strong></span> 
  e <span class="command"><strong>html_select_date</strong></span> sono esempi di funzioni utente.
 </p>
</div>
<div class="navfooter">
<hr>
...
<tr>
<td width="40%" align="left" valign="top">Chapter 3. Sintassi di base </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Attributi</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/language.syntax.functions.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03051 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
