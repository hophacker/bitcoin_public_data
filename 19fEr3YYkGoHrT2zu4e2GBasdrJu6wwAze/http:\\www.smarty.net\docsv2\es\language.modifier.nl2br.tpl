http://www.smarty.net/docsv2/es/language.modifier.nl2br.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 21:18:40 GMT
...
<p>
   ...
   <a class="ulink" href="http://php.net/nl2br" target="_top">nl2br()</a> de PHP.
  </p>
<div class="example">
<a name="id3072694"></a><p class="title"><b>Example 5.13. nl2br</b></p>
...
<br class="example-break"><p>
   Ver también <a class="link" href="language.modifier.wordwrap.tpl" title="wordwrap">word_wrap</a>,
   <a class="link" href="language.modifier.count.paragraphs.tpl" title="count_paragraphs">count_paragraphs</a>
   y <a class="link" href="language.modifier.count.sentences.tpl" title="count_sentences">count_sentences</a>.
  </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> regex_replace</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.modifier.nl2br.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01738 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
