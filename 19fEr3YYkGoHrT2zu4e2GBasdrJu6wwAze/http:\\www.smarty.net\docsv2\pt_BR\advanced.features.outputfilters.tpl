http://www.smarty.net/docsv2/pt_BR/advanced.features.outputfilters.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 13:24:51 GMT
...
<html lang="en">
  <head>
    ...
    <title>Output Filters (Filtros de Saída) | Smarty</title>
...
<tr><th colspan="3" align="center">Output Filters (Filtros de Saída)</th></tr>
<tr>
...
<div class="sect1" title="Output Filters (Filtros de Saída)">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="advanced.features.outputfilters"></a>Output Filters (Filtros de Saída)</h2></div></div></div>
<p>
...
<p>
    ...
    <a class="link" href="api.register.outputfilter.tpl" title="register_outputfilter">registrado</a> ou carregado
    do diretório de plugins usando a função
    <a class="link" href="api.load.filter.tpl" title="load_filter">load_filter()</a> ou configurando a variável
...
<div class="example">
<a name="id2768858"></a><p class="title"><b>Example 15.4. usando um filtro de saída de template</b></p>
...
<td width="40%" align="right" valign="top"> Função Manipuladora de Cache</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 6 plus 12? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="2a088a09fd37bcdd71c95eeb2b6538d9">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/advanced.features.outputfilters.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01954 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
