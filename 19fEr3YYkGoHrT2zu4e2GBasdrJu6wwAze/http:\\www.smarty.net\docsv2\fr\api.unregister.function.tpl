http://www.smarty.net/docsv2/fr/api.unregister.function.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 14:43:37 GMT
...
<html lang="en">
  <head>
    ...
    <title>unregister_function() | Smarty</title>
...
<tr><th colspan="3" align="center">unregister_function()</th></tr>
<tr>
...
<div class="refentry" title="unregister_function()">
<a name="api.unregister.function"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>unregister_function() — Désalloue dynamiquement un plugin de fonction de templates</p>
</div>
<div class="refsect1" title="Description">
<a name="id3017074"></a><h2>Description</h2>
...
<div class="example">
<a name="id3017108"></a><p class="title"><b>Example 13.27. Exemple avec unregister_function()</b></p>
...
<br class="example-break"><p>
   Voir aussi
   <a class="link" href="api.register.function.tpl" title="register_function()"><code class="varname">register_function()</code></a>.
  </p>
</div>
</div>
<div class="navfooter">
...
<tr>
<td width="40%" align="left" valign="top">unregister_compiler_function() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> unregister_modifier()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 0 plus 6? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/api.unregister.function.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02141 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
