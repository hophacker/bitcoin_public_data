http://www.smarty.net/docsv2/en/tips.wap.tpl
HTTP/1.1 200 OK
Date: Sat, 26 Jul 2014 13:09:11 GMT
...
<p>
    ...
    <a class="ulink" href="http://php.net/header" target="_top">Content-Type header</a>
    to be passed along
    with the template. The easist way to do this would be to write a custom
    function that prints the header. If you are using
    <a class="link" href="caching.tpl" title="Chapter 14. Caching">caching</a>, that won't
    ...
    tag; remember <code class="varname">{insert}</code> tags are not
    cached! Be sure that there is nothing output to the browser before the
    template, or else the header may fail.
   </p>
<div class="example">
<a name="id2885440"></a><p class="title"><b>Example 18.6. Using {insert} to write a WML Content-Type header</b></p>
...
<p>
     your Smarty template <span class="emphasis"><em>must</em></span> begin with the insert tag :
    </p>
<pre class="programlisting">
...
<td width="40%" align="right" valign="top"> Componentized Templates</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/tips.wap.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03648 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
