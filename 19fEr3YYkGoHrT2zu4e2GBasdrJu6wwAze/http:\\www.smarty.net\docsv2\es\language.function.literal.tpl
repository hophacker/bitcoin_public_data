http://www.smarty.net/docsv2/es/language.function.literal.tpl
HTTP/1.1 200 OK
...
<p>
   ...
   <a class="link" href="variable.left.delimiter.tpl" title="$left_delimiter">delimitadoras</a> que puedan 
   ...
   <a class="link" href="language.function.ldelim.tpl" title="{ldelim},{rdelim}">{ldelim}{rdelim}</a> para
   escapar delimitadores individuales en lugar de eso.
  </p>
<div class="example">
<a name="id3085745"></a><p class="title"><b>Example 7.15. Etiqueta literal</b></p>
...
<td width="40%" align="right" valign="top"> {php}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.function.literal.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02559 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
