http://www.smarty.net/docsv2/it/api.unregister.postfilter.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 04:12:10 GMT
...
<h2>Name</h2>
<p>unregister_postfilter</p>
</div>
<div class="refsect1">
<a name="id3147173"></a><h2></h2>
...
<td width="40%" align="right" valign="top"> unregister_prefilter</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/api.unregister.postfilter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02227 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
