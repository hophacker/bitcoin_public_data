http://www.smarty.net/docsv2/it/variable.debugging.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 12:15:47 GMT
...
<p>
       Questa variabile abilita la <a class="link" href="chapter.debugging.console.tpl" title="Chapter 10. Console di Debugging">console di debugging</a>.
       La console è una finestra javascript che vi informa sui template
       inclusi e sulle variabili valorizzate per la pagina attuale.
      </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $debug_tpl</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/variable.debugging.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02390 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
