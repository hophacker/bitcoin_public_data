http://www.smarty.net/docsv2/en/advanced.features.postfilters.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 20:07:43 GMT
...
<p>
  ...
  <a class="link" href="api.register.postfilter.tpl" title="register_postfilter()">registered</a> or loaded
...
<div class="example">
<a name="id2874088"></a><p class="title"><b>Example 15.3. Using a template postfilter</b></p>
...
<td width="40%" align="right" valign="top"> Output Filters</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/advanced.features.postfilters.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02448 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
