http://www.smarty.net/docsv2/fr/tips.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 20:08:24 GMT
...
<html lang="en">
  <head>
    ...
    <title>Chapter 18. Trucs et astuces | Smarty</title>
...
<tr><th colspan="3" align="center">Chapter 18. Trucs et astuces</th></tr>
<tr>
...
<div class="chapter" title="Chapter 18. Trucs et astuces">
<div class="titlepage"><div><div><h2 class="title">
<a name="tips"></a>Chapter 18. Trucs et astuces</h2></div></div></div>
<div class="toc">
...
<p></p>
<div class="sect1" title="Gestion des variables non-assignées">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="tips.blank.var.handling"></a>Gestion des variables non-assignées</h2></div></div></div>
<p>
   Peut-être voudrez-vous des fois afficher une valeur par
   défaut pour une variable qui n'a pas été assignée, comme
   pour afficher <code class="literal">&amp;nbsp;</code> afin que les couleurs
   de fond des tableaux fonctionnent. Beaucoup utiliseraient une
   instruction <a class="link" href="language.function.if.tpl" title="{if},{elseif},{else}"><code class="varname">{if}</code></a> 
...
<p>Les erreurs <span class="quote">“<span class="quote">de variable indéfinie</span>”</span> seront affichés si
     la fonction PHP
     <a class="ulink" href="http://php.net/error_reporting" target="_top">
      <code class="varname">error_reporting()</code></a> vaut <code class="constant">E_ALL</code>
...
<div class="example">
<a name="id3039412"></a><p class="title"><b>Example 18.1. Afficher &amp;nbsp; quand une variable est vide</b></p>
...
<br class="example-break"><p>
   Voir aussi
   <a class="link" href="language.modifier.default.tpl" title="default"><code class="varname">default</code></a> et
   <a class="link" href="tips.default.var.handling.tpl" title="Gestion des variables par défaut">la gestion des variables par défaut</a>.
  </p>
</div>
</div>
<div class="navfooter">
...
<tr>
<td width="40%" align="left" valign="top">Chapter 17. Diagnostic des erreurs </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Gestion des variables par défaut</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/tips.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02107 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
