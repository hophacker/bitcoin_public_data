http://www.smarty.net/docsv2/es/language.function.counter.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 05:33:53 GMT
...
<td>El número inicial para contar a partir de</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>1</em></span></td>
<td>El intervalo para contar</td>
</tr>
<tr>
...
<td>La dirección para contar (up/down)</td>
</tr>
<tr>
...
<td>Cuando mostrar o no el valor</td>
</tr>
<tr>
...
<td>La variable del template que va a recibir la salida</td>
</tr>
</tbody>
</table></div>
<p>
...
<div class="example">
<a name="id3094665"></a><p class="title"><b>Example 8.3. counter</b></p>
...
<td width="40%" align="right" valign="top"> cycle</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 6 plus 4? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.function.counter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03526 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
