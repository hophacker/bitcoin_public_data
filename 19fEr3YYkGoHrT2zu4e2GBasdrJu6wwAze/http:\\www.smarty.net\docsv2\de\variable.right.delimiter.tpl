http://www.smarty.net/docsv2/de/variable.right.delimiter.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 17:51:25 GMT
...
<p>
      Siehe auch <a class="link" href="variable.left.delimiter.tpl" title="$left_delimiter">$left_delimiter</a>
      und
      <a class="link" href="language.escaping.tpl" title="Smarty Parsing umgehen">escaping smarty parsing</a>.
    </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $compiler_class</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/variable.right.delimiter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02962 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
