http://www.smarty.net/docsv2/fr/language.function.eval.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 06:16:11 GMT
...
<p>
  <code class="varname">{eval}</code> évalue une variable comme si cette dernière
  était un template.
...
<p>
  Si vous définissez l'attribut <em class="parameter"><code>assign</code></em>, la sortie sera assignée à la
...
<td>Variable (ou chaîne de caractères) à évaluer</td>
</tr>
<tr>
...
<li class="listitem"><p>
   ...
   <a class="link" href="caching.tpl" title="Chapter 14. Cache">cache</a> est activé, la sortie sera placée en
...
<div class="example">
<a name="id2970013"></a><p class="title"><b>Example 8.6. {eval}</b></p>
<div class="example-contents">
<p>Le contenu du fichier de configuration, <code class="filename">setup.conf</code>.</p>
...
<a name="id2970068"></a><p class="title"><b>Example 8.7. un autre exemple avec {eval}</b></p>
<div class="example-contents">
<p>
   Ceci va afficher le nom du serveur (en majuscule) et son IP.
   La variable <em class="parameter"><code>$str</code></em> également venir d'une requête de base de données.
  </p>
<pre class="programlisting">
...
<td width="40%" align="right" valign="top"> {fetch}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/language.function.eval.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02654 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
