http://www.smarty.net/docsv2/fr/variable.force.compile.tpl
HTTP/1.1 200 OK
...
<p>
  ...
  Par défaut, il vaut <code class="constant">FALSE</code>. Ceci est commode pour le développement
  et le <a class="link" href="chapter.debugging.console.tpl" title="Chapter 10. Console de débogage">débogage</a>
  mais ne devrait jamais être utilisé dans un environnment de production.
  Si le système de <a class="link" href="variable.caching.tpl" title="$caching">cache</a> est actif, les
...
<td width="40%" align="right" valign="top"> $caching</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/variable.force.compile.tpl">
            </form>
            </div>
          </div>
