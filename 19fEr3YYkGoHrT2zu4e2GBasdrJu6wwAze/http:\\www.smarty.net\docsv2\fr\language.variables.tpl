http://www.smarty.net/docsv2/fr/language.variables.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 19:58:00 GMT
...
<p>
  ...
  comme <a class="link" href="language.syntax.attributes.tpl" title="Paramètres">arguments</a> pour les 
  <a class="link" href="language.syntax.functions.tpl" title="Fonctions">fonctions</a>
  et <a class="link" href="language.modifiers.tpl" title="Chapter 5. Modificateurs de variables">modificateurs</a>, à l'intérieur d'expressions
  conditionnelles, etc.
  Pour afficher une variable, il suffit de l'entourer par des
  <a class="link" href="variable.left.delimiter.tpl" title="$left_delimiter">délimiteurs</a> de
  telle sorte qu'elle soit la seule chose qu'ils contiennent.
  </p>
<div class="example">
<a name="id2928900"></a><p class="title"><b>Example 4.1. Exemple de variables</b></p>
...
<div class="note" title="Astuce" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Astuce</h3>
<p>La façon de la simple d'analyser les variables Smarty est
  d'utiliser la
  <a class="link" href="chapter.debugging.console.tpl" title="Chapter 10. Console de débogage">console de débogage</a>.
 </p>
</div>
<p>
 </p>
<div class="sect1" title="Variables assignées depuis PHP">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.assigned.variables"></a>Variables assignées depuis PHP</h2></div></div></div>
<p>
  Pour utiliser une variables <a class="link" href="api.assign.tpl" title="assign()">assignées</a> depuis PHP, il
  faut la préfixer par le symbole dollar <code class="literal">$</code>.
  Les variables asignées depuis un template grâce à la fonction
  <a class="link" href="language.custom.functions.tpl#language.function.assign" title="{assign}"><code class="varname">{assign}</code></a> sont
  manipulées de la même façon.
 </p>
<div class="example">
<a name="id2931836"></a><p class="title"><b>Example 4.2. Variables assignées</b></p>
...
<p>
    Où <code class="filename">index.tpl</code> est :
   </p>
<pre class="programlisting">
...
<br class="example-break"><div class="sect2" title="Tableaux associatifs">
<div class="titlepage"><div><div><h3 class="title">
<a name="language.variables.assoc.arrays"></a>Tableaux associatifs</h3></div></div></div>
<p>
...
<div class="example">
<a name="id2932523"></a><p class="title"><b>Example 4.3. Accéder aux variables de tableaux associatifs</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<div class="sect2" title="Tableaux indexés">
<div class="titlepage"><div><div><h3 class="title">
<a name="language.variables.array.indexes"></a>Tableaux indexés</h3></div></div></div>
<p>
   Vous pouvez utiliser des tableaux indexés de la même façon
   que vous le faites en PHP.
  </p>
<div class="example">
<a name="id2932597"></a><p class="title"><b>Example 4.4. Accès aux tableaux grâce à l'index</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<div class="sect2" title="Objets">
<div class="titlepage"><div><div><h3 class="title">
<a name="language.variables.objects"></a>Objets</h3></div></div></div>
<p>
   Les attributs des <a class="link" href="advanced.features.tpl#advanced.features.objects" title="Objets">objets</a> 
   assignés depuis PHP peuvent être utilisées en
   en spécifiant le nom après le symbole <code class="literal">-&gt;</code>.
  </p>
<div class="example">
<a name="id2932678"></a><p class="title"><b>Example 4.5. Accéder aux attributs des objets</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<tr>
<td width="40%" align="left" valign="top">Désactiver l'analyse de Smarty </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Variables chargées depuis des fichiers de configuration</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/language.variables.tpl">
            </form>
            </div>
          </div>
