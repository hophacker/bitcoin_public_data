http://www.smarty.net/docsv2/de/variable.secure.dir.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 21:33:31 GMT
...
<a accesskey="p" href="variable.security.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 12. Smarty Klassenvariablen (Objekteigenschaften)</th>
<td width="20%" align="right"> <a accesskey="n" href="variable.security.settings.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
    ...
    <a class="link" href="language.function.include.tpl" title="include (einbinden)">{include}</a>
    und <a class="link" href="language.function.fetch.tpl" title="{fetch}">{fetch}</a>
    verwenden diese Daten wenn
    <a class="link" href="variable.security.tpl" title="$security">$security</a> eingeschaltet ist.
  </p>
<p>
    Siehe auch
    <a class="link" href="variable.security.settings.tpl" title="$security_settings">Security settings</a>,
    und <a class="link" href="variable.trusted.dir.tpl" title="$trusted_dir">$trusted_dir</a>.
  </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="variable.security.settings.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> $security_settings</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/variable.secure.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02540 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
