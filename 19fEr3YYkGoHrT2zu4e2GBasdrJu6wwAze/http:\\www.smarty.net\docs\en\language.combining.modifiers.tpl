http://www.smarty.net/docs/en/language.combining.modifiers.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 10:40:37 GMT
...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Chapter 6. Combining Modifiers">
    <meta name="keywords" content="chapter, 6, combining, modifiers">
...
<div class="example">
<a name="idp7684592"></a><p class="title"><b>Example 6.1. combining modifiers</b></p>
...
<td width="40%" align="right" valign="top"> Chapter 7. Built-in Functions</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/language.combining.modifiers.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01726 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
