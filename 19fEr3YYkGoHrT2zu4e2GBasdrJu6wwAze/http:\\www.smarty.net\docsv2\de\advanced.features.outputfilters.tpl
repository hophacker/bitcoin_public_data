http://www.smarty.net/docsv2/de/advanced.features.outputfilters.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 19:31:27 GMT
...
<html lang="en">
  <head>
    ...
    <title>Ausgabefilter | Smarty</title>
...
<tr><th colspan="3" align="center">Ausgabefilter</th></tr>
<tr>
...
<div class="sect1" title="Ausgabefilter">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="advanced.features.outputfilters"></a>Ausgabefilter</h2></div></div></div>
<p>
...
<p>
    ...
    geladen werden. Man kann sie <a class="link" href="api.register.prefilter.tpl" title="register_prefilter ('pre'-Filter registrieren)">registrieren</a>,
    aus dem Plugin-Verzeichnis mit <a class="link" href="api.load.filter.tpl" title="load_filter">load_filter()</a> laden
    oder <a class="link" href="variable.autoload.filters.tpl" title="$autoload_filters">$autoload_filters</a> verwenden.
...
<div class="example">
<a name="id2934728"></a><p class="title"><b>Example 15.4. Ausgabefilter verwenden</b></p>
...
<tr>
<td width="40%" align="left" valign="top">Postfilter </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Cache Handler Funktion</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 6 plus 18? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/advanced.features.outputfilters.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02273 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
