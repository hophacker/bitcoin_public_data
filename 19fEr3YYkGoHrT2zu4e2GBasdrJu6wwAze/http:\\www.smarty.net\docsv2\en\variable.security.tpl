...
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 23:25:34 GMT
...
<p>
      ...
      unless specifially overridden with <a class="link" href="variable.security.settings.tpl" title="$security_settings">
      <em class="parameter"><code>$security_settings</code></em></a>:
      </p>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>If <a class="link" href="variable.php.handling.tpl" title="$php_handling"><em class="parameter"><code>$php_handling</code></em></a>
...
<li class="listitem"><p>
PHP functions are not allowed in <a class="link" href="language.function.if.tpl" title="{if},{elseif},{else}"><code class="varname">{if}</code></a> statements,
...
listed in the
<a class="link" href="variable.secure.dir.tpl" title="$secure_dir"><em class="parameter"><code>$secure_dir</code></em></a> array
</p></li>
<li class="listitem"><p>
...
array using <a class="link" href="language.function.fetch.tpl" title="{fetch}"><code class="varname">{fetch}</code></a>
</p></li>
<li class="listitem"><p>
<a class="link" href="language.function.php.tpl" title="{php}"><code class="varname">{php}{/php}</code></a> tags are not allowed
</p></li>
<li class="listitem"><p>
...
<td width="40%" align="right" valign="top"> $secure_dir</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/variable.security.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02434 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
