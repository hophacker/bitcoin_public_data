http://www.smarty.net/docsv2/en/language.function.fetch.tpl
HTTP/1.1 200 OK
...
<h3 class="title">Note</h3>
<p>
	   If template <a class="link" href="variable.security.tpl" title="$security">
	   ...
	   <a class="link" href="variable.secure.dir.tpl" title="$secure_dir">secure directories</a>.
	  </p>
</div>
<p>
  </p>
...
<div class="example">
<a name="id2821029"></a><p class="title"><b>Example 8.8. {fetch} examples</b></p>
...
<td width="40%" align="right" valign="top"> {html_checkboxes}</td>
          ...
          <div class="commentInfo">
              ...
              <div class="commentAuthor">by <b>moroz1999</b> on Nov  8, 2011 at  7:53</div>
              <div class="commentBody">Using a path, relative to a current template would make much more sense, imho.</div>
            </div>
                              </div>
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/language.function.fetch.tpl">
            </form>
            </div>
          </div>
