...
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 04:22:28 GMT
...
<p>
  ...
  level inside of <a class="link" href="api.display.tpl" title="display()"><code class="varname">display()</code></a>
  and <a class="link" href="api.fetch.tpl" title="fetch()"><code class="varname">fetch()</code></a>. When <a class="link" href="chapter.debugging.console.tpl" title="Chapter 10. Debugging Console"><em class="parameter"><code>debugging</code></em></a>
...
<td width="40%" align="right" valign="top"> $compile_id</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/variable.error.reporting.tpl">
            </form>
            </div>
          </div>
