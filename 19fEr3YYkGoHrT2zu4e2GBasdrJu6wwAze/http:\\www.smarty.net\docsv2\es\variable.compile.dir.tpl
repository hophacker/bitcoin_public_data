http://www.smarty.net/docsv2/es/variable.compile.dir.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 13:00:27 GMT
...
<p>
     ...
     están localizados, Por default están en  
     <code class="filename">"./templates_c"</code> , esto 
     significa que lo buscara en el directorio de templates en el 
     mismo directorio que esta ejecutando el script php.
     <span class="bold"><strong>Este directorio debe tener permiso de 
      escritura para el servidor web</strong></span>
     (<a class="link" href="installing.smarty.basic.tpl" title="Instalación Básica">ver la instalación</a>).
     también <a class="link" href="variable.use.sub.dirs.tpl" title="$use_sub_dirs">$use_sub_dirs</a>.

    </p>
<div class="note" title="Nota Técnica" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Nota Técnica</h3>
<p>
       Esa configuración debe ser un path relativo o un path
...
<p>
     Ver también <a class="link" href="variable.compile.id.tpl" title="$compile_id">$compile_id</a>
     y <a class="link" href="variable.use.sub.dirs.tpl" title="$use_sub_dirs">$use_sub_dirs</a>.
     </p>
</div>
<div class="navfooter">
<hr>
...
<tr>
<td width="40%" align="left" valign="top">Chapter 12. Clase Variables de Smarty </td>
...
<td width="40%" align="right" valign="top"> $config_dir</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/variable.compile.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02530 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
