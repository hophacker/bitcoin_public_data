http://www.smarty.net/docsv2/en/variable.cache.modified.check.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 04:22:41 GMT
...
<a accesskey="p" href="variable.cache.handler.func.tpl">Prev</a> </td>
...
<p>
  If set to <code class="constant">TRUE</code>, Smarty will respect the If-Modified-Since
  header sent from the client. If the cached file timestamp has
  not changed since the last visit, then a <code class="literal">'304: Not Modified'</code>
...
<p>
  ...
  and the
  <a class="link" href="caching.tpl" title="Chapter 14. Caching">caching section</a>.
  </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $config_overwrite</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 1 plus 14? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/variable.cache.modified.check.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01740 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
