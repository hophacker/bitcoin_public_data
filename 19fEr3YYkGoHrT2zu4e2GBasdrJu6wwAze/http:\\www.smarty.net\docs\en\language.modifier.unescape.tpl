...
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 23:36:10 GMT
...
<p>
     <code class="varname">unescape</code> is used to decode <code class="literal">entity</code>,
     <code class="literal">html</code> and <code class="literal">htmlall</code>. It counters the effects
     of the <a class="link" href="language.modifier.escape.tpl" title="escape">escape modifier</a> for the given types.
    </p>
...
<code class="literal">ISO-8859-1</code>, <code class="literal">UTF-8</code>,
      ...
      <code class="varname">htmlentities()</code></a>
      </td>
<td align="center"><code class="literal">UTF-8</code></td>
<td>The character set encoding passed to html_entity_decode() or htmlspecialchars_decode() or mb_convert_encoding() et. al.</td>
</tr>
</tbody>
</table></div>
<div class="example">
<a name="idp7036528"></a><p class="title"><b>Example 5.22. escape</b></p>
...
<p>
   These are example <code class="literal">unescape</code> template lines followed by the output
   </p>
<pre class="programlisting">
...
<br class="example-break"><p>
   See also
   <a class="link" href="language.escaping.tpl" title="Escaping Smarty Parsing">escaping smarty parsing</a>,
   <a class="link" href="language.modifier.escape.tpl" title="escape">escape modifier</a>.
  </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> upper</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 8 plus 3? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/language.modifier.unescape.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02284 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
