http://www.smarty.net/docsv2/de/variable.debugging.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 15:51:41 GMT
...
<td width="20%" align="right"> <a accesskey="n" href="variable.debug.tpl.tpl">Next</a>
</td>
</tr>
</table>
<hr>
...
<p>
    Aktiviert die <a class="link" href="chapter.debugging.console.tpl" title="Chapter 10. Debugging Konsole">Debugging Konsole</a>.
   </p>
<p>
    Die Konsole besteht aus einem Javascript-Popup-Fenster,
    welches Informationen über <a class="link" href="language.function.include.tpl" title="include (einbinden)">eingebundene Templates</a>,
    von PHP <a class="link" href="api.assign.tpl" title="assign">zugewiesene</a> Variablen
    und <a class="link" href="language.config.variables.tpl" title="Verwendung von Variablen aus Konfigurationsdateien">Variablen aus Konfigurationsdateien</a> enthält.
    Die Konsole zeigt keine Variablen an, die innerhalb des Templates mit
    <a class="link" href="language.custom.functions.tpl#language.function.assign" title="{assign} (zuweisen)">{assign}</a> zugewiesen wurden.
   </p>
<p>Lesen Sie <a class="link" href="variable.debugging.ctrl.tpl" title="$debugging_ctrl">$debugging_ctrl</a>
    um zu sehen wie Sie das Debugging über einen Parameter in der URL aktivieren können.
   </p>
<p>
    Siehe auch
    <a class="link" href="language.function.debug.tpl" title="{debug}">{debug}</a>,
    <a class="link" href="variable.debug.tpl.tpl" title="$debug_tpl">$debug_tpl</a>,
    und
    <a class="link" href="variable.debugging.ctrl.tpl" title="$debugging_ctrl">$debugging_ctrl</a>
   </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right"> <a accesskey="n" href="variable.debug.tpl.tpl">Next</a>
</td>
</tr>
<tr>
...
<td width="40%" align="right" valign="top"> $debug_tpl</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 20 plus 16? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="49daf18015fbdb5e39232608e7d9b3a7">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/variable.debugging.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01760 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
