http://www.smarty.net/docs/en/language.modifier.nl2br.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 21:18:53 GMT
...
<div class="example">
<a name="idp6597536"></a><p class="title"><b>Example 5.14. nl2br</b></p>
...
<td width="40%" align="right" valign="top"> regex_replace</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/language.modifier.nl2br.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01585 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
