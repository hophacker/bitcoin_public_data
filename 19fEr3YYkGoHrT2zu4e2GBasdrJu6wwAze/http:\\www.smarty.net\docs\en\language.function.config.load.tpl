http://www.smarty.net/docs/en/language.function.config.load.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 13:45:33 GMT
...
<div class="example">
<a name="idp8413696"></a><p class="title"><b>Example 7.24. {config_load}</b></p>
...
<div class="example">
<a name="idp8423104"></a><p class="title"><b>Example 7.25. function {config_load} with section</b></p>
...
<td width="40%" align="right" valign="top"> {debug}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/language.function.config.load.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01149 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
