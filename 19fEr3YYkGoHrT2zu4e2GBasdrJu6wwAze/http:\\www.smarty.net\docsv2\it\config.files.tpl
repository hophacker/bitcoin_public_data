http://www.smarty.net/docsv2/it/config.files.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 09:35:17 GMT
...
<html lang="en">
  <head>
    ...
    <title>Chapter 9. File di configurazione | Smarty</title>
...
<tr><th colspan="3" align="center">Chapter 9. File di configurazione</th></tr>
<tr>
...
<div class="chapter" title="Chapter 9. File di configurazione">
<div class="titlepage"><div><div><h2 class="title">
<a name="config.files"></a>Chapter 9. File di configurazione</h2></div></div></div>
<p>
...
<div class="example">
<a name="id3133133"></a><p class="title"><b>Example 9.1. Esempio di sintassi di file di configurazione</b></p>
...
<br class="example-break"><p>
  ...
  (<code class="literal">#</code>) all'inizio della riga.
 </p>
<p>
  ...
  stringhe dal contenuto arbitrario, purché non comprenda <code class="literal">[</code>
  o  <code class="literal">]</code>. Le quattro variabili in alto sono variabili globali,
...
<p>
  ...
  <span class="command"><strong>config_load</strong></span>.
 </p>
<p>
...
<td width="40%" align="right" valign="top"> Chapter 10. Console di Debugging</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/config.files.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02286 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
