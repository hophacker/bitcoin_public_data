http://www.smarty.net/docsv2/en/api.register.resource.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 03:57:08 GMT
...
<html lang="en">
  <head>
    ...
    <title>register_resource() | Smarty</title>
...
<tr><th colspan="3" align="center">register_resource()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.register.prefilter.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty Class Methods()</th>
<td width="20%" align="right"> <a accesskey="n" href="api.trigger.error.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="register_resource()">
<a name="api.register.resource"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>register_resource() — dynamically register resources</p>
</div>
<div class="refsect1" title="Description">
<a name="id2860256"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">register_resource</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">name</span></span>,<br>                       <span class="methodparam"><span class="type">array </span><span class="parameter">resource_funcs</span></span>);</code><p>
   Use this to dynamically register a
   <a class="link" href="template.resources.tpl" title="Resources">resource plugin</a>
   with Smarty.
   Pass in the <em class="parameter"><code>name</code></em> of the resource and the array of
   PHP functions implementing it. See
   <a class="link" href="template.resources.tpl" title="Resources">template resources</a>
...
<li class="listitem"><p>
   The php-function-array <em class="parameter"><code>resource_funcs</code></em>
   must have 4 or 5 elements.
   </p></li>
<li class="listitem"><p>
   With 4 elements the elements are
   the functions-callbacks for the respective <code class="literal">source</code>,
   <code class="literal">timestamp</code>, <code class="literal">secure</code> and
   <code class="literal">trusted</code> functions of the resource.
   </p></li>
<li class="listitem"><p>
   ...
   to be the method names implementing <code class="literal">source</code>,
   <code class="literal">timestamp</code>, <code class="literal">secure</code>
   and <code class="literal">trusted</code>.
  </p></li>
</ul></div>
<div class="example">
<a name="id2861355"></a><p class="title"><b>Example 13.25. register_resource()</b></p>
...
<br class="example-break"><p>
  See also
  <a class="link" href="api.unregister.resource.tpl" title="unregister_resource()"><code class="varname">unregister_resource()</code></a>
  and the
  <a class="link" href="template.resources.tpl" title="Resources">template resources</a> section.
</p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right"> <a accesskey="n" href="api.trigger.error.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">register_prefilter() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> trigger_error()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 19 plus 9? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="3fb4265a038a8173ccf0ff26edb53fb7">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/api.register.resource.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03215 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
