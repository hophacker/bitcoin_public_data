http://www.smarty.net/docsv2/en/api.clear.all.cache.tpl
HTTP/1.1 200 OK
...
<a name="id2851689"></a><h2>Description</h2>
...
<div class="example">
<a name="id2851723"></a><p class="title"><b>Example 13.6. clear_all_cache</b></p>
...
<br class="example-break"><p>
  ...
  <a class="link" href="api.is.cached.tpl" title="is_cached()"><code class="varname">is_cached()</code></a>
  and the
  <a class="link" href="caching.tpl" title="Chapter 14. Caching">caching</a> page.
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> clear_assign()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/api.clear.all.cache.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01640 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
