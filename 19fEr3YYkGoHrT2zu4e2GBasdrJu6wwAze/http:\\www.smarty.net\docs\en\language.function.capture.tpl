...
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 23:25:16 GMT
...
<p>
   <code class="varname">{capture}</code> is used to collect the output of the template between the
   tags into a  variable instead of displaying it. Any content between
   <code class="varname">{capture name='foo'}</code> and <code class="varname">{/capture}</code> is collected
   into the variable specified  in the <em class="parameter"><code>name</code></em> attribute.
   </p>
<p>The captured content can be used in the
   template from the variable <a class="link" href="language.variables.smarty.tpl#language.variables.smarty.capture" title="{$smarty.capture}"><em class="parameter"><code>$smarty.capture.foo</code></em></a>
   where <span class="quote">“<span class="quote">foo</span>”</span> is the value passed in the <em class="parameter"><code>name</code></em> attribute.
   If you do not supply the <em class="parameter"><code>name</code></em> attribute, then <span class="quote">“<span class="quote">default</span>”</span> will
   be used as the name ie <em class="parameter"><code>$smarty.capture.default</code></em>.
   </p>
<p><code class="varname">{capture}'s</code> can be nested.
   </p>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>The name of an array variable where to append the captured output to</td>
</tr>
</tbody>
</table></div>
...
<p>
   Be careful when capturing <a class="link" href="language.function.insert.tpl" title="{insert}"><code class="varname">{insert}</code></a>
   output. If you have
   <a class="link" href="caching.tpl" title="Chapter 15. Caching"><em class="parameter"><code>$caching</code></em></a>
...
<div class="example">
<a name="idp8324208"></a><p class="title"><b>Example 7.21. {capture} with the name attribute</b></p>
...
<div class="example">
<a name="idp8325664"></a><p class="title"><b>Example 7.22. {capture} into a template variable</b></p>
...
<div class="example">
<a name="idp8328128"></a><p class="title"><b>Example 7.23. {capture} into a template array variable</b></p>
<div class="example-contents">
<p>
...
<p>
  ...
  and <a class="link" href="language.function.assign.tpl" title="{assign}"><code class="varname">{assign}</code></a>.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> {config_load}</td>
          ...
          <div class="commentInfo">
              ...
              <div class="commentAuthor">by <b>Max-P</b> on Jun 18, 2012 at  7:21</div>
              <div class="commentBody">Just a quick note because I searched for it for a loooong time.

The {capture} block is being &quot;executed&quot; before it is captured and put into the {$smarty.capture.xxx} variable.Therefore, if you try to use it in a loop it will fail.

Instead of that, one can use {function} to keep the block inside the same template file, or {include} if it is large enought to put it in another template file ;)</div>
            </div>
                              </div>
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="1a8fb73433541d297ff68b9fd672ca46">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/language.function.capture.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02643 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
