http://www.smarty.net/docsv2/de/variable.compile.dir.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 14:31:00 GMT
...
<p>
    ...
    werden. Normalerweise lautet es <code class="filename">"./templates_c"</code>.
...
<p>
     Siehe auch <a class="link" href="variable.compile.id.tpl" title="$compile_id">$compile_id</a>
     und
...
<tr>
<td width="40%" align="left" valign="top">Chapter 12. Smarty Klassenvariablen (Objekteigenschaften) </td>
...
<td width="40%" align="right" valign="top"> $config_dir</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 1 plus 20? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/variable.compile.dir.tpl">
            </form>
            </div>
          </div>
