http://www.smarty.net/docsv2/es/api.clear.all.assign.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 13:00:30 GMT
...
<html lang="en">
  <head>
    ...
    <title>clear_all_assign() | Smarty</title>
...
<tr><th colspan="3" align="center">clear_all_assign()</th></tr>
<tr>
...
<div class="refentry" title="clear_all_assign()">
<a name="api.clear.all.assign"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>clear_all_assign() — &gt;limpia el valor de todas las variables asignadas</p>
</div>
<div class="refsect1" title="Descripción">
<a name="id3127126"></a><h2>Descripción</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">clear_all_assign</span>();</code><div class="example">
<a name="id3127141"></a><p class="title"><b>Example 13.5. clear_all_assign()</b></p>
...
<br class="example-break"><p>
    ...
    <a class="link" href="api.clear.config.tpl" title="clear_config()">clear_config()</a>,
    <a class="link" href="api.assign.tpl" title="assign()">assign()</a>
    y <a class="link" href="api.append.tpl" title="append()">append()</a>
    </p>
</div>
</div>
<div class="navfooter">
...
<tr>
<td width="40%" align="left" valign="top">assign_by_ref </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> clear_all_cache</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 3 plus 10? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/api.clear.all.assign.tpl">
            </form>
            </div>
          </div>
