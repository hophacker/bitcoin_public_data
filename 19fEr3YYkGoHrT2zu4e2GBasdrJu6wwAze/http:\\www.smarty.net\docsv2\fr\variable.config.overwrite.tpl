http://www.smarty.net/docsv2/fr/variable.config.overwrite.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 13:24:22 GMT
...
<p>
  Si cette variable est à <code class="constant">TRUE</code> (par défaut), les variables lues dans les
  <a class="link" href="config.files.tpl" title="Chapter 9. Fichiers de configuration">fichiers de configuration</a>
...
<div class="example">
<a name="id2997826"></a><p class="title"><b>Example 12.4. Tableau de variables de configuration</b></p>
...
<p>
   ...
   avec <em class="parameter"><code>$config_overwrite</code></em> = <code class="constant">FALSE</code>.
  </p>
...
<br class="example-break"><p>
  ...
  <a class="link" href="api.config.load.tpl" title="config_load()"><code class="varname">config_load()</code></a> et
...
<td width="40%" align="right" valign="top"> $config_booleanize</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/variable.config.overwrite.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02166 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
