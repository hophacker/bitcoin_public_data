...
<div class="example">
<a name="id2792120"></a><p class="title"><b>Example 5.15. regex_replace</b></p>
...
<br class="example-break"><p>
   See also <a class="link" href="language.modifier.replace.tpl" title="replace">
...
<td width="40%" align="right" valign="top"> replace</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/language.modifier.regex.replace.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03015 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
