http://www.smarty.net/docsv2/fr/variable.secure.dir.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 11:41:20 GMT
...
<p>
  Il s'agit d'un tableau contenant tous les fichiers et répertoires locaux qui sont
  ...
  <a class="link" href="language.function.fetch.tpl" title="{fetch}"><code class="varname">{fetch}</code></a> l'utilisent quand
  la <a class="link" href="variable.security.tpl" title="$security">sécurité</a> est activée.
 </p>
<div class="example">
<a name="id2998931"></a><p class="title"><b>Example 12.5. Exemple avec $secure_dir</b></p>
...
<br class="example-break"><p>
  Voir aussi
  la <a class="link" href="variable.security.settings.tpl" title="$security_settings">configuration pour la sécurité</a>et
...
<td width="40%" align="right" valign="top"> $security_settings</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 14 plus 5? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/variable.secure.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03077 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
