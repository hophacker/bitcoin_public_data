http://www.smarty.net/docsv2/es/api.assign.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 08:25:31 GMT
...
<h2>Name</h2>
<p>assign() — pasando valores para el template</p>
</div>
<div class="refsect1" title="Descripción">
<a name="id3126005"></a><h2>Descripción</h2>
...
<div class="example">
<a name="id3126371"></a><p class="title"><b>Example 13.3. assign()</b></p>
...
<p>
 Vea también <a class="link" href="api.assign.by.ref.tpl" title="assign_by_ref">assign_by_ref()</a>,
...
<td width="40%" align="right" valign="top"> assign_by_ref</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/api.assign.tpl">
            </form>
            </div>
          </div>
