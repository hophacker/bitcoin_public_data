http://www.smarty.net/docsv2/de/api.register.outputfilter.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 07:37:23 GMT
...
<html lang="en">
  <head>
    ...
    <title>register_outputfilter (Ausgabefilter registrieren) | Smarty</title>
...
<tr><th colspan="3" align="center">register_outputfilter (Ausgabefilter registrieren)</th></tr>
<tr>
...
<div class="refentry" title="register_outputfilter (Ausgabefilter registrieren)">
<a name="api.register.outputfilter"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>register_outputfilter (Ausgabefilter registrieren)</p>
</div>
<div class="refsect1">
<a name="id2923302"></a><h2></h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">register_outputfilter</span>(<span class="methodparam"><span class="type">mixed </span><span class="parameter">function</span></span>);</code><p>
  ...
  den Abschnitt über <a class="link" href="advanced.features.outputfilters.tpl" title="Ausgabefilter">Ausgabefilter</a>
  für mehr Informationen.
  </p>
<p>
   Der Parameter <em class="parameter"><code>function</code></em> kann als (a) einen Funktionnamen oder (b) einem Array der Form <code class="literal">array(&amp;$object, $method)</code>,
...
<td width="40%" align="right" valign="top"> register_postfilter ('post'-Filter registrieren)</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/api.register.outputfilter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02104 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
