HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 15:15:48 GMT
...
<h2>Name</h2>
<p>setTemplateDir() — set the directories where templates are stored</p>
</div>
<div class="refsect1" title="Description">
<a name="idp16966320"></a><h2>Description</h2>
...
<a name="idp17023264"></a><p class="title"><b>Example 14.47. setTemplateDir()</b></p>
...
<td width="40%" align="right" valign="top"> templateExists()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/api.set.template.dir.tpl">
            </form>
            </div>
          </div>
