...
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 13:25:10 GMT
...
<h2>Name</h2>
<p>unregisterFilter() — dynamically unregister a filter</p>
</div>
<div class="refsect1" title="Description">
<a name="idp17063744"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">unregisterFilter</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">type</span></span>,<br>                      <span class="methodparam"><span class="type">string|array </span><span class="parameter">callback</span></span>);</code><p>
   Use this to dynamically unregister filters.
...
<td width="40%" align="right" valign="top"> unregisterPlugin</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/api.unregister.filter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02123 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
