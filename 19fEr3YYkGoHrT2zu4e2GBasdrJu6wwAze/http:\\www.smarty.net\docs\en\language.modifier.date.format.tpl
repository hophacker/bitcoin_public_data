...
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 08:26:22 GMT
...
<div class="example">
<a name="idp6286592"></a><p class="title"><b>Example 5.8. date_format</b></p>
...
<td width="40%" align="right" valign="top"> default</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/language.modifier.date.format.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03653 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
