http://www.smarty.net/docsv2/it/api.clear.all.cache.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 05:33:43 GMT
...
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">clear_all_cache</span>(<span class="methodparam"><span class="type">int </span><span class="parameter">expire_time</span></span>);</code><p>
   ...
   potete fornire un'età minima in secondi che i file della 
   cache devono avere prima di essere eliminati.
  </p>
<div class="example">
<a name="id3140919"></a><p class="title"><b>Example 13.6. clear_all_cache</b></p>
...
<td width="40%" align="right" valign="top"> clear_assign</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/api.clear.all.cache.tpl">
            </form>
            </div>
          </div>
