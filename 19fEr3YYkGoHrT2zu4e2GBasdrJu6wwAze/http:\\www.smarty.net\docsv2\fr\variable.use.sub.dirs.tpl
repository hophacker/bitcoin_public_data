http://www.smarty.net/docsv2/fr/variable.use.sub.dirs.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 12:22:55 GMT
...
<p>
  ...
  <a class="link" href="variable.compile.dir.tpl" title="$compile_dir">templates_c</a> et
  <a class="link" href="variable.cache.dir.tpl" title="$cache_dir">cache</a>
  si la variable <em class="parameter"><code>$use_sub_dirs</code></em> est défini à <code class="constant">TRUE</code> (Par défaut, vaut <code class="constant">FALSE</code>).
...
<li class="listitem"><p><code class="literal">$use_sub_dirs=true</code> ne fonctionne pas avec
     <a class="ulink" href="http://php.net/features.safe-mode" target="_top">safe_mode=On</a>,
     raison pour laquelle c'est paramétrable et que c'est désactivé par défaut.
    </p></li>
<li class="listitem"><p><code class="literal">$use_sub_dirs=true</code> sous Windows peut causer des problèmes.</p></li>
<li class="listitem"><p>Safe_mode est obsolète depuis PHP6.</p></li>
</ul></div>
</div>
<p>
  Voir aussi
  <a class="link" href="variable.compile.id.tpl" title="$compile_id"><em class="parameter"><code>$compile_id</code></em></a>,
  <a class="link" href="variable.cache.dir.tpl" title="$cache_dir"><em class="parameter"><code>$cache_dir</code></em></a> et
...
<td width="40%" align="right" valign="top"> $default_modifiers</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 11 plus 20? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="f1872dff6a210e7cdae21904ca5ad59f">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/variable.use.sub.dirs.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02580 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
