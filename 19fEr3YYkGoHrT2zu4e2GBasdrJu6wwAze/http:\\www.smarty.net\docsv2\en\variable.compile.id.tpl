http://www.smarty.net/docsv2/en/variable.compile.id.tpl
HTTP/1.1 200 OK
...
<p>
  ...
  for different <a class="link" href="api.variables.tpl#variable.template.dir" title="$template_dir">
  <em class="parameter"><code>$template_dirs</code></em></a>.  If you set a distinct
  <em class="parameter"><code>$compile_id</code></em> for each
  <a class="link" href="api.variables.tpl#variable.template.dir" title="$template_dir"><em class="parameter"><code>$template_dir</code></em>
...
<p>
  ...
  <a class="link" href="plugins.prefilters.postfilters.tpl" title="Prefilters/Postfilters">prefilter</a>
...
<div class="example">
<a name="id2846531"></a><p class="title"><b>Example 12.6. $compile_id in a virtual host enviroment</b></p>
...
<td width="40%" align="right" valign="top"> $use_sub_dirs</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/variable.compile.id.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02063 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
