...
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 13:00:47 GMT
...
<h2>Name</h2>
<p>unregisterPlugin — dynamically unregister plugins</p>
</div>
<div class="refsect1" title="Description">
<a name="idp17096384"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">unregisterPlugin</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">type</span></span>,<br>                      <span class="methodparam"><span class="type">string </span><span class="parameter">name</span></span>);</code><p>
   This method unregisters plugins which previously have been registered by <a class="link" href="api.register.plugin.tpl" title="registerPlugin()">registerPlugin()</a>,
...
<div class="example">
<a name="idp17159936"></a><p class="title"><b>Example 14.50. unregister function plugin</b></p>
...
<br class="example-break"><p>
  See also <a class="link" href="api.register.plugin.tpl" title="registerPlugin()">
...
<td width="40%" align="right" valign="top"> unregisterObject()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 5 plus 4? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/api.unregister.plugin.tpl">
            </form>
            </div>
          </div>
