http://www.smarty.net/docsv2/es/language.syntax.attributes.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 12:23:03 GMT
...
<tr><th colspan="3" align="center">Atributos</th></tr>
<tr>
...
<div class="sect1" title="Atributos">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.syntax.attributes"></a>Atributos</h2></div></div></div>
<p>
  La mayoria de las <a class="link" href="language.syntax.functions.tpl" title="Funciones">funciones</a> 
...
<p>
   ...
   <code class="literal">true</code>, <code class="literal">on</code>, y 
   <code class="literal">yes</code>, o <code class="literal">false</code>, 
   <code class="literal">off</code>, y <code class="literal">no</code>.
 </p>
<div class="example">
<a name="id3065374"></a><p class="title"><b>Example 3.4. Sintaxis de atributos de Funciones</b></p>
...
<tr>
<td width="40%" align="left" valign="top">Funciones </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Colocando variables entre comillas dobles</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 2 plus 3? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="b935fb24b7de5531c1d1fd626890a995">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.syntax.attributes.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02038 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
