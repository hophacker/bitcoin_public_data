http://www.smarty.net/docsv2/es/advanced.features.prefilters.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 00:17:07 GMT
...
<p>
     ...
     <a class="link" href="api.register.prefilter.tpl" title="register_prefilter()">registrado</a>
     o cargado del directorio de plugins usando la función
     <a class="link" href="api.load.filter.tpl" title="load_filter()">load_filter()</a> o por la
...
<div class="example">
<a name="id3147296"></a><p class="title"><b>Example 15.2. usando un prefiltro prefilter de template</b></p>
...
<tr>
<td width="40%" align="left" valign="top">Chapter 15. Caracteristicas Avanzadas </td>
...
<td width="40%" align="right" valign="top"> Postfilters</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 18 plus 16? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/advanced.features.prefilters.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03413 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
