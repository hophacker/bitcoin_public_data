http://www.smarty.net/docs/en/troubleshooting.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 14:43:39 GMT
...
<html lang="en">
  <head>
    ...
    <title>Chapter 20. Troubleshooting | Smarty</title>
    <meta name="description" content="Chapter 20. Troubleshooting">
    <meta name="keywords" content="chapter, 20, troubleshooting">
...
<dl><dt><span class="sect1"><a href="troubleshooting.tpl#smarty.php.errors">Smarty/PHP errors</a></span></dt></dl>
</div>
<p></p>
...
<div class="example">
<a name="idp20238848"></a><p class="title"><b>Example 20.1. Smarty errors</b></p>
...
<div class="example">
<a name="idp20258816"></a><p class="title"><b>Example 20.2. PHP parsing errors</b></p>
<div class="example-contents"><pre class="screen">
...
<br class="example-break"><p>
    ...
    <a class="link" href="language.function.if.tpl" title="{if},{elseif},{else}"><code class="varname">{if}{/if}</code></a> or
...
<div class="example">
<a name="idp20293680"></a><p class="title"><b>Example 20.3. Other common errors</b></p>
...
<li class="listitem"><p>
      The <a class="link" href="variable.template.dir.tpl" title="$template_dir">
...
<li class="listitem"><p>
        A <a class="link" href="language.function.config.load.tpl" title="{config_load}">
...
<div class="itemizedlist"><ul class="itemizedlist" type="disc"><li class="listitem"><p>
    The <a class="link" href="variable.compile.dir.tpl" title="$compile_dir">
   <em class="parameter"><code>$compile_dir</code></em></a> is not writable by the web server.
   See the bottom of the
    <a class="link" href="installing.smarty.basic.tpl" title="Basic Installation">installing smarty</a> page
...
<div class="itemizedlist"><ul class="itemizedlist" type="disc"><li class="listitem"><p>
    This means that
    <a class="link" href="variable.caching.tpl" title="$caching"><em class="parameter"><code>$caching</code></em></a> is
    enabled and the <a class="link" href="variable.cache.dir.tpl" title="$cache_dir">
...
<div class="itemizedlist"><ul class="itemizedlist" type="disc"><li class="listitem"><p>
      ...
      error handler, please call <a class="link" href="api.mute.expected.errors.tpl" title="Smarty::muteExpectedErrors()"><code class="varname">muteExpectedErrors()</code></a> after you've registered your 
...
<td width="40%" align="right" valign="top"> Chapter 21. Tips &amp; Tricks</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/troubleshooting.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02361 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
