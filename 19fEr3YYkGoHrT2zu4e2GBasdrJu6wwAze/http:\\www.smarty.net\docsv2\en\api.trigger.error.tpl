http://www.smarty.net/docsv2/en/api.trigger.error.tpl
HTTP/1.1 200 OK
...
<a name="id2860641"></a><h2>Description</h2>
...
<p>
    ...
    and
    <a class="link" href="troubleshooting.tpl#smarty.php.errors" title="Smarty/PHP errors">troubleshooting</a>.
 </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> template_exists()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/api.trigger.error.tpl">
            </form>
            </div>
          </div>
