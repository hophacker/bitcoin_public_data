http://www.smarty.net/docsv2/it/section.template.cache.handler.func.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 04:22:05 GMT
...
<html lang="en">
  <head>
    ...
    <title>Funzione di gestione della Cache | Smarty</title>
...
<tr><th colspan="3" align="center">Funzione di gestione della Cache</th></tr>
<tr>
...
<div class="sect1" title="Funzione di gestione della Cache">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="section.template.cache.handler.func"></a>Funzione di gestione della Cache</h2></div></div></div>
<p>
...
<p>
    ...
    di classe <a class="link" href="variable.cache.handler.func.tpl" title="$cache_handler_func">$cache_handler_func</a>.
...
<div class="example">
<a name="id3156292"></a><p class="title"><b>Example 15.5. esempio con l'uso di MySQL per la cache</b></p>
...
<td width="40%" align="right" valign="top"> Risorse</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/section.template.cache.handler.func.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02209 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
