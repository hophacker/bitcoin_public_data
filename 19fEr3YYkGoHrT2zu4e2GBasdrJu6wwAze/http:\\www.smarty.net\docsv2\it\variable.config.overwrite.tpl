http://www.smarty.net/docsv2/it/variable.config.overwrite.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 03:42:01 GMT
...
<p>
       Se è impostato a true, le variabili lette dai file di configurazione si
       sovrascriveranno l'una con l'altra. Diversamente, verranno messe in un 
       array. E' utile se volete memorizzare array di dati nei file di configurazione,
       è sufficiente elencare più volte ogni elemento. true per default.
      </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $config_booleanize</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/variable.config.overwrite.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02754 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
