...
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 07:20:52 GMT
...
<html lang="en">
  <head>
    ...
    <title>Template Inheritance | Smarty</title>
    <meta name="description" content="Template Inheritance">
    <meta name="keywords" content="template, inheritance">
...
<li class="listitem"><p>
      The child templates can not define any content besides what's inside <a class="link" href="language.function.block.tpl" title="{block}"><code class="varname">{block}</code></a>
      tags they override. Anything outside of <a class="link" href="language.function.block.tpl" title="{block}"><code class="varname">{block}</code></a> tags will be removed.
    </p></li>
<li class="listitem"><p>
      The content of <a class="link" href="language.function.block.tpl" title="{block}"><code class="varname">{block}</code></a> tags from child and parent templates can be merged by 
      the <code class="literal">append</code> or <code class="literal">prepend</code> <a class="link" href="language.function.block.tpl" title="{block}"><code class="varname">{block}</code></a>
...
<li class="listitem"><p>
      ...
      solutions based on subtemplates included with the <a class="link" href="language.function.include.tpl" title="{include}"><code class="varname">{include}</code></a>
      tag it does have much better performance when rendering.
    </p></li>
<li class="listitem"><p>
      The child template extends its parent defined with the <a class="link" href="language.function.extends.tpl" title="{extends}"><code class="varname">{extends}</code></a> tag, 
      which must be the first line in the child template. Instead of using the <a class="link" href="language.function.extends.tpl" title="{extends}"><code class="varname">{extends}</code></a>
      tags in the template files you can define the whole template inheritance tree in the PHP script when you are calling <a class="link" href="api.fetch.tpl" title="fetch()"><code class="varname">fetch()</code></a>
      or <a class="link" href="api.display.tpl" title="display()"><code class="varname">display()</code></a> with the <code class="literal">extends:</code> template resource type. The later provides even more flexibillity.
    </p></li>
</ul></div>
...
<h3 class="title">Note</h3>
<p>
    If you have a subtemplate which is included with <a class="link" href="language.function.include.tpl" title="{include}"><code class="varname">{include}</code></a> and it contains 
    <a class="link" href="language.function.block.tpl" title="{block}"><code class="varname">{block}</code></a> areas it works only if the <a class="link" href="language.function.include.tpl" title="{include}"><code class="varname">{include}</code></a>
    itself is called from within a surrounding  <a class="link" href="language.function.block.tpl" title="{block}"><code class="varname">{block}</code></a>. In the final parent template you may need a dummy <a class="link" href="language.function.block.tpl" title="{block}"><code class="varname">{block}</code></a> for it.
  </p>
</div>
<div class="example">
<a name="idp19254320"></a><p class="title"><b>Example 17.6. Template inheritance example</b></p>
...
<a name="idp19262112"></a><p class="title"><b>Example 17.7. Template inheritance by template resource <code class="literal">extends:</code></b></p>
<div class="example-contents">
<p>
      Instead of using <a class="link" href="language.function.extends.tpl" title="{extends}"><code class="varname">{extends}</code></a> tags in the template
      files you can define the inheritance tree in your PHP script by using the 
      <a class="link" href="resources.extends.tpl" title="Extends Template Resources"><code class="literal">extends:</code> resource</a> type.
    </p>
<p>
...
<br class="example-break"><p>
  ...
  <a class="link" href="language.function.block.tpl" title="{block}"><code class="varname">{block}</code></a>,
   ...
   and  <a class="link" href="resources.extends.tpl" title="Extends Template Resources"><code class="literal">extends:</code> resource</a>
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> Streams</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/advanced.features.template.inheritance.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02026 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
