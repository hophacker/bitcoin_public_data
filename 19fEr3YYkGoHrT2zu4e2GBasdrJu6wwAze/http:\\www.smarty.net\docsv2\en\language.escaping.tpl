...
<html lang="en">
  <head>
    ...
    <title>Escaping Smarty Parsing | Smarty</title>
...
<tr><th colspan="3" align="center">Escaping Smarty Parsing</th></tr>
<tr>
...
<a name="language.escaping"></a>Escaping Smarty Parsing</h2></div></div></div>
<p>
  ...
  <a class="link" href="language.function.ldelim.tpl" title="{ldelim},{rdelim}">delimiters</a> for Smarty.
 </p>
<p>
...
<p>
  Including literal content is possible using <a class="link" href="language.function.literal.tpl" title="{literal}">
  <code class="varname">{literal}..{/literal}</code></a> blocks.
  Similar to HTML entity usage, you can use <a class="link" href="language.function.ldelim.tpl" title="{ldelim},{rdelim}"><code class="varname">{ldelim}</code></a>,<a class="link" href="language.function.ldelim.tpl" title="{ldelim},{rdelim}"><code class="varname">{rdelim}</code></a> or <a class="link" href="language.variables.smarty.tpl#language.variables.smarty.ldelim" title="{$smarty.ldelim}, {$smarty.rdelim}">
  <code class="varname">{$smarty.ldelim}</code></a> to display the current delimiters.
 </p>
<p>
  It is often convenient to simply change Smarty's <a class="link" href="variable.left.delimiter.tpl" title="$left_delimiter">
  <em class="parameter"><code>$left_delimiter</code></em></a> and
  <a class="link" href="variable.right.delimiter.tpl" title="$right_delimiter">
  <em class="parameter"><code>$right_delimiter</code></em></a>.
 </p>
<div class="example">
<a name="id2782641"></a><p class="title"><b>Example 3.8. changing delimiters example</b></p>
...
<td width="40%" align="right" valign="top"> Chapter 4. Variables</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/language.escaping.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02394 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
