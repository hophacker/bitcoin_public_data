http://www.smarty.net/docs/en/language.modifier.count.characters.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 11:40:53 GMT
...
<td>This determines whether or not to include
      whitespace characters in the count.</td>
</tr></tbody>
</table></div>
<div class="example">
<a name="idp6168768"></a><p class="title"><b>Example 5.4. count_characters</b></p>
...
<br class="example-break"><p>
   ...
   <a class="link" href="language.modifier.count.sentences.tpl" title="count_sentences"><code class="varname">count_sentences</code></a> and
...
<td width="40%" align="right" valign="top"> count_paragraphs</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/language.modifier.count.characters.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02288 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
