HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 15:25:56 GMT
...
<p>
	   ...
	   sobre quando este cache em particular expira. Veja também <a class="link" href="api.is.cached.tpl" title="is_cached">is_cached</a>.
      </p>
<p>
...
<td width="40%" align="right" valign="top"> $cache_dir</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/variable.caching.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.20569 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
