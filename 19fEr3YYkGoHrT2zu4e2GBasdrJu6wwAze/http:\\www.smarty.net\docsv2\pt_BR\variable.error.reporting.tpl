http://www.smarty.net/docsv2/pt_BR/variable.error.reporting.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 23:36:43 GMT
...
<a accesskey="p" href="variable.request.use.auto.globals.tpl">Prev</a> </td>
...
<p>
  ...
  <a class="ulink" href="http://php.net/error_reporting" target="_top">error_reporting</a>
  do php dentro de <a class="link" href="api.display.tpl" title="display">display()</a>
  e <a class="link" href="api.fetch.tpl" title="fetch">fetch()</a>. Quando <a class="link" href="chapter.debugging.console.tpl" title="Chapter 10. Debugging Console">debugging</a> esta ativado este valor
  é ignorado e o nível de erro é mantido intocado.
 </p>
<p>
  Veja também
  <a class="link" href="api.trigger.error.tpl" title="trigger_error">trigger_error()</a>,
  <a class="link" href="chapter.debugging.console.tpl" title="Chapter 10. Debugging Console">debugging</a>
  e
  <a class="link" href="troubleshooting.tpl" title="Chapter 17. Localização de Erros">Troubleshooting</a>.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $compile_id</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/variable.error.reporting.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01517 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
