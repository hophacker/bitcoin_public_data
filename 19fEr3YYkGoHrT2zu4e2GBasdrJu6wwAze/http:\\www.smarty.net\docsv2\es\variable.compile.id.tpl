http://www.smarty.net/docsv2/es/variable.compile.id.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 09:16:48 GMT
...
<p>
  ...
  <a class="link" href="plugins.prefilters.postfilters.tpl" title="Prefiltros/Postfiltros">prefilter</a>
...
<div class="example">
<a name="id3123076"></a><p class="title"><b>Example 12.3. $compile_id</b></p>
...
<td width="40%" align="right" valign="top"> $use_sub_dirs</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/variable.compile.id.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02748 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
