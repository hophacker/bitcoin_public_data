http://www.smarty.net/docs/en/advanced.features.prefilters.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 23:25:13 GMT
...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Prefilters">
    <meta name="keywords" content="prefilters">
...
<p>
  Prefilters can be either <a class="link" href="api.register.filter.tpl" title="registerFilter()">registered</a> or loaded from
  the <a class="link" href="variable.plugins.dir.tpl" title="$plugins_dir">plugins directory</a>
  by using <a class="link" href="api.load.filter.tpl" title="loadFilter()"><code class="varname">loadFilter()</code></a> function or
...
<div class="example">
<a name="idp19405328"></a><p class="title"><b>Example 17.11. Using a template prefilter</b></p>
...
<tr>
<td width="40%" align="left" valign="top">Static Classes </td>
...
<td width="40%" align="right" valign="top"> Postfilters</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/advanced.features.prefilters.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01861 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
