http://www.smarty.net/docsv2/en/variable.right.delimiter.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 15:02:09 GMT
...
<p>
  ...
  Default is <code class="literal">}</code>.
 </p>
<p>
  See also <a class="link" href="variable.left.delimiter.tpl" title="$left_delimiter"><em class="parameter"><code>$left_delimiter</code></em></a>
    and
...
<td width="40%" align="right" valign="top"> $compiler_class</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/variable.right.delimiter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02525 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
