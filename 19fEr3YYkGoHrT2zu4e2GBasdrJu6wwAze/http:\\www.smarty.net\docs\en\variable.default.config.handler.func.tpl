http://www.smarty.net/docs/en/variable.default.config.handler.func.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 22:10:42 GMT
...
<div class="example">
<a name="idp14475392"></a><p class="title"><b>Example 13.4. $default_config_handler_func</b></p>
...
<td width="40%" align="right" valign="top"> $default_template_handler_func</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/variable.default.config.handler.func.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02305 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
