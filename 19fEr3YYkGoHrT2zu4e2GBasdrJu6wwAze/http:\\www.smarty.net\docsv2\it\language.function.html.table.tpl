http://www.smarty.net/docsv2/it/language.function.html.table.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 11:41:50 GMT
...
<td>array di dati da visualizzare nella tabella</td>
</tr>
<tr>
...
<td>numero di colonne della tabella</td>
</tr>
<tr>
...
<td>attributi per il tag table</td>
</tr>
<tr>
<td align="center">tr_attr</td>
<td align="center">stringa</td>
<td align="center">no</td>
<td align="center"><span class="emphasis"><em>vuoto</em></span></td>
<td>attributi per i tag tr (gli array vengono alternati)</td>
</tr>
<tr>
...
<td align="center">no</td>
<td align="center"><span class="emphasis"><em>vuoto</em></span></td>
<td>attributi per i tag td (gli array vengono alternati)</td>
</tr>
<tr>
...
<td>valore per le celle aggiuntive dell'ultima riga,
                                se presenti</td>
</tr>
<tr>
...
<td>direzione di riempimento delle righe. Valori possibili: <span class="emphasis"><em>left</em></span>/<span class="emphasis"><em>right</em></span>
</td>
</tr>
<tr>
...
<td>direzione di riempimento delle colonne. Valori possibili: <span class="emphasis"><em>up</em></span>/<span class="emphasis"><em>down</em></span>
</td>
</tr>
</tbody>
</table></div>
<p>
			<span class="emphasis"><em>html_table</em></span> è una funzione utente che formatta
			un array di dati in una tabella HTML. L'attributo <span class="emphasis"><em>cols</em></span>
			determina il numero di colonne che formeranno la tabella. I valori
			di <span class="emphasis"><em>table_attr</em></span>, <span class="emphasis"><em>tr_attr</em></span> e
			<span class="emphasis"><em>td_attr</em></span> determinano gli attributi dei tag table,
			tr e td. Se <span class="emphasis"><em>tr_attr</em></span> o <span class="emphasis"><em>td_attr</em></span>
                        sono array, la funzione userà un ciclo per alternarne i valori.
			<span class="emphasis"><em>trailpad</em></span> è il valore da usare nelle ultime celle
...
<div class="example">
<a name="id3122217"></a><p class="title"><b>Example 8.13. html_table</b></p>
...
<td width="40%" align="right" valign="top"> math</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/language.function.html.table.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02765 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
