http://www.smarty.net/docsv2/de/variable.plugins.dir.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 16:53:34 GMT
...
<p>
      ...
      Die Voreinstellung ist '<code class="filename">"plugins"</code>
      unterhalb des <a class="link" href="smarty.constants.tpl#constant.smarty.dir" title="SMARTY_DIR">SMARTY_DIR</a>-Verzeichnisses.
      Wenn Sie einen relativen Pfad angeben, wird Smarty zuerst versuchen das Plugin von
      <a class="link" href="smarty.constants.tpl#constant.smarty.dir" title="SMARTY_DIR">SMARTY_DIR</a> aus zu erreichen,
...
<div class="example">
<a name="id2910065"></a><p class="title"><b>Example 12.1. Ein lokales Plugin-Verzeichnis hinzufügen</b></p>
...
<a name="id2910078"></a><p class="title"><b>Example 12.2. Mehrere Verzeichnisse im $plugins_dir</b></p>
<div class="example-contents"><pre class="programlisting">
...
<td width="40%" align="right" valign="top"> $debugging</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/variable.plugins.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02738 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
