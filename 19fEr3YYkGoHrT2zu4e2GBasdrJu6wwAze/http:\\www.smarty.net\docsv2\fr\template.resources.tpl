http://www.smarty.net/docsv2/fr/template.resources.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 20:07:57 GMT
...
<a name="template.resources"></a>Ressources</h2></div></div></div>
<p>
  Les templates peuvent provenir d'une grande variété de ressources. Quand vous
  affichez (<a class="link" href="api.display.tpl" title="display()"><code class="varname">display()</code></a>) ou
  récupérez (<a class="link" href="api.fetch.tpl" title="fetch()"><code class="varname">fetch()</code></a>) un
  ...
  Si une ressource n'est pas explicitement donnée, la valeur de la variable <a class="link" href="variable.default.resource.type.tpl" title="$default_resource_type"><em class="parameter"><code>$default_resource_type</code></em></a>
  sera utilisée.
 </p>
<div class="sect2" title="Templates depuis $template_dir">
<div class="titlepage"><div><div><h3 class="title">
<a name="templates.from.template.dir"></a>Templates depuis $template_dir</h3></div></div></div>
<p>
   Les templates du répertoire
   <a class="link" href="api.variables.tpl#variable.template.dir" title="$template_dir"><em class="parameter"><code>$template_dir</code></em></a> n'ont pas
...
<div class="example">
<a name="id3030283"></a><p class="title"><b>Example 15.6. Utilisation de templates depuis $template_dir</b></p>
...
<div class="sect2" title="Templates à partir de n'importe quel répertoire">
<div class="titlepage"><div><div><h3 class="title">
<a name="templates.from.any.dir"></a>Templates à partir de n'importe quel répertoire</h3></div></div></div>
<p>
...
<div class="example">
<a name="id3031426"></a><p class="title"><b>Example 15.7. Utilisation d'un template depuis n'importe quel répertoire</b></p>
...
<br class="example-break"><div class="sect3" title="Chemin de fichiers Windows">
<div class="titlepage"><div><div><h4 class="title">
<a name="templates.windows.filepath"></a>Chemin de fichiers Windows</h4></div></div></div>
<p>
    ...
    Assurez-vous de bien mettre <code class="literal">file:</code> dans le chemin pour éviter des
    conflits d'espace de noms et obtenir les résultats escomptés.
   </p>
<div class="example">
<a name="id3031486"></a><p class="title"><b>Example 15.8. Utilisation de templates avec des chemins de fichiers Windows</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<div class="sect2" title="Templates depuis d'autres sources">
<div class="titlepage"><div><div><h3 class="title">
<a name="templates.from.elsewhere"></a>Templates depuis d'autres sources</h3></div></div></div>
<p>
...
<p>
   Reportez-vous à la section <a class="link" href="plugins.resources.tpl" title="Ressources">ressource plugins</a>
   pour plus d'informations sur les fonctions que vous êtes censé fournir.
  </p>
<div class="note" title="Note" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Note</h3>
<p>
    Notez que vous ne pouvez pas écraser la ressource <code class="literal">file:</code> native,
...
<div class="example">
<a name="id3031578"></a><p class="title"><b>Example 15.9. Utilisation de ressources utilisateurs</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<div class="sect2" title="Fonction de gestion de template par défaut">
<div class="titlepage"><div><div><h3 class="title">
<a name="default.template.handler.function"></a>Fonction de gestion de template par défaut</h3></div></div></div>
<p>
...
<div class="example">
<a name="id3031679"></a><p class="title"><b>Example 15.10. utilisation de la fonction de gestion de template par défaut</b></p>
<div class="example-contents"><pre class="programlisting">
...
<tr>
<td width="40%" align="left" valign="top">Fonction de gestion du cache </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Chapter 16. Etendre Smarty avec des plugins</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/template.resources.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.00978 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
