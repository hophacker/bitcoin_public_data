http://www.smarty.net/docsv2/es/tips.componentized.templates.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 13:00:44 GMT
...
<html lang="en">
  <head>
    ...
    <title>Templates con Componetes | Smarty</title>
...
<p>
    ...
    <a class="link" href="api.assign.tpl" title="assign()">assign()</a>, atribuye valores a 
    las variables y muestra el template 
    <a class="link" href="api.display.tpl" title="display()">display()</a>. Por ejemplo nosotros 
...
<div class="example">
<a name="id3156902"></a><p class="title"><b>Example 18.7. Templates con Componetes</b></p>
<div class="example-contents">
<p>
      <code class="filename">function.load_ticker.php</code> -
      deja el archivo en 
      <a class="link" href="variable.plugins.dir.tpl" title="$plugins_dir">$plugins directory</a>
    </p>
...
<br class="example-break"><p>
    Vea también <a class="link" href="language.function.include.php.tpl" title="{include_php}">{include_php}</a>,
    <a class="link" href="language.function.include.tpl" title="include">{include}</a> y
...
<td width="40%" align="right" valign="top"> Ofuscando direcciones de E-mail</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/tips.componentized.templates.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02058 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
