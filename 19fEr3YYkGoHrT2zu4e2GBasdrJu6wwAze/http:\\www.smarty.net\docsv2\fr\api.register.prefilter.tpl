http://www.smarty.net/docsv2/fr/api.register.prefilter.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 15:21:33 GMT
...
<h2>Name</h2>
<p>register_prefilter() — Déclare dynamiquement des filtres de pré-compilation</p>
</div>
<div class="refsect1" title="Description">
<a name="id3015019"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">register_prefilter</span>(<span class="methodparam"><span class="type">mixed </span><span class="parameter">function</span></span>);</code><p>
   ...
   <a class="link" href="advanced.features.prefilters.tpl" title="Filtres de pré-compilation">filtres de pré-compilation</a> pour y faire
   passer des templates avant qu'ils ne soient compilés. Reportez-vous
   à la section
   <a class="link" href="advanced.features.postfilters.tpl" title="Filtres de post-compilation">filtres de pré-compilation de templates</a>
...
<p>
    ...
    <a class="link" href="variable.autoload.filters.tpl" title="$autoload_filters"><em class="parameter"><code>$autoload_filters</code></em></a> et
    les <a class="link" href="advanced.features.outputfilters.tpl" title="Filtres de sortie">filtres de sortie de template</a>.
   </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> register_resource()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 17 plus 1? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/api.register.prefilter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02956 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
