http://www.smarty.net/docsv2/de/api.register.block.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 12:22:58 GMT
...
<html lang="en">
  <head>
    ...
    <title>register_block (Block-Funktion registrieren) | Smarty</title>
...
<tr><th colspan="3" align="center">register_block (Block-Funktion registrieren)</th></tr>
<tr>
...
<div class="refentry" title="register_block (Block-Funktion registrieren)">
<a name="api.register.block"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>register_block (Block-Funktion registrieren)</p>
</div>
<div class="refsect1">
<a name="id2922085"></a><h2></h2>
...
<p>
    Der Parameter <em class="parameter"><code>impl</code></em> kann als (a) einen Funktionnamen oder (b) einem Array der Form <code class="literal">array(&amp;$object, $method)</code>,
    wobei <code class="literal">&amp;$object</code> eine Referenz zu einem Objekt und <code class="literal">$method</code> der Name der Methode die aufgerufen werden soll ist,
    oder als Array der Form <code class="literal">array(&amp;$class, $method)</code>, wobei <code class="literal">$class</code> der Name der Klasse und <code class="literal">$method</code>
    der Name der Methode ist die aufgerufen werden soll, übergeben werden.
    </p>
<p>
    <em class="parameter"><code>$cacheable</code></em> und <em class="parameter"><code>$cache_attrs</code></em> können in den meisten Fällen weggelassen werden. Konsultieren Sie <a class="link" href="caching.cacheable.tpl" title="Die Ausgabe von cachebaren Plugins Kontrollieren">Die Ausgabe von cachebaren Plugins Kontrollieren</a> für weitere Informationen. 
   </p>
<div class="example">
<a name="id2922364"></a><p class="title"><b>Example 13.21. register_block (Block-Funktion registrieren)</b></p>
...
<td width="40%" align="right" valign="top"> register_compiler_function (Compiler-Funktion registrieren)</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/api.register.block.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02663 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
