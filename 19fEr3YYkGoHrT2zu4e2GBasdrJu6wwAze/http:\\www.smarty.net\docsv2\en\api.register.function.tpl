...
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 14:43:12 GMT
...
<a name="id2857502"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">register_function</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">name</span></span>,<br>                       <span class="methodparam"><span class="type">mixed </span><span class="parameter">impl</span></span>,<br>                       <span class="methodparam"><span class="type">bool </span><span class="parameter">cacheable</span></span>,<br>                       <span class="methodparam"><span class="type">mixed </span><span class="parameter">cache_attrs</span></span>);</code><p>
   Pass in the <a class="link" href="plugins.functions.tpl" title="Template Functions">template function</a>
...
<p>
   ...
   omitted in most cases. See <a class="link" href="caching.cacheable.tpl" title="Controlling Cacheability of Plugins' Output">controlling cacheability of plugins output</a>
   on how to use them properly.
  </p>
<div class="example">
<a name="id2858590"></a><p class="title"><b>Example 13.23. register_function()</b></p>
...
and the
<a class="link" href="plugins.functions.tpl" title="Template Functions">plugin functions</a> section.
</p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> register_modifier()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 12 plus 5? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/api.register.function.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02313 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
