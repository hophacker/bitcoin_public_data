http://www.smarty.net/docsv2/fr/api.is.cached.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 15:51:50 GMT
...
<h2>Name</h2>
<p>is_cached() — Retourne <code class="constant">TRUE</code> s'il y a un fichier de cache valide pour ce template</p>
</div>
<div class="refsect1" title="Description">
<a name="id3011289"></a><h2>Description</h2>
...
<li class="listitem"><p>
   Celà fonctionne seulement si <a class="link" href="variable.caching.tpl" title="$caching">
   <em class="parameter"><code>$caching</code></em></a> est défini à <code class="constant">TRUE</code>, voir aussi la
   <a class="link" href="caching.tpl" title="Chapter 14. Cache">section sur le cache</a> pour plus d'informations.
  </p></li>
<li class="listitem"><p>
   Vous pouvez aussi passer en second paramètre un identifiant
   de <em class="parameter"><code>$cache_id</code></em> au cas où vous voudriez
   <a class="link" href="caching.multiple.caches.tpl" title="Caches multiples pour une seule page">plusieurs
   fichiers</a> de cache pour ce template.
  </p></li>
<li class="listitem"><p>
   ...
   <a class="link" href="variable.compile.id.tpl" title="$compile_id">
   <em class="parameter"><code>$compile_id</code></em></a> persistant sera utilisé.
  </p></li>
<li class="listitem"><p>
   Si vous ne voulez pas passer un <em class="parameter"><code>$cache_id</code></em> mais plutôt un
   <a class="link" href="variable.compile.id.tpl" title="$compile_id">
   <em class="parameter"><code>$compile_id</code></em></a>, vous devez passer
   <code class="constant">NULL</code> en tant que <em class="parameter"><code>$cache_id</code></em>.
  </p></li>
</ul></div>
<div class="note" title="Note technique" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Note technique</h3>
<p>
    Si <code class="varname">is_cached()</code> retourne <code class="constant">TRUE</code>, il charge en fait le cache existant et 
    le stocke en interne. Tout appel supplémentaire à 
    <a class="link" href="api.display.tpl" title="display()"><code class="varname">display()</code></a> ou
    <a class="link" href="api.fetch.tpl" title="fetch()"><code class="varname">fetch()</code></a> retournera ce
    ...
    <code class="varname">is_cached()</code> et l'appel à
    ...
    <a class="link" href="api.clear.cache.tpl" title="clear_cache()"><code class="varname">clear_cache()</code></a>
    et les changements de paramètres du cache peuvent n'avoir aucun effet alors que 
    <code class="varname">is_cached()</code> a retourné <code class="constant">TRUE</code>.
   </p>
</div>
<div class="example">
<a name="id3011871"></a><p class="title"><b>Example 13.19. Exemple avec is_cached()</b></p>
...
<a name="id3011885"></a><p class="title"><b>Example 13.20. Exemple avec is_cached() et plusieurs templates</b></p>
<div class="example-contents"><pre class="programlisting">
...
<br class="example-break"><p>
   Voir aussi
   <a class="link" href="api.clear.cache.tpl" title="clear_cache()"><code class="varname">clear_cache()</code></a>,
   <a class="link" href="api.clear.all.cache.tpl" title="clear_all_cache()"><code class="varname">clear_all_cache()</code></a> et
   la <a class="link" href="caching.tpl" title="Chapter 14. Cache">section sur le cache</a>.
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> load_filter()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 16 plus 19? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="9d77bfc4ba625ef48cec3459d92df58d">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/api.is.cached.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02682 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
