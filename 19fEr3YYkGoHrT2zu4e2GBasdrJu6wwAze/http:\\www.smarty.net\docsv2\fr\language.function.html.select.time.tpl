http://www.smarty.net/docsv2/fr/language.function.html.select.time.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 14:31:04 GMT
...
<p>
  <code class="varname">{html_select_time}</code> est une
...
<p>
  L'attribut <em class="parameter"><code>time</code></em> accepte comme paramètre différents
  formats. Ils peuvent être un timestamp unique, une chaîne respectant le format
  <code class="literal">YYYYMMDDHHMMSS</code> ou une chaîne
...
<td>Par quoi préfixer la variable.</td>
</tr>
<tr>
...
<td>Quel jour / heure utiliser.</td>
</tr>
<tr>
...
<td>S'il faut afficher l'heure.</td>
</tr>
<tr>
...
<td align="center">Non</td>
<td align="center"><code class="constant">TRUE</code></td>
<td>S'il faut afficher les minutes.</td>
</tr>
<tr>
...
<td align="center">Non</td>
<td align="center"><code class="constant">TRUE</code></td>
<td>S'il faut afficher les secondes.</td>
</tr>
<tr>
...
<td align="center">Non</td>
<td align="center"><code class="constant">TRUE</code></td>
<td>S'il faut afficher le méridian (am/pm)</td>
</tr>
<tr>
...
<td align="center">Non</td>
<td align="center"><code class="constant">TRUE</code></td>
<td>S'il faut utiliser l'horloge 24 heure.</td>
</tr>
<tr>
...
<td>Intervalle des minutes dans la liste
     déroulante</td>
</tr>
<tr>
...
<td align="center">Non</td>
<td align="center">1</td>
<td>Intervalle des secondes dans la liste
     déroulante</td>
</tr>
<tr>
...
<td>Nom du tableau dans lequel les valeures
     seront stockées.</td>
</tr>
<tr>
...
<td align="center">null</td>
<td>Ajoute des attributs supplémentaires aux balises
     select / input du méridian.</td>
</tr>
</tbody>
</table></div>
<div class="example">
<a name="id2977477"></a><p class="title"><b>Example 8.21. html_select_time</b></p>
...
<br class="example-break"><p>
  ...
  <a class="link" href="language.function.html.select.date.tpl" title="{html_select_date}"><code class="varname">{html_select_date}</code></a> et
...
<td width="40%" align="right" valign="top"> {html_table}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 6 plus 0? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="6000eef585ad9ea24c77e27fb26dad03">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/language.function.html.select.time.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02785 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
