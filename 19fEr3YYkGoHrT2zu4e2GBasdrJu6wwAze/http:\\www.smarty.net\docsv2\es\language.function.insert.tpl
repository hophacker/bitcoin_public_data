http://www.smarty.net/docsv2/es/language.function.insert.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 03:42:04 GMT
...
<p>
    La etiqueta funciona parecido a las etiquetas <a class="link" href="language.function.include.tpl" title="include">{include}</a>, excepto
   que las etiquetas insert no van para el cache cuando
   <a class="link" href="caching.tpl" title="Chapter 14. Cache">caching</a> esta activado. 
...
<p>
             ...
             #banner_location_id# y #site_id# (obtenidos de un <a class="link" href="config.files.tpl" title="Chapter 9. Config Files">archivo de configuración</a>), 
             y necesita llamar una función para obtener el contenido del banner.
			</p>
<div class="example">
<a name="id3084647"></a><p class="title"><b>Example 7.12. función {insert}</b></p>
...
<p>
   ...
   Nota: definir la salida a una variable no es util cuando el  <a class="link" href="variable.caching.tpl" title="$caching">cache</a> esta habilitado.
			</p>
<p>
   ...
   La ruta puede ser absuluta o relativa a <a class="link" href="variable.trusted.dir.tpl" title="$trusted_dir">$trusted_dir</a>.
   Cuando <a class="link" href="variable.security.tpl" title="$security">la seguridad esta activada</a>,
   el script debe estar en <a class="link" href="variable.trusted.dir.tpl" title="$trusted_dir">$trusted_dir</a>.
			</p>
<p>
...
<p>
            ...
            Si usted tuviera <a class="link" href="caching.tpl" title="Chapter 14. Cache">caching</a> 
...
<td width="40%" align="right" valign="top"> if,elseif,else</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.function.insert.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02751 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
