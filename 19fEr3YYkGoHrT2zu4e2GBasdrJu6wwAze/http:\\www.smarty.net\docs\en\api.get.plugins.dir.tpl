...
<h2>Name</h2>
<p>getPluginsDir() — return the directory where plugins are stored</p>
</div>
<div class="refsect1" title="Description">
<a name="idp16243920"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">array </span><span class="methodname">getPluginsDir</span>();</code><div class="example">
<a name="idp16297360"></a><p class="title"><b>Example 14.27. getPluginsDir()</b></p>
...
<br class="example-break"><p>
   ...
   <a class="link" href="api.add.plugins.dir.tpl" title="addPluginsDir()"><code class="varname">addPluginsDir()</code></a> and
...
<td width="40%" align="right" valign="top"> getRegisteredObject()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/api.get.plugins.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01841 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
