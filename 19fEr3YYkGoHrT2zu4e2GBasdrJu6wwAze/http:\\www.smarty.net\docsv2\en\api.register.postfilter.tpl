http://www.smarty.net/docsv2/en/api.register.postfilter.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 07:37:33 GMT
...
<h2>Name</h2>
<p>register_postfilter() — dynamically register postfilters</p>
</div>
<div class="refsect1" title="Description">
<a name="id2859296"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">register_postfilter</span>(<span class="methodparam"><span class="type">mixed </span><span class="parameter">function</span></span>);</code><p>
   ...
   <a class="link" href="advanced.features.postfilters.tpl" title="Postfilters">postfilters</a> to run templates
   through after they are compiled. See <a class="link" href="advanced.features.postfilters.tpl" title="Postfilters">template postfilters</a> for
...
<p>
  ...
  <a class="link" href="variable.autoload.filters.tpl" title="$autoload_filters">
  <em class="parameter"><code>$autoload_filters</code></em></a>
  and the
...
<td width="40%" align="right" valign="top"> register_prefilter()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 17 plus 16? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/api.register.postfilter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01803 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
