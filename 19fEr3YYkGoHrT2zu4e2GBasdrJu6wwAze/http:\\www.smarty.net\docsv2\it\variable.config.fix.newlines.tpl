http://www.smarty.net/docsv2/it/variable.config.fix.newlines.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 11:55:05 GMT
...
<p>
           ...
           file di configurazione vengono convertiti a \n quando sono analizzati.
           true per default.
	   </p>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> $default_template_handler_func</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/variable.config.fix.newlines.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02507 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
