http://www.smarty.net/docsv2/it/variable.config.dir.tpl
HTTP/1.1 200 OK
...
<p>
       Questa è la directory usata per memorizzare i file di configurazione
       usati nei template. Il default è "./configs2, che significa
       che Smarty cercherà la directory dei file di configurazione
       nella stessa directory dello script php in esecuzione.
      </p>
...
<td width="40%" align="right" valign="top"> $plugins_dir</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/variable.config.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02128 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
