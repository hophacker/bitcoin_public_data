http://www.smarty.net/docsv2/es/variable.security.settings.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 11:54:23 GMT
...
<p>
       ...
       seguridad cuando 
       <a class="link" href="variable.security.tpl" title="$security">security esta habilitado</a>. 
       Estas son las posibles configuraciones.
      </p>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>
         PHP_HANDLING - true/false. la configuracion de 
         <a class="link" href="variable.php.handling.tpl" title="$php_handling">$php_handling</a> 
...
<li class="listitem"><p>
         ...
         lista de <a class="link" href="variable.secure.dir.tpl" title="$secure_dir">$secure_dir</a>.
          </p></li>
<li class="listitem"><p>
         PHP_TAGS - true/false. Si es asignado true, las etiquetas 
         <a class="link" href="language.function.php.tpl" title="{php}">{php}{/php}</a> son 
         permitidas en los templates.
          </p></li>
<li class="listitem"><p>MODIFIER_FUNCS - Este es un arreglo de nombres de
...
<td width="40%" align="right" valign="top"> $trusted_dir</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/variable.security.settings.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.00938 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
