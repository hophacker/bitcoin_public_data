http://www.smarty.net/docs/en/variable.left.delimiter.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 11:22:22 GMT
...
<p>
  See also <a class="link" href="variable.right.delimiter.tpl" title="$right_delimiter"><em class="parameter"><code>$right_delimiter</code></em></a>
  and
...
<td width="40%" align="right" valign="top"> $locking_timeout</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/variable.left.delimiter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01458 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
