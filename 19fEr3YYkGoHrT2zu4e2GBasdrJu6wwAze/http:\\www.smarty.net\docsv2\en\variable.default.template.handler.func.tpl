http://www.smarty.net/docsv2/en/variable.default.template.handler.func.tpl
HTTP/1.1 200 OK
...
<td width="40%" align="right" valign="top"> $php_handling</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="9d607e30f58a23d76d039abaf0693c89">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/variable.default.template.handler.func.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02225 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
