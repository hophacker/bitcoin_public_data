http://www.smarty.net/docsv2/en/api.unregister.resource.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 22:01:21 GMT
...
<html lang="en">
  <head>
    ...
    <title>unregister_resource() | Smarty</title>
...
<tr><th colspan="3" align="center">unregister_resource()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.unregister.prefilter.tpl">Prev</a> </td>
...
<div class="refentry" title="unregister_resource()">
<a name="api.unregister.resource"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>unregister_resource() — dynamically unregister a resource plugin</p>
</div>
<div class="refsect1" title="Description">
<a name="id2863648"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">unregister_resource</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">name</span></span>);</code><p>
   Pass in the <em class="parameter"><code>name</code></em> of the resource.
  </p>
<div class="example">
<a name="id2863573"></a><p class="title"><b>Example 13.29. unregister_resource()</b></p>
...
<br class="example-break"><p>
 See also
 <a class="link" href="api.register.resource.tpl" title="register_resource()">
 <code class="varname">register_resource()</code></a>
 and
...
<tr>
<td width="40%" align="left" valign="top">unregister_prefilter() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Chapter 14. Caching</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 0 plus 9? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/api.unregister.resource.tpl">
            </form>
            </div>
          </div>
