http://www.smarty.net/docsv2/fr/language.modifier.escape.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 05:45:48 GMT
...
<p>
  <code class="varname">escape</code> est utilisé pour encoder / échapper
  une variable pour quelles soient compatibles
  avec les <code class="literal">url</code> <code class="literal">html</code>, avec les hexadécimaux,
  avec les entités hexadécimales, avec <code class="literal">javascript</code>
  et avec les e-mails.
  Par défaut, ce paramètre est <code class="literal">html</code>.
 </p>
...
<td>Format d'échappement à utiliser.</td>
</tr>
<tr>
...
<td align="center">Non</td>
<td align="center">
      <code class="literal">ISO-8859-1</code>, <code class="literal">UTF-8</code>, ... n'importe quel jeu de
      caractères supporté par
      <a class="ulink" href="http://php.net/htmlentities" target="_top"><code class="varname">htmlentities()</code></a>
     </td>
<td align="center"><code class="literal">ISO-8859-1</code></td>
<td>Le jeu de caractères passé à htmlentities()</td>
</tr>
</tbody>
</table></div>
<div class="example">
<a name="id2939419"></a><p class="title"><b>Example 5.10. escape</b></p>
...
<p>
   Voici des exemples de template avec <code class="literal">escape</code> suivis par l'affichage produit.
  </p>
<pre class="programlisting">
...
<a name="id2939453"></a><p class="title"><b>Example 5.11. Autres exemples</b></p>
<div class="example-contents">
<p>Les fonctions PHP peuvent être utilisées comme modificateurs, suivant la
   configuration de
   <a class="link" href="variable.security.tpl" title="$security">
   <code class="varname">$security</code></a>.
  </p>
<pre class="screen">
...
<p>
   ...
   <a class="link" href="language.function.mailto.tpl" title="{mailto}"><code class="varname">{mailto}</code></a></p>
<pre class="screen">
...
<br class="example-break"><p>
  Voir aussi la
  l'<a class="link" href="language.escaping.tpl" title="Désactiver l'analyse de Smarty">anayse Smarty d'échappement</a>,
  <a class="link" href="language.function.mailto.tpl" title="{mailto}"><code class="varname">{mailto}</code></a> et
  le <a class="link" href="tips.obfuscating.email.tpl" title="Dissimuler les adresses email">mascage des adresses e-mail</a>.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> indent</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/language.modifier.escape.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03272 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
