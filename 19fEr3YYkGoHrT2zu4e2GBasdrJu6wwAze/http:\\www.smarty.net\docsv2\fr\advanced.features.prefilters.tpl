http://www.smarty.net/docsv2/fr/advanced.features.prefilters.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 12:25:16 GMT
...
<html lang="en">
  <head>
    ...
    <title>Filtres de pré-compilation | Smarty</title>
...
<tr><th colspan="3" align="center">Filtres de pré-compilation</th></tr>
<tr>
...
<div class="sect1" title="Filtres de pré-compilation">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="advanced.features.prefilters"></a>Filtres de pré-compilation</h2></div></div></div>
<p>
  Les filtres de pré-compilation sont des fonctions PHP que vos templates
  exécutent <span class="emphasis"><em>avant qu'ils ne soient compilés</em></span>. Celà peut être utile
...
<p>
  ...
  <a class="link" href="api.register.prefilter.tpl" title="register_prefilter()">déclarés</a>, soit chargés
  à partir des <a class="link" href="variable.plugins.dir.tpl" title="$plugins_dir">répertoires de plugins</a>
  en utilisant la fonction <a class="link" href="api.load.filter.tpl" title="load_filter()"><code class="varname">load_filter()</code></a> ou
...
<div class="example">
<a name="id3029957"></a><p class="title"><b>Example 15.2. Utilisation un filtre de pré-compilation de template</b></p>
...
<br class="example-break"><p>
  ...
  les <a class="link" href="advanced.features.postfilters.tpl" title="Filtres de post-compilation">post-filtres</a> et
...
<tr>
<td width="40%" align="left" valign="top">Chapter 15. Fonctionnalités avancées </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Filtres de post-compilation</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/advanced.features.prefilters.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01923 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
