http://www.smarty.net/docsv2/fr/language.modifier.strip.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 07:36:57 GMT
...
<p>
   ...
   utilisez la fonction <a class="link" href="language.function.strip.tpl" title="{strip}"><code class="varname">{strip}</code></a>.
  </p>
</div>
<div class="example">
<a name="id2941702"></a><p class="title"><b>Example 5.19. strip</b></p>
...
<br class="example-break"><p>
  Voir aussi
  <a class="link" href="language.function.strip.tpl" title="{strip}"><code class="varname">{strip}</code></a> et
...
<td width="40%" align="right" valign="top"> strip_tags</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/language.modifier.strip.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03016 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
