http://www.smarty.net/docsv2/es/caching.cacheable.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 11:54:55 GMT
...
<html lang="en">
  <head>
    ...
    <title>Controlando salida de Cacheabilidad de plugins | Smarty</title>
...
<p>
   ...
   o registrados. 
   El tercer parámetro para <a class="link" href="api.register.block.tpl" title="register_block()">register_block()</a>, 
   <a class="link" href="api.register.compiler.function.tpl" title="register_compiler_function">register_compiler_function()</a> 
   y <a class="link" href="api.register.block.tpl" title="register_block()">register_function()</a> es llamado 
...
<p>
   ...
   la función <a class="link" href="plugins.inserts.tpl" title="Inserts">insert</a>.
  </p>
<p>
   En contraste con <a class="link" href="language.function.insert.tpl" title="insert">{insert}</a> 
...
<div class="example">
<a name="id3146078"></a><p class="title"><b>Example 14.10. Previniendo que una saída de plugin de ser cacheada</b></p>
...
<a name="id3146137"></a><p class="title"><b>Example 14.11. Previniendo una pasada entera del template para el cache</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<td width="40%" align="right" valign="top"> Chapter 15. Caracteristicas Avanzadas</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/caching.cacheable.tpl">
            </form>
            </div>
          </div>
