http://www.smarty.net/docsv2/en/variable.cache.handler.func.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 08:24:33 GMT
...
<html lang="en">
  <head>
    ...
    <title>$cache_handler_func | Smarty</title>
...
<tr><th colspan="3" align="center">$cache_handler_func</th></tr>
<tr>
...
<div class="sect1" title="$cache_handler_func">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="variable.cache.handler.func"></a>$cache_handler_func</h2></div></div></div>
<p>
       ...
       See the custom  <a class="link" href="section.template.cache.handler.func.tpl" title="Cache Handler Function">cache
       handler function section</a> for more details.
      </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $cache_modified_check</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 14 plus 3? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/variable.cache.handler.func.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01982 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
