...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 01:29:05 GMT
...
<html lang="en">
  <head>
    ...
    <title>Extended Setup | Smarty</title>
...
<p>
    This is a continuation of the <a class="link" href="installing.smarty.basic.tpl" title="Basic Installation">basic installation</a>, please read
    that first!
   </p>
<p>
...
<div class="example">
<a name="id2779013"></a><p class="title"><b>Example 2.10. /php/includes/guestbook/setup.php</b></p>
...
<div class="example">
<a name="id2779042"></a><p class="title"><b>Example 2.11. /web/www.example.com/guestbook/htdocs/index.php</b></p>
<div class="example-contents"><pre class="programlisting">
...
<td width="40%" align="right" valign="top"> Part II. Smarty For Template Designers</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 5 plus 11? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/installing.smarty.extended.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02331 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
