http://www.smarty.net/docsv2/it/variable.default.resource.type.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 14:31:25 GMT
...
<p>
          Dice a Smarty che tipo di risorsa usare implicitamente. Il valore di
          default è 'file', il che significa che $smarty-&gt;display('index.tpl'); 
          e $smarty-&gt;display('file:index.tpl'); hanno identico significato. 
          Leggete il capitolo <a class="link" href="template.resources.tpl" title="Risorse">risorse</a>
          per i dettagli.
      </p>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> Chapter 13. Methods</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/variable.default.resource.type.tpl">
            </form>
            </div>
          </div>
