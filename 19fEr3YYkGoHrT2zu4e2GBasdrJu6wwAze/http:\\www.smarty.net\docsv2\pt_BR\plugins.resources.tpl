http://www.smarty.net/docsv2/pt_BR/plugins.resources.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 06:16:14 GMT
...
<html lang="en">
  <head>
    ...
    <title>Recursos (Resources) | Smarty</title>
...
<tr><th colspan="3" align="center">Recursos (Resources)</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="plugins.outputfilters.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 16. Extendendo a Smarty com Plugins</th>
...
<div class="sect1" title="Recursos (Resources)">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="plugins.resources"></a>Recursos (Resources)</h2></div></div></div>
<p>
...
<p>
     ...
     A função deve retornar <code class="literal">true</code> se
     ela está apta a devolver com sucesso o recurso e
     caso contrário retorna <code class="literal">false</code>.
    </p>
<p>
     ...
     A função deve retornar <code class="literal">true</code>
     se o timestamp poderia ser determinado com sucesso,
      e caso contrário retornaria <code class="literal">false</code>.
    </p>
<p>
     A terceira função deve retornar <code class="literal">true</code> ou
     <code class="literal">false</code>, dependendo do recurso requisitado
     está seguro ou não. Esta função é usada
     apenas para recursos de template mas ainda assim seria definida.
    </p>
<p>
     A quarta função deve retornar <code class="literal">true</code>
     ou <code class="literal">false</code>, dependendo
     do recurso requisitado ser confiável ou não.
     Esta função é usada apenas para componentes de 
     script PHP requisitados pelas tags <span class="command"><strong>include_php</strong></span> ou
     <span class="command"><strong>insert</strong></span> com o atributo <em class="structfield"><code>src</code></em>.
     Entretanto, ela ainda assim mesmo seria definida para os recursos de template.
    </p>
<p>
     Veja também:
     <a class="link" href="api.register.resource.tpl" title="register_resource">register_resource()</a>,
     <a class="link" href="api.unregister.resource.tpl" title="unregister_resource">unregister_resource()</a>.
    </p>
<div class="example">
<a name="id2774860"></a><p class="title"><b>Example 16.10. Plugin resource (recurso)</b></p>
...
<tr>
<td width="40%" align="left" valign="top">Filtros de saída </td>
...
<td width="40%" align="right" valign="top"> Inserts</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 14 plus 11? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/plugins.resources.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02034 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
