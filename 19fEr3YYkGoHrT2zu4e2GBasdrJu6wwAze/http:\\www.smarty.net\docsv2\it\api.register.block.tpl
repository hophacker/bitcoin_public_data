http://www.smarty.net/docsv2/it/api.register.block.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 01:29:07 GMT
...
<html lang="en">
  <head>
    ...
    <title>register_block | Smarty</title>
...
<tr><th colspan="3" align="center">register_block</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.load.filter.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Methods</th>
<td width="20%" align="right"> <a accesskey="n" href="api.register.compiler.function.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="register_block">
<a name="api.register.block"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>register_block</p>
</div>
<div class="refsect1">
<a name="id3144202"></a><h2></h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">register_block</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">name</span></span>,<br>                    <span class="methodparam"><span class="type">mixed </span><span class="parameter">impl</span></span>,<br>                    <span class="methodparam"><span class="type">bool </span><span class="parameter">cacheable</span></span>,<br>                    <span class="methodparam"><span class="type">mixed </span><span class="parameter">cache_attrs</span></span>);</code><p>
...
<p>
   Il parametro <em class="parameter"><code>impl</code></em>, contenente la funzione 
...
<p>
   <em class="parameter"><code>cacheable</code></em> e <em class="parameter"><code>cache_attrs</code></em>
   possono essere omessi nella maggioranza dei casi. Consultate
   <a class="link" href="caching.cacheable.tpl" title="Mettere in Cache l'output dei Plugin">Controllo della Cache per l'output dei Plugins</a>
   per capire come usarli.
  </p>
<div class="example">
<a name="id3144492"></a><p class="title"><b>Example 13.21. register_block</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="api.register.compiler.function.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">load_filter </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> register_compiler_function</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="87499805ae7fe4c3f9afbb8bf4688bfe">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/api.register.block.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01688 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
