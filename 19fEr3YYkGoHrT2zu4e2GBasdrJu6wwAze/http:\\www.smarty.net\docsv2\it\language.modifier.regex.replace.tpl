http://www.smarty.net/docsv2/it/language.modifier.regex.replace.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 23:36:59 GMT
...
<td>E' l'espressione regolare da sostituire.</td>
</tr>
<tr>
...
<td align="center">Sì</td>
<td align="center"><span class="emphasis"><em>nessuno</em></span></td>
<td>E' la stringa di testo da usare per la sostituzione.</td>
</tr>
</tbody>
</table></div>
<p>
...
<div class="example">
<a name="id3097519"></a><p class="title"><b>Example 5.14. regex_replace</b></p>
...
<td width="40%" align="right" valign="top"> replace</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/language.modifier.regex.replace.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02749 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
