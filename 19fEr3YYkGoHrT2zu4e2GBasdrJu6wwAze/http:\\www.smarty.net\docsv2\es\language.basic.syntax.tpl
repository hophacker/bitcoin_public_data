http://www.smarty.net/docsv2/es/language.basic.syntax.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 03:31:56 GMT
...
<html lang="en">
  <head>
    ...
    <title>Chapter 3. Basic Syntax | Smarty</title>
...
<p>
   ...
   Por default , estos delimitadores son <code class="literal">{</code>
   y <code class="literal">}</code>, sino estos pueden 
   <a class="link" href="variable.left.delimiter.tpl" title="$left_delimiter">cambiar</a>.
 </p>
<p>
   Para estos ejemplos, nosotros asumiremos que usted está usando los
...
<div class="sect1" title="Comentarios">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="language.syntax.comments"></a>Comentarios</h2></div></div></div>
<p>
...
<div class="example">
<a name="id3063646"></a><p class="title"><b>Example 3.1. Comentarios</b></p>
...
<td width="40%" align="right" valign="top"> Variables</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 10 plus 1? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.basic.syntax.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02637 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
