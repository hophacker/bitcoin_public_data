http://www.smarty.net/docsv2/it/variable.error.reporting.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 13:00:42 GMT
...
<p>
           Quando a questa variabile viene dato un valore non-null,
           il suo valore viene usato come livello di error_reporting
           di php all'interno di display() e fetch(). Quando il debugging
           è abilitato questo valore è ignorato e il livello degli 
           errori viene lasciato invariato.
      </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $compile_id</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/variable.error.reporting.tpl">
            </form>
            </div>
          </div>
