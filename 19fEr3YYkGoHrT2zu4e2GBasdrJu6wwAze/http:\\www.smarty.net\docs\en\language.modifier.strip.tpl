...
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 00:03:18 GMT
...
<p>
    If you want to strip blocks of template text, use the built-in <a class="link" href="language.function.strip.tpl" title="{strip}"><code class="varname">{strip}</code></a> function.
   </p>
</div>
<div class="example">
<a name="idp6845872"></a><p class="title"><b>Example 5.19. strip</b></p>
...
<td width="40%" align="right" valign="top"> strip_tags</td>
          ...
          <div class="commentInfo">
              ...
              <div class="commentAuthor">by <b>Devpro</b> on Feb 29, 2012 at  1:42</div>
              <div class="commentBody">This function is not safe for ISO8859-1 special chars. It's really not your fault but you should know it.

Running PHP 5.3.6.</div>
            </div>
                              </div>
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 1 plus 2? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/language.modifier.strip.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01818 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
