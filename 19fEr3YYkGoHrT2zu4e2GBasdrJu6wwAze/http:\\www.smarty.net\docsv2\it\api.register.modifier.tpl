http://www.smarty.net/docsv2/it/api.register.modifier.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 01:29:23 GMT
...
<h2>Name</h2>
<p>register_modifier</p>
</div>
<div class="refsect1">
<a name="id3144742"></a><h2></h2>
...
<div class="example">
<a name="id3145648"></a><p class="title"><b>Example 13.23. register_modifier</b></p>
...
<td width="40%" align="right" valign="top"> register_object</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 6 plus 19? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/api.register.modifier.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02438 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
