http://www.smarty.net/docsv2/es/api.clear.all.cache.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 13:44:59 GMT
...
<h2>Name</h2>
<p>clear_all_cache — limpia completamente el cache del template</p>
</div>
<div class="refsect1">
<a name="id3127411"></a><h2></h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">clear_all_cache</span>(<span class="methodparam"><span class="type">int </span><span class="parameter">expire_time</span></span>);</code><p>
   Como un parámetro opcional, usted puede proporcionar un periodo minimo 
   en segundos que el archivo de cache debe tener antes de ser anulado.
  </p>
<div class="example">
<a name="id3128130"></a><p class="title"><b>Example 13.6. clear_all_cache</b></p>
...
<br class="example-break"><p>
  ...
  <a class="link" href="api.is.cached.tpl" title="is_cached()">is_cached()</a>
  y
...
<td width="40%" align="right" valign="top"> clear_assign()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/api.clear.all.cache.tpl">
            </form>
            </div>
          </div>
