http://www.smarty.net/docsv2/it/api.get.registered.object.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 18:04:59 GMT
...
<div class="example">
<a name="id3142640"></a><p class="title"><b>Example 13.16. get_registered_object</b></p>
...
<td width="40%" align="right" valign="top"> get_template_vars</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/api.get.registered.object.tpl">
            </form>
            </div>
          </div>
