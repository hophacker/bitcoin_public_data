http://www.smarty.net/docs/en/variable.default.config.type.tpl
HTTP/1.1 200 OK
Date: Sat, 26 Jul 2014 13:10:15 GMT
...
<p>
	  This tells smarty what resource type to use for config files. The default value
	  is <code class="literal">file</code>, meaning that
          <code class="literal">$smarty-&gt;configLoad('test.conf')</code> and
          <code class="literal">$smarty-&gt;configLoad('file:test.conf')</code> are identical in
      meaning. See the <a class="link" href="resources.tpl" title="Chapter 16. Resources">resource</a>
...
<td width="40%" align="right" valign="top"> $default_modifiers</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 6 plus 15? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="55ed6edabb16c478c3a57df5e461430d">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/variable.default.config.type.tpl">
            </form>
            </div>
          </div>
