http://www.smarty.net/docsv2/es/api.unregister.block.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 05:33:44 GMT
...
<html lang="en">
  <head>
    ...
    <title>unregister_block | Smarty</title>
...
<tr><th colspan="3" align="center">unregister_block</th></tr>
<tr>
...
<td width="20%" align="right"> <a accesskey="n" href="api.unregister.compiler.function.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="unregister_block">
<a name="api.unregister.block"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>unregister_block — Des-registra dinamicamente un plugin de bloque de funciones</p>
</div>
<div class="refsect1" title="Descripción">
<a name="id3136395"></a><h2>Descripción</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">unregister_block</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">name</span></span>);</code><p>
   Use esto para des-registrar dinámicamente un 
   <a class="link" href="plugins.block.functions.tpl" title="Block Functions">bloque de funciones de plugin</a>. 
   Pase en el bloque el <em class="parameter"><code>nombre</code></em> de la función.
  </p>
<p>
      Ver también 
      <a class="link" href="api.register.block.tpl" title="register_block()">register_block()</a>
      y
      <a class="link" href="plugins.block.functions.tpl" title="Block Functions">Block Functions Plugins</a>.
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right"> <a accesskey="n" href="api.unregister.compiler.function.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">template_exists() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> unregister_compiler_function()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 10 plus 3? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="d2a1b91e73c3d0168ba38e4e1a0bef22">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/api.unregister.block.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02324 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
