...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 09:51:27 GMT
...
<h2>Name</h2>
<p>unregisterCacheResource() — dynamically unregister a CacheResource plugin</p>
</div>
<div class="refsect1" title="Description">
<a name="idp17048240"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">unregisterCacheResource</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">name</span></span>);</code><p>
   Pass in the <em class="parameter"><code>name</code></em> of the CacheResource.
  </p>
<div class="example">
<a name="idp17086800"></a><p class="title"><b>Example 14.49. unregisterCacheResource()</b></p>
...
<br class="example-break"><p>
  ...
  and the
  <a class="link" href="caching.custom.tpl" title="Custom Cache Implementation">Custom CacheResource Implementation</a> section.
</p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> unregisterFilter()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/api.unregister.cacheresource.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02401 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
