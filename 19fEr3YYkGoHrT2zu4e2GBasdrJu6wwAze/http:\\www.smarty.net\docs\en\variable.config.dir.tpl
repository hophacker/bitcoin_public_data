...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 09:35:22 GMT
...
<p>
       ...
       <a class="link" href="api.add.config.dir.tpl" title="addConfigDir()"><code class="varname">addConfigDir()</code></a> instead.
      </p>
</div>
<p>
      See also 
...
<td width="40%" align="right" valign="top"> $config_overwrite</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/variable.config.dir.tpl">
            </form>
            </div>
          </div>
