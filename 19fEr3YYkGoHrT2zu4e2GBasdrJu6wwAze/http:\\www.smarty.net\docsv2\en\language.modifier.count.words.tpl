http://www.smarty.net/docsv2/en/language.modifier.count.words.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 03:32:10 GMT
...
<div class="example">
<a name="id2788363"></a><p class="title"><b>Example 5.7. count_words</b></p>
...
<td width="40%" align="right" valign="top"> date_format</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/language.modifier.count.words.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01485 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
