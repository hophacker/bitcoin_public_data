http://www.smarty.net/docsv2/es/variable.php.handling.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 00:17:05 GMT
...
<p>
      ...
      <a class="link" href="language.function.php.tpl" title="{php}">{php}{/php}</a> en el template.
      </p>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>SMARTY_PHP_PASSTHRU - Smarty echos tags as-is.</p></li>
<li class="listitem"><p>SMARTY_PHP_QUOTE - Smarty abre comillas a las etiquetas 
         de entidades html.</p></li>
<li class="listitem"><p>SMARTY_PHP_REMOVE -  Smarty borra las etiquetas del
       template.</p></li>
<li class="listitem"><p>SMARTY_PHP_ALLOW - Smarty ejecuta las etiquetas como
       código PHP.</p></li>
</ul></div>
...
<p>
        ...
        Use <a class="link" href="language.custom.functions.tpl" title="Chapter 8. Custom Functions">custom functions</a> 
        o <a class="link" href="language.modifiers.tpl" title="Chapter 5. Modificadores de variables">modifiers</a> en vez de eso.
       </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> $security</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/variable.php.handling.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02404 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
