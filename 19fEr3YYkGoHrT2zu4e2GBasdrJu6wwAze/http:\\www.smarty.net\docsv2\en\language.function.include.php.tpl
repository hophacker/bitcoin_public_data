...
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 21:33:32 GMT
...
<p>
    ...
    <a class="link" href="variable.plugins.dir.tpl" title="$plugins_dir"><code class="filename">plugins/</code></a>
    directory or your
    application code. See the <a class="link" href="tips.componentized.templates.tpl" title="Componentized Templates">componentized template
...
<p>
  ...
  If <a class="link" href="variable.security.tpl" title="$security"><em class="parameter"><code>$security</code></em></a> is enabled,
  then the php script must be located in the <a class="link" href="variable.trusted.dir.tpl" title="$trusted_dir"><em class="parameter"><code>$trusted_dir</code></em></a> path.
  ...
  relative to  <a class="link" href="variable.trusted.dir.tpl" title="$trusted_dir"><em class="parameter"><code>$trusted_dir</code></em></a>,
  or an absolute path.
 </p>
<p>
...
<div class="example">
<a name="id2805975"></a><p class="title"><b>Example 7.21. function {include_php}</b></p>
...
<br class="example-break"><p>
  See also <a class="link" href="language.function.include.tpl" title="{include}"><code class="varname">{include}</code></a>,
...
<a class="link" href="variable.trusted.dir.tpl" title="$trusted_dir"><em class="parameter"><code>$trusted_dir</code></em></a>,
  <a class="link" href="language.function.php.tpl" title="{php}"><code class="varname">{php}</code></a>, <a class="link" href="language.builtin.functions.tpl#language.function.capture" title="{capture}"><code class="varname">{capture}</code></a>, <a class="link" href="template.resources.tpl" title="Resources">template resources</a> and <a class="link" href="tips.componentized.templates.tpl" title="Componentized Templates">componentized templates</a> </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> {insert}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/language.function.include.php.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01644 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
