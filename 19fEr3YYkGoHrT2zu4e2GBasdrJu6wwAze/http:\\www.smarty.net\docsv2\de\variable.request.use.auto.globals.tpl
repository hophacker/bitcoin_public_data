http://www.smarty.net/docsv2/de/variable.request.use.auto.globals.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 22:01:05 GMT
...
<p>
     ...
     <a class="link" href="language.variables.smarty.tpl" title="Die reservierte {$smarty} Variable">{$smarty.request.*}, {$smarty.get.*}</a>
     , etc... verwenden.
     Achtung: Wenn $request_use_auto_globals auf TRUE gesetzt ist,
     hat <a class="link" href="variable.request.vars.order.tpl" title="$request_vars_order">variable.request.vars.order</a>
     keine Auswirkungen, da PHPs Konfigurationswert <code class="literal">gpc_order</code> verwendet wird.
   </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $error_reporting</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 4 plus 7? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/variable.request.use.auto.globals.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01976 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
