http://www.smarty.net/docsv2/es/variable.left.delimiter.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 02:19:07 GMT
...
<p>
  Ver también  <a class="link" href="variable.right.delimiter.tpl" title="$right_delimiter">$right_delimiter</a>
  y <a class="link" href="language.escaping.tpl" title="Escaping Smarty Parsing">escaping smarty parsing</a>.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $right_delimiter</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 4 plus 2? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/variable.left.delimiter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02182 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
