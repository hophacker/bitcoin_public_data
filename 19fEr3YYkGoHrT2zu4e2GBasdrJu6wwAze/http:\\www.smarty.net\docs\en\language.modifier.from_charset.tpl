http://www.smarty.net/docs/en/language.modifier.from_charset.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 13:45:41 GMT
...
<p>
   <code class="varname">from_charset</code> is used to transcode a string from a given charset to the internal charset.
   This is the exact opposite of the <a class="link" href="language.modifier.to_charset.tpl" title="to_charset">to_charset modifier</a>.
  </p>
...
<code class="literal">ISO-8859-1</code>, <code class="literal">UTF-8</code>,
      ...
      <a class="ulink" href="http://php.net/mb_convert_encoding" target="_top">
      <code class="varname">mb_convert_encoding()</code></a>
      </td>
<td align="center"><code class="literal">ISO-8859-1</code></td>
<td>The charset encoding the value is supposed to be decoded from</td>
</tr></tbody>
</table></div>
...
<p>
   See also
   <a class="link" href="charset.tpl" title="Chapter 11. Charset Encoding">Charset Enconding</a>,
   <a class="link" href="language.modifier.from_charset.tpl" title="from_charset">from_charset modifier</a>.
  </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> indent</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 13 plus 15? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/language.modifier.from_charset.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02935 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
