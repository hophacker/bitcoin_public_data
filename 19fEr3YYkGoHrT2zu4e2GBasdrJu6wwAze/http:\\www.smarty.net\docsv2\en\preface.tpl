http://www.smarty.net/docsv2/en/preface.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 17:26:38 GMT
...
<p>
   ...
   <span class="productname">SmartTemplate</span>™ came into existence (note: this
...
<tr>
<td width="40%" align="left" valign="top">Smarty Manual </td>
...
<td width="40%" align="right" valign="top"> Part I. Getting Started</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/preface.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02789 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
