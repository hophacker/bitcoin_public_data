http://www.smarty.net/docsv2/fr/language.function.textformat.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 09:51:28 GMT
...
<p>
  <code class="varname">{textformat}</code> est une
  <a class="link" href="plugins.block.functions.tpl" title="Fonctions de blocs">fonction de bloc</a>
...
<p>
  ...
  chaque attribut. Actuellement, seul le style prédéfini <span class="quote">“<span class="quote">email</span>”</span> est
  disponible.
 </p>
...
<td>Taille de l'indentation pour chaque
     ligne</td>
</tr>
<tr>
...
<td align="center">Non</td>
<td align="center"><span class="emphasis"><em>0</em></span></td>
<td>Taille de l'indentation de la
     première ligne</td>
</tr>
<tr>
...
<td>Le caractère (ou la chaîne) à utiliser pour
     indenter</td>
</tr>
<tr>
...
<td>À combien de caractères doit on ajuster chaque
     ligne</td>
</tr>
<tr>
...
<td>Le caractère (ou chaîne de caractères) avec lequel
     terminer les lignes</td>
</tr>
<tr>
...
<td>Si true, wrap réduira les lignes au caractère exact
     au lieu d'ajuster à la fin d'un mot</td>
</tr>
<tr>
...
<td align="center">Non</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Le nom de la variable PHP dans laquelle la
     sortie sera assignée</td>
</tr>
</tbody>
</table></div>
<div class="example">
<a name="id2984507"></a><p class="title"><b>Example 8.27. {textformat}</b></p>
...
<br class="example-break"><p>
  Voir aussi
  <a class="link" href="language.function.strip.tpl" title="{strip}">{strip}</a> et
  <a class="link" href="language.modifier.wordwrap.tpl" title="wordwrap">{wordwrap}</a>.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> Chapter 9. Fichiers de configuration</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 2 plus 1? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="e439a8c79192d92eb13d99f32fc6e015">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/language.function.textformat.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02996 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
