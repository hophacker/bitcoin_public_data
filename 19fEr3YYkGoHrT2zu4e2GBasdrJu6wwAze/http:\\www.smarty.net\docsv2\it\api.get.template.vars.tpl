http://www.smarty.net/docsv2/it/api.get.template.vars.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 00:16:46 GMT
...
<div class="example">
<a name="id3142731"></a><p class="title"><b>Example 13.17. get_template_vars</b></p>
...
<td width="40%" align="right" valign="top"> is_cached</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/api.get.template.vars.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02665 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
