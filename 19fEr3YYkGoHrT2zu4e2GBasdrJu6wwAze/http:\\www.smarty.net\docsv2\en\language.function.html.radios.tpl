http://www.smarty.net/docsv2/en/language.function.html.radios.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 19:31:25 GMT
...
<div class="example">
<a name="id2824700"></a><p class="title"><b>Example 8.16. {html_radios} first example</b></p>
...
<a name="id2824736"></a><p class="title"><b>Example 8.17. {html_radios} second example</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<br class="example-break"><div class="example">
<a name="id2824787"></a><p class="title"><b>Example 8.18. {html_radios} - Database example (eg PEAR or ADODB):</b></p>
<div class="example-contents">
<pre class="programlisting">
...
<br class="example-break"><p>
  See also <a class="link" href="language.function.html.checkboxes.tpl" title="{html_checkboxes}"><code class="varname">{html_checkboxes}</code></a>
  and <a class="link" href="language.function.html.options.tpl" title="{html_options}"><code class="varname">{html_options}</code></a>
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> {html_select_date}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 0 plus 18? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/language.function.html.radios.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01789 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
