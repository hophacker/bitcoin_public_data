http://www.smarty.net/docsv2/en/api.template.exists.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 14:30:51 GMT
...
<a name="id2861058"></a><h2>Description</h2>
...
<div class="example">
<a name="id2861101"></a><p class="title"><b>Example 13.26. template_exists()</b></p>
...
<td width="40%" align="right" valign="top"> unregister_block()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 17 plus 17? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/api.template.exists.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01695 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
