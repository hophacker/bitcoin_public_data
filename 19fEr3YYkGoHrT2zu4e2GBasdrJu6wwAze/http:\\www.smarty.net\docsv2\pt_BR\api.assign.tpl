http://www.smarty.net/docsv2/pt_BR/api.assign.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 20:08:08 GMT
...
<a name="api.assign"></a>assign</h2></div></div></div>
<div class="funcsynopsis">
<table border="0" summary="Function synopsis" cellspacing="0" cellpadding="0" class="funcprototype-table"><tr>
<td><code class="funcdef">void <b class="fsfunc">assign</b>(</code></td>
<td>
<var class="pdparam">var</var><code>)</code>;</td>
<td> </td>
</tr></table>
<div class="paramdef-list">
<code>mixed <var class="pdparam">var</var></code>;</div>
...
<div class="example">
<a name="id2755291"></a><p class="title"><b>Example 13.3. assign</b></p>
...
$smarty-&gt;assign(array("city" =&gt; "Lincoln","state" =&gt; "Nebraska"));</pre></div>
</div>
...
<tr>
<td width="40%" align="left" valign="top">append_by_ref </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> assign_by_ref</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/api.assign.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01952 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
