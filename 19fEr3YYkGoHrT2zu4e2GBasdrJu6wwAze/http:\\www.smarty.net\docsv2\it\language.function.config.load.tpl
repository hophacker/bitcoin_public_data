http://www.smarty.net/docsv2/it/language.function.config.load.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 17:50:59 GMT
...
<td>Nome del file di configurazione da importare</td>
</tr>
<tr>
...
<td align="center"><span class="emphasis"><em>nessuno</em></span></td>
<td>Nome della sezione da caricare</td>
</tr>
<tr>
...
<p>
  ...
  Vedere <a class="link" href="config.files.tpl" title="Chapter 9. File di configurazione">Config Files</a> per
  maggiori informazioni.
 </p>
<div class="example">
<a name="id3104424"></a><p class="title"><b>Example 7.2. funzione config_load</b></p>
...
<br class="example-break"><p>
  ...
  <span class="emphasis"><em>section</em></span>.
 </p>
<div class="note" title="Note" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Note</h3>
<p>
   <span class="emphasis"><em>Le sezioni dei file di configurazione</em></span> e la funzione
   incorporata dei template chiamata <span class="emphasis"><em>section</em></span> non hanno
   nulla a che fare fra di loro, hanno soltanto lo stesso nome.
  </p>
</div>
<div class="example">
<a name="id3104470"></a><p class="title"><b>Example 7.3. funzione config_load con section</b></p>
<div class="example-contents"><pre class="programlisting">
...
<tr>
<td width="40%" align="left" valign="top">Chapter 7. Funzioni incorporate </td>
...
<td width="40%" align="right" valign="top"> foreach,foreachelse</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/language.function.config.load.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02037 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
