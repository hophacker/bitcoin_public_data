http://www.smarty.net/docsv2/fr/advanced.features.postfilters.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 15:15:45 GMT
...
<html lang="en">
  <head>
    ...
    <title>Filtres de post-compilation | Smarty</title>
...
<tr><th colspan="3" align="center">Filtres de post-compilation</th></tr>
<tr>
...
<div class="sect1" title="Filtres de post-compilation">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="advanced.features.postfilters"></a>Filtres de post-compilation</h2></div></div></div>
<p>
  Les filtres de post-compilation sont des fonctions PHP que vos templates
  exécutent <span class="emphasis"><em>après avoir été compilés</em></span>. Les filtres de post-compilation
  peuvent  être soit <a class="link" href="api.register.postfilter.tpl" title="register_postfilter()">déclarés</a>, soit chargés
  depuis les <a class="link" href="variable.plugins.dir.tpl" title="$plugins_dir">répertoires des plugins</a>
  en utilisant la fonction
  <a class="link" href="api.load.filter.tpl" title="load_filter()"><code class="varname">load_filter()</code></a> ou en réglant
  la variable
...
<div class="example">
<a name="id3029231"></a><p class="title"><b>Example 15.3. Utilisation d'un filtre de post-compilation de templates</b></p>
...
<p>
   Votre template Smarty <code class="filename">index.tpl</code> ressemblera, après compilation à :
  </p>
<pre class="screen">
...
<br class="example-break"><p>
  ...
  <a class="link" href="advanced.features.prefilters.tpl" title="Filtres de pré-compilation">les pré-filtres</a> et
...
<tr>
<td width="40%" align="left" valign="top">Filtres de pré-compilation </td>
...
<td width="40%" align="right" valign="top"> Filtres de sortie</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/advanced.features.postfilters.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02499 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
