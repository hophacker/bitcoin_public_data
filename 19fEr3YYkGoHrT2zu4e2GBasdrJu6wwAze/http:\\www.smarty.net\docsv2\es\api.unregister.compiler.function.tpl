http://www.smarty.net/docsv2/es/api.unregister.compiler.function.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 06:24:42 GMT
...
<h2>Name</h2>
<p>unregister_compiler_function() — des-registrar dinámicamente una función de compilación</p>
</div>
<div class="refsect1" title="Descripción">
<a name="id3136691"></a><h2>Descripción </h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">unregister_compiler_function</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">name</span></span>);</code><p>
   Pase el <em class="parameter"><code>nombre</code></em> de la función compiladora.
  </p>
<p>
   Ver también  <a class="link" href="api.register.compiler.function.tpl" title="register_compiler_function">register_compiler_function() </a>
...
<td width="40%" align="right" valign="top"> unregister_function()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/api.unregister.compiler.function.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02302 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
