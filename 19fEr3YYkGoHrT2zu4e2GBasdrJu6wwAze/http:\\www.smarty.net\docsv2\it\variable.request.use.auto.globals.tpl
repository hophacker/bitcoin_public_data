http://www.smarty.net/docsv2/it/variable.request.use.auto.globals.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 16:02:39 GMT
...
<p>
           Specifica se Smarty deve usare gli array di php $HTTP_*_VARS[]
	   ($request_use_auto_globals=false che è il valore di default) o
	   $_*[] ($request_use_auto_globals=true). Ciò ha effetto sui template
	   che usano {$smarty.request.*}, {$smarty.get.*} ecc. .
	   Attenzione: Se impostate $request_use_auto_globals a true, <a class="link" href="variable.request.vars.order.tpl" title="$request_vars_order">$request_vars_order</a> 
           non ha effetto, e viene usato il valore di configurazione di 
           php <code class="literal">gpc_order</code>.
      </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $error_reporting</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 9 plus 9? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/variable.request.use.auto.globals.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02428 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
