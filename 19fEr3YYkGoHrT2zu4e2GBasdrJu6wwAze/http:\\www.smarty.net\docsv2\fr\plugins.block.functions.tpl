http://www.smarty.net/docsv2/fr/plugins.block.functions.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 11:55:10 GMT
...
<html lang="en">
  <head>
    ...
    <title>Fonctions de blocs | Smarty</title>
...
<tr><th colspan="3" align="center">Fonctions de blocs</th></tr>
<tr>
...
<div class="sect1" title="Fonctions de blocs">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="plugins.block.functions"></a>Fonctions de blocs</h2></div></div></div>
...
<code>array <var class="pdparam">$params</var></code>;<br><code>mixed <var class="pdparam">$content</var></code>;<br><code>object <var class="pdparam">&amp;$smarty</var></code>;</div>
<div class="funcprototype-spacer"> </div>
</div>
<p>
  Les fonctions de blocs sont des fonctions de la forme <code class="literal">{func} .. {/func}</code>.
  ...
  pouvez avoir une fonction utilisateur <code class="literal">{func}</code> et une fonction de bloc
...
<li class="listitem"><p>
    ...
    fermante (voir <code class="literal">$repeat</code> ci-dessous 
...
<li class="listitem"><p>
    ...
    contenus dans le tableau associatif <em class="parameter"><code>$params</code></em>.
    Votre fonction a aussi accès aux attributs de la balise
    ouvrante quand c'est la balise fermante qui est exécutée.
   </p></li>
<li class="listitem"><p>
    La valeur de la variable <em class="parameter"><code>$content</code></em> est différente
    selon si votre fonction est appelée pour la balise ouvrante ou la
    balise fermante. Si c'est pour la balise ouvrante, elle sera à <code class="constant">NULL</code> et si c'est la balise fermante,
...
<li class="listitem"><p>
    Le paramètre <em class="parameter"><code>$repeat</code></em> est passé
    ...
    <em class="parameter"><code>$repeat</code></em> vaut
    <code class="constant">TRUE</code> lors du premier appel à la fonction de bloc (le bloc d'ouverture du tag) et
    <code class="constant">FALSE</code> lors de tous les autres appels à la fonction
    de bloc (le bloc de fermeture du tag). Chaque fois que la fonction
    d'implémentation retourne avec le paramètre
    <em class="parameter"><code>$repeat</code></em> vallant <code class="constant">TRUE</code>, le contenu situé
    <code class="literal">{func}...{/func}</code> est évalué et la fonction d'implémentation est appelé
...
<p>
  ...
  la fonction de bloc parente grâce à la variable <code class="literal">$smarty-&gt;_tag_stack</code>.
  Faîtes un <a class="ulink" href="http://php.net/var_dump" target="_top"><code class="varname">var_dump()</code></a>
  dessus et la structure devrait apparaître.
 </p>
<div class="example">
<a name="id3035412"></a><p class="title"><b>Example 16.5. Fonction de bloc</b></p>
...
<br class="example-break"><p>
  Voir aussi :
  <a class="link" href="api.register.block.tpl" title="register_block()"><code class="varname">register_block()</code></a> et
  <a class="link" href="api.unregister.block.tpl" title="unregister_block()"><code class="varname">unregister_block()</code></a>.
 </p>
</div>
<div class="navfooter">
<hr>
...
<tr>
<td width="40%" align="left" valign="top">Modificateurs </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Fonctions de compilation</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="9cd5867de4c5548a54d8aaa408683261">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/plugins.block.functions.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03170 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
