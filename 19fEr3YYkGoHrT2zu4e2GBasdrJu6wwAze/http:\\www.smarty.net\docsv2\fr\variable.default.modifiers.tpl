...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 05:46:02 GMT
...
<p>
  ...
  utilisez <code class="literal">array('escape:"htmlall"')</code>. Pour rendre une variable indépendante
  des modificateurs par défaut, passez-lui en paramètre le modificateur
  <code class="literal">nodefaults</code> : <code class="literal">{$var|smarty:nodefaults}</code>.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $default_resource_type</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/variable.default.modifiers.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.20516 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
