http://www.smarty.net/docsv2/fr/installing.smarty.extended.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 04:22:16 GMT
...
<html lang="en">
  <head>
    ...
    <title>Configuration avancée | Smarty</title>
...
<tr><th colspan="3" align="center">Configuration avancée</th></tr>
<tr>
...
<div class="sect1" title="Configuration avancée">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="installing.smarty.extended"></a>Configuration avancée</h2></div></div></div>
<p>
    Ceci est la suite de <a class="link" href="installing.smarty.basic.tpl" title="Installation de base">l'installation de base</a>, veuillez
...
<p>
    ...
    <code class="filename">/php/includes/livredor/</code> et un nouveau fichier
    appelé <code class="filename">setup.php</code>.
    Dans notre exemple d'environnement, <code class="filename">/php/includes</code> est notre
    include_path PHP. Assurez-vous de faire la même chose ou alors d'utiliser
    des chemins absolus.
   </p>
<div class="example">
<a name="id2927592"></a><p class="title"><b>Example 2.10. Édition de /php/includes/livredor/setup.php</b></p>
...
<br class="example-break"><p>
    Modifions maintenant le fichier <code class="filename">index.php</code> pour qu'il utilise 
    <code class="filename">setup.php</code>
   </p>
<div class="example">
<a name="id2927621"></a><p class="title"><b>Example 2.11. Édition de /web/www.example.com/docs/livredor/index.php</b></p>
<div class="example-contents"><pre class="programlisting">
...
<br class="example-break"><p>
    ...
    correctement configurée, en utilisant <code class="literal">Smarty_livredor()</code>
...
<tr>
<td width="40%" align="left" valign="top">Installation de base </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Part II. Smarty pour les graphistes</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/installing.smarty.extended.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02115 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
