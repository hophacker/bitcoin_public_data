...
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 23:25:25 GMT
...
<h2>Name</h2>
<p>getRegisteredObject() — returns a reference to a registered object</p>
</div>
<div class="refsect1" title="Description">
<a name="idp16268608"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">array </span><span class="methodname">getRegisteredObject</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">object_name</span></span>);</code><p>
   ...
   <a class="link" href="api.register.object.tpl" title="registerObject()">registered object</a>. See the
   <a class="link" href="advanced.features.objects.tpl" title="Objects">objects</a> page for more info.
  </p>
<div class="example">
<a name="idp16323216"></a><p class="title"><b>Example 14.28. getRegisteredObject()</b></p>
...
<br class="example-break"><p>
  ...
  and
  <a class="link" href="advanced.features.objects.tpl" title="Objects">objects page</a>
  </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> getTags()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 9 plus 15? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/api.get.registered.object.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02498 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
