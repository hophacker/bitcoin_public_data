http://www.smarty.net/docsv2/fr/plugins.resources.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 10:40:17 GMT
...
<tr><th colspan="3" align="center">Ressources</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="plugins.outputfilters.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 16. Etendre Smarty avec des plugins</th>
...
<div class="sect1" title="Ressources">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="plugins.resources"></a>Ressources</h2></div></div></div>
<p>
...
<li class="listitem"><p>
    ...
    stocké. La fonction est supposée retourner <code class="constant">TRUE</code> si
    elle réussit à récupérer la ressource et <code class="constant">FALSE</code> sinon.
   </p></li>
<li class="listitem"><p>
    ...
    être stockée. La fonction est supposée renvoyer <code class="constant">TRUE</code> si elle
    réussit à récupérer la date et <code class="constant">FALSE</code> sinon.
   </p></li>
<li class="listitem"><p>
    La troisième fonction est supposée retourner <code class="constant">TRUE</code>
    ou <code class="constant">FALSE</code> selon si la ressource demandée est sûre
    ou non. La fonction est utilisée seulement pour les ressources templates
    mais doit tout de même être définie.
   </p></li>
<li class="listitem"><p>
    La quatrième fonction est supposée retourner <code class="constant">TRUE</code>
    ou <code class="constant">FALSE</code> selon si l'on peut faire confiance ou
    ...
    <a class="link" href="language.function.include.php.tpl" title="{include_php}">
     <code class="varname">{include_php}</code></a> ou
    <a class="link" href="language.function.insert.tpl" title="{insert}"><code class="varname">{insert}</code></a>
    ayant un attribut <em class="parameter"><code>src</code></em>. Quoiqu'il en soit,
    elle doit être définie pour les ressources templates.
   </p></li>
</ul></div>
<div class="example">
<a name="id3037125"></a><p class="title"><b>Example 16.10. resource plugin</b></p>
...
<br class="example-break"><p>
  Voir aussi :
  <a class="link" href="api.register.resource.tpl" title="register_resource()">register_resource()</a> et
  <a class="link" href="api.unregister.resource.tpl" title="unregister_resource()">unregister_resource()</a>.
 </p>
</div>
<div class="navfooter">
<hr>
...
<tr>
<td width="40%" align="left" valign="top">Filtres de sortie </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Insertions</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 6 plus 8? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/plugins.resources.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02597 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
