http://www.smarty.net/docsv2/es/language.function.html.select.time.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 16:54:07 GMT
...
<td>cual date/time va a usar</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center">true</td>
<td>Mostrar o no los minutos</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center">true</td>
<td>Mostrar o no los segundos</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center">true</td>
<td>Mostrar o no el meridiano (am/pm)</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center">true</td>
<td>Usar o no reloj de 24 horas</td>
</tr>
<tr>
...
<td>número de los intervalos de los minutos del menu dropdown</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center">1</td>
<td>número de los intervalos de los segundos del menu dropdown</td>
</tr>
<tr>
...
<td>muestra los valores del arreglo con este nombre</td>
</tr>
<tr>
...
<td>adiciona atributos extras a las etiquetas select/input
        si fueron proporcionados</td>
</tr>
<tr>
...
<p>
  ...
  parseda por php's <a class="ulink" href="http://php.net/strtotime" target="_top">strtotime()</a>.
 </p>
<div class="example">
<a name="id3102321"></a><p class="title"><b>Example 8.17. {html_select_time}</b></p>
...
<td width="40%" align="right" valign="top"> {html_table}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.function.html.select.time.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02160 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
