http://www.smarty.net/docsv2/fr/plugins.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 17:26:27 GMT
...
<html lang="en">
  <head>
    ...
    <title>Chapter 16. Etendre Smarty avec des plugins | Smarty</title>
...
<tr><th colspan="3" align="center">Chapter 16. Etendre Smarty avec des plugins</th></tr>
<tr>
...
<div class="chapter" title="Chapter 16. Etendre Smarty avec des plugins">
<div class="titlepage"><div><div><h2 class="title">
<a name="plugins"></a>Chapter 16. Etendre Smarty avec des plugins</h2></div></div></div>
<div class="toc">
...
<li class="listitem">les fonctions</li>
<li class="listitem">les modificateurs</li>
<li class="listitem">les fonctions de blocs</li>
<li class="listitem">les fonctions de compilation</li>
<li class="listitem">les filtres de pré-compilation</li>
<li class="listitem">les filtres de post-compilation</li>
<li class="listitem">les filtres de sorties</li>
<li class="listitem">les ressources</li>
<li class="listitem">les insertions</li>
</ul></div>
<p>
  ...
  <code class="literal">$custom_funcs</code>, <code class="literal">$custom_mods</code> et
...
<div class="sect1" title="Comment fonctionnent les plugins">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="plugins.howto"></a>Comment fonctionnent les plugins</h2></div></div></div>
<p>
...
<p>
  Le <a class="link" href="variable.plugins.dir.tpl" title="$plugins_dir">répertoire de plugin</a> peut
...
<tr>
<td width="40%" align="left" valign="top">Ressources </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Conventions de nommage</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 1 plus 1? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="c911c9273adcead8e98432725b087c5c">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/plugins.tpl">
            </form>
            </div>
          </div>
