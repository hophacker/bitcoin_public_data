http://www.smarty.net/docsv2/en/api.unregister.compiler.function.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 06:16:07 GMT
...
<html lang="en">
  <head>
    ...
    <title>unregister_compiler_function() | Smarty</title>
...
<tr><th colspan="3" align="center">unregister_compiler_function()</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="api.unregister.block.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 13. Smarty Class Methods()</th>
<td width="20%" align="right"> <a accesskey="n" href="api.unregister.function.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="refentry" title="unregister_compiler_function()">
<a name="api.unregister.compiler.function"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>unregister_compiler_function() — dynamically unregister a compiler function</p>
</div>
<div class="refsect1" title="Description">
<a name="id2861847"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">unregister_compiler_function</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">name</span></span>);</code><p>
   Pass in
   the <em class="parameter"><code>name</code></em> of the compiler function.
  </p>
<p>
  See also
  <a class="link" href="api.register.compiler.function.tpl" title="register_compiler_function()">
  <code class="varname">register_compiler_function()</code></a>
  and
  <a class="link" href="plugins.compiler.functions.tpl" title="Compiler Functions">plugin compiler functions</a>.
</p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right"> <a accesskey="n" href="api.unregister.function.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">unregister_block() </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> unregister_function</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/api.unregister.compiler.function.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02168 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
