http://www.smarty.net/docsv2/pt_BR/variable.request.vars.order.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 13:24:55 GMT
...
<td width="40%" align="right" valign="top"> $request_use_auto_globals</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="c22dc3af9f882a3ce375b2940e6240e8">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/variable.request.vars.order.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02396 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
