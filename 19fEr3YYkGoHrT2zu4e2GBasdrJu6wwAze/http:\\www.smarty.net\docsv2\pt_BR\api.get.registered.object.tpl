http://www.smarty.net/docsv2/pt_BR/api.get.registered.object.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 08:26:19 GMT
...
<div class="sect1" title="get_registered_object">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="api.get.registered.object"></a>get_registered_object</h2></div></div></div>
<div class="funcsynopsis">
<table border="0" summary="Function synopsis" cellspacing="0" cellpadding="0" class="funcprototype-table"><tr>
<td><code class="funcdef">array <b class="fsfunc">get_registered_object</b>(</code></td>
<td>
<var class="pdparam">object_name</var><code>)</code>;</td>
<td> </td>
</tr></table>
<div class="paramdef-list">
<code>string <var class="pdparam">object_name</var></code>;</div>
...
<div class="example">
<a name="id2758087"></a><p class="title"><b>Example 13.16. get_registered_object</b></p>
...
<td width="40%" align="right" valign="top"> get_template_vars</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/api.get.registered.object.tpl">
            </form>
            </div>
          </div>
