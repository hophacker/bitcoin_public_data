http://www.smarty.net/docsv2/it/language.function.include.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 01:39:51 GMT
...
<td>Nome del file di template da includere</td>
</tr>
<tr>
...
<td align="center"><span class="emphasis"><em>nessuno</em></span></td>
<td>Nome della variabile cui sarà assegnato
                                                l'output dell'include</td>
</tr>
<tr>
<td align="center">[variabile ...]</td>
<td align="center">[tipo variabile]</td>
<td align="center">no</td>
<td align="center"><span class="emphasis"><em>nessuno</em></span></td>
<td>Variabile da passare localmente al template</td>
</tr>
</tbody>
</table></div>
<p>
...
<p>
			Opzionalmente si può passare l'attributo <span class="emphasis"><em>assign</em></span>,
			che specifica un nome di variabile del template alla quale
			sarà assegnato l'output dell'<span class="emphasis"><em>include</em></span>, invece
			di essere visualizzato.
			</p>
<div class="example">
<a name="id3105756"></a><p class="title"><b>Example 7.6. funzione include</b></p>
<div class="example-contents"><pre class="programlisting">
{include file="header.tpl"}

{* qui va il corpo del template *}

{include file="footer.tpl"}</pre></div>
</div>
...
<div class="example">
<a name="id3105777"></a><p class="title"><b>Example 7.7. funzione include con passaggio di variabili</b></p>
<div class="example-contents"><pre class="programlisting">
{include file="header.tpl" title="Main Menu" table_bgcolor="#c0c0c0"}

{* qui va il corpo del template *}

{include file="footer.tpl" logo="http://my.example.com/logo.gif"}</pre></div>
</div>
<br class="example-break"><p>
			Usate la sintassi delle <a class="link" href="template.resources.tpl" title="Risorse">risorse dei template</a> per
			includere file esterni alla directory $template_dir.
			</p>
<div class="example">
<a name="id3105802"></a><p class="title"><b>Example 7.8. esempi di funzione include con le risorse dei template</b></p>
<div class="example-contents"><pre class="programlisting">
{* percorso assoluto *}
...
{include file="db:header.tpl"}</pre></div>
</div>
...
<td width="40%" align="right" valign="top"> include_php</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/language.function.include.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02062 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
