http://www.smarty.net/docsv2/fr/variable.caching.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 05:45:55 GMT
...
<p>
  ...
  <a class="link" href="caching.multiple.caches.tpl" title="Caches multiples pour une seule page">nombreux fichiers de cache</a>
...
<li class="listitem"><p>
  ...
  la durée de vie d'un fichier de cache avant de <a class="link" href="api.fetch.tpl" title="fetch()">récupérer</a>
    le template pour avoir un certain contrôle quand ce fichier en particulier expire. Voir
  aussi <a class="link" href="api.is.cached.tpl" title="is_cached()"><code class="varname">is_cached()</code></a>.
   </p></li>
<li class="listitem"><p>
    Si <a class="link" href="variable.compile.check.tpl" title="$compile_check"><em class="parameter"><code>$compile_check</code></em></a>
...
<li class="listitem"><p>
    Si <a class="link" href="variable.force.compile.tpl" title="$force_compile">
     <em class="parameter"><code>$force_compile</code></em></a> est actif, le contenu du cache
...
<p>
  ...
  <a class="link" href="variable.cache.lifetime.tpl" title="$cache_lifetime"><em class="parameter"><code>$cache_lifetime</code></em></a>,
  <a class="link" href="variable.cache.handler.func.tpl" title="$cache_handler_func"><em class="parameter"><code>$cache_handler_func</code></em></a>,
  ...
  <a class="link" href="api.is.cached.tpl" title="is_cached()"><code class="varname">is_cached()</code></a> et
...
<td width="40%" align="right" valign="top"> $cache_dir</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/variable.caching.tpl">
            </form>
            </div>
          </div>
