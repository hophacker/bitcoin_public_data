http://www.smarty.net/docsv2/it/language.custom.functions.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 21:18:35 GMT
...
<p>
  Smarty è fornito di numerose funzioni utente che potete
...
<td>Nome della variabile valorizzata</td>
</tr>
<tr>
...
<td align="center">sì</td>
<td align="center"><span class="emphasis"><em>nessuno</em></span></td>
<td>Valore assegnato alla variabile</td>
</tr>
</tbody>
</table></div>
<p>
...
<div class="example">
<a name="id3113841"></a><p class="title"><b>Example 8.1. assign</b></p>
...
The value of $name is Bob.</pre></div>
</div>
...
<td width="40%" align="right" valign="top"> counter</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 18 plus 14? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/language.custom.functions.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02552 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
