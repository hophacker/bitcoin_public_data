http://www.smarty.net/docsv2/es/language.function.html.table.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 11:22:27 GMT
...
<td>matriz de datos para el ciclo(loop)</td>
</tr>
<tr>
...
<td>Número de columnas para la tabla. Si el atributo cols esta vacio, 
...
<td> Número de renglones en la tabla. Si el atributo rows es vacio, 
...
<td> Dirección consecutiva de los elementos en el arreglo para ser representados.
                     <span class="emphasis"><em>cols</em></span> manera en que los elementos son mostrados columna 
                     por columna.  <span class="emphasis"><em>rows</em></span> manera en que los elementos son mostrados 
                     renglon por renglon.
                    </td>
</tr>
<tr>
...
<td>atributos para la etiqueta table</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>empty</em></span></td>
<td>atributos para la etiqueta tr (arreglos del ciclo)</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>empty</em></span></td>
<td>atributos para la etiqueta td (arreglos del ciclo)</td>
</tr>
<tr>
...
<td>valor de relleno de las celdas para el ultimo
                        renglon con (si hay alguno)</td>
</tr>
<tr>
...
<td> dirección de una linea para ser representada.  posibles valores: 
                         <span class="emphasis"><em>left</em></span> (left-to-right), <span class="emphasis"><em>right</em></span> (right-to-left)
                        </td>
</tr>
<tr>
...
<td>Dirección de las columnas para ser representadas.  posibles valores:
                              <span class="emphasis"><em>down</em></span> (top-to-bottom), <span class="emphasis"><em>up</em></span> (bottom-to-top)
                        </td>
</tr>
</tbody>
</table></div>
<p>
    ...
    <span class="emphasis"><em>cols</em></span> determina el número de columnas que tendra la tabla.
    Los valores <span class="emphasis"><em>table_attr</em></span>, <span class="emphasis"><em>tr_attr</em></span> y 
    <span class="emphasis"><em>td_attr</em></span> determinan los atributos dados para las etiquetas 
    tabla, tr y td. Si <span class="emphasis"><em>tr_attr</em></span> o  <span class="emphasis"><em>td_attr</em></span>
    son arreglos, ellos entraran en un ciclo. <span class="emphasis"><em>trailpad</em></span> y el 
    valor depositado dentro de trailing cells en la ultima linea de la tabla si existe 
    alguna presente.
			</p>
<div class="example">
<a name="id3103538"></a><p class="title"><b>Example 8.18. html_table</b></p>
...
<td width="40%" align="right" valign="top"> math</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 15 plus 5? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.function.html.table.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03725 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
