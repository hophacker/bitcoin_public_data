http://www.smarty.net/docsv2/it/variable.cache.dir.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 06:16:03 GMT
...
<p>
       Questo è il nome della directory dove vengono salvati i file
       della cache. Per default è "./cache", che significa che Smarty
       cercherà la directory della cache nella stessa directory dello
       script php in esecuzione. Potete anche usare una funzione 
       personalizzata di gestione della cache, che ignorerà questa
       impostazione.
      </p>
<div class="note" title="Nota tecnica" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Nota tecnica</h3>
<p>
        Questa impostazione deve essere un percorso relativo o assoluto.
        include_path non viene usato per i file in scrittura.
       </p>
</div>
<div class="note" title="Nota tecnica" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Nota tecnica</h3>
...
<td width="40%" align="right" valign="top"> $cache_lifetime</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/variable.cache.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02589 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
