http://www.smarty.net/docsv2/fr/getting.started.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 14:43:25 GMT
...
<html lang="en">
  <head>
    ...
    <title>Part I. Pour commencer | Smarty</title>
...
<tr><th colspan="3" align="center">Part I. Pour commencer</th></tr>
<tr>
...
<div class="part" title="Part I. Pour commencer">
<div class="titlepage"><div><div><h1 class="title">
<a name="getting.started"></a>Part I. Pour commencer</h1></div></div></div>
<div class="toc">
...
<tr>
<td width="40%" align="left" valign="top">Préface </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Chapter 1. Qu'est-ce que Smarty ?</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 12 plus 6? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/getting.started.tpl">
            </form>
            </div>
          </div>
