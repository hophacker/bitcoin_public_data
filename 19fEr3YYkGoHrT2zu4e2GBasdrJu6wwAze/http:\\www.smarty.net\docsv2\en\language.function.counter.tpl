http://www.smarty.net/docsv2/en/language.function.counter.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 09:16:30 GMT
...
<div class="example">
<a name="id2818800"></a><p class="title"><b>Example 8.4. {counter}</b></p>
...
<td width="40%" align="right" valign="top"> {cycle}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 5 plus 15? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/language.function.counter.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01768 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
