http://www.smarty.net/docsv2/de/section.template.cache.handler.func.tpl
HTTP/1.1 200 OK
...
<html lang="en">
  <head>
    ...
    <title>Cache Handler Funktion | Smarty</title>
...
<tr><th colspan="3" align="center">Cache Handler Funktion</th></tr>
<tr>
...
<td width="20%" align="right"> <a accesskey="n" href="template.resources.tpl">Next</a>
</td>
</tr>
</table>
<hr>
</div>
<div class="sect1" title="Cache Handler Funktion">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="section.template.cache.handler.func"></a>Cache Handler Funktion</h2></div></div></div>
<p>
...
<p>
  ...
  <a class="link" href="variable.cache.handler.func.tpl" title="$cache_handler_func">$cache_handler_func</a> zu.
...
<p>
  Der letzte Parameter (<em class="parameter"><code>$exp_time</code></em>) wurde in
  Smarty-2.6.0 hinzugefügt.
 </p>
<div class="example">
<a name="id2934924"></a><p class="title"><b>Example 15.5. Beispiel mit einer MySQL Datenbank als Datenquelle</b></p>
...
<td width="40%" align="right"> <a accesskey="n" href="template.resources.tpl">Next</a>
</td>
</tr>
<tr>
<td width="40%" align="left" valign="top">Ausgabefilter </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Ressourcen</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/section.template.cache.handler.func.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02350 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
