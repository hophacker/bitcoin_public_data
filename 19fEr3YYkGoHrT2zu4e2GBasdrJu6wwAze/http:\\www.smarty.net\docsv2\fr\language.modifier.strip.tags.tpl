...
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 14:31:14 GMT
...
<p>
  ...
  entre <code class="literal">&lt;</code> et <code class="literal">&gt;</code>.
 </p>
...
<td>Si l'on remplace les éléments par ' ' ou par ''</td>
</tr></tbody>
</table></div>
<div class="example">
<a name="id2942830"></a><p class="title"><b>Example 5.20. strip_tags</b></p>
...
<td width="40%" align="right" valign="top"> truncate</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/language.modifier.strip.tags.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02059 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
