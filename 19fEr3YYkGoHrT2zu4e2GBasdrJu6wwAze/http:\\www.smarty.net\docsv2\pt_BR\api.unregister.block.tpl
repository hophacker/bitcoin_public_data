http://www.smarty.net/docsv2/pt_BR/api.unregister.block.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 09:17:01 GMT
...
<div class="sect1" title="unregister_block">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="api.unregister.block"></a>unregister_block</h2></div></div></div>
<div class="funcsynopsis">
<table border="0" summary="Function synopsis" cellspacing="0" cellpadding="0" class="funcprototype-table"><tr>
<td><code class="funcdef">void <b class="fsfunc">unregister_block</b>(</code></td>
<td>
...
<td width="40%" align="right" valign="top"> unregister_compiler_function</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/api.unregister.block.tpl">
            </form>
            </div>
          </div>
