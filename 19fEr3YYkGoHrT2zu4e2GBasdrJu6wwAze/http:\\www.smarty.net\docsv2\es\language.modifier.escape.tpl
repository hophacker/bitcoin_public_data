http://www.smarty.net/docsv2/es/language.modifier.escape.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 08:25:59 GMT
...
<td align="center">html,htmlall,url,quotes,hex,hexentity,javascript</td>
<td align="center">html</td>
<td>Este es el formato de escape a utilizar.</td>
</tr></tbody>
</table></div>
<p>
...
<div class="example">
<a name="id3072111"></a><p class="title"><b>Example 5.10. escape</b></p>
...
<br class="example-break"><p>
   Ver también <a class="link" href="language.escaping.tpl" title="Escaping Smarty Parsing">Escaping Smarty Parsing</a>
   y <a class="link" href="tips.obfuscating.email.tpl" title="Ofuscando direcciones de E-mail">Obfuscating E-mail Addresses</a>.
  </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> indent</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 12 plus 0? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.modifier.escape.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02720 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
