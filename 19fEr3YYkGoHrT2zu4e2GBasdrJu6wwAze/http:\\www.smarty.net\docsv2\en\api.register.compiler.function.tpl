...
<h2>Name</h2>
<p>register_compiler_function() — dynamically register a compiler function plugin</p>
</div>
<div class="refsect1" title="Description">
<a name="id2857065"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">bool </span><span class="methodname">register_compiler_function</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">name</span></span>,<br>                                <span class="methodparam"><span class="type">mixed </span><span class="parameter">impl</span></span>,<br>                                <span class="methodparam"><span class="type">bool </span><span class="parameter">cacheable</span></span>);</code><p>
   Pass in the
   <a class="link" href="plugins.compiler.functions.tpl" title="Compiler Functions">compiler function</a> name,
...
<p>
   <em class="parameter"><code>cacheable</code></em> can be omitted in
   most cases. See <a class="link" href="caching.cacheable.tpl" title="Controlling Cacheability of Plugins' Output">controlling
   cacheability of plugin output</a> on how to use it properly.
  </p>
<p>
See also
...
and the
<a class="link" href="plugins.compiler.functions.tpl" title="Compiler Functions">plugin compiler functions</a> section.
</p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> register_function()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/api.register.compiler.function.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02469 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
