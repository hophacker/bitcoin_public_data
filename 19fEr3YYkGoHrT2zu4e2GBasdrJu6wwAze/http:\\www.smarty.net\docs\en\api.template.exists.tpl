...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 13:45:27 GMT
...
<h2>Name</h2>
<p>templateExists() — checks whether the specified template exists</p>
</div>
<div class="refsect1" title="Description">
<a name="idp16991136"></a><h2>Description</h2>
...
<div class="example">
<a name="idp17049792"></a><p class="title"><b>Example 14.48. templateExists()</b></p>
...
<td width="40%" align="right" valign="top"> unregisterCacheResource()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/api.template.exists.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01736 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
