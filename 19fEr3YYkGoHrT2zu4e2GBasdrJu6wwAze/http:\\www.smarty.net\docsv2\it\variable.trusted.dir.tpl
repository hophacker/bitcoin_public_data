http://www.smarty.net/docsv2/it/variable.trusted.dir.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 09:16:42 GMT
...
<p>
	   $trusted_dir viene usata solo quando $security è abilitata. E' un array
	   di tutte le directory che sono considerate affidabili. Le directory
	   affidabili sono quelle dalle quali possono essere eseguiti script php
	   direttamente dai template con <a class="link" href="language.function.include.php.tpl" title="include_php">{include_php}</a>.
      </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $left_delimiter</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/variable.trusted.dir.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.19035 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
