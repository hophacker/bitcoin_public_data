...
<html lang="en">
  <head>
    ...
    <title>Static Classes | Smarty</title>
    <meta name="description" content="Static Classes">
    <meta name="keywords" content="static, classes">
...
<tr><th colspan="3" align="center">Static Classes</th></tr>
<tr>
...
<div class="sect1" title="Static Classes">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="advanced.features.static.classes"></a>Static Classes</h2></div></div></div>
<p>
...
<div class="example">
<a name="idp19331120"></a><p class="title"><b>Example 17.10. static class access syntax </b></p>
...
<tr>
<td width="40%" align="left" valign="top">Objects </td>
...
<td width="40%" align="right" valign="top"> Prefilters</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/advanced.features.static.classes.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02121 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
