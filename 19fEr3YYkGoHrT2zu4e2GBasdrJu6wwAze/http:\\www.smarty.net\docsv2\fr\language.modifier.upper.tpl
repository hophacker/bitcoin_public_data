http://www.smarty.net/docsv2/fr/language.modifier.upper.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 04:22:10 GMT
...
<p>
  Met une variable en majuscules. C'est l'équivalent de la fonction PHP
  <a class="ulink" href="http://php.net/strtoupper" target="_top"><code class="varname">strtoupper()</code></a>.
 </p>
<div class="example">
<a name="id2942940"></a><p class="title"><b>Example 5.22. upper</b></p>
...
<br class="example-break"><p>
  Voir aussi
  <a class="link" href="language.modifier.lower.tpl" title="lower"><code class="varname">lower</code></a> et
...
<td width="40%" align="right" valign="top"> wordwrap</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 3 plus 20? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/language.modifier.upper.tpl">
            </form>
            </div>
          </div>
