http://www.smarty.net/docsv2/it/variable.compile.check.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 12:15:50 GMT
...
<p>
           ...
           modificati. Consultate <a class="link" href="variable.force.compile.tpl" title="$force_compile">$force_compile</a> o <a class="link" href="api.clear.compiled.tpl.tpl" title="clear_compiled_tpl">clear_compiled_tpl</a>.
      </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $force_compile</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/variable.compile.check.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02740 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
