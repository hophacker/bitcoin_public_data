http://www.smarty.net/docsv2/pt_BR/advanced.features.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 18:04:44 GMT
...
<p>
	O quinto parâmetro opcional só tem efeito com <em class="parameter"><code>format</code></em> 
	sendo <code class="literal">true</code> e contém 
	...
	(<code class="literal">{foobar-&gt;meth2}...{/foobar-&gt;meth2}</code>) e
	...
	<em class="parameter"><code>&amp;$smarty</code></em> e
	<em class="parameter"><code>&amp;$repeat</code></em> e eles também comportam-se como
	block-function-plugins.
	</p>
<div class="example">
<a name="id2769159"></a><p class="title"><b>Example 15.1. usando um objeto registrado ou atribuído</b></p>
...
<td width="40%" align="right" valign="top"> Prefilters</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 3 plus 16? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/advanced.features.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02548 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
