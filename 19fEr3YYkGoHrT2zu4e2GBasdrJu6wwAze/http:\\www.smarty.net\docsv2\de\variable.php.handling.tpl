http://www.smarty.net/docsv2/de/variable.php.handling.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 08:25:46 GMT
...
<p>
      ...
      auf PHP-Code aus, der zwischen <a class="link" href="language.function.php.tpl" title="php">{php}{/php}</a>
      Tags steht.
    </p>
<div class="itemizedlist"><ul class="itemizedlist" type="disc">
<li class="listitem"><p>SMARTY_PHP_PASSTHRU - Smarty gibt die Tags aus.</p></li>
<li class="listitem"><p>SMARTY_PHP_QUOTE - Smarty maskiert die Tags als HTML-Entities.</p></li>
<li class="listitem"><p>SMARTY_PHP_REMOVE - Smarty entfernt die Tags.</p></li>
<li class="listitem"><p>SMARTY_PHP_ALLOW - Smarty führt den Code als PHP-Code aus.</p></li>
</ul></div>
<p>
      ACHTUNG: Es wird dringend davon abgeraten, PHP-Code in Templates einzubetten.
      Bitte verwenden Sie stattdessen <a class="link" href="language.custom.functions.tpl" title="Chapter 8. Eigene Funktionen">custom functions</a>
      oder <a class="link" href="language.modifiers.tpl" title="Chapter 5. Variablen-Modifikatoren">Variablen-Modifikatoren</a>.
    </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $security</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/variable.php.handling.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01810 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
