http://www.smarty.net/docsv2/en/language.function.html.checkboxes.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 15:16:00 GMT
...
<div class="example">
<a name="id2821730"></a><p class="title"><b>Example 8.9. {html_checkboxes}</b></p>
...
<a name="id2821817"></a><p class="title"><b>Example 8.10. 
...
<td width="40%" align="right" valign="top"> {html_image}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/language.function.html.checkboxes.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02359 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
