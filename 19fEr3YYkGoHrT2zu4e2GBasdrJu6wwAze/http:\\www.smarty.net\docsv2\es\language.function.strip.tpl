http://www.smarty.net/docsv2/es/language.function.strip.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 19:57:53 GMT
...
<p>
   Muchas veces el diseñador de web tiene problemas con los espacios en
...
<p>
    ...
    Vea la función <a class="link" href="language.modifier.strip.tpl" title="strip">strip modifier</a>.
			</p>
</div>
<div class="example">
<a name="id3089263"></a><p class="title"><b>Example 7.30. {strip} tags</b></p>
...
<p>
     Vea También <a class="link" href="language.modifier.strip.tpl" title="strip">strip modifier</a>
   </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> Chapter 8. Custom Functions</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.function.strip.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02304 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
