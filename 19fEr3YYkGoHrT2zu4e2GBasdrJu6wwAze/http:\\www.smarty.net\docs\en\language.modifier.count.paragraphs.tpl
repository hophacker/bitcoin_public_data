http://www.smarty.net/docs/en/language.modifier.count.paragraphs.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 03:32:01 GMT
...
<div class="example">
<a name="idp6149040"></a><p class="title"><b>Example 5.5. count_paragraphs</b></p>
...
<td width="40%" align="right" valign="top"> count_sentences</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/language.modifier.count.paragraphs.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02220 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
