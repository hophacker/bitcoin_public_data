http://www.smarty.net/docsv2/es/language.function.popup.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 20:07:55 GMT
...
<td>El text/html para mostrar en la ventana popup</td>
</tr>
<tr>
...
<td>El que va a ser usado para que aparezca la
                        ventana. Puede ser onMouseOver u onClick</td>
</tr>
<tr>
...
<td>Hace que el poppup se quede cerca hasta que se cierre</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Defíne el texto para el título</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>El color que va a ser usado dentro de la caja popup</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>El color del borde de la caja popup</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Defíne el color del texto dentro de la caja popup</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Defíne el color del título de la caja</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Defíne el color del texto para cerrar</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Defíne el color del texto para ser usado en el texto principal</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Defíne el tipo de letra para ser usado en el Título</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Defíne el tipo de letra para el texto "Close"</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Defíne el tipo de letra del texto principal</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Defíne el tamaño del tipo de letra del título</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Defíne el tamaño del tipo de letra del texto "Close"</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Defíne el ancho de la caja</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Defíne la altura de la caja</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>false</em></span></td>
<td>Hace que el popups vaya para la izquierda del ratón</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>false</em></span></td>
<td>Hace que el popups vaya para la derecha del ratón</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>false</em></span></td>
<td>Hace que el popups vaya al centro del ratón</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>false</em></span></td>
<td> Hace que el popups vaya por encima del
                           rató. NOTA:solamente es posible si el height fue definido
						                  </td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>false</em></span></td>
<td>Hace que el popups vaya por abajo del ratón</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Torna en gruesos o finos los bordes del popups</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>A que distancia del ratón aparecera el popup, horizontalmente
                        </td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>A que distancia del ratón aparecera el popup, verticalmente
                        </td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Defíne una imagen para usar en vez del color del popup.
						                  </td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td> defíne una imagen para ser usada como borde en
                         vez de un color para el popup.  
                         NOTA:Usted debe definir bgcolor como "" o el color aparecera también. 
                         NOTA: Cuando tuviera un link "Close", el Netscape rediseñara las
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Defíne el texto "Close" a otra cosa</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>No muestra el texto "Close" pegado con el título</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Defíne el texto en la barra de estado del navegador </td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Defíne el texto en la barra de estado para el texto del popup.  
                         NOTA: sobreescribe la definición del status.</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Defíne el texto de la barra de estado como el texto del título 
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td> Indica al overLib desde que índice de la
      matriz ol_text debe leer el texto, localizada en overlib.js.  
      Este parámetro puede ser usado en vez del texto
						</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Indica al overLib a partir de que índice de la
                           matriz ol_caps leer el título</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Muestra la imagen antes del título</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Instantanea el popup a una posición
                         constante en una cuadricula horizontal</td>
</tr>
<tr>
...
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Instantanea el popup a una posición
                         constante en una cuadricula vertical</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Cierra el popups en una posición horizontal
                           Nota: pasa por encima de otros colocados horizontal</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Cierra popups en posición vertical
                           Note: pasa por encima de otros colocados vertical</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Defíne una imagen para ser usada como fondo en
                           vez de la tabla</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Rellena el fondo de la imagen con espacios en blanco
                           horizontal para colocar el texto.  
                           Nota: este es un comando de dos parámetros</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Permite a usted controlar completamente el html sobre
                           la figura de fondo. 
                           El código HTML es esperado en el atributo "text"</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Controla popups en frames diferentes. Para mayores informes 
                        sobre esta función vea la pagina de overlib</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>LLama especificamente a una función javascript
                           y toma el valor que retorna, como el texto que se
                           va a mostrar en la ventana popup</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Hace que el popup funcione como un tooltip.
                           Este aparecera solo con un retraso en milesimas de segundo</td>
</tr>
<tr>
...
<td align="center">No</td>
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Determina automáticamente si el popup debe
                           aparecer a la izquierda o a la derecha del ratón. </td>
</tr>
<tr>
...
<td align="center"><span class="emphasis"><em>n/a</em></span></td>
<td>Determina automáticamente si el popup debe
           aparecer abajo o arriba del ratón.</td>
</tr>
</tbody>
</table></div>
<p>
    {popup} es usado para crear ventanas popup con javascript.
    <a class="link" href="language.function.popup.init.tpl" title="{popup_init}">{popup_init}</a> DEBE ser
    llamado primero para poder trabajar.
			</p>
<div class="example">
<a name="id3107206"></a><p class="title"><b>Example 8.22. popup</b></p>
...
<br class="example-break"><p>
 Ver también <a class="link" href="language.function.popup.init.tpl" title="{popup_init}">{popup_init}</a>
 y <a class="ulink" href="http://www.bosrup.com/web/overlib/" target="_top">overLib</a>.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> {textformat}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/language.function.popup.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02885 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
