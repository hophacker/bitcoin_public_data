http://www.smarty.net/docsv2/fr/variable.autoload.filters.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 04:22:51 GMT
...
<p>
  Voir aussi
      ...
      <a class="link" href="api.register.postfilter.tpl" title="register_postfilter()"><code class="varname">register_postfilter()</code></a> et
...
<td width="40%" align="right" valign="top"> $compile_check</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/variable.autoload.filters.tpl">
            </form>
            </div>
          </div>
