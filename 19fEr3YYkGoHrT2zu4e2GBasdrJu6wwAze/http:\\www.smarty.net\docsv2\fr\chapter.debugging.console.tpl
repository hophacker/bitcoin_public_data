http://www.smarty.net/docsv2/fr/chapter.debugging.console.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 03:42:23 GMT
...
<html lang="en">
  <head>
    ...
    <title>Chapter 10. Console de débogage | Smarty</title>
...
<tr><th colspan="3" align="center">Chapter 10. Console de débogage</th></tr>
<tr>
...
<div class="chapter" title="Chapter 10. Console de débogage">
<div class="titlepage"><div><div><h2 class="title">
<a name="chapter.debugging.console"></a>Chapter 10. Console de débogage</h2></div></div></div>
<p>
  Il existe une console de débogage dans Smarty. La console vous indique
  toutes les templates <a class="link" href="language.function.include.tpl" title="{include}">incluses</a>,
  les variables <a class="link" href="api.assign.tpl" title="assign()">assignées</a> et chargées depuis un fichier de
  <a class="link" href="language.config.variables.tpl" title="Variables chargées depuis des fichiers de configuration">configuration</a> pour le template courant.
  Un template appelé <code class="literal">debug.tpl</code> est inclus dans la distribution de Smarty qui contrôle
  le formattage de la console. Définissez <a class="link" href="variable.debugging.tpl" title="$debugging">$debugging</a>
  à <code class="constant">TRUE</code> dans Smarty et, si besoin, vous pouvez définir
  <a class="link" href="variable.debug.tpl.tpl" title="$debug_tpl"><em class="parameter"><code>$debug_tpl</code></em></a>
  de façon à ce que ce dernier contienne le chemin du template à utiliser(dans
  <a class="link" href="smarty.constants.tpl#constant.smarty.dir" title="SMARTY_DIR"><code class="constant">SMARTY_DIR</code></a> par defaut).
  ...
  voir la fonction <a class="link" href="language.function.debug.tpl" title="{debug}"><code class="varname">{debug}</code></a>.
  Pour désactiver la console de débogage, définissez 
  <a class="link" href="variable.debugging.tpl" title="$debugging"><em class="parameter"><code>$debugging</code></em></a> à <code class="constant">FALSE</code>.
  Vous pouvez également temporairement activer le débogage en indiquant
  <code class="literal">SMARTY_DEBUG</code> dans l'url si tant est que l'option
...
<p>
    ...
    <code class="literal">debug.tpl</code> pour formater les données de la façon qui vous conviendra le
...
<p>
   Voir aussi
   <a class="link" href="troubleshooting.tpl" title="Chapter 17. Diagnostic des erreurs">troubleshooting</a>,
   <a class="link" href="variable.error.reporting.tpl" title="$error_reporting"><em class="parameter"><code>$error_reporting</code></em></a>
   et <a class="link" href="api.trigger.error.tpl" title="trigger_error()"><code class="varname">trigger_error()</code></a>.
   </p>
</div>
<div class="navfooter">
<hr>
...
<tr>
<td width="40%" align="left" valign="top">Chapter 9. Fichiers de configuration </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Part III. Smarty pour les programmeurs</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 3 plus 8? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="d41c2124062f87c7f24e4896b7b75d9e">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/chapter.debugging.console.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01651 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
