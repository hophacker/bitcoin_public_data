http://www.smarty.net/docsv2/en/variable.request.vars.order.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 17:26:42 GMT
...
<p>
 See also
 <a class="link" href="language.variables.smarty.tpl" title="{$smarty} reserved variable"><em class="parameter"><code>$smarty.request</code></em></a>
 and
 <a class="link" href="variable.request.use.auto.globals.tpl" title="$request_use_auto_globals"><em class="parameter"><code>$request_use_auto_globals</code></em></a>.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $request_use_auto_globals</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/variable.request.vars.order.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.20686 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
