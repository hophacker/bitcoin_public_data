...
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 02:10:27 GMT
...
<h2>Name</h2>
<p>getTags() — return tags used by template</p>
</div>
<div class="refsect1" title="Description">
<a name="idp16293392"></a><h2>Description</h2>
...
<div class="itemizedlist"><ul class="itemizedlist" type="disc"><li class="listitem"><p>
       <em class="parameter"><code>template</code></em> is the template object.
      </p></li></ul></div>
<p>
  </p>
...
<div class="example">
<a name="idp16352672"></a><p class="title"><b>Example 14.29. getTags()</b></p>
...
<td width="40%" align="right" valign="top"> getTemplateDir()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docs/en/api.get.tags.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01525 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
