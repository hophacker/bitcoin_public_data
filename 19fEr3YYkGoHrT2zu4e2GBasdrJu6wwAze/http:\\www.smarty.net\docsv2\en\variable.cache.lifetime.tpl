http://www.smarty.net/docsv2/en/variable.cache.lifetime.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 12:22:53 GMT
...
<li class="listitem"><p>
     <em class="parameter"><code>$caching</code></em> must be turned on (either 1 or 2) for
     <em class="parameter"><code>$cache_lifetime</code></em> to have any purpose.
     </p></li>
<li class="listitem"><p>
     A <em class="parameter"><code>$cache_lifetime</code></em> value of -1 will force the cache to never expire.
     </p></li>
<li class="listitem"><p>A value of 0 will cause
     the cache to always regenerate (good for testing only, to disable caching
     a more efficient method is to set <a class="link" href="variable.caching.tpl" title="$caching"><em class="parameter"><code>$caching</code></em></a> = 0).
    </p></li>
<li class="listitem"><p>
      If you want to give certain templates their own cache lifetime, you could
      do this by setting <a class="link" href="variable.caching.tpl" title="$caching">
      <em class="parameter"><code>$caching</code></em></a> = 2,
      then set <em class="parameter"><code>$cache_lifetime</code></em> to a unique value just
      before calling <a class="link" href="api.display.tpl" title="display()"><code class="varname">display()</code>
      </a> or <a class="link" href="api.fetch.tpl" title="fetch()"><code class="varname">fetch()</code></a>.
     </p></li>
</ul></div>
<p>
     If <a class="link" href="variable.force.compile.tpl" title="$force_compile">
     <em class="parameter"><code>$force_compile</code></em></a> is
     enabled, the cache files will be regenerated every time, effectively
     disabling caching. You can clear all the cache files with the <a class="link" href="api.clear.all.cache.tpl" title="clear_all_cache()"><code class="varname">clear_all_cache()</code></a>
     function, or individual cache files (or groups) with the <a class="link" href="api.clear.cache.tpl" title="clear_cache()"><code class="varname">clear_cache()</code></a> function.
    </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $cache_handler_func</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/variable.cache.lifetime.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01785 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
