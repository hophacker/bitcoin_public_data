http://www.smarty.net/docsv2/en/plugins.functions.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 15:26:37 GMT
...
<html lang="en">
  <head>
    ...
    <title>Template Functions | Smarty</title>
...
<tr><th colspan="3" align="center">Template Functions</th></tr>
<tr>
...
<a name="plugins.functions"></a>Template Functions</h2></div></div></div>
...
<p>
     All <a class="link" href="language.syntax.attributes.tpl" title="Attributes">attributes</a> passed to
     template functions from the template are contained in the
     <em class="parameter"><code>$params</code></em> as an associative array.
    </p>
<p>
     ...
     task without any output, eg the <a class="link" href="language.custom.functions.tpl#language.function.assign" title="{assign}">
     <code class="varname">{assign}</code></a> function.
    </p>
<p>
     If the function needs to assign some variables to the template or use
     some other Smarty-provided functionality, it can use the supplied
     <em class="parameter"><code>$smarty</code></em> object to do so eg
     <code class="literal">$smarty-&gt;foo()</code>.
    </p>
<p>
     </p>
<div class="example">
<a name="id2879234"></a><p class="title"><b>Example 16.1. function plugin with output</b></p>
...
<div class="example">
<a name="id2879285"></a><p class="title"><b>Example 16.2. function plugin without output</b></p>
<div class="example-contents"><pre class="programlisting">
...
<p>
     ...
     <a class="link" href="api.unregister.function.tpl" title="unregister_function"><code class="varname">unregister_function()</code></a>.
    </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> Modifiers</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 17 plus 20? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/plugins.functions.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01649 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
