http://www.smarty.net/docsv2/es/variable.default.resource.type.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 22:10:33 GMT
...
<p>
   ...
   Para mas detalles vea el capitulo <a class="link" href="template.resources.tpl" title="Recursos">resource</a>.
      </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> Chapter 13. La clase Methods() de Smarty</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 4 plus 4? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/variable.default.resource.type.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.18857 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
