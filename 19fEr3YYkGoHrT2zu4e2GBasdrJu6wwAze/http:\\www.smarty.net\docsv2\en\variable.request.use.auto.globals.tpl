...
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 07:21:25 GMT
...
<p>
   Specifies if Smarty should use PHP's <code class="literal">$HTTP_*_VARS[]</code>
   when <code class="constant">FALSE</code> or <code class="literal">$_*[]</code> when
   <code class="constant">TRUE</code> which is the default value. This affects templates that make use of
   <a class="link" href="language.variables.smarty.tpl" title="{$smarty} reserved variable">
   <code class="literal">{$smarty.request.*}, {$smarty.get.*}</code></a> etc.
      </p>
<div class="note" title="Caution" style="margin-left: 0.5in; margin-right: 0.5in;">
<h3 class="title">Caution</h3>
<p>
       If you set <code class="literal">$request_use_auto_globals to true</code>,
       <a class="link" href="variable.request.vars.order.tpl" title="$request_vars_order">
       <em class="parameter"><code>$request_vars_order</code></em></a> has no effect but
       PHP's configuration value  <code class="literal">gpc_order</code> is used.
   </p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> $error_reporting</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/variable.request.use.auto.globals.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03263 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
