...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 20:06:58 GMT
...
<html lang="en">
  <head>
    ...
    <title>Chapter 18. Tips &amp; Tricks | Smarty</title>
...
<div class="example">
<a name="id2884084"></a><p class="title"><b>Example 18.1. Printing &amp;nbsp; when a variable is empty</b></p>
...
See also <a class="link" href="language.modifier.default.tpl" title="default">
<code class="varname">default</code></a> modifier and
<a class="link" href="tips.default.var.handling.tpl" title="Default Variable Handling">default variable handling</a>.
</p>
</div>
</div>
<div class="navfooter">
...
<td width="40%" align="right" valign="top"> Default Variable Handling</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 9 plus 5? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/tips.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01132 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
