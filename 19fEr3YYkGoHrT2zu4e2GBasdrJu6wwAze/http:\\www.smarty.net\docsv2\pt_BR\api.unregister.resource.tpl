http://www.smarty.net/docsv2/pt_BR/api.unregister.resource.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 22:01:13 GMT
...
<div class="sect1" title="unregister_resource">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="api.unregister.resource"></a>unregister_resource</h2></div></div></div>
<div class="funcsynopsis">
<table border="0" summary="Function synopsis" cellspacing="0" cellpadding="0" class="funcprototype-table"><tr>
<td><code class="funcdef">void <b class="fsfunc">unregister_resource</b>(</code></td>
<td>
<var class="pdparam">name</var><code>)</code>;</td>
<td> </td>
</tr></table>
<div class="paramdef-list">
<code>string <var class="pdparam">name</var></code>;</div>
...
<div class="example">
<a name="id2762180"></a><p class="title"><b>Example 13.27. unregister_resource</b></p>
<div class="example-contents"><pre class="programlisting">
$smarty-&gt;unregister_resource("db");</pre></div>
</div>
...
<td width="40%" align="right" valign="top"> Chapter 14. Caching</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 15 plus 18? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/api.unregister.resource.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01945 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
