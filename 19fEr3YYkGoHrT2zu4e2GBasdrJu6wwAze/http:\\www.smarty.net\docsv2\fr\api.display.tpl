http://www.smarty.net/docsv2/fr/api.display.tpl
HTTP/1.1 200 OK
...
<h2>Name</h2>
<p>display() — Affiche le template</p>
</div>
<div class="refsect1" title="Description">
<a name="id3008768"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">display</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">template</span></span>,<br>             <span class="methodparam"><span class="type">string </span><span class="parameter">cache_id</span></span>,<br>             <span class="methodparam"><span class="type">string </span><span class="parameter">compile_id</span></span>);</code><p>
   ...
   chemin de <a class="link" href="template.resources.tpl" title="Ressources">ressource template</a>
   valides. Vous pouvez passer en second paramètre un identifiant
   de fichier de <em class="parameter"><code>$cache id</code></em>. Reportez-vous à la section
   <a class="link" href="caching.tpl" title="Chapter 14. Cache">cache</a> pour plus de renseignements.
  </p>
<p>
...
<div class="example">
<a name="id3009570"></a><p class="title"><b>Example 13.12. Exemple avec display()</b></p>
...
<br class="example-break"><p>
   Utilisez la syntaxe des <a class="link" href="template.resources.tpl" title="Ressources">ressources templates</a>
   pour afficher des fichiers en-dehors du répertoire
   <a class="link" href="api.variables.tpl#variable.template.dir" title="$template_dir"><em class="parameter"><code>$template_dir</code></em></a>.
  </p>
<div class="example">
<a name="id3009660"></a><p class="title"><b>Example 13.13. Exemples de fonction d'affichage de ressources templates</b></p>
<div class="example-contents"><pre class="programlisting">
...
<td width="40%" align="right" valign="top"> fetch()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/api.display.tpl">
            </form>
            </div>
          </div>
