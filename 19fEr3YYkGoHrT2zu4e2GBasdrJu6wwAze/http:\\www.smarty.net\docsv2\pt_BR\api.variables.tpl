http://www.smarty.net/docsv2/pt_BR/api.variables.tpl
HTTP/1.1 200 OK
...
<html lang="en">
  <head>
    ...
    <title>Chapter 12. Variáveis | Smarty</title>
...
<tr><th colspan="3" align="center">Chapter 12. Variáveis</th></tr>
<tr>
...
<div class="chapter" title="Chapter 12. Variáveis">
<div class="titlepage"><div><div><h2 class="title">
<a name="api.variables"></a>Chapter 12. Variáveis</h2></div></div></div>
<div class="toc">
...
<td width="40%" align="right" valign="top"> $compile_dir</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 3 plus 7? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/api.variables.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03435 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
