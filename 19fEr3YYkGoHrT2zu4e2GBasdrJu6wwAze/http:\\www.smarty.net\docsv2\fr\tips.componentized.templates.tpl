http://www.smarty.net/docsv2/fr/tips.componentized.templates.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 09:17:06 GMT
...
<html lang="en">
  <head>
    ...
    <title>Templates composants | Smarty</title>
...
<tr><th colspan="3" align="center">Templates composants</th></tr>
<tr>
<td width="20%" align="left">
<a accesskey="p" href="tips.wap.tpl">Prev</a> </td>
<th width="60%" align="center">Chapter 18. Trucs et astuces</th>
...
<div class="sect1" title="Templates composants">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="tips.componentized.templates"></a>Templates composants</h2></div></div></div>
<p>
    ...
    les variables et <a class="link" href="api.display.tpl" title="display()"><code class="varname">display()</code></a> le
...
<div class="example">
<a name="id3040940"></a><p class="title"><b>Example 18.7. Template composant</b></p>
<div class="example-contents">
<p>
     <code class="filename">function.load_ticker.php</code> -
     Efface le fichier du répertoire des
     <a class="link" href="variable.plugins.dir.tpl" title="$plugins_dir"><em class="parameter"><code>$plugins</code></em></a>
    </p>
...
<td width="40%" align="right" valign="top"> Dissimuler les adresses email</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/tips.componentized.templates.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02084 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
