http://www.smarty.net/docsv2/it/plugins.prefilters.postfilters.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 12:22:51 GMT
...
<html lang="en">
  <head>
    ...
    <title>Prefiltri/Postfiltri | Smarty</title>
...
<tr><th colspan="3" align="center">Prefiltri/Postfiltri</th></tr>
<tr>
...
<div class="sect1" title="Prefiltri/Postfiltri">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="plugins.prefilters.postfilters"></a>Prefiltri/Postfiltri</h2></div></div></div>
<p>
...
<div class="example">
<a name="id3159961"></a><p class="title"><b>Example 16.7. plugin prefiltro</b></p>
...
<div class="example">
<a name="id3159978"></a><p class="title"><b>Example 16.8. plugin postfilro</b></p>
<div class="example-contents"><pre class="programlisting">
...
<tr>
<td width="40%" align="left" valign="top">Funzioni di Compilazione </td>
...
<td width="40%" align="right" valign="top"> Filtri di Output</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/plugins.prefilters.postfilters.tpl">
            </form>
            </div>
          </div>
