http://www.smarty.net/docsv2/it/variable.debugging.ctrl.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 02:19:34 GMT
...
<p>
       Questa variabile consente modi alternativi per abilitare il 
       debugging. NONE significa che non sono consentiti metodi
       alternativi. URL significa che quando la parola chiave
       SMARTY_DEBUG viene trovata nella QUERY_STRING, il debugging
       viene abilitato per quella chiamata dello script. Se
       $debugging è true, questo valore viene ignorato.
      </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $autoload_filters</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/variable.debugging.ctrl.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02320 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
