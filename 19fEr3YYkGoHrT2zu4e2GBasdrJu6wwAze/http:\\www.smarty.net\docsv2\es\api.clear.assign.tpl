http://www.smarty.net/docsv2/es/api.clear.assign.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 04:22:44 GMT
...
<html lang="en">
  <head>
    ...
    <title>clear_assign() | Smarty</title>
...
<tr><th colspan="3" align="center">clear_assign()</th></tr>
<tr>
...
<div class="refentry" title="clear_assign()">
<a name="api.clear.assign"></a><div class="titlepage"></div>
<div class="refnamediv">
<h2>Name</h2>
<p>clear_assign() — limpia el valor de una variable asignada</p>
</div>
<div class="refsect1" title="Descripción">
<a name="id3127531"></a><h2> Descripción</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">clear_assign</span>(<span class="methodparam"><span class="type">mixed </span><span class="parameter">var</span></span>);</code><p>
   Este puede ser un valor simple, o un arreglo de valores.
  </p>
<div class="example">
<a name="id3127563"></a><p class="title"><b>Example 13.7. clear_assign()</b></p>
...
<br class="example-break"><p>
    Ver también
    <a class="link" href="api.clear.all.assign.tpl" title="clear_all_assign()">clear_all_assign()</a>,
    <a class="link" href="api.clear.config.tpl" title="clear_config()">clear_config()</a>,
    <a class="link" href="api.get.template.vars.tpl" title="get_template_vars()">get_template_vars()</a>,
...
<tr>
<td width="40%" align="left" valign="top">clear_all_cache </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> clear_cache()</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/es/api.clear.assign.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02447 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
