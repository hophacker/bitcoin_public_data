http://www.smarty.net/docsv2/it/api.clear.all.assign.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 18:04:28 GMT
...
<h2>Name</h2>
<p>clear_all_assign</p>
</div>
<div class="refsect1">
<a name="id3139563"></a><h2></h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">clear_all_assign</span>();</code><p>
   Annulla i valori di tutte le variabili assegnate.
  </p>
<div class="example">
<a name="id3139583"></a><p class="title"><b>Example 13.5. clear_all_assign</b></p>
...
<td width="40%" align="right" valign="top"> clear_all_cache</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/api.clear.all.assign.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02837 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
