http://www.smarty.net/docsv2/en/language.function.html.table.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 14:30:56 GMT
...
<div class="example">
<a name="id2828705"></a><p class="title"><b>Example 8.22. {html_table}</b></p>
...
<td width="40%" align="right" valign="top"> {mailto}</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/language.function.html.table.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.01919 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
