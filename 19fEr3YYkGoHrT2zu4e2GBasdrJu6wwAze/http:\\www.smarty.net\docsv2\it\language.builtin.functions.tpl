http://www.smarty.net/docsv2/it/language.builtin.functions.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 11:41:29 GMT
...
<html lang="en">
  <head>
    ...
    <title>Chapter 7. Funzioni incorporate | Smarty</title>
...
<tr><th colspan="3" align="center">Chapter 7. Funzioni incorporate</th></tr>
<tr>
...
<div class="chapter" title="Chapter 7. Funzioni incorporate">
<div class="titlepage"><div><div><h2 class="title">
<a name="language.builtin.functions"></a>Chapter 7. Funzioni incorporate</h2></div></div></div>
<div class="toc">
...
<td>Nome del blocco catturato</td>
</tr>
<tr>
...
<td>Nome della variabile cui assegnare l'output catturato</td>
</tr>
</tbody>
</table></div>
<p>
...
<p>
        Fate attenzione se catturate l'output di <span class="command"><strong>insert</strong></span>.
        Se avete il caching attivato e usate comandi <span class="command"><strong>insert</strong></span>
...
<div class="example">
<a name="id3103979"></a><p class="title"><b>Example 7.1. catturare il contenuto del template</b></p>
...
<tr>
<td width="40%" align="left" valign="top">Chapter 6. Combinare i modificatori </td>
...
<td width="40%" align="right" valign="top"> config_load</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/language.builtin.functions.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02662 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
