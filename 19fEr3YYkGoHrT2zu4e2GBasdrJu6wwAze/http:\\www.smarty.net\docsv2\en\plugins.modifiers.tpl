...
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 13:58:05 GMT
...
<p>
     <a class="link" href="language.modifiers.tpl" title="Chapter 5. Variable Modifiers">Modifiers</a> are little functions
...
<div class="example">
<a name="id2878137"></a><p class="title"><b>Example 16.3. A simple modifier plugin</b></p>
...
<div class="example">
<a name="id2879663"></a><p class="title"><b>Example 16.4. More complex modifier plugin</b></p>
...
<br class="example-break"><p>
     See also
     <a class="link" href="api.register.modifier.tpl" title="register_modifier()"><code class="varname">register_modifier()</code></a>,
...
<td width="40%" align="right" valign="top"> Block Functions</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/plugins.modifiers.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03186 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
