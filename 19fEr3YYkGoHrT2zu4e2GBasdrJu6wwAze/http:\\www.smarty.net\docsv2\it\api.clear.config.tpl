http://www.smarty.net/docsv2/it/api.clear.config.tpl
HTTP/1.1 200 OK
...
<div class="example">
<a name="id3141059"></a><p class="title"><b>Example 13.10. clear_config</b></p>
...
<td width="40%" align="right" valign="top"> config_load</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/api.clear.config.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02592 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
