http://www.smarty.net/docsv2/en/variable.config.fix.newlines.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 13:25:03 GMT
...
<p>
	   If set to <code class="constant">TRUE</code>, mac and dos newlines ie <code class="literal">'\r'</code> and
       <code class="literal">'\r\n'</code> in config files are
	   converted to <code class="literal">'\n'</code> when they are parsed.
       Default is <code class="constant">TRUE</code>.
	   </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $default_template_handler_func</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/en/variable.config.fix.newlines.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03079 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
