http://www.smarty.net/docsv2/fr/variable.default.resource.type.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 06:25:11 GMT
...
<p>
  ...
  par défaut est <code class="literal">file</code>, signifiant que
  <code class="literal">$smarty-&gt;display('index.tpl')</code> et
  <code class="literal">$smarty-&gt;display('file:index.tpl')</code> sont la même chose. Voyez le chapitre
  <a class="link" href="template.resources.tpl" title="Ressources">ressource</a> pour plus de détails.
 </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> Chapter 13. Méthodes</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 20 plus 18? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              <input id="commentFormChallengeObf" type="hidden" name="obf" value="4d39535357fc38b3c130b9dd84eeb544">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/variable.default.resource.type.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02712 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
