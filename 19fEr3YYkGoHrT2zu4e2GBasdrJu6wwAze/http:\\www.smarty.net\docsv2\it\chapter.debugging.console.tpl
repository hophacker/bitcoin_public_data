http://www.smarty.net/docsv2/it/chapter.debugging.console.tpl
HTTP/1.1 200 OK
Date: Thu, 24 Jul 2014 12:22:46 GMT
...
<html lang="en">
  <head>
    ...
    <title>Chapter 10. Console di Debugging | Smarty</title>
...
<tr><th colspan="3" align="center">Chapter 10. Console di Debugging</th></tr>
<tr>
...
<div class="chapter" title="Chapter 10. Console di Debugging">
<div class="titlepage"><div><div><h2 class="title">
<a name="chapter.debugging.console"></a>Chapter 10. Console di Debugging</h2></div></div></div>
<p>
  C'è una console di debugging inclusa in Smarty. La console vi informa di
  ...
  distribuzione di Smarty è incluso un template chiamato "debug.tpl" che
  ...
  consultate la funzione <a class="link" href="language.function.debug.tpl" title="debug">{debug}</a>.
  ...
  nell'URL, se abilitate questa opzione con <a class="link" href="variable.debugging.ctrl.tpl" title="$debugging_ctrl">$debugging_ctrl</a>.
 </p>
...
<tr>
<td width="40%" align="left" valign="top">Chapter 9. File di configurazione </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Part III. Smarty Per Programmatori</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 5 plus 17? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/chapter.debugging.console.tpl">
            </form>
            </div>
          </div>
