http://www.smarty.net/docsv2/it/api.unregister.resource.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 03:31:49 GMT
...
<h2>Name</h2>
<p>unregister_resource</p>
</div>
<div class="refsect1">
<a name="id3147291"></a><h2></h2>
...
<div class="example">
<a name="id3147323"></a><p class="title"><b>Example 13.27. unregister_resource</b></p>
...
<td width="40%" align="right" valign="top"> Chapter 14. Caching</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 12 plus 20? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/api.unregister.resource.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.03184 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
