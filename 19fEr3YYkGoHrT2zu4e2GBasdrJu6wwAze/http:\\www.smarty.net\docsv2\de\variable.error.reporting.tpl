http://www.smarty.net/docsv2/de/variable.error.reporting.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 23:37:09 GMT
...
<p>
      ...
      von PHP beim Aufruf von <a class="link" href="api.display.tpl" title="display (ausgeben)">display()</a>
      und <a class="link" href="api.fetch.tpl" title="fetch">fetch()</a>.
      Wenn <a class="link" href="chapter.debugging.console.tpl" title="Chapter 10. Debugging Konsole">debugging</a>
      aktiviert ist, dann wird dieser Wert ignoriert.
    </p>
<p>
      Siehe auch
      <a class="link" href="api.trigger.error.tpl" title="trigger_error (Fehler auslösen)">trigger_error()</a>,
      <a class="link" href="chapter.debugging.console.tpl" title="Chapter 10. Debugging Konsole">debugging</a>
      und
      <a class="link" href="troubleshooting.tpl" title="Chapter 17. Problemlösung">Troubleshooting</a>.
    </p>
</div>
<div class="navfooter">
<hr>
...
<td width="40%" align="right" valign="top"> $compile_id</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/de/variable.error.reporting.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.18783 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
