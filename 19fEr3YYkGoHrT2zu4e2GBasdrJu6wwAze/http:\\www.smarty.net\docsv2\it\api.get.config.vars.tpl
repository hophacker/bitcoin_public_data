http://www.smarty.net/docsv2/it/api.get.config.vars.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 13:45:39 GMT
...
<code class="methodsynopsis"><span class="type">array </span><span class="methodname">get_config_vars</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">varname</span></span>);</code><p>
   Restituisce il valore della variabile di configurazione data, se è stata
   caricata. Se non viene passato un parametro viene restituito un array
   di tutte le variabili di configurazione caricate.
  </p>
<div class="example">
<a name="id3142434"></a><p class="title"><b>Example 13.15. get_config_vars</b></p>
...
<td width="40%" align="right" valign="top"> get_registered_object</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 7 plus 9? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/it/api.get.config.vars.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02249 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
