http://www.smarty.net/docsv2/fr/plugins.modifiers.tpl
HTTP/1.1 200 OK
Date: Wed, 23 Jul 2014 17:51:10 GMT
...
<html lang="en">
  <head>
    ...
    <title>Modificateurs | Smarty</title>
...
<tr><th colspan="3" align="center">Modificateurs</th></tr>
<tr>
...
<div class="sect1" title="Modificateurs">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="plugins.modifiers"></a>Modificateurs</h2></div></div></div>
<p>
  Les <a class="link" href="language.modifiers.tpl" title="Chapter 5. Modificateurs de variables">modificateurs</a>
...
<p>
  Le modificateur doit <a class="ulink" href="http://php.net/return" target="_top">retourner</a>
  le résultat de son exécution.
 </p>
<div class="example">
<a name="id3033358"></a><p class="title"><b>Example 16.3. Plugin modificateur simple</b></p>
...
<div class="example">
<a name="id3034885"></a><p class="title"><b>Example 16.4. Un plugin modificateur un peu plus complexe</b></p>
...
<br class="example-break"><p>
  ...
  <a class="link" href="api.unregister.modifier.tpl" title="unregister_modifier()"><code class="varname">unregister_modifier()</code></a>.
 </p>
</div>
<div class="navfooter">
<hr>
...
<tr>
<td width="40%" align="left" valign="top">Les fonctions de templates </td>
<td width="20%" align="center"><a accesskey="h" href="index.tpl">Home</a></td>
<td width="40%" align="right" valign="top"> Fonctions de blocs</td>
</tr>
</table>
</div>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <div id="commentFormChallenge">What is 10 plus 15? <input id="commentFormChallengeText" type="text" name="challenge" size="30" value="" style="color: grey"> <span style="font-style: italic">(Are you human?)</span></div>
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/plugins.modifiers.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02808 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
