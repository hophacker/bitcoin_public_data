http://www.smarty.net/docsv2/pt_BR/api.clear.all.assign.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 07:21:23 GMT
...
<div class="sect1" title="clear_all_assign">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="api.clear.all.assign"></a>clear_all_assign</h2></div></div></div>
<div class="funcsynopsis">
<table border="0" summary="Function synopsis" cellspacing="0" cellpadding="0" class="funcprototype-table"><tr>
<td><code class="funcdef">void <b class="fsfunc">clear_all_assign</b>(</code></td>
<td>
<var class="pdparam"></var><code>)</code>;</td>
<td> </td>
</tr></table>
<div class="paramdef-list">
<code><var class="pdparam"></var></code>;</div>
...
<div class="example">
<a name="id2755776"></a><p class="title"><b>Example 13.5. clear_all_assign</b></p>
<div class="example-contents"><pre class="programlisting">
// clear all assigned variables
$smarty-&gt;clear_all_assign();</pre></div>
</div>
...
<td width="40%" align="right" valign="top"> clear_all_cache</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/api.clear.all.assign.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.20846 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
