http://www.smarty.net/docsv2/fr/api.append.by.ref.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 17:27:02 GMT
...
<h2>Name</h2>
<p>append_by_ref() — Ajoute des valeurs par référence</p>
</div>
<div class="refsect1" title="Description">
<a name="id3005186"></a><h2>Description</h2>
<code class="methodsynopsis"><span class="type">void </span><span class="methodname">append_by_ref</span>(<span class="methodparam"><span class="type">string </span><span class="parameter">varname</span></span>,<br>                   <span class="methodparam"><span class="type">mixed </span><span class="parameter">var</span></span>,<br>                   <span class="methodparam"><span class="type">bool </span><span class="parameter">merge</span></span>);</code><p>
   Utilisée pour <a class="link" href="api.append.tpl" title="append()">ajouter</a> des valeurs à un
   ...
   <code class="varname">append_by_ref()</code> ne fait pas de copie en mémoire de l'objet
   assigné. Voir la documentation PHP pour plus d'informations sur les
   références de variable.
   Si vous passez le troisième paramètre à <code class="constant">TRUE</code>, la valeur 
...
<p>
  Le paramètre <em class="parameter"><code>merge</code></em> respecte les clés du tableau,
  ...
  est diférent de la fonction PHP <a class="ulink" href="http://php.net/array_merge" target="_top">array_merge()</a> 
  qui élimine des clés numériques et les renumérote.
 </p>
</div>
<div class="example">
<a name="id3006180"></a><p class="title"><b>Example 13.2. Exemple avec append_by_ref</b></p>
...
<br class="example-break"><p>
  ...
  <a class="link" href="api.assign.tpl" title="assign()"><code class="varname">assign()</code></a> et
...
<td width="40%" align="right" valign="top"> assign()</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/fr/api.append.by.ref.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02648 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
