http://www.smarty.net/docsv2/pt_BR/api.unregister.function.tpl
HTTP/1.1 200 OK
Date: Tue, 22 Jul 2014 07:20:43 GMT
...
<div class="sect1" title="unregister_function">
<div class="titlepage"><div><div><h2 class="title" style="clear: both">
<a name="api.unregister.function"></a>unregister_function</h2></div></div></div>
<div class="funcsynopsis">
<table border="0" summary="Function synopsis" cellspacing="0" cellpadding="0" class="funcprototype-table"><tr>
<td><code class="funcdef">void <b class="fsfunc">unregister_function</b>(</code></td>
<td>
...
<div class="example">
<a name="id2760520"></a><p class="title"><b>Example 13.25. unregister_function</b></p>
<div class="example-contents"><pre class="programlisting">
// nós não queremos que designers template tenham acesso aos nossos arquivos do sistema

$smarty-&gt;unregister_function("fetch");</pre></div>
</div>
...
<td width="40%" align="right" valign="top"> unregister_modifier</td>
          ...
          <div id="commentFormWrapper">
            ...
            <form id="commentForm" method="post" action="/comments/post">
              ...
              <input id="commentFormPageID" type="hidden" name="page_id" value="docsv2/pt_BR/api.unregister.function.tpl">
            </form>
            </div>
          </div>
  ...
  <div id="footer">
    ...
    <p>This page generated in 0.02746 secs with <a href="http://www.tinymvc.com/">TinyMVC</a> and Smarty 3.</p>
  </div>    
