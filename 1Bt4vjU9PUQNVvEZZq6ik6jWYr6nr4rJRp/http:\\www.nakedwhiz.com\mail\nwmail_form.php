http://www.nakedwhiz.com/mail/nwmail_form.php
HTTP/1.0 200 OK
Date: Thu, 24 Jul 2014 04:27:44 GMT
...
<HTML>
<HEAD>
<TITLE>The Naked Whiz's Ceramic Charcoal Cooker Page</TITLE>
</head>
<body bgcolor="#000000" text="#ffffff" link=lime alink=lime vlink=lime>
...
<P><BR><P>
<center><font size=6><B>Send Email To The Webmaster</b></font></center>

<P>
<center>
<font face=verdana>
<B>NOTE: This form can only be used to send email to the webmaster.</B>  <BR>(This form cannot be used to email a webpage to a friend.)
</font>
</center>

<P>
<form action="record_nwmail.php" method="post">
<table align=center cellpadding=10 width=650 style="border: white 1px solid; border-collapse:collapse;"><tr><td>

<P>
<table width=650 align=center>

<tr align=center>
<td valign=top align=right width=40%><font face=verdana size=-1><b>Your name <font color=yellow>(required)</font>:</b></font></td>
<td align=left width=60%><input type=text name="name" size=40></td>
</tr>

<tr align=center>
<td valign=top align=right><font face=verdana size=-1><b>Your Email Address <font color=yellow>(required)</font>:</b></font></td>
<td align=left><input type=text name="email" size=40></td>
</tr>

<tr align=center>
<td valign=top align=right><font face=verdana size=-1><b>Subject <font color=yellow>(required)</font>:</b></font></td>
...
<BR><P>
<b>Please type your message below <font color=yellow>(required)</font>:
</b></font><br>
<textarea cols=50 rows=8 name="body"></textarea>

<br>
<font face=verdana size=-1>
<center>Press the <B>Send Email</b> button below after<BR>you enter your message above.  Thank you!</center><br /></font>
